...
[宽世界导入程序-源](https://github.com/Microsoft/sql-server-samples/tree/master/samples/databases/wide-world-importers/wwi-dw-database-scripts)
...
[适用于 SQL Server 2016 （和更高版本）开发人员/评估版]
