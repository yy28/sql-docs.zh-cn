---
title: WideWorldImporters OLTP 数据库目录-SQL |Microsoft 文档
ms.prod: sql
ms.prod_service: sql
...
此架构中的存储的过程使用 ETL 过程。 获得所需的时间范围的各种表中所需的数据[ETL 包](wide-world-importers-perform-etl.md)。
