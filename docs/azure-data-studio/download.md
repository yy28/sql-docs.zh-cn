...
1. 下载并运行[适用于 Windows 的 [!INCLUDE[name-sos](../includes/name-sos-short.md)] 用户安装程序](https://go.microsoft.com/fwlink/?linkid=2109256)  。
2. 启动 [!INCLUDE[name-sos-short](../includes/name-sos-short.md)] 应用。

**系统安装程序**

1. 下载并运行[适用于 Windows 的 [!INCLUDE[name-sos](../includes/name-sos-short.md)] 系统安装程序](https://go.microsoft.com/fwlink/?linkid=2109085)  。
2. 启动 [!INCLUDE[name-sos-short](../includes/name-sos-short.md)] 应用。

**zip 文件**

1. 下载[适用于 Windows 的 [!INCLUDE[name-sos](../includes/name-sos-short.md)] .zip](https://go.microsoft.com/fwlink/?linkid=2109255)。
2. 浏览到下载文件并将其解压缩。
...
1. 下载[适用于 macOS 的 [!INCLUDE[name-sos](../includes/name-sos-short.md)]](https://go.microsoft.com/fwlink/?linkid=2109180)。
2. 若要展开 zip 的内容，请双击。
