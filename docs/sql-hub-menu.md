                ...
                <ul id="products">
                         ...
                         <ul id="products-sql-server" class="cardsC">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>使用可缩放的混合数据库平台生成任务关键型智能应用程序。 它具有一切内置的功能优势：从内存中性能和高级安全性，到数据库内分析。</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>新增功能</h3>
                                                <p>SQL Server 2016 和更高版本的新功能与更新</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SQL Server Management Studio 教程</h3>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Transact-SQL 教程</h3>
                                                <p>了解如何编写 Transact-SQL 语句</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li>
                        ...
                        <ul id="products-sql-server-azure" class="cardsC">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>Azure 虚拟机上宿主 SQL Server，包括 SQL Server 2016 Enterprise Edition。 使用库映像或自带许可证。 将本地 SQL Server 工作负荷迁移到云中。</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>预配</h3>
                                                <p>在 Azure 门户中预配 SQL Server 虚拟机</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>迁移</h3>
                                                <p>将 SQL Server 数据库迁移到 Azure 虚拟机中的 SQL Server</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>可用性和恢复</h3>
                                                <p>Azure 虚拟机中 SQL Server 的高可用性和灾难恢复</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>适用于 VM 上的 SQL Server 的方案</h3>
                                                <p>了解 SQL Server 虚拟机如何解决各种业务问题</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>常见问题解答</h3>
                                                <p>获取有关 Azure VM 上的 SQL Server 常见问题的解答</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>文档</h3>
                                                <p>下载 Azure VM 上的 SQL Server 的文档</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li>
                        <a href="/en-us/sql/linux?toc=/sql/linux/toc.json">Linux 上的 SQL Server</a>
                    </li>
                    <li>
                        <a href="/en-us/sql/advanced-analytics/r-services/">SQL Server R Services</a>
                    </li>
                    <li>
                        <a href="/en-us/azure/sql-database/">Azure SQL 数据库</a>
                    </li>
                    <li>
                        <a href="/en-us/azure/sql-data-warehouse/">Azure SQL 数据仓库</a>
                    </li>
                    <li>
                        <a href="/en-us/sql/microsoft-sql-documentation-table-of-contents">SQL 目录</a>
                    </li>
                </ul>
            </li>
            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>T-SQL</h3>
                                                <p><a href="https://msdn.microsoft.com/library/bb510741.aspx">入门</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>ADO.NET</h3>
                                                <p><a href="/sql/connect/ado-net/microsoft-ado-net-for-sql-server">入门</a></p>
                                                <p><a href="https://msdn.microsoft.com/library/system.data.sqlclient.aspx">API 参考</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>驱动程序</h3>
                                                <p><a href="/sql/connect/sql-server-drivers">入门</a></p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SSMS</h3>
                                                <p><a href="/azure/sql-database/sql-database-connect-query-ssms">入门</a></p>
                                                <p><a href="/sql/ssms/download-sql-server-management-studio-ssms">下载 SQL Server Management Studio</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SSDT</h3>
                                                <p><a href="https://msdn.microsoft.com/library/hh272686(v=vs.103).aspx">入门</a></p>
                                                <p><a href="/sql/ssdt/download-sql-server-data-tools-ssdt">下载 SQL Server Data Tools</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>VS Code 和 SQL 扩展</h3>
                                                <p><a href="https://code.visualstudio.com/docs">入门</a></p>
                                                <p><a href="https://code.visualstudio.com/">下载 Visual Studio Code</a></p>
                                                <p><a href="https://marketplace.visualstudio.com/items?itemName=ms-mssql.mssql">SQL 扩展 (mssql)</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>PowerShell</h3>
                                                <p><a href="/azure/powershell-install-configure">入门</a></p>
                                                <p><a href="/powershell/resourcemanager/azurerm.sql/v2.3.0/azurerm.sql">Azure SQL 数据库 cmdlet</a></p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure CLI 2.0</h3>
                                                <p><a href="/cli/azure/get-started/">入门</a></p>
                                                <p><a href="https://github.com/Azure/azure-cli">下载 Azure CLI 2.0</a></p>
                                                <p><a href="/cli/azure/">参考</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure CLI</h3>
                                                <p><a href="/azure/xplat-cli-install?toc=/azure/virtual-machines/linux/toc.json">入门</a></p>
                                                <p><a href="http://aka.ms/linux-azure-cli">下载适用于 Linux 的 Azure CLI</a></p>
                                                <p><a href="http://aka.ms/mac-azure-cli">下载适用于 Mac 的 Azure CLI</a></p>
                                                <p><a href="http://aka.ms/webpi-azure-cli">下载适用于 Windows 的 Azure CLI</a></p>
                                                <p><a href="https://azure.microsoft.com/documentation/articles/azure-cli-arm-commands/">参考</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <ul id="architecture">
                    <li>
                        ...
                        <ul id="architecture1" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>SQL 的体系结构建议和模式，从 Azure SQL 数据库开始。</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>多租户 SaaS 应用程序</h3>
                                                    <p>Azure SQL 数据库中多租户 SaaS 应用程序的设计模式</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>行级安全性</h3>
                                                    <p>在 Azure SQL 数据库中使用分片数据库实现行级安全性</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>应用程序的灾难恢复设计</h3>
                                                    <p>在 Azure SQL 数据库中使用活动异地复制设计应用程序的云灾难恢复</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用弹性池实现灾难恢复策略</h3>
                                                    <p>在 Azure SQL 数据库中使用弹性池为应用程序实现灾难恢复策略</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
