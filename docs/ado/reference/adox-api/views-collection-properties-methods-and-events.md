---
title: 视图集合属性、 方法和事件 |Microsoft Docs
ms.prod: sql
...
ms.locfileid: "63281224"
---
# <a name="views-collection-properties-methods-and-events"></a>视图集合属性、方法和事件
...
## <a name="methods"></a>方法  
 [Append 方法 （视图）](../../../ado/reference/adox-api/append-method-adox-views.md)  
