...
ms.locfileid: "67966689"
---
# <a name="command-property-adox"></a>Command 属性 (ADOX)
指定 ADO[命令](../../../ado/reference/ado-api/command-object-ado.md)可用于创建或执行该过程的对象。  
...
|||  
|-|-|  
|[过程对象 (ADOX)](../../../ado/reference/adox-api/procedure-object-adox.md)|[视图对象 (ADOX)](../../../ado/reference/adox-api/view-object-adox.md)|  
