...
-   返回与集合中包含的过程数[计数](../../../ado/reference/ado-api/count-property-ado.md)属性。  
  
-   从与集合中移除一个过程[删除](../../../ado/reference/adox-api/delete-method-adox-collections.md)方法。  
