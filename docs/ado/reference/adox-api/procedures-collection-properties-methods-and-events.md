---
description: 过程集合属性、方法和事件
title: 过程集合属性、方法和事件 |Microsoft Docs
ms.prod: sql
...
## <a name="methods"></a>方法  
 [Append 方法 (过程) ](./append-method-adox-procedures.md)  
  
 [ (集合的 Delete 方法) ](./delete-method-adox-collections.md)  
