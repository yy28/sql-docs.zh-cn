...
-   [列和表追加方法名称的属性示例 （VC + +）](../../../ado/reference/adox-api/columns-and-tables-append-methods-name-property-example-vc.md)  
  
-   [连接关闭方法，表类型的属性示例 （VC + +）](../../../ado/reference/adox-api/connection-close-method-table-type-property-example-vc.md)  
  
-   [创建方法示例 （VC + +）](../../../ado/reference/adox-api/create-method-example-vc.md)  
...
-   [组和用户追加，ChangePassword 方法示例 （VC + +）](../../../ado/reference/adox-api/groups-and-users-append-changepassword-methods-example-vc.md)  
  
-   [索引追加方法示例 （VC + +）](../../../ado/reference/adox-api/indexes-append-method-example-vc.md)  
...
-   [属性的属性示例 （VC + +）](../../../ado/reference/adox-api/attributes-property-example-vc.md)  
  
-   [目录 ActiveConnection 属性示例 （VC + +）](../../../ado/reference/adox-api/catalog-activeconnection-property-example-vc.md)  
  
-   [Clustered 的属性示例 （VC + +）](../../../ado/reference/adox-api/clustered-property-example-vc.md)  
  
-   [命令和 CommandText 属性示例 （VC + +）](../../../ado/reference/adox-api/command-and-commandtext-properties-example-vc.md)  
  
-   [命令属性，参数集合示例 （VC + +）](../../../ado/reference/adox-api/parameters-collection-command-property-example-vc.md)  
  
-   [时间和 DateModified 属性示例 （VC + +）](../../../ado/reference/adox-api/datecreated-and-datemodified-properties-example-vc.md)  
...
-   [NumericScale 和精度属性示例 （VC + +）](../../../ado/reference/adox-api/numericscale-and-precision-properties-of-the-column-object-example-vc.md)  
  
-   [ParentCatalog 属性示例 （VC + +）](../../../ado/reference/adox-api/parentcatalog-property-example-vc.md)  
  
-   [PrimaryKey 和唯一属性示例 （VC + +）](../../../ado/reference/adox-api/primarykey-and-unique-properties-example-vc.md)  
  
-   [表类型属性，连接关闭方法的示例 （VC + +）](../../../ado/reference/adox-api/connection-close-method-table-type-property-example-vc.md)  
  
## <a name="collections"></a>集合  
  
-   [参数集合，命令属性示例 （VC + +）](../../../ado/reference/adox-api/parameters-collection-command-property-example-vc.md)
