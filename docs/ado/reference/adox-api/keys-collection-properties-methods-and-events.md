---
title: 键集合属性、 方法和事件 |Microsoft 文档
ms.prod: sql
...
ms.locfileid: "35286566"
---
# <a name="keys-collection-properties-methods-and-events"></a>键集合属性、 方法和事件
...
## <a name="methods"></a>方法  
 [Append 方法 （键）](../../../ado/reference/adox-api/append-method-adox-keys.md)  
