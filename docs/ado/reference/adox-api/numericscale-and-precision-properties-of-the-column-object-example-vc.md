---
title: NumericScale 和精度属性的列的示例 （VC + +） |Microsoft 文档
ms.prod: sql
...
ms.locfileid: "35286546"
---
# <a name="numericscale-and-precision-properties-of-the-column-object-example-vc"></a>NumericScale 和精度属性的列对象的示例 （VC + +）
