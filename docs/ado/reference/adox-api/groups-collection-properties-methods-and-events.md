---
title: 集合属性、 方法和事件进行分组 |Microsoft 文档
ms.prod: sql
...
ms.locfileid: "35286006"
---
# <a name="groups-collection-properties-methods-and-events"></a>组集合属性、 方法和事件
...
## <a name="methods"></a>方法  
 [Append 方法 （组）](../../../ado/reference/adox-api/append-method-adox-groups.md)  
