...
## <a name="remarks"></a>备注  
 [追加](../../../ado/reference/adox-api/append-method-adox-views.md)方法**视图**是唯一的 ADOX 集合。 你可以：  
  
-   将新视图添加到具有集合**追加**方法。  
  
 剩余的属性和方法是标准到 ADO 集合。 你可以：  
  
-   访问集合中具有视图[项](../../../ado/reference/ado-api/item-property-ado.md)属性。  
  
-   返回与集合中包含的视图数目[计数](../../../ado/reference/ado-api/count-property-ado.md)属性。  
