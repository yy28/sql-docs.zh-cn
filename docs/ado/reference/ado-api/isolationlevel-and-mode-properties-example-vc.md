---
description: 'IsolationLevel 和 Mode Properties (VC + +) '
title: IsolationLevel 和 Mode Properties (VC + +) |Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88990788"
---
# <a name="isolationlevel-and-mode-properties-example-vc"></a>IsolationLevel 和 Mode Properties (VC + +) 
