...
-   用于 [COM 的 Visual C++ 语法索引的 ado](../../../ado/reference/ado-api/ado-for-visual-c-syntax-index-for-com.md) 涵盖 ado 属性和方法，而不会将 **#import** 编译器指令与 Microsoft Visual C++ 结合使用。  
  
-   用于 [Visual C++ 语法索引的 ado #import](../../../ado/reference/ado-api/ado-for-visual-c-syntax-index-with-sharpimport.md) 在将 **#import** 编译器指令与 Microsoft Visual C++ 一起使用时涵盖 ado 属性和方法。  
