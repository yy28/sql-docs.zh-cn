...
## <a name="remarks"></a>备注  
 ...
 使用可选*源*参数，以指定数据源使用以下值之一：**命令**对象变量、 SQL 语句、 存储的过程、 表名称、 一个 URL 或完整文件路径名称。 如果*源*是文件路径名称，它可以是完整路径 ("c:\dir\file.rst") 的相对路径 ("...\file.rst")，或 URL ("http://files/file.rst")。  
