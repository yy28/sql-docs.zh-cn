---
description: Update 和 CancelUpdate 方法示例 (VC++)
title: Update 和 CancelUpdate 方法示例 (VC + +) |Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88988108"
---
# <a name="update-and-cancelupdate-methods-example-vc"></a>Update 和 CancelUpdate 方法示例 (VC++)
此示例将 [更新](./update-method.md) 方法与 [CancelUpdate](./cancelupdate-method-ado.md) 方法结合在一起。  
