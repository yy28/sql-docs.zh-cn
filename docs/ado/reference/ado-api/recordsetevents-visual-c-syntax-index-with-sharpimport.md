---
title: 'RecordsetEvents （使用的 Visual c + + 语法索引 #import） |Microsoft Docs'
ms.prod: sql
...
---
# <a name="recordsetevents-visual-c-syntax-index-with-import"></a>RecordsetEvents （使用的 Visual c + + 语法索引 #import）
## <a name="events"></a>事件  
