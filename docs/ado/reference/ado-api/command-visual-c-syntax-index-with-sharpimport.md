---
description: '命令 (Visual C++ 语法索引与 #import) '
title: 命令 (#import) 的 Visual C++ 语法索引 |Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88776126"
---
# <a name="command-visual-c-syntax-index-with-import"></a>命令 (Visual C++ 语法索引与 #import) 
## <a name="methods"></a>方法  
