---
title: "AddNew 方法示例 (JScript) |Microsoft 文档"
...
此示例使用[AddNew](../../../ado/reference/ado-api/addnew-method-ado.md)方法具有指定名称创建一条新记录。 剪切并粘贴到记事本或其他文本编辑器，下面的代码，然后将其保存为**AddNewJS.asp**。  
