---
title: '记录集 （使用的 Visual c + + 语法索引 #import） |Microsoft Docs'
ms.prod: sql
...
ms.locfileid: "47731405"
---
# <a name="recordset-visual-c-syntax-index-with-import"></a>记录集 （使用的 Visual c + + 语法索引 #import）
## <a name="methods"></a>方法  
