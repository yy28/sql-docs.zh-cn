...
ms.locfileid: "35279556"
---
# <a name="move-method-example-vc"></a>移动方法示例 （VC + +）
此示例使用[移动](../../../ado/reference/ado-api/move-method-ado.md)方法为记录指针定位基于用户输入。  
