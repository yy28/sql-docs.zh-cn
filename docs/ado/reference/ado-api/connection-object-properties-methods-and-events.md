...
## <a name="propertiescollections"></a>属性/集合  
 ...
 [提供程序属性](./provider-property-ado.md)  
  
 [State 属性](./state-property-ado.md)  
  
 [Version 属性](./version-property-ado.md)  
...
## <a name="events"></a>事件  
 ...
 [ConnectComplete 和断开连接事件](./connectcomplete-and-disconnect-events-ado.md)  
