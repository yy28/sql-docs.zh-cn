...
## <a name="remarks"></a>备注  
 使用**删除**集合上的方法，可删除其中一个对象集合中。 此方法是仅适用于**参数**系列[命令](../../../ado/reference/ado-api/command-object-ado.md)对象。 必须使用[参数](../../../ado/reference/ado-api/parameter-object.md)对象的[名称](../../../ado/reference/ado-api/name-property-ado.md)属性或调用时其集合索引**删除**方法 — 对象变量不是有效的参数。  
