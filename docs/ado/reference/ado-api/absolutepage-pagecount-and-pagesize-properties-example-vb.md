---
title: AbsolutePage、 PageCount，以及 PageSize 属性示例 (VB) |Microsoft 文档
ms.prod: sql
...
ms.locfileid: "35274914"
---
# <a name="absolutepage-pagecount-and-pagesize-properties-example-vb"></a>AbsolutePage、 PageCount，以及 PageSize 属性示例 (VB)
```  
'BeginAbsolutePageVB  
