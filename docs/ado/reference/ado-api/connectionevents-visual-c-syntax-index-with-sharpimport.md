---
title: 'ConnectionEvents (VisualC++使用 #import 语法索引) |Microsoft Docs'
ms.prod: sql
...
ms.locfileid: "66698723"
---
# <a name="connectionevents-visual-c-syntax-index-with-import"></a>ConnectionEvents (VisualC++使用 #import 语法索引)
## <a name="events"></a>事件  
