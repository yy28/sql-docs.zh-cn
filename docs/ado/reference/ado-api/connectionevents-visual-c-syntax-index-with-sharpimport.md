---
description: 'ConnectionEvents (Visual C++ 语法索引与 #import) '
title: 'ConnectionEvents (Visual C++ #import) 的语法索引 |Microsoft Docs'
ms.prod: sql
...
ms.locfileid: "88974808"
---
# <a name="connectionevents-visual-c-syntax-index-with-import"></a>ConnectionEvents (Visual C++ 语法索引与 #import) 
## <a name="events"></a>事件  
