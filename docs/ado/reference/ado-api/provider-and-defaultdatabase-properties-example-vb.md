---
title: 提供程序和 DefaultDatabase 属性示例 (VB) |Microsoft 文档
ms.prod: sql
...
ms.locfileid: "35280816"
---
# <a name="provider-and-defaultdatabase-properties-example-vb"></a>提供程序和 DefaultDatabase 属性示例 (VB)
