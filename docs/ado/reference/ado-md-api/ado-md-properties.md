...
|[项](../../../ado/reference/ado-md-api/item-property-ado-md-cellset.md)|从使用其坐标是单元集检索单元格。|  
|[项](../../../ado/reference/ado-api/item-property-ado.md)|按名称或序号返回集合的特定成员。|  
|[FormattedValue](../../../ado/reference/ado-md-api/formattedvalue-property-ado-md.md)|指示格式化的显示的一个单元格值。|  
|[LevelDepth](../../../ado/reference/ado-md-api/leveldepth-property-ado-md.md)|指示层次结构的根和成员之间的级别数。|  
|[LevelName](../../../ado/reference/ado-md-api/levelname-property-ado-md.md)|指示某个成员的级别的名称。|  
|[名称](../../../ado/reference/ado-md-api/name-property-ado-md.md)|指示对象的名称。|  
|[序号 （单元）](../../../ado/reference/ado-md-api/ordinal-property-ado-md-cell.md)|唯一标识的集中的单元格位置来的单元格。|  
|[序号 （位置）](../../../ado/reference/ado-md-api/ordinal-property-ado-md-position.md)|唯一标识沿 x 轴的位置。|  
|[Parent](../../../ado/reference/ado-md-api/parent-property-ado-md.md)|指示是层次结构中的当前成员的父级的成员。|  
|[ParentSameAsPrev](../../../ado/reference/ado-md-api/parentsameasprev-property-ado-md.md)|指示此位置成员的父级是否与前面紧邻的成员的父级的相同。|  
