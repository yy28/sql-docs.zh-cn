---
description: 层次结构集合属性、方法和事件
title: 层次结构集合属性、方法和事件 |Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88778096"
---
# <a name="hierarchies-collection-properties-methods-and-events"></a>层次结构集合属性、方法和事件
