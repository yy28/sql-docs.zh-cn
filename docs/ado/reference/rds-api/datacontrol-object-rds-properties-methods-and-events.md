---
title: "DataControl 对象 (RDS) 属性、 方法和事件 |Microsoft 文档"
...
---
# <a name="datacontrol-object-rds-properties-methods-and-events"></a>DataControl 对象 (RDS) 属性、 方法和事件
> [!IMPORTANT]
...
## <a name="properties"></a>属性  
 ...
 [记录集，SourceRecordset 属性 (RDS)](../../../ado/reference/rds-api/recordset-sourcerecordset-properties-rds.md)  
  
 [服务器属性 (RDS)](../../../ado/reference/rds-api/server-property-rds.md)  
