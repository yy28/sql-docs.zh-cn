...
|对象|描述|  
|------------|-----------------|  
|[RDS.空间](../../../ado/reference/rds-api/dataspace-object-rds.md)|此对象包含用于获取服务器代理的方法。 代理可能是默认的或自定义的服务器程序 (业务对象) 。 服务器程序可以在 Internet、intranet、局域网或本地动态链接库上进行调用。<br /><br /> 对于脚本编写，" **空间** " 对象是安全的。|  
