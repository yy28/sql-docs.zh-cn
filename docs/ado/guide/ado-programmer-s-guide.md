...
-   [ActiveX 数据对象 (ADO)](./data/ado-fundamentals.md?view=sql-server-ver15&preserve-view=true)
...
-   [附录](./appendixes/appendix-a-providers.md?view=sql-server-ver15&preserve-view=true)
