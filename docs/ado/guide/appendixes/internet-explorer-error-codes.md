...
|Internet Explorer （Wininet）错误|数字|说明|
|------------------------------------------|------------|-----------------|
...
|**IDS_WinInet_ SSLPostLimitation**|8196-2146820092 0x800A2004|Internet 客户端错误： TLS/SSL 错误（可能为32K 数据上传限制）。|
