...
ms.locfileid: "67926828"
---
# <a name="internet-information-services-error-codes-for-remote-data-service"></a>远程数据服务 Internet Information Services 错误代码
下表列出了与远程数据服务使用有关的 Microsoft® Internet Information Services （IIS）错误代码。 低2字节的正十进制转换、完整错误代码的负小数转换以及十六进制值。

|Internet Information Services 错误|数字|说明|
|------------------------------------------|------------|-----------------|
