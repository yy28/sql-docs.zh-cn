...
## <a name="command-text"></a>命令文本
 ...
 提供程序不接受存储过程调用或简单表名称（例如， [CommandType](../../../ado/reference/ado-api/commandtype-property-ado.md)属性将始终为**adCmdText**）。
...
## <a name="see-also"></a>另请参阅
 [CommandType 属性（ado）](../../../ado/reference/ado-api/commandtype-property-ado.md) [ConnectionString 属性（](../../../ado/reference/ado-api/connectionstring-property-ado.md) ado）[属性集合（](../../../ado/reference/ado-api/properties-collection-ado.md) ado）[提供程序属性](../../../ado/reference/ado-api/provider-property-ado.md)（ado）[记录集对象（](../../../ado/reference/ado-api/recordset-object-ado.md) ado）[支持方法](../../../ado/reference/ado-api/supports-method.md)
