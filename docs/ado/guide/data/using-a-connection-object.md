...
> [!NOTE]
>  此外可以指定 ODBC 数据源名称 (DSN) 或数据链接 (UDL) 文件中的连接字符串。 有关 Dsn 的详细信息，请参阅[管理数据源](../../../odbc/admin/managing-data-sources.md)中的 ODBC 程序员参考。 有关 Udl 的详细信息，请参阅[数据链接 API 概述](https://msdn.microsoft.com/95c180ea-bd4f-4dca-b95a-576afd135bbc)中的 OLE DB 程序员参考。  
