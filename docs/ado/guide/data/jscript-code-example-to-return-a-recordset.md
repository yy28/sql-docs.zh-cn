---
description: 用于返回记录集的 JScript 代码示例
...
1.  将上面的代码保存到一个文本文件中。 将该文件另存为 rs.js。  
  
2.  打开一个命令提示符，然后将其保存到 ( # A0) 中保存 JScript 文件的目录。  
