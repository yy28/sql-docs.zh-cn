...
|\<表-exp>|{\<provider-command>} &#124;<br /><br /> （\<形状>） &#124;<br /><br /> 引用\<的表-名称> &#124;<br /><br /> \<带引号的>|  
...
|\<关系-列出>|\<关系-导线> [， \<关系-导线> ...]|  
|\<关系-导线>|\<字段名> \<对子引用>|  
|\<子引用>|\<字段名> &#124;<br /><br /> 参数\<参数-引用>|  
|\<param-引用>|\<数字>|  
|\<字段列表>|\<字段名> [， \<字段名>]|  
|\<聚合-exp>|SUM （\<限定域名>） &#124;<br /><br /> AVG （\<限定域名>） &#124;<br /><br /> 最小\<值（限定域名>） &#124;<br /><br /> 最大\<值（限定域名>） &#124;<br /><br /> 计数（\<限定别名> &#124; \<限定名>） &#124;<br /><br /> STDEV （\<限定域名>） &#124;<br /><br /> ANY （\<限定域名>）|  
