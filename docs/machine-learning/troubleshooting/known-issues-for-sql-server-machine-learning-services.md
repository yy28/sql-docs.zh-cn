...
了解与初始安装和配置相关的进程和常见问题的说明，请参阅[升级和安装常见问题解答](upgrade-and-installation-faq-sql-server-r-services.md)。 其中包含有关升级、并行安装和安装新 R 或新 Python 组件的信息。
