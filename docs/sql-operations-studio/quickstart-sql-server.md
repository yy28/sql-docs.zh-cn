---
title: 快速入门： 连接和查询 SQL Server 使用 SQL Operations Studio （预览版） |Microsoft Docs
description: 本快速入门介绍如何使用 SQL Operations Studio （预览版） 连接到 SQL Server 并运行查询
ms.custom: tools|sos
ms.date: 03/08/2018
ms.prod: sql
