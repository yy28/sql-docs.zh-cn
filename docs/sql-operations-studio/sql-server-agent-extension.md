---
title: SQL Operations Studio （预览版） SQL Server 代理扩展 |Microsoft Docs
description: SQL Operations Studio （预览版） 的 SQL Server 代理扩展
ms.custom: tools|sos
ms.date: 07/19/2018
...
ms.locfileid: "39147008"
---
# <a name="sql-server-agent-extension"></a>SQL Server 代理扩展

SQL Server 代理扩展是用于管理和故障排除 SQL 代理作业和配置扩展。 此扩展当前处于预览状态。
