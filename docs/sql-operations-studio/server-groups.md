---
title: SQL 操作 Studio （预览版） 中的服务器组 |Microsoft 文档
description: 了解有关 SQL 操作 Studio （预览版） 中的服务器组。
ms.custom: tools|sos
ms.date: 11/15/2017
ms.prod: sql
...
若要编辑可用服务器组颜色，编辑*服务器组*中值[用户设置](settings.md)。
