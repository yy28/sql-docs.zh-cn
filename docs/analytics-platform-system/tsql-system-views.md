---
title: 系统视图
description: 用于分析平台系统（AP） SQL Server 并行数据仓库（PDW）的系统视图。
author: mzaman1
ms.prod: sql
...
用于分析平台系统（AP） SQL Server 并行数据仓库（PDW）的系统视图。
...
## <a name="parallel-data-warehouse-dynamic-management-views-dmvs"></a>并行数据仓库动态管理视图（Dmv）
...
* [sys. 程序集](https://msdn.microsoft.com/library/ms189790.aspx)
...
* [sys. 证书](https://msdn.microsoft.com/library/ms189774.aspx)
...
* [sys. 凭据](../relational-databases/system-catalog-views/sys-credentials-transact-sql.md)
...
* [sys. filegroup](https://msdn.microsoft.com/library/ms187782.aspx)
...
* [sys.databases. 参数](https://msdn.microsoft.com/library/ms176074.aspx)
...
* [sys. 分区](https://msdn.microsoft.com/library/ms175012.aspx)
* [sys. 过程](https://msdn.microsoft.com/library/ms188737.aspx)
...
* [sys.databases](../relational-databases/system-catalog-views/sys-synonyms-transact-sql.md)
...
* [sys. sys.syslanguages](../relational-databases/system-compatibility-views/sys-syslanguages-transact-sql.md)
...
* [sys.databases](https://msdn.microsoft.com/library/ms187406.aspx)
* [sys.databases](https://msdn.microsoft.com/library/ms188021.aspx)
...
并行数据仓库公开了许多 SQL Server 动态管理视图（Dmv）。 当在并行数据仓库中查询这些视图时，它们将报告分布区上运行的 SQL Server 数据库的状态。
...
| 并行数据仓库中的 DMV 名称 | 指向 SQL Server T-sql 主题的链接 |
|:--- |:--- |
...
* [表列](../relational-databases/system-information-schema-views/columns-transact-sql.md)
* [PARAMETERS](../relational-databases/system-information-schema-views/parameters-transact-sql.md)
* [例程](../relational-databases/system-information-schema-views/routines-transact-sql.md)
* [架构](../relational-databases/system-information-schema-views/schemata-transact-sql.md)
* [张](../relational-databases/system-information-schema-views/tables-transact-sql.md)
...
* [视图](../relational-databases/system-information-schema-views/views-transact-sql.md)
