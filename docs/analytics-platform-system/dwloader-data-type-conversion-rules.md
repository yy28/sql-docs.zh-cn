...
|-------------------|-----------------------|------------------------------------|  
|字符串文本用**datetime**格式|年-月-日 hh: mm: [.fff]'<br /><br />例如：'2007-05-08 12:35:29.123'|插入值时，缺少的小数位数将设置为 0。 例如，文本 2007年-05-08 12:35 作为插入 2007年-05-08 12:35:00.000。|  
...
|-------------------|-----------------------|------------------------------------------|  
|字符串文本用**datetime**格式|年-月-日 hh: mm: [.fff]'<br /><br />例如：'2007-05-08 12:35:29.123'|缺少的小数位数和偏移量的值设置为 0 时插入的值。 例如，文本 2007年-05-08 12:35:29.123 作为插入 2007年-05-08 12:35:29.1230000 + 00:00。|  
...
|-------------------|-----------------------|-------------------------------------|  
|字符串文本用**datetime**格式|年-月-日 hh: mm: [.fff]'<br /><br />例如：'2007-05-08 12:35:29.123'|秒的小数部分是可选的当插入的值设置为 0。|  
