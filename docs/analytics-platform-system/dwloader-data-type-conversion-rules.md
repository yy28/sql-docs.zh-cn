---
title: Dwloader 数据类型转换规则-并行数据仓库 |Microsoft 文档
...
ms.locfileid: "31539707"
---
# <a name="data-type-conversion-rules-for-dwloader---parallel-data-warehouse"></a>数据类型 dwloader-并行数据仓库的转换的规则
