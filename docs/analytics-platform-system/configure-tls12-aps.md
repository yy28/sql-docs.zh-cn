...
> [!WARNING]
> 本节、方法或任务所含的步骤告知您如何修改注册表。 但是，如果错误地修改了可能会导致数据丢失并要求重新安装操作系统的注册表，则可能会出现严重问题。 我们强烈建议在修改注册表之前对其进行备份。 如果发生问题，以后可还原注册表。 有关如何备份和恢复注册表的详细信息，请单击下面的文章编号以参阅 Microsoft 知识库中的文章：<br>
