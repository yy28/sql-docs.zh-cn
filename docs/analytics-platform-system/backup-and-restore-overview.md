---
title: 备份和还原-并行数据仓库 |Microsoft 文档
description: 描述如何备份和还原可并行数据仓库 (PDW) 数据。 备份和还原操作用于灾难恢复。 备份和还原还可将数据库从一个设备复制到另一个设备。
author: mzaman1
manager: craigg
ms.prod: sql
...
ms.locfileid: "31544809"
---
# <a name="backup-and-restore"></a>备份和还原
描述如何备份和还原可并行数据仓库 (PDW) 数据。 备份和还原操作用于灾难恢复。 备份和还原还可将数据库从一个设备复制到另一个设备。  
