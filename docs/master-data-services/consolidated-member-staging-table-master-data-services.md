---
description: 合并成员临时表 (Master Data Services)
title: 合并成员临时表
ms.custom: ''
ms.date: 04/01/2016
ms.prod: sql
...
|**ImportStatus_ID**<br /><br /> 必选|导入过程的状态。 可能的值包括：<br /><br /> **0**- 指定此值表示记录已经准备好临时存储。<br /><br /> **1**- 自动分配的值，表示记录的暂存过程已成功。<br /><br /> **2**- 自动分配的值，表示记录的临时过程已失败。|  
