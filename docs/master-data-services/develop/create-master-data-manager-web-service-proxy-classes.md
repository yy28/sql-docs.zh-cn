...
-   servername:port 是承载  *的计算机名称和端口号*[!INCLUDE[ssMDSmdm](../../includes/ssmdsmdm-md.md)]。  
  
-   virtual_path 是 Internet 信息服务 (IIS) 中  *的虚拟路径*[!INCLUDE[ssMDSmdm](../../includes/ssmdsmdm-md.md)]。  
