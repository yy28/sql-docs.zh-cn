...
## <a name="external-resources"></a>外部资源  
 msdn.com 上的博文 [Transactions, Validation Issue and Staging table cleanup（事务、验证问题和临时表清除）](https://techcommunity.microsoft.com/t5/sql-server-integration-services/transactions-validation-issue-and-staging-table-cleanup/ba-p/388209)。  
