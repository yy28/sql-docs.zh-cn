---
title: "数据库要求 (Master Data Services) |Microsoft 文档"
ms.custom: 
ms.date: 03/14/2017
...
## <a name="see-also"></a>另请参阅  
 ...
 [连接到 Master Data Services 的数据库对话框](../../master-data-services/connect-to-a-master-data-services-database-dialog-box.md)   
