...
ms.topic: "article"
helpviewer_keywords: 
  - "安全性 [Master Data Services]，数据库角色"
  - "数据库 [Master Data Services]，用户"
  - "安全性 [Master Data Services]，数据库用户"
  - "数据库 [Master Data Services]，角色"
  - "数据库 [Master Data Services]，登录"
  - "安全性 [Master Data Services]，数据库登录"
