 ...
 *数据库邮件配置文件*是数据库邮件帐户的集合。 *数据库邮件帐户*包含[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]用于向 SMTP 服务器发送电子邮件的信息。 当您在 [!INCLUDE[ssMDScfgmgr](../includes/ssmdscfgmgr-md.md)]中创建配置文件和帐户时，帐户将自动添加到配置文件，并且帐户信息将用于发送电子邮件。  
...
|控件名称|说明|  
|------------------|-----------------|  
|**电子邮件地址**|键入帐户电子邮件地址的名称。 这是电子邮件发送的电子邮件地址，并且必须采用@*email_namedomain_name*格式。 *email_name* 电子邮件地址示例为 sales@contoso.com。|  
...
|**此服务器要求安全连接(SSL)**|使用传输层安全 （TLS）加密通信，以前称为安全套接字层 （SSL）。|  
...
|控件名称|说明|  
|------------------|-----------------|  
|**使用数据库引擎服务凭据的 Windows 身份验证**|指定数据库邮件应使用[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)][!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]Windows 服务帐户的凭据在 SMTP 服务器上进行身份验证。|  
...
## <a name="see-also"></a>另请参阅  
 [数据库配置页&#40;主数据服务配置管理器&#41;](../master-data-services/database-configuration-page-master-data-services-configuration-manager.md)   
