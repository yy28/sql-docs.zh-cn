---
title: "已更新-SQL Server 文档的 Master Data Services |Microsoft 文档"
description: "显示有关最近更改中的文档，有关 Master Data Services (MDS) 的 Microsoft SQL Server 的更新内容的代码段。"
services: na
documentationcenter: 
author: MightyPen
manager: jhubbard
...
---
# <a name="new-and-recently-updated-master-data-services-for-sql-server"></a>新的和最近的更新： SQL Server 的 Master Data Services
...
- *主题区域：* &nbsp; **for SQL Server 的 Master Data Services (MDS)**。
...
1. [在 AlwaysOn 环境中安装 Master Data Services](installing-mds-in-an-alwayson-group-environment/installing-mds-in-an-alwayson-group-environment.md)
