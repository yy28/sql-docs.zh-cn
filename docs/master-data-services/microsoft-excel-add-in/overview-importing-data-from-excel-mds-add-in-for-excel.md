---
title: "概述：从 Excel（用于 Excel 的 MDS 外接程序）导入数据 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
---
# 概述：从 Excel（用于 Excel 的 MDS 外接程序）导入数据
...
|执行合并冲突，以便你可以发布更改。|[合并冲突（用于 Excel 的 MDS 外接程序）](../../master-data-services/microsoft-excel-add-in/merge-conflicts-mds-add-in-for-excel.md)|  
