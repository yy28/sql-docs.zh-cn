---
description: 数据质量匹配列（用于 Excel 的 MDS 外接程序）
title: 数据质量匹配列
...
## <a name="see-also"></a>另请参阅  
 ...
 [匹配相似的数据 &#40;MDS Add-in for Excel&#41;](../../master-data-services/microsoft-excel-add-in/match-similar-data-mds-add-in-for-excel.md)   
