...
## <a name="see-also"></a>另请参阅  
 [网页配置页&#40;主数据服务配置管理器&#41;](../master-data-services/web-configuration-page-master-data-services-configuration-manager.md)   
