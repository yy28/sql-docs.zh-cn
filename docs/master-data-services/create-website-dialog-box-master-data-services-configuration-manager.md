...
|控件名称|描述|  
|------------------|-----------------|  
|**Name**|为新的应用程序池键入唯一的友好名称，或者使用提供的默认名称。 此网站的根 Web 应用程序在此应用程序池中运行。<br /><br /> 应用程序池提供的边界可防止一个应用程序池中的应用程序影响另一个应用程序池中的应用程序。|  
