...
* 若要浏览 [!INCLUDE[ssCurrent_md](../includes/sscurrent-md.md)] [!INCLUDE[ssMDSshort_md](../includes/ssmdsshort-md.md)]中引入的新特性和功能，请尝试执行[自进度实验室](https://www.microsoft.com/handsonlabs/selfpacedlabs)（需要使用你的 Microsoft 帐户登录）。  
* 若要开发 [!INCLUDE[ssMDSshort_md](../includes/ssmdsshort-md.md)] 解决方案来存储和管理地理数据的主列表，请使用适用于 Excel 的外接程序和 [!INCLUDE[ssMDSmdm_md](../includes/ssmdsmdm-md.md)]，尝试[自行进度的实验室](https://www.microsoft.com/handsonlabs/selfpacedlabs)。 你将创建实体和层次结构，并使用 [!INCLUDE[ssIS_md](../includes/ssis-md.md)] 来填充维度表。  
