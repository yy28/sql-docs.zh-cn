...
ms.topic: "article"
helpviewer_keywords: 
  - "属性组 [Master Data Services]"
  - "属性组 [Master Data Services], 关于属性组"
...
## 显示或隐藏属性组  
 创建属性组时，对除创建者之外的所有用户自动隐藏它。 有关使组可见的详细信息，请参阅[使属性组对用户可见 (Master Data Services)](../master-data-services/make-an-attribute-group-visible-to-users-master-data-services.md)。  
  
 如果要隐藏组中的特定属性，可以将 **“拒绝”** 权限分配给该属性。 有关详细信息，请参阅[叶权限 (Master Data Services)](../master-data-services/leaf-permissions-master-data-services.md)或[合并的权限 (Master Data Services)](../Topic/Consolidated%20Permissions%20\(Master%20Data%20Services\).md)。  
