...
-   更新排序规则后，重新处理分隔和维度。  
 ...
 你可使用 SQL Server Management Studio 或 AMO PowerShell 更改服务器级别的默认语言或排序规则。 或者可以修改 msmdsrv.ini 文件中的 **\<Language>** 和 **\<CollationName>** 设置，指定语言的 LCID。  
