---
title: "定义父子层次结构中的父特性属性 | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
有关详细信息，请参阅[父子维度](../analysis-services/multidimensional-models/parent-child-dimensions.md)、[父子层次结构中的属性](../analysis-services/multidimensional-models/attributes-in-parent-child-hierarchies.md)  
...
10. ![显示“雇员”层次结构的数据透视表](../analysis-services/media/l4-employee-1.gif "显示“雇员”层次结构的数据透视表")  
...
4.  在第二行（**\*** 行）中，在“名称”列中键入“Employee Level \*”，然后单击第三行。  
    ...
    ![“级别命名模板”对话框](../analysis-services/media/l4-namingtemplate.gif "“级别命名模板”对话框")  
...
5.  将“雇员”层次结构拖到“行标签”区域。  
    ...
    ![修改后的“雇员”层次结构](../analysis-services/media/l4-employee-2.png "修改后的“雇员”层次结构")  
