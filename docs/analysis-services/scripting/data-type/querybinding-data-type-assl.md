---
title: QueryBinding 数据类型 (ASSL) |Microsoft 文档
ms.custom: ''
ms.date: 03/06/2017
...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]定义一个派生的数据类型，表示此关联的[数据源](../../../analysis-services/scripting/objects/datasource-element-assl.md)具有元素[QueryDefinition](../../../analysis-services/scripting/properties/querydefinition-element-assl.md)元素。  
...
## <a name="remarks"></a>Remarks  
 ...
 分析管理对象 (AMO) 对象模型中的相应元素是<xref:Microsoft.AnalysisServices.QueryBinding>。  
