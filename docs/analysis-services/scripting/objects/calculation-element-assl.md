...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]一个具有计算 Asssociates[透视](../../../analysis-services/scripting/objects/perspective-element-assl.md)元素。  
