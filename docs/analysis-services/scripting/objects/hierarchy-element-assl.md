...
|祖先或父级|数据类型|  
|------------------------|---------------|  
|[维度](../../../analysis-services/scripting/objects/dimension-element-assl.md)|[层次结构](../../../analysis-services/scripting/data-type/hierarchy-data-type-assl.md)|  
...
|关系|元素|  
|------------------|-------------|  
|父元素|[层次结构](../../../analysis-services/scripting/collections/hierarchies-element-assl.md)|  
|子元素|无|  
