...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]指示在其中的求解次序[CalculationProperty](../../../analysis-services/scripting/objects/calculationproperty-element-assl.md)元素应用于计算的成员或计算的单元定义。  
