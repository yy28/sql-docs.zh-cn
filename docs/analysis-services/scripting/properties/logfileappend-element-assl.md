...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]确定是否[跟踪](../../../analysis-services/scripting/objects/trace-element-assl.md)元素将其日志记录输出追加到现有的日志文件，或者覆盖它。  
