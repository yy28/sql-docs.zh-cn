...
ms.locfileid: "40392950"
---
# <a name="entitytype-element-csdlbi"></a>EntityType 元素 (CSDLBI)
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]
  **EntityType**元素是表示高级实体，例如客户或订单，数据模型中的结构的复杂类型。 **Bi: EntityType**元素扩展的定义[EntityType](http://msdn.microsoft.com/library/bb399206.aspx)中使用[实体数据框架](/dotnet/framework/data/adonet/ef/overview)。  
  
 必须为数据模型中包括的每个实体指定 EntityType 元素。 EntityType 的子元素描述表中的列和度量值。 中包含表之间的关系**EntityContainer**。  
  
## <a name="elements-and-attributes"></a>元素和属性  
 下表列出的元素和定义的属性**EntityType**元素。 另请参阅适用于属性[EntityType](http://msdn.microsoft.com/library/bb399206.aspx)元素。  
 ...
 **表格**  
 ...
 以下示例显示在 AdventureWorks 表格模型中使用的 Geography 表的 CSDLBI 版本 1.1 表示形式的一部分。 RowNumber 列是一个隐藏的列作为行标识符在表格模型中，会自动生成并因此具有 Contents 属性**RowNumber**。  
