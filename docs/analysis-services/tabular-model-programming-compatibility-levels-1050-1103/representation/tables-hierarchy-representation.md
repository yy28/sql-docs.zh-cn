---
title: "层次结构表示形式 （表格） |Microsoft 文档"
ms.custom: 
ms.date: 03/06/2017
...
---
# <a name="tables---hierarchy-representation"></a>表的层次结构表示形式
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]在表格模型层次结构是一个属性从到另一个用户选择的值为基础的导航路径。  
