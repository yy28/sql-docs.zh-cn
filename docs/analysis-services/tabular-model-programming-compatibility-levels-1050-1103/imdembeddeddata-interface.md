---
title: IMDEmbeddedData 接口 |Microsoft Docs
ms.date: 05/07/2018
ms.prod: sql
...
ms.locfileid: "62467778"
---
# <a name="imdembeddeddata-interface"></a>IMDEmbeddedData 接口
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]
  IMDEmbeddedData 接口是用于管理嵌入的公共接口[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]数据库或表格模型数据库。 接口继承自**IPersistStream**接口。 此接口允许以下操作：  
...
-   验证嵌入的数据库上次保存以来是否发生更改。 继承自**IPersistStream**。  
...
## <a name="reference"></a>参考  
 以下参考文档**IMDEmbeddedData**接口所述**msmd.h**标头文件。  
...
#### <a name="description"></a>Description  
 将本地或进程内数据库保存到容器文档中嵌入流。 继承自**IPersistStream**。  
