...
10. 在“表”窗格中，右键单击“InternetSalesReason (dbo.FactInternetSalesReason)”，然后单击“浏览数据”。  
    ...
    ![用于标识购买的销售原因的键值](../analysis-services/media/l5-many-to-many-1.png "用于标识购买的销售原因的键值")  
...
6.  在“属性”窗口中，将“Internet Sales Reason Count”度量值的“Visible”属性更改为“False”。  
    ...
    ![“Internet 销售原因计数”度量值的属性](../analysis-services/media/l5-many-to-many-2.gif "“Internet 销售原因计数”度量值的属性")  
...
4.  在“中间度量值组”列表中，选择“Internet 销售原因”。  
    ...
    ![“定义关系”对话框](../analysis-services/media/l5-many-to-many-3.gif "“定义关系”对话框")  
...
6.  展开“销售原因类型”级别的每个成员，查看与 Queensland 中的客户为其通过 Internet 采购 [!INCLUDE[ssSampleDBCoShort](../includes/sssampledbcoshort-md.md)] 产品所给出的每个原因相关联的美元值。  
    ...
    ![多维数据集设计器的“筛选器”窗格和“数据”窗格](../analysis-services/media/l5-many-to-many-5.gif "多维数据集设计器的“筛选器”窗格和“数据”窗格")  
  
## 课程中的下一个任务  
[定义度量值组中的维度粒度](../analysis-services/defining-dimension-granularity-within-a-measure-group.md)  
