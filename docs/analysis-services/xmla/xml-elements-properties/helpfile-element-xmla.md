---
title: "HelpFile 元素 (XMLA) |Microsoft 文档"
ms.custom: 
ms.date: 03/03/2017
...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]包含到帮助文件或主题描述父路径或 URL[错误](../../../analysis-services/xmla/xml-elements-properties/error-element-xmla.md)元素。  
...
|关系|元素|  
|------------------|-------------|  
|父元素|[错误](../../../analysis-services/xmla/xml-elements-properties/error-element-xmla.md)|  
|子元素|无|  
