...
ms.locfileid: "38046921"
---
# <a name="synchronizesecurity-element-xmla"></a>SynchronizeSecurity 元素 (XMLA)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]
  指定如何同步安全定义，如角色和权限，期间[同步](../../../analysis-services/xmla/xml-elements-commands/synchronize-element-xmla.md)命令。  
 ...
 **安全**元素确定的安全定义，如角色和权限定义对 Analysis Services 数据库同步期间**同步**命令。 此元素还确定是否作为的一部分的 Windows 用户帐户和组定义为安全定义成员**同步**命令。  
  
 此元素的值限定为下表中列出的字符串之一。  
  
|ReplTest1|Description|  
|-----------|-----------------|  
|*SkipMembership*|包含安全定义，但不包括成员身份信息期间**同步**命令。|  
|*CopyAll*|包括安全定义和成员身份信息期间**同步**命令。|  
|*IgnoreSecurity*|不包括安全定义期间**同步**命令。|  
