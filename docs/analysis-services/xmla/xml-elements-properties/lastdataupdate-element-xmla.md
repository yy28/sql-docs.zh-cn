...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]包含的日期和时间的数据的多维数据集表示通过父[多维数据集](../../../analysis-services/xmla/xml-elements-properties/cube-element-olapinfo-xmla.md)上次更新元素。  
