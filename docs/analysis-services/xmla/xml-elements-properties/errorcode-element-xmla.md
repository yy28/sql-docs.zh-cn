---
title: "ErrorCode 元素 (XMLA) |Microsoft 文档"
ms.custom: 
ms.date: 03/04/2017
...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]包含父级的数值返回代码[错误](../../../analysis-services/xmla/xml-elements-properties/error-element-xmla.md)元素。  
