...
ms.locfileid: "38979229"
---
# <a name="command-element-xmla"></a>Command 元素 (XMLA)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]
  包含要由执行的命令[Execute](../../../analysis-services/xmla/xml-elements-methods-execute.md)方法。  
 ...
 **命令**所使用的元素**Execute**命令转发到数据源的方法。 虽然 XML for Analysis (XMLA) 1.1 规范只支持**语句**命令时，Analysis Services 支持许多新的 XMLA 命令。 有关支持的 XMLA 命令的详细信息[!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)]，请参阅[命令&#40;XMLA&#41;](../../../analysis-services/xmla/xml-elements-commands/xml-elements-commands.md)。  
