---
title: 步骤元素 (XMLA) |Microsoft Docs
ms.date: 05/08/2018
ms.prod: sql
...
ms.locfileid: "38050468"
---
# <a name="steps-element-xmla"></a>Steps 元素 (XMLA)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]
  指定的步骤使用的最大数[DesignAggregations](../../../analysis-services/xmla/xml-elements-commands/designaggregations-element-xmla.md)命令用于设计聚合。  
