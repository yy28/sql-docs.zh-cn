# [XMLA 元素的属性](xml-elements-properties.md)
...
# [Name 元素（参数）(XMLA)](name-element-parameter-xmla.md)
...
# [PropertyList 元素 - 支持的 XMLA 属性](propertylist-element-supported-xmla-properties.md)
