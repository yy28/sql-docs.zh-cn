...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]包含一套[查询](../../../analysis-services/xmla/xml-elements-properties/query-element-xmla.md)所使用的元素[DesignAggregations](../../../analysis-services/xmla/xml-elements-commands/designaggregations-element-xmla.md)命令在基于使用情况的优化过程。  
...
|子元素|[“数据集属性”](../../../analysis-services/xmla/xml-elements-properties/query-element-xmla.md)|  
