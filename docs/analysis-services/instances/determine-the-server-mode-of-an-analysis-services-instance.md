...
## 对象资源管理器中的服务器图标  
 ...
 ![每个服务器模式的对象资源管理器图标](../../analysis-services/instances/media/ssas-ssms-servermodes.gif "每个服务器模式的对象资源管理器图标")  
  
## 在 MSMDSRV.INI 文件中查看 DeploymentMode 属性  
