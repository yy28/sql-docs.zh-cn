...
ms.topic: "article"
helpviewer_keywords: 
  - "Analysis Services 对象, 脚本"
  - "对象 [Analysis Services], 脚本"
  - "脚本 [Analysis Services], 对象"
...
## 另请参阅  
 ...
 [XMLA 查询编辑器（Analysis Services - 多维数据）](../Topic/XMLA%20Query%20Editor%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)  
