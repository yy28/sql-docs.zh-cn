---
title: "为重播创建事件探查器跟踪 (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "性能 [Analysis Services], 重播"
  - "跟踪 [Analysis Services]"
...
-   Discover Begin 事件类及其所有数据列。 TextData 列提供发现请求的 \<RequestType> 部分，RequestProperties 列提供发现请求的 \<Properties> 部分。 EventSubclass 列提供发现类型。 有关详细信息，请参阅 [Discover Events Data Columns](../../analysis-services/trace-events/discover-events-data-columns.md)。  
