...
## 方案 1：工作簿作数据源 (WDS)。  
 ![see 1](../../../analysis-services/instances/install-windows/media/ssas-callout1.png "see 1") Office Online Server 打开一个 Excel 工作簿，![see 2](../../../analysis-services/instances/install-windows/media/ssas-callout2.png "see 2") 检测与另一个工作簿的数据连接。 Office Online Server 向 [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] 重定向程序服务 ![see 3](../../../analysis-services/instances/install-windows/media/ssas-callout3.png "see 3") 发送请求，以打开第二个工作簿和数据 ![see 4](../../../analysis-services/instances/install-windows/media/ssas-callout4.png "see 4")。  
...
### 2016 SQL Server 数据库引擎和处于 Power Pivot 模式的 Analysis Services  
 ...
 ![注释](../../../analysis-services/instances/install-windows/media/ssrs-fyi-note.png "注释") 在 [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)] 安装向导中，处于 Power Pivot 模式下的 [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] 将作为功能选择工作流的一部分进行安装。  
...
4.  请注意，默认情况下，搜索中不包括“计算机”对象类型。 单击 ![click objects to add computer account](../../../analysis-services/instances/install-windows/media/ss-objects-button.png "click objects to add computer account") 以添加计算机对象。  
...
5.  安装声明为 Windows 令牌服务 (C2WTS) **这是方案 1 的必需操作**。 有关详细信息，请参阅 [Claims to Windows Token Service (c2WTS) 概述](https://msdn.microsoft.com/en-us/library/ee517278.aspx)。  
...
6.  为 Kerberos 配置 SharePoint 身份验证提供程序。 **这是方案 1 的必需操作**。 有关详细信息，请参阅 [在 SharePoint 2013 中规划 Kerberos 身份验证](https://technet.microsoft.com/en-us/library/ee806870.aspx)。  
