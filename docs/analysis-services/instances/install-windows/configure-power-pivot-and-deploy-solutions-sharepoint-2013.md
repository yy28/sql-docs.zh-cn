...
4.  在 **“参数”** 选项卡上：  
    ...
    4.  **[!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] Server for Excel Services**：键入 [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] SharePoint 模式服务器的名称。 在单服务器部署中，它与数据库服务器相同。 `[ServerName]\powerpivot`  
