...
指定了一种分组方法后，必须使用 **DiscretizationBucketCount** 属性指定分组的数量。 有关详细信息，请参阅[对属性成员进行分组（离散化）](../analysis-services/multidimensional-models/group-attribute-members-discretization.md)。  
...
5.  在“属性”窗口中，将** DiscretizationMethod** 属性的值更改为 **Automatic**，将 **DiscretizationBucketCount** 属性的值更改为 **5**。  
    ...
    ![修改后的“年收入”属性](../analysis-services/media/l4-discretizationmethod-1.gif "修改后的“年收入”属性")  
...
9. 在字段列表中，展开“雇员”维度，展开“组织”，然后将“病假时间”拖到“列标签”。  
    ...
    ![按雇员病假时间划分维度的“销售额”](../analysis-services/media/l4-discretizationmethod-2.gif "按雇员病假时间划分维度的“销售额”")  
...
## 另请参阅  
[对属性成员进行分组（离散化）](../analysis-services/multidimensional-models/group-attribute-members-discretization.md)  
