...
ms.locfileid: "65403789"
---
# <a name="lesson-4-2---defining-parent-attribute-properties-in-a-parent-child-hierarchy"></a>4-第二课-父-子层次结构中的定义父特性属性
...
有关详细信息，请参阅[父子维度](../multidimensional-models/parent-child-dimension.md)、[父子层次结构中的属性](../multidimensional-models/parent-child-dimension-attributes.md)  
...
10. ![数据透视表显示员工层次结构](../media/l4-employee-1.gif "显示员工层次结构的数据透视表")  
...
4.  在第二行（**\*** 行）中，在“名称”列中键入“Employee Level \*”，然后单击第三行。  
    ...
    ![级别命名模板对话框](../media/l4-namingtemplate.gif "级别命名模板对话框")  
...
5.  将“雇员”层次结构拖到“行标签”区域。  
    ...
    ![修改员工层次结构](../media/l4-employee-2.png "修改员工层次结构")  
  
## <a name="next-task-in-lesson"></a>课程中的下一个任务  
[自动将属性成员分组](lesson-4-3-automatically-grouping-attribute-members.md)  
  
## <a name="see-also"></a>请参阅  
[父子维度](../multidimensional-models/parent-child-dimension.md)  
