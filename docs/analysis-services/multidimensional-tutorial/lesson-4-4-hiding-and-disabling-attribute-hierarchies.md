...
ms.locfileid: "65404019"
---
# <a name="lesson-4-4---hiding-and-disabling-attribute-hierarchies"></a>第 4-4 课-隐藏和禁用属性层次结构
...
4.  在“属性”窗口中，将所选特性的“AttributeHierarchyEnabled”  属性的值设置为“False”  。  
    ...
    ![AttributeHierarchyEnabled 属性设置为 False](../media/l4-hierarchyenabled-1.gif "AttributeHierarchyEnabled 属性设置为 False")  
...
4.  在“属性”窗口中，将所选特性的“AttributeHierarchyVisible”  属性的值设置为“False”  。  
    ...
    ![AttributeHierarchyVisible 属性设置为 False](../media/l4-hierarchyvisible-1.gif "AttributeHierarchyVisible 属性设置为 False")  
