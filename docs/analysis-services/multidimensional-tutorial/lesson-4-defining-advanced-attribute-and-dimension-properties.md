...
在该任务中，将定义父子维度的级别名称，并指定是否显示与父成员有关的数据。 有关详细信息，请参阅 [父子维度](../multidimensional-models/parent-child-dimension.md) 和 [父子层次结构中的属性](../multidimensional-models/parent-child-dimension-attributes.md)。  
