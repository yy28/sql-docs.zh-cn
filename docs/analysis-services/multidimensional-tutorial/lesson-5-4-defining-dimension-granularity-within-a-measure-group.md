...
5.  展开“销售区域”  维度，然后将“销售区域”  用户定义层次结构添加到行标签。  
    ...
    ![销售区域所属多维数据集维度](../media/l5-granularity-2.gif "Sales Territory 多维数据集维度")  
...
7.  在数据透视表字段列表中，选择“销售区域”  用户层次结构，然后单击右侧的向下箭头。  
    ...
    ![在字段列表中的销售区域层次结构](../media/l5-granularity-1a.png "字段列表中的销售区域层次结构")  
  
8.  在筛选器中，单击“全选”复选框以取消选中所有选择，然后仅选择 **North America**。  
  
    ![筛选器窗格中的选择北美](../media/l5-granularity-1b.png "用于选择北美地区的筛选器窗格")  
...
11. 在数据透视表中，单击“行标签”旁的向下箭头。 取消选中除 **FY 2008** 之外的所有年份。  
    ...
    ![值为销售金额配额](../media/l5-granularity-3.png "值 Sales Amount 配额")  
...
8.  依次展开 **FY 2008**、 **H1 FY 2008**以及 **Q1 FY 2008**。  
    ...
    ![销售配额度量值组正确划分维度](../media/l5-granularity-7.gif "正确划分维度的 Sales Quota 度量值组")  
