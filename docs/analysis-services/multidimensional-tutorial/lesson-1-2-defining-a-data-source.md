...
ms.locfileid: "65404009"
---
# <a name="lesson-1-2---defining-a-data-source"></a>课程 1-2-定义数据源
...
5.  在“服务器名称”文本框中，键入 **localhost**。  
    ...
    若要连接到本地计算机上的命名实例，请键入**localhost\\<instance name>**。 若要连接到特定的计算机而不是本地计算机，请键入该计算机名称或 IP 地址。  
