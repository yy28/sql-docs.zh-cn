...
### -Credential \<PSCredential>  
 ...
 有关身份验证和凭据使用的详细信息，请参阅 [Analysis Services 中的 PowerShell 脚本](../../analysis-services/instances/powershell-scripting-in-analysis-services.md)。 有关 HTTP 访问的详细信息，请参阅[在 Internet Information Services (IIS) 8.0 上配置对 Analysis Services 的 HTTP 访问](../../analysis-services/instances/configure http access to analysis services on iis 8.0.md)。  
