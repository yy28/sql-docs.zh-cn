...
|[PredictSupport (DMX)](../../dmx/predictsupport-dmx.md)|对于神经网络模型和逻辑回归模型，该函数将返回表示整个模型的定型集大小的单个值。|  
...
## <a name="see-also"></a>请参阅  
 ...
 [第 5 课：生成神经网络模型和逻辑回归模型&#40;数据挖掘中级教程&#41;](http://msdn.microsoft.com/library/42c3701a-1fd2-44ff-b7de-377345bbbd6b)  
