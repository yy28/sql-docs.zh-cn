...
helpviewer_keywords: 
  - "属性 [数据挖掘]"
  - "挖掘结构 [Analysis Services], 关于挖掘结构"
  - "挖掘结构 [Analysis Services]"
  - "数据挖掘 [Analysis Services], 结构"
  - "Analysis Services 对象, 数据挖掘对象"
  - "数据挖掘 [Analysis Services], 模型"
  - "算法 [数据挖掘]"
  - "数据挖掘 [Analysis Services], 对象"
...
# 挖掘结构（Analysis Services – 数据挖掘）
 ...
 ![处理数据：源到结构再到模型](../../analysis-services/data-mining/media/dmcon-modelarch.gif "处理数据：源到结构再到模型")  
...
### 查看挖掘结构  
 ...
 `SELECT * FROM <model>.CASES` 语句返回相同的列，但是仅针对该特定模型中的事例返回。 有关详细信息，请参阅 [SELECT FROM \<结构>.CASES](../Topic/SELECT%20FROM%20%3Cstructure%3E.CASES.md) 和 [SELECT FROM \<模型>.CASES (DMX)](../Topic/SELECT%20FROM%20%3Cmodel%3E.CASES%20\(DMX\).md)。  
...
|使用基于 OLAP 多维数据集的挖掘结构|[创建新的 OLAP 挖掘结构](../../analysis-services/data-mining/create-a-new-olap-mining-structure.md)<br /><br /> [筛选挖掘结构的源多维数据集](../Topic/Filter%20the%20Source%20Cube%20for%20a%20Mining%20Structure.md)|  
