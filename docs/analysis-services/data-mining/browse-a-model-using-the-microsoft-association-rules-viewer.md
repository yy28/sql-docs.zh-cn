...
>  若要查看有关模型中使用的公式以及所发现的模式的详细信息，请使用 [!INCLUDE[msCoName](../../includes/msconame-md.md)] 一般内容树查看器。 有关详细信息，请参阅[使用 Microsoft 一般内容树查看器浏览模型](../../analysis-services/data-mining/browse-a-model-using-the-microsoft-generic-content-tree-viewer.md)或 [Microsoft 一般内容树查看器（数据挖掘）](http://msdn.microsoft.com/library/751b4393-f6fd-48c1-bcef-bdca589ce34c)。  
 ...
 有关如何创建、 浏览和使用关联挖掘模型的演练，请参阅[第 3 课：生成市场篮方案&#40;数据挖掘中级教程&#41;](http://msdn.microsoft.com/library/651eef38-772e-4d97-af51-075b1b27fc5a)。  
 ...
 **“项集”** 选项卡显示被模型识别为经常发现一起出现的项集的列表。 选项卡显示的网格有以下列：**支持**，**大小**，和**项集**。 有关支持的详细信息，请参阅 [Microsoft Association Algorithm](../../analysis-services/data-mining/microsoft-association-algorithm.md)。 **“大小”** 列显示项集中的项的数量。 **“项集”** 列显示模型发现的实际项集。 可以使用 **“显示”** 列表控制项集的格式，可将格式设置为以下选项：  
