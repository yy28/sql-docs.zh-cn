---
title: "使用 DMX 来创建钻取查询 | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
```  
 ...
 有关使用 DMX 查询返回事例数据的其它信息，请参阅 [SELECT FROM \<模型>.CASES (DMX)](../Topic/SELECT%20FROM%20%3Cmodel%3E.CASES%20\(DMX\).md) 和 [SELECT FROM \<结构>.CASES](../Topic/SELECT%20FROM%20%3Cstructure%3E.CASES.md)。  
