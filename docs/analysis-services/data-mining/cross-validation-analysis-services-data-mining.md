...
### <a name="setting-the-number-of-partitions"></a>设置分区的数目  
 ...
 ![交叉验证分段数据的方式](../../analysis-services/data-mining/media/xvoverviewmain.gif "交叉验证分段数据的方式")  
...
### <a name="cross-validation-stored-procedures"></a>交叉验证存储过程  
 对于高级用户，交叉验证还可以完全参数化的系统存储过程的形式提供。 您可以通过从[!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]或从任何托管代码应用程序连接到实例来运行存储过程。  
