...
-   还可以使用 DMX 来定义挖掘结构。 有关详细信息，请参阅[数据挖掘扩展插件 (DMX) 数据定义语句](../Topic/Data%20Mining%20Extensions%20\(DMX\)%20Data%20Definition%20Statements.md)。  
...
###  <a name="bkmk_ViewExplore"></a> 查看和浏览模型  
