...
## <a name="in-this-section"></a>本节内容  
 [数据挖掘 OLE DB](data-mining-programming-ole-db.md)  
...
## <a name="related-reference"></a>相关参考  
 ...
 [使用 Analysis Services 脚本语言 (ASSL) 开发](https://docs.microsoft.com/bi-reference/assl/analysis-services-scripting-language-assl-for-xmla)  
 介绍 XML for Analysis (XMLA) 及其扩展插件。  
  
## <a name="see-also"></a>请参阅  
 [Analysis Services 开发人员文档](../analysis-services-developer-documentation.md)   
