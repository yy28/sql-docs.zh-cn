...
|建模标志|描述|  
|-------------------|-----------------|  
|MODEL_EXISTENCE_ONLY|意味着，该列将被视为具有两个可能状态：**缺少**并**现有**。 Null 表示缺失值。<br /><br /> 适用于挖掘模型列。|  
