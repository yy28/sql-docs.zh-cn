...
##  <a name="bkmk_top"></a> 获取有关逻辑回归模型的信息  
 ...
 若要继续探讨查询方案，可以创建逻辑回归模型中的数据挖掘中级教程的以下部分所述：[第 5 课：生成神经网络模型和逻辑回归模型&#40;数据挖掘中级教程&#41;](http://msdn.microsoft.com/library/42c3701a-1fd2-44ff-b7de-377345bbbd6b)。  
