...
## 配置权限和服务器属性  
 数据挖掘需要对 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 数据库具有其他权限。 可以使用[“Analysis Server 属性”对话框 (Analysis Services)](../Topic/Analysis%20Server%20Properties%20Dialog%20Box%20\(Analysis%20Services\).md) 设置大多数数据挖掘属性。  
...
## 另请参阅  
 [物理体系结构（Analysis Services - 多维数据）](../Topic/Physical%20Architecture%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)   
