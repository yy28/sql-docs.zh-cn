...
### 预测离散列  
 ...
 ![Microsoft 决策树算法中的直方图](../../analysis-services/data-mining/media/dt-histogram.gif "Microsoft 决策树算法中的直方图")  
...
### 预测连续列  
 ...
 ![显示非线性的多条回归线](../../analysis-services/data-mining/media/regression-tree1.png "显示非线性的多条回归线")  
 ...
 ![表示非线性点的等式](../../analysis-services/data-mining/media/regression-tree2.gif "表示非线性点的等式")  
