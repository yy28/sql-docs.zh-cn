...
ms.topic: "article"
helpviewer_keywords: 
  - "筛选规则 [Analysis Services]"
  - "挖掘模型查看器 [Analysis Services], 规则"
  - "规则查看器"
...
## 另请参阅  
 ...
 [第 3 课：生成市场篮方案（数据挖掘中级教程）](../Topic/Lesson%203:%20Building%20a%20Market%20Basket%20Scenario%20\(Intermediate%20Data%20Mining%20Tutorial\).md)  
