...
-   [在依赖关系网络中查找特定的节点](../../analysis-services/data-mining/find-a-specific-node-in-a-dependency-network.md)  
  
-   [筛选器中关联的规则规则模型](../../analysis-services/data-mining/filter-a-rule-in-an-association-rules-model.md)  
  
-   [筛选项集在关联规则模型](../../analysis-services/data-mining/filter-an-itemset-in-an-association-rules-model.md)  
