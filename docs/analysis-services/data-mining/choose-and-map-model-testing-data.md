...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]若要创建准确性图表中的[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]，你必须选择将用于测试模型，并将数据映射到模型的数据。  
