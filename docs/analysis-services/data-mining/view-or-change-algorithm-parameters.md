...
-   指定种子值或用于模型创建的内部维持集的大小。  
 ...
 为每种算法提供的参数变动很大;可以为每个算法设置的参数的列表，请参阅此部分中的技术参考主题：[数据挖掘算法&#40;Analysis Services-数据挖掘&#41;](../../analysis-services/data-mining/data-mining-algorithms-analysis-services-data-mining.md)。  
