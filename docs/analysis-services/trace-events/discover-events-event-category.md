...
ms.author: owend
manager: kfile
ms.openlocfilehash: c09bbd998d56e4a3e4200c435c3ea1934134314d
...
|-----------------|--------------|-----------------|  
|发现开始|36|收集自从启动跟踪以来的所有发现开始事件。|  
|发现结束|38|收集自从启动跟踪以来的所有发现结束事件。|  
  
 有关与每个“发现事件”事件类关联的列的信息，请参阅 [Discover Events Data Columns](../../analysis-services/trace-events/discover-events-data-columns.md)。  
