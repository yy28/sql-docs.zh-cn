---
title: 配置或修复 Power Pivot for SharePoint 2013 |Microsoft Docs
ms.date: 05/02/2018
ms.prod: sql
...
||Passphrase|用户输入|用于数据加密的主密钥。 默认情况下，用于生成密钥的通行短语是用来在场中设置新服务的相同通行短语。 您可以将默认通行短语替换为唯一通行短语。|  
...
1.  在 SharePoint 2013 网站上，单击设置图标![SharePoint 设置](../../analysis-services/media/as-sharepoint2013-settings-gear.gif "SharePoint 设置")，然后单击**站点设置**。  
