...
|[配置专用的数据刷新或仅限查询的处理 (Power Pivot for SharePoint)](http://msdn.microsoft.com/5e027605-1086-4941-bb01-f315df8f829b)|可选|一个 [!INCLUDE[ssGemini_md](../../includes/ssgemini-md.md)] 实例可以专用于数据刷新作业或查询。 此外，您可以修改并行数据刷新作业的默认设置。|  
