---
title: Power Pivot 服务器管理和在管理中心内配置 |Microsoft Docs
ms.date: 05/02/2018
ms.prod: sql
...
|[在管理中心中针对网站集激活 Power Pivot 功能集成](../../analysis-services/power-pivot-sharepoint/activate-power-pivot-integration-for-site-collections-in-ca.md)|必填|此步骤在站点集合级别启用 [!INCLUDE[ssGemini_md](../../includes/ssgemini-md.md)] 功能。|  
...
|[使用 SharePoint 2010 进行 Power Pivot 数据刷新](http://msdn.microsoft.com/01b54e6f-66e5-485c-acaa-3f9aa53119c9)|建议|数据刷新是可选的，但建议执行刷新。 它允许你对已发布的 Excel 工作簿中的 [!INCLUDE[ssGemini_md](../../includes/ssgemini-md.md)] 数据计划执行无人参与的更新。|  
|[配置 Power Pivot 无人参与的数据刷新帐户 (Power Pivot for SharePoint)](http://msdn.microsoft.com/81401eac-c619-4fad-ad3e-599e7a6f8493)|建议|此步骤设置特殊目的的帐户，该帐户可用于在服务器上运行数据刷新作业。|  
...
|[配置专用数据刷新或仅限查询的处理 (Power Pivot for SharePoint)](http://msdn.microsoft.com/5e027605-1086-4941-bb01-f315df8f829b)|可选|一个 [!INCLUDE[ssGemini_md](../../includes/ssgemini-md.md)] 实例可以专用于数据刷新作业或查询。 此外，您可以修改并行数据刷新作业的默认设置。|  
