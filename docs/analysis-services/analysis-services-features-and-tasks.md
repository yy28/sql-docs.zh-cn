---
title: "Analysis Services 功能和任务 |Microsoft 文档"
ms.custom: 
ms.date: 03/02/2017
...
[!INCLUDE[ssas-appliesto-sqlas](../includes/ssas-appliesto-sqlas.md)]Analysis Services 基础文档组织的模型类型和服务器模式，以便你可以专注于只是工具、 任务和所安装的模式中可用的功能。 可以在“实例管理”中找到跨多个模式的服务器管理任务。  
