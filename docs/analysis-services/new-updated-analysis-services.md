...
1. [数据源中支持 SQL Server Analysis Services 表格 1400年模型](tabular-models/data-sources-supported-ssas-tabular-1400.md)
2. [表格建模（1400 兼容级别）](tutorial-tabular-1400/as-adventure-works-tutorial.md)
3. [创建分区](tutorial-tabular-1400/as-lesson-10-create-partitions.md)
4. [创建角色](tutorial-tabular-1400/as-lesson-11-create-roles.md)
5. [在 Excel 中分析](tutorial-tabular-1400/as-lesson-12-analyze-in-excel.md)
6. [部署](tutorial-tabular-1400/as-lesson-13-deploy.md)
7. [创建表格模型项目](tutorial-tabular-1400/as-lesson-1-create-a-new-tabular-model-project.md)
8. [获取数据](tutorial-tabular-1400/as-lesson-2-Get-data.md)
9. [将标记为日期表](tutorial-tabular-1400/as-lesson-3-mark-as-date-table.md)
10. [创建关系](tutorial-tabular-1400/as-lesson-4-create-relationships.md)
11. [创建计算的列](tutorial-tabular-1400/as-lesson-5-create-calculated-columns.md)
12. [创建度量值](tutorial-tabular-1400/as-lesson-6-create-measures.md)
13. [创建关键绩效指标](tutorial-tabular-1400/as-lesson-7-create-key-performance-indicators.md)
14. [创建透视](tutorial-tabular-1400/as-lesson-8-create-perspectives.md)
15. [创建层次结构](tutorial-tabular-1400/as-lesson-9-create-hierarchies.md)
16. [补充课程 - 详细信息行](tutorial-tabular-1400/as-supplemental-lesson-detail-rows.md)
17. [补充课程 - 动态安全性](tutorial-tabular-1400/as-supplemental-lesson-dynamic-security.md)
18. [补充课程 - 不规则层次结构](tutorial-tabular-1400/as-supplemental-lesson-ragged-hierarchies.md)
