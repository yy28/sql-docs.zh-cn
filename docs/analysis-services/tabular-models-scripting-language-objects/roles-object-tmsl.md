...
## <a name="object-definition"></a>对象定义  
 ...
 成员  
 成员包含成员名称和 ID，其中成员名称是别名或 Windows 安全原则，友好名称，该 ID 是安全标识符。 同时被指定角色定义中。请参阅[SID 组件](https://msdn.microsoft.com/library/windows/desktop/aa379597\(v=vs.85\).aspx)有关标识符的详细信息。  
