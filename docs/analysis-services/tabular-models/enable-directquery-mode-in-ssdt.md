...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]在本主题中，我们将介绍如何为表格模型项目中启用 DirectQuery 模式[!INCLUDE[ssBIDevStudio](../../includes/ssbidevstudio-md.md)]。  
