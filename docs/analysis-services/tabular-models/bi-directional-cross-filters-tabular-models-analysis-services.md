---
title: "SQL Server 2016 Analysis Services 中适用于表格模型的双向交叉筛选器 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/07/2017"
...
---
# SQL Server 2016 Analysis Services 中适用于表格模型的双向交叉筛选器
 ...
 在 SSDT 中，设置交叉筛选器的机制是通过表关系对话框中的“筛选器方向”选项。 此功能仅适用于在 [SQL Server Data Tools Visual Studio 2015 (SSDT)](http://go.microsoft.com/fwlink/p/?LinkID=627574) 中于 1200 兼容级别创建的表格模型。  
...
4.  确认模型兼容级别是否设置为 **SQL Server 2016 RTM (1200)**。  
...
## 另请参阅  
 ...
 [演示如何在 Power Pivot 和 SSAS 表格模型处理简单多对多关系的实践示例](http://social.technet.microsoft.com/wiki/contents/articles/22202.a-practical-example-of-how-to-handle-simple-many-to-many-relationships-in-power-pivotssas-tabular-models.aspx)   
