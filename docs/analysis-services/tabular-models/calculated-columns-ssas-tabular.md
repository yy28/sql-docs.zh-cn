...
> [!NOTE]  
>  在 DirectQuery 模式下，表格模型不支持计算列。 有关详细信息，请参阅 [DirectQuery 模式（SSAS 表格）](../../analysis-services/tabular-models/directquery-mode-ssas-tabular.md)。  
...
-   有一些字符不能用于列名中。 有关详细信息，请参阅 [DAX 语法参考](http://msdn.microsoft.com/zh-cn/098630f4-7d1d-467e-976c-99b2279430d5)中的“命名要求”。  
...
|主题|Description|  
|-----------|-----------------|  
|[创建计算列（SSAS 表格）](../../analysis-services/tabular-models/create-a-calculated-column-ssas-tabular.md)|本主题中的任务描述了如何向表中添加新的计算列。|  
...
## 另请参阅  
 ...
 [计算（SSAS 表格）](../../analysis-services/tabular-models/calculations-ssas-tabular.md)  
