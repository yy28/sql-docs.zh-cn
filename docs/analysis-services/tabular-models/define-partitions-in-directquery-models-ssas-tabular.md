---
title: "在 DirectQuery 模型中定义分区（SSAS 表格） | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
|DataView=Sample<br /><br /> 适用于使用示例数据视图的表格 1200 模型|允许处理分区|如果模型正在使用示例数据，则你可以处理要返回已筛选的数据集的表，该数据集将在模型设计过程中提供视觉提示。|  
