...
### [指定“标记为日期表”以便用于时间智能](specify-mark-as-date-table-for-use-with-time-intelligence-ssas-tabular.md)  
...
# [部署表格模型解决方案](tabular-model-solution-deployment-ssas-tabular.md)  
## [从 SQL Server Data Tools 部署](deploy-from-sql-server-data-tools-ssas-tabular.md)  
