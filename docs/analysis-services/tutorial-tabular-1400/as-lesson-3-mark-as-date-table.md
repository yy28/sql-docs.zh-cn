...
ms.locfileid: "37973164"
---
# <a name="mark-as-date-table"></a>标记为日期表

[!INCLUDE[ssas-appliesto-sql2017-later-aas](../../includes/ssas-appliesto-sql2017-later-aas.md)]

在第 2 课： 获取数据，您导入名为的维度表**DimDate**。 虽然在模型中此表名为 DimDate，它可能也被称为*日期表*，它包含日期和时间数据。  
...
本文是表格建模教程应按顺序完成的一部分。 在之前在本课程中执行的任务，您应已完成上一课：[第 2 课： 获取数据](../tutorial-tabular-1400/as-lesson-2-get-data.md)。 
