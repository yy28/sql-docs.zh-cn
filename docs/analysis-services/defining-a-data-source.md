...
2.  在“数据源向导”的“欢迎使用数据源向导”页上，单击“下一步”可打开“选择如何定义连接”页。  
...
5.  在“服务器名称”文本框中，键入 **localhost**。  
    ...
    要连接到本地计算机上的命名实例，请键入 **localhost\\<instance name>**。 若要连接到特定的计算机而不是本地计算机，请键入该计算机名称或 IP 地址。  
...
## 课程中的下一个任务  
[定义数据源视图](../analysis-services/defining-a-data-source-view.md)  
