...
8.  在“翻译列”列表中，选择“SpanishMonthName”，如下图所示。  
    ...
    ![“翻译属性数据”对话框](../analysis-services/media/l9-translations-4.gif "“翻译属性数据”对话框")  
...
1.  请切换到 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 教程多维数据集的多维数据集设计器，然后切换到“翻译”选项卡。  
    ...
    ![“翻译”选项卡中的默认语言](../analysis-services/media/l9-translations-5.gif "“翻译”选项卡中的默认语言")  
...
5.  在工具栏上，选择“语言”列表中的“西班牙语(西班牙)”。  
    ...
    ![重新填充的元数据窗格](../analysis-services/media/l9-translations-6.png "重新填充的元数据窗格")  
...
9. 在“元数据”窗格中，右键单击“Mes del Ano”，然后选择“添加到查询”。  
    ...
    ![数据窗格中以西班牙语表示的月份名称](../analysis-services/media/l9-translations-7.gif "数据窗格中以西班牙语表示的月份名称")  
