...
|主题|Description|  
|-----------|-----------------|  
|[维度简介&#40;Analysis Services-多维数据&#41;](../../analysis-services/multidimensional-models-olap-logical-dimension-objects/dimensions-introduction.md)|概述维度概念。|  
|[属性和属性层次结构](../../analysis-services/multidimensional-models-olap-logical-dimension-objects/attributes-and-attribute-hierarchies.md)|说明属性和属性层次结构。|  
|[用户层次结构](../../analysis-services/multidimensional-models-olap-logical-dimension-objects/user-hierarchies.md)|说明用户定义的属性层次结构。|  
|[写入的维度](../../analysis-services/multidimensional-models-olap-logical-dimension-objects/write-enabled-dimensions.md)|说明已启用写操作的维度。|  
|[维度转换](../../analysis-services/multidimensional-models-olap-logical-dimension-objects/dimension-translations.md)|说明维度元数据的翻译。|  
