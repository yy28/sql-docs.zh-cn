...
ms.topic: "article"
helpviewer_keywords: 
  - "期间增长 [Analysis Services]"
  - "并行时间段比较 [Analysis Services]"
  - "Business Intelligence 增强功能 [Analysis Services], 时间智能"
  - "时间视图 [Analysis Services]"
  - "层次结构 [Analysis Services], 时间"
  - "时间段 [Analysis Services]"
  - "移动平均值"
  - "时间 [Analysis Services]"
  - "本期截止到现在 [Analysis Services]"
  - "计算 [Analysis Services], 时间"
  - "时间层次结构 [Analysis Services]"
  - "时间智能 [Analysis Services]"
...
-   **帐户维度的成员** 在 **“定义计算作用域”** 页中， **“可用度量值”** 列表已包括帐户维度。 帐户维度的 **Type** 属性已设置为 **Accounts**。 如果有帐户维度但该维度没有出现在 **“可用度量值”** 列表中，则可以使用商业智能向导对该维度应用帐户智能。 有关详细信息，请参阅[向维度中添加帐户智能](../../analysis-services/multidimensional-models/add-account-intelligence-to-a-dimension.md)。  
