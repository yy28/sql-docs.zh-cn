...
|图标|属性用法|  
|----------|---------------------|  
|![属性图标](../../analysis-services/multidimensional-models/media/as-icon-attribute.png "属性图标")|常规或 AccountType|  
|![键属性图标](../../analysis-services/multidimensional-models/media/as-icon-key-attribute.png "键属性图标")|Key|  
|![父属性图标](../../analysis-services/multidimensional-models/media/as-icon-parent-attribute.png "父属性图标")|Parent|  
