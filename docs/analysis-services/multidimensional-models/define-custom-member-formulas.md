...
ms.topic: "article"
helpviewer_keywords: 
  - "成员 [Analysis Services], 自定义"
  - "自定义汇总公式 [Analysis Services]"
  - "MDX [Analysis Services], 自定义汇总公式"
...
# 定义自定义成员公式
 ...
 在为特性指定自定义成员公式前，请确保包含该特性的维度表或直接相关的表具有用于存储自定义成员公式的字符串列。 如果满足上述条件，则可以手动设置特性的 **CustomRollupColumn** 属性，或使用商业智能向导的“设置自定义成员公式”增强功能启用特性的自定义成员公式。 有关如何使用此增强功能的详细信息，请参阅[为维度中的属性设置自定义成员公式](../../analysis-services/multidimensional-models/set-custom-member-formulas-for-attributes-in-a-dimension.md)。  
...
## 另请参阅  
 ...
 [为维度中的属性设置自定义成员公式](../../analysis-services/multidimensional-models/set-custom-member-formulas-for-attributes-in-a-dimension.md)  
