...
-   打开\<*项目名称*>.deploymentoptions 在任何文本编辑器并手动更改的选项。 用于 PartitionDeployment 的选项是 DeployPartitions，RetainPartitions。 用于 RoleDeployment 的选项是 DeployRolesAndMembers、 DeployRolesRetainMembers、 RetainRoles。
