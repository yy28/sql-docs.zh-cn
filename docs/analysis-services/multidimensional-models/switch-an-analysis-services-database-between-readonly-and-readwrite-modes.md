...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)][!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]作为分布在多个仅查询服务器之间的查询工作负荷的较大工作的一部分，数据库管理员可以更改表格或多维数据库的读/写模式。  
