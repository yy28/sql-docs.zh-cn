---
title: "创建父子类型的财务帐户维度 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "维度 [Analysis Services], 帐户"
  - "帐户维度 [Analysis Services]"
  - "添加帐户智能"
  - "帐户智能 [Analysis Services]"
...
-   帐号属性 - 用于报表用途的属性。 您可以通过将特性的 **Type** 属性设置为 **AccountNumber**来标识帐号特性。  
 ...
 有关属性类型的详细信息，请参阅[配置属性类型](../../analysis-services/multidimensional-models/configure-attribute-types.md)。  
  
## 通过商业智能向导添加帐户智能  
 定义帐户维度并将该维度添加到多维数据集后，可以使用商业智能向导添加帐户智能功能，例如，标识帐户类型，将帐户类型映射到维度。 有关详细信息，请参阅[向维度中添加帐户智能](../../analysis-services/multidimensional-models/add-account-intelligence-to-a-dimension.md)。  
...
## 另请参阅  
 ...
 [商业智能向导的 F1 帮助](../Topic/Business%20Intelligence%20Wizard%20F1%20Help.md)   
 [维度类型](../Topic/Dimension%20Types.md)  
