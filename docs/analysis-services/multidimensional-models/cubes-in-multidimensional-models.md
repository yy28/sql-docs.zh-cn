...
ms.topic: "article"
helpviewer_keywords: 
  - "OLAP 对象 [Analysis Services], 多维数据集"
  - "多维数据集 [Analysis Services], 关于多维数据集"
  - "多维数据集 [Analysis Services]"
  - "OLAP [Analysis Services], 多维数据集"
...
|层次结构|[创建用户定义层次结构](../../analysis-services/multidimensional-models/create-user-defined-hierarchies.md)|  
