---
title: 使用 Analysis Services 项目和开发中的数据库 |Microsoft Docs
ms.date: 05/02/2018
ms.prod: sql
...
ms.locfileid: "62743113"
---
# <a name="work-with-analysis-services-projects-and-databases-in-development"></a>使用 Analysis Services 项目和数据库开发中
