...
> [!NOTE]  
>  有关计算传递如何影响计算的详细信息，请参阅[理解传递次序和求解次序 (MDX)](../../../analysis-services/multidimensional-models/mdx/understanding-pass-order-and-solve-order-mdx.md)。  
...
## 使用 CALCULATE 语句  
 ...
 有关 CALCULATE 语句的语法详细信息，请参阅 [CALCULATE 语句 (MDX)](../Topic/CALCULATE%20Statement%20\(MDX\).md)。  
...
```  
 ...
 有关 SCOPE 语句的语法详细信息，请参阅 [SCOPE 语句 (MDX)](../Topic/SCOPE%20Statement%20\(MDX\).md)。  
