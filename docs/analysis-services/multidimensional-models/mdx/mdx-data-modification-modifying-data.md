...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]除了使用多维表达式 (MDX) 来检索和处理从维度和多维数据集的数据，你可以使用 MDX 来更新或*写回*维度和多维数据集数据。 这些更新可以是暂时的，例如对于推测分析或“假设”分析；也可以是永久的，例如当必须基于数据分析进行更改时。  
