---
title: "在 MDX 中生成子多维数据集 (MDX) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
helpviewer_keywords: 
  ...
  - "子多维数据集 [MDX]"
  - "筛选视图 [MDX]"
  - "MDX [Analysis Services], 子多维数据集"
  - "多维表达式 [Analysis Services], 子多维数据集"
  - "CREATE SUBCUBE 语句"
...
# 在 MDX 中生成子多维数据集 (MDX)
 ...
 若要定义子多维数据集，请按照本主题所述使用 [CREATE SUBCUBE](../Topic/CREATE%20SUBCUBE%20Statement%20\(MDX\).md) 语句。  
...
```  
 ...
 创建子多维数据集后，该子多维数据集将成为所有 MDX 查询的上下文，直到会话结束或运行 [DROP SUBCUBE](../Topic/DROP%20SUBCUBE%20Statement%20\(MDX\).md) 语句。  
