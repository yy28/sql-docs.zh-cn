...
> [!NOTE]  
>  请注意，**WITH** 关键字与 [CurrentMember (MDX)](../../../mdx/currentmember-mdx.md) 和 [Name (MDX)](../../../mdx/name-mdx.md) 函数一起用于创建在查询中使用的计算成员。 有关详细信息，请参阅[基本 MDX 查询 (MDX)](../../../analysis-services/multidimensional-models/mdx/the-basic-mdx-query-mdx.md)。  
