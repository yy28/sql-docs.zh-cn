...
ms.topic: "article"
helpviewer_keywords: 
  - "写回 [Analysis Services], 多维数据集"
  - "多维数据集 [Analysis Services], 修改"
  - "修改多维数据集"
  - "UPDATE CUBE 语句"
  - "多维数据集 [Analysis Services], 写回"
...
---
# 使用多维数据集写回 (MDX)
  可以使用 [UPDATE CUBE](../Topic/UPDATE%20CUBE%20Statement%20\(MDX\).md) 语句更新多维数据集。 通过此语句，您可以使用特定值更新元组。 若要有效地使用 UPDATE CUBE 语句更新多维数据集，必须了解该语句的语法、发生错误的条件以及更新可能对多维数据集产生的影响。  
...
## 另请参阅  
 [修改数据 (MDX)](../../../analysis-services/multidimensional-models/mdx/modifying-data-mdx.md)  
