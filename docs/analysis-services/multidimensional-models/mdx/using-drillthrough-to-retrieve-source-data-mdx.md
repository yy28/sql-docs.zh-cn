...
# 使用 DRILLTHROUGH 检索源数据 (MDX)
  多维表达式 (MDX) 使用 [DRILLTHROUGH](../Topic/DRILLTHROUGH%20Statement%20\(MDX\).md) 语句从多维数据集单元的源数据中检索行集。  
...
## 另请参阅  
 [操作数据 (MDX)](../../../analysis-services/multidimensional-models/mdx/manipulating-data-mdx.md)  
