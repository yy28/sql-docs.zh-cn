...
ms.topic: "article"
helpviewer_keywords: 
  - "多维数据集 [Analysis Services], MDX"
  - "MDX [Analysis Services], 多维数据集上下文"
  - "SELECT 语句 [MDX]"
  - "多维表达式 [Analysis Services], 多维数据集上下文"
  - "查询 [MDX], 多维数据集上下文"
...
```  
 ...
 有关 MDX SELECT 语句中的 FROM 子句的详细信息，请参阅 [SELECT 语句 (MDX)](../Topic/SELECT%20Statement%20\(MDX\).md)。  
