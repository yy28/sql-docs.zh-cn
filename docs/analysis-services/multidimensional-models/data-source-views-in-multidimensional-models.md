---
title: 数据源的多维模型中的视图 |Microsoft Docs
ms.date: 05/02/2018
ms.prod: sql
...
## <a name="related-tasks"></a>Related Tasks  
 ...
 [在数据源视图中定义逻辑关系 (Analysis Services)](../../analysis-services/multidimensional-models/define-logical-relationships-in-a-data-source-view-analysis-services.md)  
