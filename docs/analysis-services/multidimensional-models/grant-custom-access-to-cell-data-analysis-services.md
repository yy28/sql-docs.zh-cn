---
title: "授予单元数据的自定义访问权限 (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
helpviewer_keywords: 
  - "用户访问权限 [Analysis Services], 单元数据"
  - "权限 [Analysis Services], 单元"
  - "有条件读取权限"
  - "读取权限"
  - "单元 [Analysis Services]"
  - "自定义单元数据权限 [Analysis Services]"
...
# 授予单元数据的自定义访问权限 (Analysis Services)
 ...
 ![显示允许和拒绝单元的数据透视表](../../analysis-services/multidimensional-models/media/ssas-permscellsallowed.png "显示允许和拒绝单元的数据透视表")  
...
```  
 ...
 ![单元显示为不可用的 Excel 列](../../analysis-services/multidimensional-models/media/ssas-permscellshidemeasure.png "单元显示为不可用的 Excel 列")  
...
```  
 ...
 ![含可用和不可用单元的 Excel 表](../../analysis-services/multidimensional-models/media/ssas-permscalculatedcells.png "含可用和不可用单元的 Excel 表")  
...
## 另请参阅  
 [MDX 生成器（Analysis Services -多维数据）](../Topic/MDX%20Builder%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)   
