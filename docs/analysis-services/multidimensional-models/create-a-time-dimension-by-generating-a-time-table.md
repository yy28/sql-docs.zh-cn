...
helpviewer_keywords: 
  ...
  - "维度 [Analysis Services], 时间"
  - "时间段 [Analysis Services]"
  - "基于范围的时间维度 [Analysis Services]"
  - "服务器时间维度 [Analysis Services]"
  - "日历 [Analysis Services]"
  - "基于表的时间维度 [Analysis Services]"
...
## 选择日历  
 当您创建时间维度时，所用日历始终包括标准（公历） 12 个月日历（从 1 月 1 日开始，到 12 月 31 日结束）。 在向导的 **“选择日历”** 页中，您可以指定维度中的层次结构所基于的其他日历。 有关日历类型的说明，请参阅[创建日期类型维度](../../analysis-services/multidimensional-models/create-a-date-type-dimension.md)。  
...
## 另请参阅  
 ...
 [创建日期类型维度](../../analysis-services/multidimensional-models/create-a-date-type-dimension.md)   
