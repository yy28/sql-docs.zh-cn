...
helpviewer_keywords: 
  - "访问权限 [Analysis Services]，用户"
  - "权限 [Analysis Services]，用户"
  - "安全性 [Analysis Services]，用户访问"
  - "用户访问权限 [Analysis Services]"
  - "授予权限 [Analysis Services]，用户"
...
1.  在 SSMS 中，右键单击一个数据库，然后选择“新建查询”|“MDX”。  
