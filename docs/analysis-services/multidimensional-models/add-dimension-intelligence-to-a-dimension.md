---
title: "向维度中添加维度智能 | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Business Intelligence 增强功能 [Analysis Services], 维度智能"
  - "维度 [Analysis Services], Business Intelligence 增强功能"
  - "维度智能 [Analysis Services]"
  - "Type 属性"
...
> [!NOTE]  
>  如果选择 **“帐户”** 作为维度，则要指定维度的帐户智能。 有关详细信息，请参阅[向维度中添加帐户智能](../../analysis-services/multidimensional-models/add-account-intelligence-to-a-dimension.md)。  
