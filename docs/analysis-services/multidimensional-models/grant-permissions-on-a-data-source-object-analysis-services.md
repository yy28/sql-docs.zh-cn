---
title: "授予数据源对象的权限 (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
helpviewer_keywords: 
  - "读/写权限"
  - "用户访问权限 [Analysis Services], 数据源"
  - "安全性 [Analysis Services], 数据源"
  - "连接字符串 [Analysis Services]"
  - "数据源 [Analysis Services], 安全性"
