...
ms.topic: "article"
helpviewer_keywords: 
  - "权限 [Analysis Services], 程序集"
  - "调用用户定义函数"
  - "用户模拟 [Analysis Services]"
  - "模拟 [Analysis Services]"
  - "数据挖掘扩展 [Analysis Services], 程序集"
  - "MDX [Analysis Services], 程序集"
  - "用户定义函数 [Analysis Services]"
  - "Analysis Services 对象, 程序集"
  - "程序集 [Analysis Services]"
  - "应用程序域 [Analysis Services]"
