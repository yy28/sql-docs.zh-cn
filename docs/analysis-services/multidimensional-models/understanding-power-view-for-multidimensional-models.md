 ...
 **多维模型体系结构的 Power View**  
 ...
 ![多维模型体系结构的 Power View](../../analysis-services/multidimensional-models/media/daxmd-architecture.gif "多维模型体系结构的 Power View")  
 ...
 **Power View 字段列表中的度量值组**  
 ...
 ![Power View 中的字段列表](../../analysis-services/multidimensional-models/media/daxmd-powerviewfieldlist.gif "Power View 中的字段列表")  
 ...
 **度量值组中的度量值和 KPI**  
 ...
 ![Power View 字段列表中的度量组](../../analysis-services/multidimensional-models/media/daxmd-fieldlist-group.gif "Power View 字段列表中的度量组")  
 ...
 **SQL Server Data Tools (SSDT) 和 Power View 字段列表中的维度、属性和层次结构**  
 ...
 ![SSDT 以及 Power View 字段列表中的维度](../../analysis-services/multidimensional-models/media/daxmd-ssdt-dimensions.gif "SSDT 以及 Power View 字段列表中的维度")  
 ...
 **SSDT 和 Power View 字段列表中的维度属性地理类型**  
 ...
 ![维度特性地理类型](../../analysis-services/multidimensional-models/media/daxmd-ssdt-attribute-geog-types.gif "维度特性地理类型")  
 ...
 **具有计算成员的 Power View 报表**  
 ...
 ![Power View 中的计算成员](../../analysis-services/multidimensional-models/media/daxmd-calcmembersinpowerview.gif "Power View 中的计算成员")  
 ...
 **固定的筛选器**  
 ...
 ![固定的筛选器](../../analysis-services/multidimensional-models/media/daxmd-pinnedfilterinpowerview.gif "固定的筛选器")  
