...
ms.topic: "article"
helpviewer_keywords: 
  - "浏览数据 [Analysis Services]"
  - "数据源视图 [Analysis Services]，浏览数据"
  - "查看源数据"
...
3.  右键单击包含要查看的数据的表、视图或命名查询，再单击“浏览数据”。  
     ...
     将对数据源视图中表、视图或命名查询下的数据源进行查询，并且结果将显示在“浏览\<对象名称>表”选项卡中。  
  
4.  在“浏览\<对象名称>表”工具栏中，请单击“抽样选项”图标。  
  
     此时将打开 **“数据浏览选项”** 对话框。 在该对话框中可以指定抽样方法（记录少于或多于默认抽样大小 5000 行）或抽样计数。  
  
5.  根据需要单击 **“确定”** 或 **“取消”** 。  
  
6.  若要对数据重新抽样，请单击“浏览\<对象名称>表”工具栏中的“对数据重新抽样”。  
