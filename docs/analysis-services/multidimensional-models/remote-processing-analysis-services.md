...
#### 向 SQL Server 代理帐户授予对 SSAS 的管理员权限  
...
## 另请参阅  
 [SQL Server 代理的组件](../../ssms/agent/sql-server-agent.md#Components)   
