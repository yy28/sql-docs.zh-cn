...
# [配置特性关系属性](configure-attribute-relationship-properties.md)
...
# [在维度设计器中查看树、列表或网格中的属性](view-attributes-in-a-tree-list-or-grid-in-dimension-designer.md)
...
# [指定处理选项](specifying-processing-options.md)
# [指定分区和角色部署选项](specifying-partition-and-role-deployment-options.md)
...
# [定义默认成员](define-a-default-member.md)
...
# [在维度设计器中启动商业智能向导](start-the-business-intelligence-wizard-in-dimension-designer.md)
...
# [在维度设计器中浏览维度数据](browse-dimension-data-in-dimension-designer.md)
...
# [指定安装目标](specifying-the-installation-target.md)
...
# [为维度中的属性设置自定义成员公式](set-custom-member-formulas-for-attributes-in-a-dimension.md)
# [定义维度的排序](define-the-ordering-for-a-dimension.md)
# [使用聚合函数](use-aggregate-functions.md)
# [配置属性类型](configure-attribute-types.md)
# [计算](calculations-in-multidimensional-models.md)
# [处理权限](grant-process-permissions-analysis-services.md)
# [将属性绑定到键列](bind-an-attribute-to-a-key-column.md)
...
# [在解决方案资源管理器中修改或删除数据库维度](modify-or-delete-a-database-dimension-in-solution-explorer.md)
...
# [父子维度中的一元运算符](unary-operators-in-parent-child-dimensions.md)
# [向维度中添加维度智能](add-dimension-intelligence-to-a-dimension.md)
...
# [从维度中删除属性](remove-an-attribute-from-a-dimension.md)
...
# [创建货币类型维度](create-a-currency-type-dimension.md)
...
# [启用维度写回](enable-dimension-writeback.md)
# [父子维度中的自定义汇总运算符](custom-rollup-operators-in-parent-child-dimensions.md)
# [通过在数据源中生成非时间表来创建维度](create-a-dimension-by-generating-a-non-time-table-in-the-data-source.md)
# [修改某个特性的 KeyColumn 属性](modify-the-keycolumn-property-of-an-attribute.md)
...
# [排列属性关系图中的形状](arrange-shapes-in-the-attribute-relationship-diagram.md)
...
# [添加或删除用户定义层次结构](add-or-delete-a-user-defined-hierarchy.md)
# [为解决方案部署指定配置设置](specifying-configuration-settings-for-solution-deployment.md)
...
# [定义属性关系](define-attribute-relationships.md)
...
# [定义属性关系的关系类型](define-the-relationship-type-of-an-attribute-relationship.md)
# [在维度设计器中查看属性](view-attributes-in-dimension-designer.md)
...
# [创建日期类型维度](create-a-date-type-dimension.md)
...
# [对属性成员分组（离散化）](group-attribute-members-discretization.md)
# [从模板创建多维数据集而无需使用数据源视图](create-a-cube-from-a-template-without-using-a-data-source-view.md)
# [定义引用的关系和引用的关系属性](define-a-referenced-relationship-and-referenced-relationship-properties.md)
...
# [将属性绑定到名称列](bind-an-attribute-to-a-name-column.md)
# [父子维度](parent-child-dimensions.md)
...
# [向维度中添加帐户智能](add-account-intelligence-to-a-dimension.md)
# [在联机模式下连接到 Analysis Services 数据库](connect-in-online-mode-to-an-analysis-services-database.md)
# [向维度中添加自定义聚合](add-a-custom-aggregation-to-a-dimension.md)
...
# [创建父子类型的财务帐户维度](create-a-finance-account-of-parent-child-type-dimension.md)
# [维度](dimensions-in-multidimensional-models.md)
# [部署 Analysis Services 项目 (SSDT)](deploy-analysis-services-projects-ssdt.md)
# [分区](partitions-in-multidimensional-models.md)
# [定义自定义成员公式](define-custom-member-formulas.md)
# [向维度中添加属性](add-an-attribute-to-a-dimension.md)
# [父子层次结构中的属性](attributes-in-parent-child-hierarchies.md)
# [了解用于创建部署脚本的输入文件](understanding-the-input-files-used-to-create-the-deployment-script.md)
# [自动定义新属性](define-a-new-attribute-automatically.md)
# [在数据源视图中定义逻辑主键](define-logical-primary-keys-in-a-data-source-view-analysis-services.md)
# [用户定义的层次结构](create-user-defined-hierarchies.md)
# [重命名多维数据库](rename-a-multidimensional-database-analysis-services.md)
# [创建、修改或删除属性关系](create-modify-or-delete-an-attribute-relationship.md)
...
# [配置属性层次结构的“(全部)”级别](configure-the-all-level-for-attribute-hierarchies.md)
