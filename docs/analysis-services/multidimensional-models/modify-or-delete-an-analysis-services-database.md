...
ms.topic: "article"
helpviewer_keywords: 
  - "数据库 [Analysis Services], 修改"
  - "删除数据库"
  - "删除数据库"
  - "删除数据库"
  - "数据库 [Analysis Services], 删除"
  - "修改数据库"
...
## 使用 SQL Server Management Studio 修改数据库  
...
## 使用 SQL Server Data Tools 修改数据库  
