...
## 另请参阅  
[在维度设计器中浏览维度数据](../analysis-services/multidimensional-models/browse-dimension-data-in-dimension-designer.md)  
