...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]存储过程的安全设置与**PermissionSet**对存储过程的实例的属性[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]（服务器级别），[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]数据库，或[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]项目。  
