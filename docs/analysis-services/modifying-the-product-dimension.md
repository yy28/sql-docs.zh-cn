...
## 课程中的下一个任务  
[修改“日期”维度](../analysis-services/modifying-the-date-dimension.md)  
...
[配置属性层次结构的“(全部)”级别](../analysis-services/multidimensional-models/configure-the-all-level-for-attribute-hierarchies.md)  
