---
title: SQL Server Trusted Launchpad 服务帐户配置 |Microsoft Docs
description: 如何修改用于 SQL Server 上的外部脚本执行的 SQL Server Trusted Launchpad 服务帐户。
ms.prod: sql
...
1. 打开 [SQL Server 配置管理器](../../relational-databases/sql-server-configuration-manager.md)。 
  ...
  + 在开始页上键入**MMC**以打开 Microsoft 管理控制台。
