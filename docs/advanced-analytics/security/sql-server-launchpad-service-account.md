...
有关详细信息，请参阅 [SQL Server 机器学习服务中的扩展性体系结构](../../advanced-analytics/concepts/extensibility-framework.md#launchpad)和 [SQL Server 机器学习服务中扩展性框架的安全性概述](../../advanced-analytics/concepts/security.md#launchpad)中的 Launchpad 部分。
