...
1. [安装没有 internet 访问权限的机器学习组件](#TitleNum_1)
...
### <a name="1-nbsp-installing-machine-learning-components-without-internet-accessrinstalling-ml-components-without-internet-accessmd"></a>1.&nbsp;[安装没有 internet 访问权限的机器学习组件](r/installing-ml-components-without-internet-access.md)
