...
### <a name="2-nbsp-converting-r-code-for-execution-in-databaserconverting-r-code-for-use-in-sql-servermd"></a>2.&nbsp;[执行数据库中的转换 R 代码](r/converting-r-code-for-use-in-sql-server.md)
