---
title: 为使用 sqlrutils 包的 R 代码生成的 R 存储过程 |Microsoft 文档
ms.prod: sql
...
ms.locfileid: "31202599"
---
# <a name="generate-an-r-stored-procedure-for-r-code-using-the-sqlrutils-package"></a>为使用 sqlrutils 包的 R 代码生成的 R 存储过程
