---
title: olapR R 函数库
description: SQL Server 2016 R Services 中的 olapR 函数库简介, 以及 R SQL Server 机器学习服务。
ms.prod: sql
...
产品 | Location |
--------|----------|
SQL Server 机器学习服务 (包含 R 集成) | C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\R_SERVICES\library | 
