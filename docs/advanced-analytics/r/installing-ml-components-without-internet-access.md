...
**SQL Server 自 2017 年 1 CTP 3.0** |
Microsoft R Open     |无更改;使用 CTP 2.0|
Microsoft R Server     |无更改;使用 CTP 2.0|
Microsoft Python 打开     |无更改;使用 CTP 2.0|
Microsoft Python 服务器    |无更改;使用 CTP 2.0|
**SQL Server 自 2017 年 1 CTP 4.0** |
Microsoft R Open     |无更改;使用 CTP 2.0|
Microsoft R Server     |无更改;使用 CTP 2.0|
Microsoft Python 打开     |无更改;使用 CTP 2.0|
Microsoft Python 服务器    |无更改;使用 CTP 2.0|
