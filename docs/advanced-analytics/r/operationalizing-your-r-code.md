...
有关使用存储过程将 R 代码部署到生产环境中的更全面的示例，请参阅[教程：适用于 SQL 开发者的 R 数据分析](../../advanced-analytics/tutorials/sqldev-in-database-r-for-sql-developers.md)中找到
