---
title: 课程 3 浏览和可视化数据使用 R 和 T-SQL （SQL Server 机器学习） |Microsoft Docs
...
1. 在中[!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]，在对象资源管理器中，右键单击**TaxiNYC_Sample**数据库，展开**可编程性**，然后展开**存储过程**查看在第 2 课中创建的过程。
