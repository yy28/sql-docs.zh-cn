...
| 快速入门 | 描述 |
|-|-|
| [Python 中的 Hello World 和 SQL Server](quickstart-python-run-using-t-sql.md) | 了解如何在 T-sql 中调用 Python 的基本知识。 |
| [在 SQL Server 中使用 Python 处理输入和输出](quickstart-python-inputs-and-outputs.md) | 了解如何在[sp_execute_external_script](../../relational-databases/system-stored-procedures/sp-execute-external-script-transact-sql.md)中处理 Python 的输入和输出。 |
| [SQL Server 中的 Python 数据结构](quickstart-python-data-structures.md) | 演示 SQL Server 如何使用 Python pandas 包处理数据结构。 |
| [训练和使用您的第一个模型](quickstart-python-train-score-in-tsql.md) | 说明如何创建、定型和使用 Python 模型来预测新数据。 |
