...
ms.locfileid: "70211961"
---
# <a name="tutorial-prepare-data-to-perform-clustering-in-python-with-sql-server-machine-learning-services"></a>教程：准备数据以在 Python 中执行群集 SQL Server 机器学习服务

在此四部分的系列教程的第二部分中, 你将使用 Python 从 SQL 数据库导入并准备数据。 稍后在本系列中, 你将使用此数据, 通过 SQL Server 机器学习服务在 Python 中训练和部署群集模型。
...
* 本教程的第二部分假设已满足[**第一部分**](tutorial-python-clustering-model.md)的先决条件。
...
> [教程：使用 SQL Server 机器学习服务在 Python 中创建预测模型](tutorial-python-clustering-model-build.md)
