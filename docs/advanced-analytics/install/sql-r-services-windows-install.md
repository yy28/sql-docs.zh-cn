...
3. 在“功能选择”页面上，选择以下选项：
   ...
   - 选择“R Services (数据库内)” 。对在数据库内使用 R 的安装支持。
...
4. 在“同意安装 Microsoft R Open”页上，单击“接受”。
    ...
    需要此许可协议才能下载 Microsoft R Open，其中包括开源 R 基础软件包和工具的分发版，以及 Microsoft R 开发团队提供的增强 R 软件包和连接提供程序。
...
要想重启该服务，可以在 SSMS 中右键单击实例的“重启”命令、使用“控制面板”中的“服务”面板，或使用 SQL Server 配置管理器。
