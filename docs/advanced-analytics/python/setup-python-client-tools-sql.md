---
title: 设置用于 SQL Server 机器学习 Python 客户端工具 |Microsoft 文档
ms.prod: sql
...
ms.locfileid: "31203799"
---
# <a name="set-up-python-client-tools-for-use-with-sql-server-machine-learning"></a>设置 Python 客户端工具，用于 SQL Server 机器学习
