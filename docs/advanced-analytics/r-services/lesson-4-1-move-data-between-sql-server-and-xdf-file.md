...
ms.openlocfilehash: eb0c2ffa340fb3190500f8031a2cee3d1fc1f0c9
ms.lasthandoff: 04/11/2017

---
# <a name="lesson-4-1---move-data-between-sql-server-and-xdf-file"></a>课程 4-1 - 在 SQL Server 和 XDF 文件之间移动数据
