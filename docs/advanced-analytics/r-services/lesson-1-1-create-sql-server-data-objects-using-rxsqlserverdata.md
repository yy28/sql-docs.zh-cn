...
ms.openlocfilehash: 11a956e113585b314947e5afe07983875b01a8b0
ms.lasthandoff: 04/11/2017

---
# <a name="lesson-1-1---create-sql-server-data-objects-using-rxsqlserverdata"></a>课程 1-1 - 使用 RxSqlServerData 创建 SQL Server 数据对象
...
#### <a name="to-create-the-training-data-table"></a>创建定型数据表  
...
#### <a name="to-load-data-into-the-training-table"></a>将数据加载到定型表中  
...
#### <a name="to-load-data-into-the-scoring-table"></a>将数据加载到计分表中  
...
[查询和修改 SQL Server 数据（对数据科学的深入探讨）](../../advanced-analytics/r-services/lesson-1-2-query-and-modify-the-sql-server-data.md)  
