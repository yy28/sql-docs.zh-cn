...
ms.openlocfilehash: 53f48b344a037abf1dc8695bb9cb900c5c849214
ms.lasthandoff: 04/11/2017

---
# <a name="lesson-1-3---define-and-use-compute-contexts"></a>课程 1-3 - 定义并使用计算上下文
...
4.  准备好所有变量后，将它们作为参数提供给 *RxInSqlServer* 构造函数以创建*计算上下文对象*。  
...
2. 若要更改计算上下文，请使用 *rxSetComputeContext* 函数，并按名称指定上下文。
