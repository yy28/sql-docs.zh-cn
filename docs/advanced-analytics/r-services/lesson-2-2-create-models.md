...
ms.openlocfilehash: 96cb968d8cd52df0489494d58cd4743e4def4861
ms.lasthandoff: 04/11/2017

---
# <a name="lesson-2-2---create-models"></a>课程 2-2 - 创建模型
...
state=AK                Dropped    Dropped Dropped  Dropped state=AL             -1.043e+00  1.383e+00  -0.754   0.4511*      
（省略其他状态）  
...
[对新数据进行评分（对数据科学的深入探讨）](../../advanced-analytics/r-services/lesson-2-3-score-new-data.md)  
