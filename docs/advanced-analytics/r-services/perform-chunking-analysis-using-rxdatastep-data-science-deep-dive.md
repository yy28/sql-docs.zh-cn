...
manager: "jhubbard"
---
# 使用 rxDataStep 执行区块分析（对数据科学的深入探讨）
...
4.  将该变量插入新 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 数据源的 *sqlQuery* 参数。  
...
## 上一步  
[使用 rxDataStep 创建新的 SQL Server 表（对数据科学的深入探讨）](../../advanced-analytics/r-services/create-new-sql-server-table-using-rxdatastep-data-science-deep-dive.md)  
