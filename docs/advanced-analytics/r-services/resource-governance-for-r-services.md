...
ms.openlocfilehash: dbe8585d6906b354af750e7ae2a710d4812fc0d0
...
> [!NOTE]  
>  目前，新的资源调控器属性只能通过 DDL 语句或脚本使用；无法使用 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] 中的用户界面创建外部资源组。  
