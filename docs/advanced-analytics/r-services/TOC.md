# [监视 R 服务](monitoring-r-services.md)
...
# [实现 R 代码](operationalizing-your-r-code.md)
# [数据科学端到端演练](data-science-end-to-end-walkthrough.md)
...
# [设置 Azure 上的 R Server Only SQL Server 2016 Enterprise VM](provision-the-r-server-only-sql-server-2016-enterprise-vm-on-azure.md)
# [如何︰ 为 R 创建资源池](how-to-create-a-resource-pool-for-r.md)
# [在 Azure 虚拟机上安装 SQL Server R 服务](installing-sql-server-r-services-on-an-azure-virtual-machine.md)
...
# [使用 RxSqlServerData 创建 SQL Server 数据对象](create-sql-server-data-objects-using-rxsqlserverdata.md)
# [SQL Server R Services](sql-server-r-services.md)
# [R 和数据优化 (R Services)](r-and-data-optimization-r-services.md)
# [用于 SQL Server R Services Dmv](dmvs-for-sql-server-r-services.md)
# [定义并使用计算上下文](define-and-use-compute-contexts-data-science-deep-dive.md)
# [创建模型](create-models-data-science-deep-dive.md)
# [确定要在 SQL Server 上安装的包](determine-which-packages-are-installed-on-sql-server.md)
# [使用 rxDataStep 创建新的 SQL Server 表](create-new-sql-server-table-using-rxdatastep-data-science-deep-dive.md)
# [SQL Server R Services 的 R 包管理](r-package-management-for-sql-server-r-services.md)
# [安全性概述 (SQL Server R Services)](security-overview-sql-server-r-services.md)
# [配置和管理高级分析扩展](configure-and-manage-advanced-analytics-extensions.md)
# [查询和修改 SQL Server 数据](query-and-modify-the-sql-server-data-data-science-deep-dive.md)
# [在 R 功能的 SQL Server 各版本之间的差异](differences-in-r-features-between-editions-of-sql-server.md)
# [对新数据进行评分](score-new-data-data-science-deep-dive.md)
...
# [第 4 课：在本地计算上下文中分析数据](lesson-4-analyze-data-in-local-compute-context-data-science-deep-dive.md)
# [SQL Server R Services 的无人参与安装](unattended-installs-of-sql-server-r-services.md)
# [如何启用或禁用 R 包管理](how-to-enable-or-disable-r-package-management.md)
...
# [使用 R 创建图形和绘图](create-graphs-and-plots-using-r-data-science-end-to-end-walkthrough.md)
# [与 SQL Server 数据一起使用的 scaleR 函数](scaler-functions-for-working-with-sql-server-data.md)
...
# [步骤 4：使用 T-SQL 创建数据功能](step-4-create-data-features-using-t-sql-in-database-advanced-analytics-tutorial.md)
# [SQL Server R Services 入门](getting-started-with-sql-server-r-services.md)
# [使用 Management Studio 中的自定义报表监视 R Services](monitor-r-services-using-custom-reports-in-management-studio.md)
# [修改 SQL Server R 服务的用户帐户池](modify-the-user-account-pool-for-sql-server-r-services.md)
# [SQL Server 以支持 R 服务中的新组件](new-components-in-sql-server-to-support-r-services.md)
# [步骤 6：操作模型](step-6-operationalize-the-model-in-database-advanced-analytics-tutorial.md)
...
# [SQL Server R 服务的扩展事件](extended-events-for-sql-server-r-services.md)
# [在 Transact-SQL 中使用 R 代码](using-r-code-in-transact-sql-sql-server-r-services.md)
# [使用 sqlBindR.exe 升级 R Services 的实例](use-sqlbindr-exe-to-upgrade-an-instance-of-r-services.md)
# [安装 SQL Server R Services（数据库中）](set-up-sql-server-r-services-in-database.md)
# [安装和管理多个 R 包](installing-and-managing-r-packages.md)
# [SQL Server 配置 （R 服务）](sql-server-configuration-r-services.md)
# [数据科学方案和解决方案模板](data-science-scenarios-and-solution-templates.md)
# [第 3 课：创建数据功能](lesson-3-create-data-features-data-science-end-to-end-walkthrough.md)
# [使用 rxImport 将数据加载到内存中](load-data-into-memory-using-rximport-data-science-deep-dive.md)
# [使用 rxDataStep 执行区块分析](perform-chunking-analysis-using-rxdatastep-data-science-deep-dive.md)
# [创建 R Server（独立版）](create-a-standalone-r-server.md)
# [在 SQL Server 和 XDF 文件之间移动数据](move-data-between-sql-server-and-xdf-file-data-science-deep-dive.md)
# [步骤 2：使用 PowerShell 将数据导入 SQL Server](step-2-import-data-to-sql-server-using-powershell.md)
# [使用 R 查看和汇总数据](view-and-summarize-data-using-r-data-science-end-to-end-walkthrough.md)
# [在 SQL Server 中创建使用 R 的工作流](creating-workflows-that-use-r-in-sql-server.md)
...
# [R 服务的资源调控](resource-governance-for-r-services.md)
# [使用分析函数的 R 代码](using-r-code-profiling-functions.md)
# [使用 R 可视化 SQL Server 数据](visualize-sql-server-data-using-r-data-science-deep-dive.md)
# [性能案例研究 (R Services)](performance-case-study-r-services.md)
# [将 R 代码转换为在 R Services 中使用](converting-r-code-for-use-in-r-services.md)
...
# [SQL Server R 服务中的 R 互操作性](r-interoperability-in-sql-server-r-services.md)
