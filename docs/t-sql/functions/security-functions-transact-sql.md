---
title: "安全函数 (Transact SQL) |Microsoft 文档"
ms.custom: 
ms.date: 03/15/2017
...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  下列函数返回对管理安全性有用的信息。 其他函数下列出[加密功能 &#40;Transact SQL &#41;](../../t-sql/functions/cryptographic-functions-transact-sql.md).  
...
|[改用 DATABASE_PRINCIPAL_ID &#40;Transact SQL &#41;](../../t-sql/functions/database-principal-id-transact-sql.md)|[SCHEMA_NAME &#40;Transact SQL &#41;](../../t-sql/functions/schema-name-transact-sql.md)|  
...
|[权限 &#40;Transact SQL &#41;](../../t-sql/functions/permissions-transact-sql.md)||  
  
 有关 Windows 组的成员身份的信息，请参阅[xp_logininfo &#40;Transact SQL &#41;](../../relational-databases/system-stored-procedures/xp-logininfo-transact-sql.md)和[xp_enumgroups &#40;Transact SQL &#41;](../../relational-databases/system-stored-procedures/xp-enumgroups-transact-sql.md).  
