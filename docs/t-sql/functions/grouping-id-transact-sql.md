...
### <a name="b-using-grouping_id-to-filter-a-result-set"></a>B. 使用 GROUPING_ID 筛选结果集  
...
|名称|标题|Grouping Level|Employee Count|名称|  
|----------|-----------|--------------------|--------------------|----------|  
...
|年龄|月份|日期|Total Due|Bit Vector (base-2)|Integer Equivalent|Grouping Level|  
|----------|-----------|---------|---------------|----------------------------|------------------------|--------------------|  
