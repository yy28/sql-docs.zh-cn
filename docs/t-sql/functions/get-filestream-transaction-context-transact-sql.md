---
title: "GET_FILESTREAM_TRANSACTION_CONTEXT (Transact SQL) |Microsoft 文档"
ms.custom: 
ms.date: 03/14/2017
...
## <a name="examples"></a>示例  
 下面的示例使用`GET_FILESTREAM_TRANSACTION_CONTEXT`中[!INCLUDE[tsql](../../includes/tsql-md.md)]事务可以获取的事务上下文。  
