...
## <a name="examples"></a>示例  
 下面的示例返回的值**IsClustered**， **IndexDepth**，和**IndexFillFactor**属性`PK`_`Employee` \_`BusinessEntityID`索引`Employee`表中[!INCLUDE[ssSampleDBnormal](../../includes/sssampledbnormal-md.md)]数据库。  
