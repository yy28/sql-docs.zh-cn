---
title: "分析函数 (Transact SQL) |Microsoft 文档"
ms.custom: 
ms.date: 07/24/2017
...
SQL Server 支持以下分析函数。 解析函数基于一组行计算聚合值。 不过，与聚合函数不同，它们可能针对每个组返回多行。 可以使用分析函数来计算移动平均线、运行总计、百分比或一个组内的前 N 个结果。
  
|||  
|-|-|  
|[CUME_DIST &#40;Transact SQL &#41;](../../t-sql/functions/cume-dist-transact-sql.md)|[主管 &#40;Transact SQL &#41;](../../t-sql/functions/lead-transact-sql.md)|  
