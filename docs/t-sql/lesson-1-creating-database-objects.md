...
-   [创建数据库（教程）](../t-sql/creating-a-database-tutorial.md)  
  
-   [创建表（教程）](../t-sql/creating-a-table-tutorial.md)  
  
-   [插入和更新表中的数据（教程）](../t-sql/inserting-and-updating-data-in-a-table-tutorial.md)  
  
-   [读取表中的数据（教程）](../t-sql/reading-the-data-in-a-table-tutorial.md)  
  
-   [摘要：创建数据库对象](../t-sql/summary-creating-database-objects.md)  
