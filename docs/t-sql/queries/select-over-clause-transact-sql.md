...
## <a name="see-also"></a>另请参阅  
 ...
 [Itzik Ben-Gan 在 sqlmag.com 上撰写的关于窗口函数和 OVER 的优秀博客文章](https://sqlmag.com/sql-server-2012/how-use-microsoft-sql-server-2012s-window-functions-part-1)  
