...
[!INCLUDE[tsql-appliesto-ss2008-all_md](../../includes/tsql-appliesto-ss2008-all-md.md)]
  ...
  数据操作语言 (DML) 是用于检索和使用中的数据的词汇[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]和 SQL 数据库。 另一次即可在 SQL 数据仓库和 PDW （查看每个单独的语句，有关详细信息）。 使用这些语句可以从 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 数据库添加、修改、查询或删除数据。  
...
|[顶部 &#40;Transact SQL &#41;](../../t-sql/queries/top-transact-sql.md)|DELETE、INSERT、MERGE、SELECT、UPDATE|  
|[WHERE &#40;Transact-SQL&#41;](../../t-sql/queries/where-transact-sql.md)|删除、 选择、 更新、 匹配|  
|[使用 common_table_expression &#40;Transact SQL &#41;](../../t-sql/queries/with-common-table-expression-transact-sql.md)|DELETE、INSERT、MERGE、SELECT、UPDATE|  
