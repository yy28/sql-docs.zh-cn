---
description: OGC 静态地理方法
title: OGC 静态地理方法 | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88467500"
---
# <a name="ogc-static-geography-methods"></a>OGC 静态地理方法
[!INCLUDE [SQL Server Azure SQL Database ](../../includes/applies-to-version/sql-asdb.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 支持开放地理空间联盟 (OGC) 的静态地理方法。  
