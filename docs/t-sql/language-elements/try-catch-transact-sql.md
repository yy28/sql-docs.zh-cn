...
```  
 ...
 ERROR\_\* 函数也适用于[本机编译的存储过程](../../relational-databases/in-memory-oltp/a-guide-to-query-processing-for-memory-optimized-tables.md)内的 `CATCH` 块。  
