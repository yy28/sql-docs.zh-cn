---
title: "+ = （加等于） (Transact SQL) |Microsoft 文档"
ms.custom: 
ms.date: 03/16/2017
...
---
# <a name="-add-equals-transact-sql"></a>+=（加等于）(Transact-SQL)
...
## <a name="see-also"></a>另请参阅  
 ...
 [+ = &#40;字符串串联 &#41;&#40;Transact SQL &#41;](../../t-sql/language-elements/string-concatenation-equal-transact-sql.md)  
