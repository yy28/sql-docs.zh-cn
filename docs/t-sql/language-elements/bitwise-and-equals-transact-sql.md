---
title: "&amp;= （位与等于） (Transact SQL) |Microsoft 文档"
ms.custom: 
ms.date: 01/10/2017
...
---
# <a name="amp-bitwise-and-equals-transact-sql"></a>&amp;= （位与等于） (Transact SQL)
...
## <a name="remarks"></a>注释  
 有关详细信息，请参阅[& &#40;按位 AND &#41;&#40;Transact SQL &#41;](../../t-sql/language-elements/bitwise-and-transact-sql.md).  
