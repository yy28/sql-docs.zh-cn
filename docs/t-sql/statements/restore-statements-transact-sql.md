...
>   <th><a href="restore-statements-transact-sql.md?view=azuresqldb-mi-current">SQL DB<br />托管实例</a></th>
...
指定要用于还原操作的 URL。 URL 格式用于从 Microsoft Azure 存储服务还原备份。 
