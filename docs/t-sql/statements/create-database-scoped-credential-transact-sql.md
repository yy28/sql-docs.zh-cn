...
请先[创建 AAD 应用程序](https://docs.microsoft.com/en-us/azure/data-lake-store/data-lake-store-authenticate-using-active-directory)，并记录 client_id、OAuth_2.0_Token_EndPoint 和密钥，然后再尝试创建数据库范围凭据。
