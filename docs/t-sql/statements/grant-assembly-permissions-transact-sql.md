---
description: GRANT 程序集权限 (Transact-SQL)
title: GRANT 程序集权限 (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 06/12/2017
ms.prod: sql
...
ms.locfileid: "88426539"
---
# <a name="grant-assembly-permissions-transact-sql"></a>GRANT 程序集权限 (Transact-SQL)
