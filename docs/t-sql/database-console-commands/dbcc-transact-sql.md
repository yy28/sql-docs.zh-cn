...
- [DBCC CLONEDATABASE](../../t-sql/database-console-commands/dbcc-clonedatabase-transact-sql.md) <br /><br /> **适用对象**：[!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] SP2 和更高版本。
