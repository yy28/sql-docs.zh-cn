...
对于 [!INCLUDE[ssSDS](../../includes/sssds-md.md)] 高级层，需要数据库的 `VIEW DATABASE STATE` 权限。 对于 [!INCLUDE[ssSDS](../../includes/sssds-md.md)] 标准层和基本层，需要 [!INCLUDE[ssSDS](../../includes/sssds-md.md)] 管理员帐户。 不支持重置等待和闩锁统计信息。
