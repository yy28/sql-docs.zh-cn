...
* [在 Windows 上的 Java 入门](https://www.microsoft.com/sql-server/developer-get-started/java/windows/)
* [开始使用 Java 在 macOS 上](https://www.microsoft.com/sql-server/developer-get-started/java/mac/)
