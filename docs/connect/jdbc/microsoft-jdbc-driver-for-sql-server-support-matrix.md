...
|-|-|-|-|  
|Microsoft JDBC Driver 6.2 for SQL Server|6.2|mssql jdbc 6.2.1.jre8.jar<br> mssql jdbc 6.2.1.jre7.jar|2022 年 6 月 30 日|    
...
|驱动程序版本|SQL Server 2008|SQL Server 2008R2|SQL Server 2012|Azure SQL Database|PDW 2008R2 AU3<sup>4</sup>|SQL Server 2014|SQL Server 2016|  
|-|-|-|-|-|-|-|-| 
|6.2|是|是|是|是|是|是|是|  
|6.1|是|是|是|是|是|是|是|  
|6.0|是|是|是|是|是|是|是|  
...
|4.1|是|是|是|是|是|是|是|  
|4.0|是|是|是|是|是|是|是|  
|3.0|是|是|Y<sup>1</sup>|Y<sup>2</sup>|否|Y<sup>5</sup>|否|  
|2.0|Y<sup>3</sup>|Y<sup>3</sup>|否|否|否|否|否|  
|1.2|Y<sup>3</sup>|否|否|否|否|否|否|  
|1.1|否|否|否|否|否|否|否|  
|1.0|否|否|否|否|否|否|否|  
|2000|否|否|否|否|否|否|否|  
