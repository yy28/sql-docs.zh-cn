...
|[使用高级的数据类型](../../connect/jdbc/using-advanced-data-types.md)|描述 JDBC 高级数据类型。|  
|[了解数据的类型差异](../../connect/jdbc/understanding-data-type-differences.md)|描述不同 JDBC 驱动程序数据类型之间的差异。|  
|[了解数据类型转换](../../connect/jdbc/understanding-data-type-conversions.md)|描述当使用 getter 和 setter 方法时如何处理数据类型转换。|  
|[国家/地区字符集支持](../../connect/jdbc/national-character-set-support.md)|介绍对区域字符集类型的支持。|  
