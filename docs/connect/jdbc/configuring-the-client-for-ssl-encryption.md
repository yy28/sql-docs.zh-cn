---
title: 为 SSL 加密配置客户端 |Microsoft Docs
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
...
ms.locfileid: "69028206"
---
# <a name="configuring-the-client-for-ssl-encryption"></a>为客户端配置 SSL 加密
[!INCLUDE[Driver_JDBC_Download](../../includes/driver_jdbc_download.md)]
 ...
 若要详细了解如何验证服务器证书，请参阅[了解 SSL 支持](../../connect/jdbc/understanding-ssl-support.md)中的“验证服务器 SSL 证书”部分。  
