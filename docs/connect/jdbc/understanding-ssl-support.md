...
>
> 有关如何为配置 SSL 的[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]详细信息，请参阅[启用到数据库引擎的加密连接](../../database-engine/configure-windows/enable-encrypted-connections-to-the-database-engine.md)。  
