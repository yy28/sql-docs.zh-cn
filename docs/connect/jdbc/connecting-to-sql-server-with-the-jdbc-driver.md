...
|主题|Description|  
|-----------|-----------------|  
|[生成连接 URL](../../connect/jdbc/building-the-connection-url.md)|介绍如何连接到窗体连接 URL[!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)]数据库。 此外介绍了连接到命名实例的[!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)]数据库。|  
...
|[针对高可用性、 灾难恢复的 JDBC 驱动程序支持](../../connect/jdbc/jdbc-driver-support-for-high-availability-disaster-recovery.md)|说明如何开发将连接到 AlwaysOn 可用性组的应用程序。|  
