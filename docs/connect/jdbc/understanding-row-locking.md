...
> [!NOTE]  
>  有关 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] 中的行锁定的详细信息，请参阅 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] 联机丛书中的“[!INCLUDE[ssDE](../../includes/ssde_md.md)] 中的锁定”。  
