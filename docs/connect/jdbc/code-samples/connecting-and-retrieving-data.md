...
|主题|描述|  
|-----------|-----------------|  
|[连接 URL 示例](../../../connect/jdbc/code-samples/connection-url-sample.md)|介绍了如何先使用连接 URL 连接到 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]，再使用 SQL 语句来检索数据。|  
