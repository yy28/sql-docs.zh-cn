...
| 主题                                                                                                                         | 描述                                                              |
| ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| [读取大型数据的示例](../../../connect/jdbc/code-samples/reading-large-data-sample.md)                                               | 说明如何使用 SQL 语句检索大值数据。       |
| [使用存储过程读取大型数据的示例](../../../connect/jdbc/code-samples/reading-large-data-with-stored-procedures-sample.md) | 说明如何检索大型 CallableStatement OUT 参数值。 |
| [更新大型数据的示例](../../../connect/jdbc/code-samples/updating-large-data-sample.md)                                             | 说明如何更新数据库中的大值数据。                |
