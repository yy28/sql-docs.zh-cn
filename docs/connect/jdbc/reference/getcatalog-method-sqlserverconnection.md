...
## <a name="remarks"></a>Remarks  
 此 getCatalog 方法由 getCatalog 方法在 sql 连接接口中指定。  
  
 返回 SQLServerConnection 对象的当前目录属性, 如果未设置该属性, 则返回 null。 使用 [setCatalog](../../../connect/jdbc/reference/setcatalog-method-sqlserverconnection.md) 方法显式设置目录属性，或者可通过读取当前目录的 TDS 环境更改隐式更新目录属性。  
