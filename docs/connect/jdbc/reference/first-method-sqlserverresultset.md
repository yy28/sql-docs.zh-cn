...
ms.locfileid: "67954559"
---
# <a name="first-method-sqlserverresultset"></a>first 方法 (SQLServerResultSet)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  将游标移到此 [SQLServerResultSet](../../../connect/jdbc/reference/sqlserverresultset-class.md) 对象的第一行。  
...
## <a name="remarks"></a>备注  
 此 first 方法是由 java.sql.ResultSet 接口中的 first 方法指定此 first 方法是由 java.sql.ResultSet 接口中的 first 方法指定的。  
