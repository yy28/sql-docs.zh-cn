...
|[setBinaryStream 方法和 #40;java.lang.String、 java.io.InputStream、 long 类型的值和 #41;](../../../connect/jdbc/reference/setbinarystream-method-java-lang-string-java-io-inputstream-long.md)|将指定参数设置为指定的输入流，而指定输入流将含有指定字节数。|  
