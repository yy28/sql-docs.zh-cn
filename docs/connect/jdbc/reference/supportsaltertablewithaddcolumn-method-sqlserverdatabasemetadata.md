---
title: supportsAlterTableWithAddColumn 方法 |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>注释  
 由 java.sql.DatabaseMetaData 接口中的 supportsAlterTableWithAddColumn 方法指定此 supportsAlterTableWithAddColumn 方法。  
