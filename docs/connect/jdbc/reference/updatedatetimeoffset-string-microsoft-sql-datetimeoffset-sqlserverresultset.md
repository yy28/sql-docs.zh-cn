...
## <a name="remarks"></a>Remarks  
 可以使用[SQLServerResultSet](../../../connect/jdbc/reference/getdatetimeoffset-sqlserverresultset.md)检索[DateTimeOffset 类](../../../connect/jdbc/reference/datetimeoffset-class.md)的值。  
