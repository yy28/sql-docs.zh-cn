---
title: TRANSACTION_SNAPSHOT 字段 (SQLServerConnection) |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32847312"
---
# <a name="transactionsnapshot-field-sqlserverconnection"></a>TRANSACTION_SNAPSHOT 字段 (SQLServerConnection)
