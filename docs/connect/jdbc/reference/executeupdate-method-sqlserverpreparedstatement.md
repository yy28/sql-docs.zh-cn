---
title: executeUpdate 方法 (SQLServerPreparedStatement) |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|名称|Description|  
|----------|-----------------|  
|[executeUpdate （)](../../../connect/jdbc/reference/executeupdate-method.md)|在此运行的 SQL 语句[SQLServerPreparedStatement](../../../connect/jdbc/reference/sqlserverpreparedstatement-class.md)对象，它必须是 SQL INSERT、 UPDATE、 MERGE 或 DELETE 语句; 或返回任何内容，例如 DDL 语句的 SQL 语句。|  
