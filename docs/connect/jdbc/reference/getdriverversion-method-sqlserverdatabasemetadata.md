---
description: getDriverVersion 方法 (SQLServerDatabaseMetaData)
...
## <a name="remarks"></a>备注  
 此 getDriverVersion 方法是由 java.sql.DatabaseMetaData 接口中的 getDriverVersion 方法指定的。  
