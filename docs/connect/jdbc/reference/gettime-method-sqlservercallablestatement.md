---
title: getTime 方法 (SQLServerCallableStatement) |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|[getTime （int、 java.util.Calendar）](../../../connect/jdbc/reference/gettime-method-int-java-util-calendar.md)|作为 Java 编程语言提供的参数索引，使用给定的日历对象中的 java.sql.Time 对象中检索指定参数的值。|  
...
|[getTime （java.lang.String，java.util.Calendar）](../../../connect/jdbc/reference/gettime-method-java-lang-string-java-util-calendar.md)|作为 Java 编程语言提供参数名称，使用给定的日历对象中的 java.sql.Time 对象中检索指定参数的值。|  
