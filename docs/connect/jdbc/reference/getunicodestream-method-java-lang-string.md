---
title: "getUnicodeStream 方法 (java.lang.String) |Microsoft 文档"
ms.custom: 
ms.date: 01/19/2017
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  检索此当前行中的指定的列名称的值[SQLServerResultSet](../../../connect/jdbc/reference/sqlserverresultset-class.md)为 Unicode 字符流的对象。  
