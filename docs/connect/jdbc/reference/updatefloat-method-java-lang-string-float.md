---
title: updateFloat 方法 （java.lang.String，float） |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>注释  
 由 java.sql.ResultSet 接口中的 updateFloat 方法指定此 updateFloat 方法。  
