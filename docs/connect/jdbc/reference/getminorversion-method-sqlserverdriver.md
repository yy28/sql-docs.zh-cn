---
title: getMinorVersion 方法 (SQLServerDriver) |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.author: genemi
manager: craigg
ms.openlocfilehash: 35920a80643a33c4911ee68ce25c41ee6d81df60
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  返回的次要版本号[!INCLUDE[jdbcNoVersion](../../../includes/jdbcnoversion_md.md)]。  
 ...
 **Int** ，其中包含的 JDBC 驱动程序的次版本号。  
  
## <a name="remarks"></a>注释  
 由 java.sql.Driver 接口中的 getMinorVersion 方法指定此 getMinorVersion 方法。  
