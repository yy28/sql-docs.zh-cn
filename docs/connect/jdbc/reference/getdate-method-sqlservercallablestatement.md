---
description: getDate 方法 (SQLServerCallableStatement)
...
|[getDate (java.lang.String, java.util.Calendar)](../../../connect/jdbc/reference/getdate-method-java-lang-string-java-util-calendar.md)|在给定参数名称和 Calendar 对象的情况下，检索指定参数的值作为 Java 编程语言中的 java.sql.Date 对象。|  
