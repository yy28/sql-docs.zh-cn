...
ms.locfileid: "67978286"
---
# <a name="geturl-method-sqlservercallablestatement"></a>getURL 方法 (SQLServerCallableStatement)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  检索指定参数作为 Java 编程语言中的 URL 对象的值。  
  
## <a name="overload-list"></a>重载列表  
  
|名称|说明|  
|----------|-----------------|  
|[getURL (int)](../../../connect/jdbc/reference/geturl-method-int.md)|根据给定的参数索引检索指定参数作为 Java 编程语言中的 URL 对象的值。|  
|[getURL (java.lang.String)](../../../connect/jdbc/reference/geturl-method-java-lang-string.md)|根据给定的参数名称，检索指定参数作为 Java 编程语言中的 URL 对象的值。|  
