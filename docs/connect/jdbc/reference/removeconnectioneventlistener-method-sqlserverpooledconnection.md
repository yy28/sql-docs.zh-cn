---
title: removeConnectionEventListener 方法 (SQLServerPooledConnection) |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.author: genemi
manager: craigg
ms.openlocfilehash: eb392f05a15cdcb9a865ba0ad00dd21ac9e66927
...
## <a name="remarks"></a>注释  
 由 javax.sql.PooledConnection 接口中的 removeConnectionEventListener 方法指定此 removeConnectionEventListener 方法。  
