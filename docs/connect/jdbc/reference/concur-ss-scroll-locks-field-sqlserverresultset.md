---
description: CONCUR_SS_SCROLL_LOCKS 字段 (SQLServerResultSet)
title: CONCUR_SS_SCROLL_LOCKS 字段 (SQLServerResultSet) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  用于指定 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 有行锁的读/写乐观并发类型。  
