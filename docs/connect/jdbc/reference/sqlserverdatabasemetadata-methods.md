...
ms.locfileid: "66800534"
---
# <a name="sqlserverdatabasemetadata-methods"></a>SQLServerDatabaseMetaData 方法
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  有关成员的相关信息[SQLServerDatabaseMetaData](../../../connect/jdbc/reference/sqlserverdatabasemetadata-class.md)，请参阅[SQLServerDatabaseMetaData 成员](../../../connect/jdbc/reference/sqlserverdatabasemetadata-members.md)。  
