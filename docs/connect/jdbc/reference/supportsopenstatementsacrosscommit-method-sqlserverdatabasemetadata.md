---
title: supportsOpenStatementsAcrossCommit 方法 |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>注释  
 由 java.sql.DatabaseMetaData 接口中的 supportsOpenStatementsAcrossCommit 方法指定此 supportsOpenStatementsAcrossCommit 方法。  
