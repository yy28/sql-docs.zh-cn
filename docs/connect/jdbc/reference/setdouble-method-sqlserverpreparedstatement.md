---
title: setDouble 方法 (SQLServerPreparedStatement) |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.author: genemi
manager: craigg
ms.openlocfilehash: f6a490f209079836fd3a8696764cad90b495ac01
...
## <a name="remarks"></a>注释  
 由 java.sql.PreparedStatement 接口中的 setDouble 方法指定此 setDouble 方法。  
