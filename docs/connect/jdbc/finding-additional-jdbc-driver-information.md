...
|资源|描述|  
|--------------|-----------------|  
|[JDBC Driver for SQL Server GitHub 存储库](https://github.com/microsoft/mssql-jdbc)|此存储库包含适用于 SQL Server JDBC 驱动程序的源代码。 使用此站点直接与 JDBC 驱动程序团队的成员进行交互。 可以在此处提出的问题，提供反馈，并提供直接向驱动程序。|
...
|[JDBC 博客](https://go.microsoft.com/fwlink/?LinkId=124746)|此博客用于提供有关的信息[!INCLUDE[jdbcNoVersion](../../includes/jdbcnoversion_md.md)]。|  
