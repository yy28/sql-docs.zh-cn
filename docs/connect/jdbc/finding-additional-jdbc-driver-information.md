...
|资源|描述|  
|--------------|-----------------|  
|[适用于 SQL Server GitHub 存储库的 JDBC 驱动程序](https://github.com/microsoft/mssql-jdbc)|此存储库包含 JDBC Driver for SQL Server 的源代码。 使用此站点可直接与 JDBC 驱动程序团队的成员进行交互。 你可以在此处提出问题、提供反馈并直接参与驱动程序。|
...
|[JDBC 博客](https://go.microsoft.com/fwlink/?LinkId=124746)|此博客用于提供有关的[!INCLUDE[jdbcNoVersion](../../includes/jdbcnoversion_md.md)]信息。|  
