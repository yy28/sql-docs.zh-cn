...
-   表值参数仅可编制索引以支持 UNIQUE 或 PRIMARY KEY 约束。 不维护表值参数列的统计信息。  
...
|公共 SQLServerMetaData (SQLServerMetaData sqlServerMetaData)|初始化新实例的 SQLServerMetaData 从另一个 SQLServerMetaData 对象。|  
