...
| [SQL 数据发现和分类](../../connect/jdbc/data-discovery-classification-sample.md) | 此示例应用程序演示如何使用 JDBC Driver 从结果集对象检索[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]数据库中包含的数据发现和分类信息。                                      |
