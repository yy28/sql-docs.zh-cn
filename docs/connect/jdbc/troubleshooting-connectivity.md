...
-   无法为 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 启用 TCP/IP，或者指定的服务器或端口号不正确。 验证 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 是否正通过指定服务器和端口上的 TCP/IP 进行侦听。 系统可能会报告类似“登录已经失败。 对主机的 TCP/IP 连接已失败。”的异常。 这指示下列内容之一：  
    ...
    -   已安装了 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]，但并没有通过以下方法针对 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 将 TCP/IP 作为网络协议进行安装：使用 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的 [!INCLUDE[ssVersion2000](../../includes/ssversion2000-md.md)] 网络实用工具，或者使用 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 及更高版本的 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 配置管理器。  
