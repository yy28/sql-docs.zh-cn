...
description: 适用于 SQL Server 的 Microsoft OLE DB 驱动程序的下载地址
ms.date: 10/15/2019
ms.prod: sql
...
- [适用于 SQL Server 的 Microsoft OLE DB 驱动程序 18.3.0](https://go.microsoft.com/fwlink/?linkid=871294)
