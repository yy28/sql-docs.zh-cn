...
<b id="table3_1">[1]:</b>为了提高安全性，加密和证书验证行为修改时使用的身份验证/访问令牌初始化属性或其相应的连接字符串关键字。 有关详细信息，请参阅[加密和证书验证](../features/using-azure-active-directory.md#encryption-and-certificate-validation)。
