...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
  ...
  在开发时为 SQL Server 库使用 OLE DB 驱动程序的应用程序，有一系列派上用场的问题。 在本部分中的主题讨论了多个类问题，包括从 MDAC 升级到 OLE DB 驱动程序，对于 SQL Server，使用 OLE DB 驱动程序的 SQL Server 标头和库文件，可用于 OLE DB 驱动程序为 S 的各种连接字符串的概述QL Server。  

## <a name="in-this-section"></a>本节内容  
 [安装适用于 SQL Server 的 OLE DB 驱动程序](../../oledb/applications/installing-oledb-driver-for-sql-server.md)  
 讨论如何安装 OLE DB 驱动程序适用于 SQL Server、 各种组件安装到的位置以及如何卸载 SQL Server 的 OLE DB 驱动程序。  

 [适用于 SQL Server 的 OLE DB 驱动程序的组件](../../oledb/applications/components-of-oledb-driver-for-sql-server.md)  
 讨论构成包括库、 资源、 帮助和标头文件的 SQL Server 的 OLE DB 驱动程序的组件。  
 ...
 讨论如何使用 SQL Server 标头和库文件应用程序中的 OLE DB 驱动程序。  
 ...
 讨论 OLE DB 驱动程序适用于 SQL Server 和 MDAC 和从 MDAC 升级到 OLE DB 驱动程序，适用于 SQL Server 时应考虑的问题之间的差异。  

 [从 SQL Server 2005 Native Client 更新应用程序](../../oledb/applications/updating-an-application-from-sql-server-2005-native-client.md)  
 讨论从升级时应考虑的问题[!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)]Native Client OLE DB 驱动程序适用于 SQL Server。  

 [将 ADO 与适用于 SQL Server 的 OLE DB 驱动程序结合使用](../../oledb/applications/using-ado-with-oledb-driver-for-sql-server.md)  
 讨论 ADO 如何使用 OLE DB 驱动程序适用于 SQL Server 可以访问和使用[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]功能。  

 [适用于 SQL Server 的 OLE DB 驱动程序的支持策略](../../oledb/applications/support-policies-for-oledb-driver-for-sql-server.md)  
 讨论了各种数据访问组件可与不同版本的 OLE DB 驱动程序适用于 SQL Server。  
