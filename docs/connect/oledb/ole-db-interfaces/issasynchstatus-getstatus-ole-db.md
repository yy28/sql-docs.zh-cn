---
title: ISSAsynchStatus::GetStatus（OLE DB 驱动程序）| Microsoft Docs
description: 了解 ISSAsynchStatus::GetStatus 方法如何返回 OLE DB Driver for SQL Server 中的异步执行操作的状态。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
