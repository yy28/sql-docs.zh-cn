---
title: 设置大型数据（OLE DB 驱动程序）
description: 了解如何通过 OLE DB Driver for SQL Server 将指针传递给使用者存储对象来设置 BLOB 数据。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
  ...
  借助于 OLE DB Driver for SQL Server，你可以通过将指针传递给使用者存储对象来设置 BLOB 数据。  
