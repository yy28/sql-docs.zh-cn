---
title: 针对日期和时间改进的数据类型支持（OLE DB 驱动程序）| Microsoft Docs
description: 了解 OLE DB Driver for SQL Server 中支持 SQL Server 日期/时间数据类型的 OLE DB 类型。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
  ...
  本文提供有关支持 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 日期/时间数据类型的 OLE DB (OLE DB Driver for SQL Server) 类型的信息。  
...
## <a name="data-formats-data-structures"></a>数据格式：数据结构  
 在以下所述的 OLE DB 特定结构中，OLE DB 遵守以下约束。 这些值取自公历：  
...
|----------------------------------|-----------------------------------------|-----------|  
|DBTYPE_DBDATE|date||  
|DBTYPE_DBTIMESTAMP|**datetime2**(p)|OLE DB Driver for SQL Server 检查 DBCOLUMDESC bScale  成员以确定秒小数部分的精度。|  
