...
description: 在此示例中，了解如何使用 IRowsetFastUpload 接口将 4MB 到 4GB 的数据发送到 OLE DB Driver for SQL Server 中的 FILESTREAM 列。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
## <a name="example"></a>示例  
 ...
 复制第三个代码列表，并将其粘贴到名为 IRowsetFastLoadUpload.cpp 的文件中。  
