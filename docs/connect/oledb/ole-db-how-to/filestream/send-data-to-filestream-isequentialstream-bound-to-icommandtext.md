---
title: 向 FILESTREAM 发送数据 - ISequentialStream 绑定到 ICommandText | Microsoft Docs
description: 通过此示例了解如何使用绑定到 ICommandText 参数的 ISequentialStream 接口向 filestream 列发送大小在 4 MB 到 4 GB 之间的数据。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
