---
title: 使用日期和时间增强功能（OLE DB 驱动程序）
description: 了解如何使用日期/时间功能（date、time、datetime2 和 datetimeoffset）运行命令，以及如何使用它们检索 OLE DB Driver for SQL Server 中的行集结果。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
