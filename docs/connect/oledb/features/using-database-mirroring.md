...
description: 对 OLE DB Driver for SQL Server 使用数据库镜像
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
...
> [!NOTE]  
>  如果希望在 DSN、连接字符串或连接属性/特性中使用此功能，必须显式指定连接要使用的数据库。 否则，OLE DB Driver for SQL Server 将不会尝试故障转移到伙伴数据库。  
>   
