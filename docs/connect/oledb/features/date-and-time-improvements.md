...
description: SQL Server OLE DB 驱动程序的日期和时间改进
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
  ...
  本主题介绍 SQL Server 对中[!INCLUDE[ssKatmai](../../../includes/sskatmai-md.md)]添加的日期和时间数据类型的支持的 OLE DB 驱动程序。  
  
 有关日期/时间改进的详细信息, 请参阅[日期和时间&#40;改进&#41;OLE DB](../../oledb/ole-db-date-time/date-and-time-improvements-ole-db.md)。  
...
### <a name="use-date-as-a-distinct-data-type"></a>将日期用作非重复数据类型  
 从开始[!INCLUDE[ssKatmai](../../../includes/sskatmai-md.md)], 增强了对日期/时间类型的支持, 以便更有效地使用 DBTYPE_DBDATE OLE DB 类型。  
...
### <a name="use-time-as-a-distinct-data-type-with-extended-fractional-seconds-precision"></a>将具有扩展的秒的小数部分精度的时间用作非重复数据类型  
 某些应用程序（如过程控制和生产应用程序）要求能够处理精度高达 100 纳秒的时间数据。 在 OLE DB 中, 此目的的新类型为 DBTYPE_DBTIME2。  
