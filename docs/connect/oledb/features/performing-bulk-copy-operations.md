...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
 ...
 有关演示此功能的示例应用程序，请参阅[大容量复制数据使用 IRowsetFastLoad &#40;OLE DB&#41;](../../oledb/ole-db-how-to/bulk-copy-data-using-irowsetfastload-ole-db.md)。  
...
#### <a name="irowsetfastload-rowsets"></a>IRowsetFastLoad 行集  
 适用于 SQL Server 的 OLE DB 驱动程序大容量复制行集是只写的，但它们公开的接口允许使用者确定 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 表的结构。 以下接口的公开方式大容量复制启用 OLE DB 驱动程序为 SQL Server 行集：  
