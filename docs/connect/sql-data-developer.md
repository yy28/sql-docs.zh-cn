...
* [SQL Azure](https://docs.microsoft.com/azure/sql-database/)： 使用 SQL Azure 数据库移动到云 
* [SQL Compact](https://www.microsoft.com/en-us/download/details.aspx?id=17876): SQL Server Compact 构建独立和偶尔连接应用程序的移动设备、 桌面和 Web 客户端。
...
* [SQL 客户端驱动程序](sql-connection-libraries.md)： 使用 SQL 驱动程序连接，请查询、 更新、 插入或删除 SQL 数据库中的数据。
* [实体框架](https://msdn.microsoft.com/library/gg696172.aspx)： 使用实体框架可以轻松地访问使用 LINQ，直接访问 SQL Server 和选项来控制实体数据模型 (EDM) 和原始关系结构之间的映射的数据库。 
* [Windows Communication Foundation (WCF)](https://msdn.microsoft.com/library/dd456779.aspx)： 使用数据服务，以近乎统包解决方案轻松地创建和使用 web 和 intranet 上的 OData 服务
* [同步框架](https://msdn.microsoft.com/library/jj839436.aspx)： 使用 Sync Framework 启用脱机访问任何数据类型、 任何数据存储、 任何传输协议和任何网络拓扑。
* [被动扩展](https://msdn.microsoft.com/library/hh242985.aspx)： 使用被动扩展 (Rx) 执行事件流编程并简化异步编程使用可观察的序列和 LINQ 样式查询运算符。  使用 javascript (RxJS) 被动扩展简化使用可观察的序列在 web 上的异步回调基于和事件驱动编程。
...
* [SQLXML 4.0](../relational-databases/sqlxml/sqlxml-4-0-programming-concepts.md)： 使用 SQLXML 4.0 中将关系数据导出到 XML。
