...
ms.locfileid: "67935657"
---
# <a name="ruby-driver-for-sql-server"></a>用于 SQL Server 的 Ruby 驱动程序

![Download-DownArrow-Circled](../../ssdt/media/download.png)[下载 Ruby Driver for SQL Server 的具体步骤](../sql-connection-libraries.md#anchor-20-drivers-relational-access)
