...
1.  **下载 Ruby 安装程序**  
如果你的计算机没有 Ruby，请安装它。 对于新的 ruby 用户，我们建议使用 Ruby 2.2.X 安装程序。 它们提供的稳定语言和扩展的包 (gem) 兼容的和已更新的列表。 转[Ruby 下载页](http://rubyinstaller.org/downloads/)并下载合适的 2.1.x 安装程序。 有关示例，如果您是在 64 位计算机上，下载 Ruby 2.1.6 (x64) 安装程序。   
