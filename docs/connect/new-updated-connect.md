...
1. [客户端编程到 Microsoft SQL Server 主页](homepage-sql-connection-programming.md)
2. [使用 Azure Active Directory 身份验证进行连接](php/azure-active-directory.md)
3. [空闲连接复原](php/connection-resiliency.md)
4. [PHP Linux 和 Mac 驱动程序安装教程](php/installation-tutorial-linux-mac.md)
5. [Microsoft SQL 数据库的连接模块](sql-connection-libraries.md)
