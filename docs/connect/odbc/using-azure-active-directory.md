...
[使用 Azure AD 身份验证的 Azure SQL DB 对基于令牌的身份验证的支持](/archive/blogs/sqlsecurity/token-based-authentication-support-for-azure-sql-db-using-azure-ad-auth)
