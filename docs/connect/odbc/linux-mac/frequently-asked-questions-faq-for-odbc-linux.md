...
为 SQL_CHAR 数据使用 UTF-8，为 SQL_WCHAR 数据使用 UTF-16。 根据系统区域设置和驱动程序版本, 也可以支持多个编码之一中的非 UTF-8 数据。 有关详细信息, 请参阅[编程准则](../../../connect/odbc/linux-mac/programming-guidelines.md)。
