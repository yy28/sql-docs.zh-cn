---
title: 异步执行（通知方法）示例
description: 演示如何在 Microsoft ODBC Driver for SQL Server 中使用异步执行（使用通知方法）的示例代码。
ms.custom: ''
ms.date: 09/01/2020
ms.prod: sql
...
ms.locfileid: "89287919"
---
# <a name="asynchronous-execution-notification-method-sample"></a>异步执行（通知方法）示例
[!INCLUDE[Driver_ODBC_Download](../../../includes/driver_odbc_download.md)]

  本主题中的代码示例演示如何使用[异步执行（通知方法）](../../../odbc/reference/develop-app/asynchronous-execution-notification-method.md)。  
