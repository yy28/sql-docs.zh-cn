...
|PDO::SQLSRV_CLIENT_BUFFER_MAX_SIZE|[!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)]|integer|设置查询缓冲区的大小。<br /><br />如果未在 php.ini 文件中指定，则默认值为 10240 KB。<br /><br />不允许使用零和负数。<br /><br />有关创建客户端游标的查询的详细信息，请参阅[游标类型（PDO_SQLSRV 驱动程序）](../../connect/php/cursor-types-pdo-sqlsrv-driver.md)。|  
