...
ms.locfileid: "91726798"
---
# <a name="pdolastinsertid"></a>PDO::lastInsertId
[!INCLUDE[Driver_PHP_Download](../../includes/driver_php_download.md)]

返回最近插入数据库中的表的行标识符。 该表必须含有 IDENTITY NOT NULL 列。 如果提供了序列名称，则 `lastInsertId` 返回提供的序列名称的最新插入的序列号（有关序列号的详细信息，请参阅[此处](../../relational-databases/sequence-numbers/sequence-numbers.md)）。
