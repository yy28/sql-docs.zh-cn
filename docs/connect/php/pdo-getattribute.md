...
|PDO::ATTR_DRIVER_VERSION|[!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)]|String|指示[!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)]版本 (*MajorVer*。*MinorVer*。*BuildNumber*。*修订*)|  
...
|PDO::ATTR_SERVER_VERSION|[!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)]|String|指示 SQL Server 版本 (*主要*。*次要*。*BuildNumber*)|  
