...
$cursor_orientation：指示要在准备语句指定  *时检索的行的可选（整数）符号*`PDO::ATTR_CURSOR => PDO::CURSOR_SCROLL`。 请参阅 $cursor_orientation 的可能值列表的“备注”部分  。 有关使用可滚动游标的示例，请参阅 [PDO::prepare](../../connect/php/pdo-prepare.md) 。  
