---
title: "PHP SQL 驱动程序编程指南 |Microsoft 文档"
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="programming-guide-for-php-sql-driver"></a>PHP SQL 驱动程序编程指南
...
|[PHP SQL 驱动程序的安全注意事项](../../connect/php/security-considerations-for-php-sql-driver.md)|介绍有关开发、部署和运行应用程序的安全注意事项。|  
