...
>  此功能将在将来版本的 Windows 中删除。 避免在新的开发工作中使用此功能，并计划修改当前使用此功能的应用程序。 Microsoft 建议使用驱动程序的光标功能。  
 ...
 本主题讨论在游标库中使用**SQLGetStmtAttr**函数。 有关**SQLGetStmtAttr**的一般信息，请参阅[SQLGetStmtAttr 函数](../../../odbc/reference/syntax/sqlgetstmtattr-function.md)。  
  
 游标库支持以下语句属性与**SQLGetStmtAttr**：  
