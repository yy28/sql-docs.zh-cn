...
|**分钟 (** *time_exp* **)** (ODBC 1.0)|返回分钟中的分钟字段基于*time_exp* 0-59 范围内的一个整数值。|  
...
|**第二个 (** *time_exp* **)** (ODBC 1.0)|返回根据第二个字段中的第二个*time_exp* 0-59 范围内的一个整数值。|
...
|**一周 (** *date_exp* **)** (ODBC 1.0)|返回所处年度中的周字段的一周*date_exp*为整数值 1-53 范围内。|  
|**年 (** *date_exp* **)** (ODBC 1.0)|返回根据年份字段中的年份*date_exp*为整数值。 范围是由数据源决定。|
