...
TERVAL_DAY_TO_SECOND**|SQL_FALSE|SQL_PRED_BASIC|\<空 >|SQL_FALSE|\<空 >|"间隔 DAY() 到 FRACTION(5)"|  
...
ERVAL_DAY_TO_SECOND**|5|5|SQL_INTERVAL|SQL_CODE_INTERVALDAY_TO_SECOND|\<空 >|9|
