...
|SQL_ODBC_API_CONFORMANCE (ODBC 1.0)|指示 ODBC 一致性级别的 SQLSMALLINT 值。<br /><br /> SQL_OAC_NONE = None<br /><br /> SQL_OAC_LEVEL1 = 级别 1 支持<br /><br /> SQL_OAC_LEVEL2 = 2 级支持|  
