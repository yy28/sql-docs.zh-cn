...
-   Open Group 和 ISO CLI 规范编写的应用程序将使用 ODBC 3 *.x*驱动程序或符合标准的驱动程序时使用 ODBC 3 编译 *.x*标头文件，并与链接ODBC 3 *.x*库，并当它获得通过 ODBC 3 驱动程序的访问权限 *.x*驱动程序管理器。  
  
-   编写 Open Group 和 ISO CLI 规范的驱动程序将使用 ODBC 3 *.x*应用程序或符合标准的应用程序时使用 ODBC 3 编译 *.x*标头文件和链接ODBC 3 *.x*库，并当应用程序获得通过 ODBC 3 驱动程序的访问权限 *.x*驱动程序管理器。  
