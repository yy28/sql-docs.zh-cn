...
ms.locfileid: "63280993"
---
# <a name="odbc-header-files"></a>ODBC 头文件
> [!NOTE]  
>  重新分发 ODBC 头文件的不是必需的。 不被视为"核心"。  
 ...
 **头文件**  
 ...
 Sqlspi.h (用于驱动程序开发，请参阅[ODBC 服务提供程序接口 (SPI) 参考](../../../odbc/reference/syntax/odbc-service-provider-interface-spi-reference.md)有关详细信息) 开始 Windows 8 SDK 中的提供。
