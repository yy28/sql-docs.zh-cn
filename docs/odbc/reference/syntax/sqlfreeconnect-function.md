---
title: SQLFreeConnect 函数 |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **摘要**  
 ODBC 3 中 *.x*，ODBC 2.0 函数**SQLFreeConnect**已被取代**SQLFreeHandle**。 有关详细信息，请参阅[SQLFreeHandle](../../../odbc/reference/syntax/sqlfreehandle-function.md)。  
