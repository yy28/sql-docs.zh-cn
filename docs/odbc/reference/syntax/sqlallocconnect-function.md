---
title: SQLAllocConnect 函数 |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **摘要**  
 在 ODBC 3。*x*，ODBC 2。*x*函数**SQLAllocConnect**已被取代**SQLAllocHandle**。 有关详细信息，请参阅[SQLAllocHandle 函数](../../../odbc/reference/syntax/sqlallochandle-function.md)。  
