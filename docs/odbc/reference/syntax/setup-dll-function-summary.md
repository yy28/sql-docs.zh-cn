---
title: 设置 DLL 函数摘要 |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|任务|函数名称|用途|  
|----------|-------------------|-------------|  
|设置数据源和转换器|[ConfigDriver](../../../odbc/reference/syntax/configdriver-function.md)<br /><br /> [ConfigDSN](../../../odbc/reference/syntax/configdsn-function.md)<br /><br /> [ConfigTranslator](../../../odbc/reference/syntax/configtranslator-function.md)|安装或卸载驱动程序。<br /><br /> 添加、 修改或删除数据源。<br /><br /> 返回默认转换选项。|
