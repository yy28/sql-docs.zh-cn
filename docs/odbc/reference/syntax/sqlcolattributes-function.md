---
title: SQLColAttributes 函数 |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **摘要**  
 在 ODBC 3。*x*，ODBC 2.0 函数**SQLColAttributes**已被取代**SQLColAttribute**。 有关详细信息，请参阅[SQLColAttribute 函数](../../../odbc/reference/syntax/sqlcolattribute-function.md)。  
