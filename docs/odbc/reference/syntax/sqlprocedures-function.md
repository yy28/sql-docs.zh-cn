...
|NUM_INPUT_PARAMS （ODBC 2.0）|4|不适用|保留供将来使用。 应用程序不应依赖于这些结果列中返回的数据。|  
|NUM_OUTPUT_PARAMS （ODBC 2.0）|5|不适用|保留供将来使用。 应用程序不应依赖于这些结果列中返回的数据。|  
|NUM_RESULT_SETS （ODBC 2.0）|6|不适用|保留供将来使用。 应用程序不应依赖于这些结果列中返回的数据。|  
