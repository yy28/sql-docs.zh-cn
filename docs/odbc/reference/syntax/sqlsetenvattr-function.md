...
## <a name="comments"></a>注释  
 应用程序可以调用**SQLSetEnvAttr**仅当在环境上不分配任何连接句柄。 已成功设置环境的应用程序的所有环境属性都保存直到**SQLFreeHandle**在环境中调用。 可以在 ODBC 中同时分配多个环境句柄*3.x*。  
