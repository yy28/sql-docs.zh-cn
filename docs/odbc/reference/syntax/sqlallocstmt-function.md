---
title: SQLAllocStmt 函数 |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "81298747"
---
# <a name="sqlallocstmt-function"></a>SQLAllocStmt 函数
**度**  
 引入的版本： ODBC 1.0 标准符合性：已弃用  
  
 **摘要**  
 ODBC 3 中的。*x*，ODBC 2。*x*函数**SQLAllocStmt**已替换为**SQLAllocHandle**。 有关详细信息，请参阅[SQLAllocHandle 函数](../../../odbc/reference/syntax/sqlallochandle-function.md)。  
