 ...
 **摘要**  
 在 ODBC 3。*x*，ODBC 2。*x*函数**SQLAllocStmt**已替换为**SQLAllocHandle**。 有关详细信息，请参阅[SQLAllocHandle 函数](../../../odbc/reference/syntax/sqlallochandle-function.md)。  
