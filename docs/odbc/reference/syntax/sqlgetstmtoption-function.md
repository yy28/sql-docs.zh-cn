---
title: SQLGetStmtOption 函数 |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **摘要**  
 在 ODBC 3。*x*，ODBC 2.0 函数**SQLGetStmtOption**已被取代**SQLGetStmtAttr**。 有关详细信息，请参阅[SQLGetStmtAttr](../../../odbc/reference/syntax/sqlgetstmtattr-function.md)。  
