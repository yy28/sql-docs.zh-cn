 ...
 **摘要**  
 在 ODBC 3 *.x*，ODBC 2.0 函数**SQLSetStmtOption**已由**SQLSetStmtAttr**。 有关详细信息，请参阅[SQLSetStmtAttr](../../../odbc/reference/syntax/sqlsetstmtattr-function.md)。  
