...
|数据源|前缀|值|  
|-----------------|------------|-----------|  
|驱动程序管理器|采购<br />[ODBC_component]<br />[data_source]|微软<br />[ODBC 驱动程序管理器]<br />空值|  
|Visual FoxPro 驱动程序|采购<br />[ODBC_component]<br />[data_source]|微软<br />[ODBC Visual FoxPro 驱动程序]<br />空值|  
