...
|*函数*|是否支持|  
|----------------|---------------|  
|SQL_API_SQLBROWSECONNECT|是|  
|SQL_API_SQLCOLUMNPRIVELEGES|是|  
|SQL_API_SQLDATASOURCES|是|  
|SQL_API_SQLDESCRIBEPARAM|是|  
|SQL_API_SQLDRIVERS|是|  
|SQL_API_SQLEXTENDEDFETCH|是|  
|SQL_API_SQLFOREIGNKEYS|是|  
|SQL_API_SQLMORERESULTS|是|  
|SQL_API_SQLNATIVESQL|是|  
|SQL_API_SQLNUMPARAMS|是|  
|SQL_API_SQLPARAMOPTIONS|是|  
|SQL_API_SQLPRIMARYKEYS|是|  
|SQL_API_SQLPROCEDURECOLUMNS|是|  
|SQL_API_SQLPROCEDURES|是|  
|SQL_API_SQLSETPOS|是|  
|SQL_API_SQLSETSCROLLOPTIONS|是|  
|SQL_API_SQLTABLEPRIVILEGES|是|  
