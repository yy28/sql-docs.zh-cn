...
|DATETIME|年月日（例如，01-17-92）<br /><br /> MMM DD YY （例如，17-92 年1月）<br /><br /> 年月日（例如，92年1月17日）<br /><br /> YYYY-MM-DD （例如，1992-01-17）<br /><br /> YYYY 月（例如，1992-01-17）<br /><br /> 表中不允许使用混合日期分隔符。<br /><br /> 文本 ISAM 根据 Windows 控制面板中的 "国际" 设置，将 "日期时间" 字段的格式设置为 "美国" 或 "欧洲"。|  
