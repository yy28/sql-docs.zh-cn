...
|3.5|1996年10月|这些驱动程序已启用双字节字符集（DBCS），更适合与先前版本的 Internet 应用程序配合使用，并提供文件数据源名称（Dsn）的使用。 Microsoft Access 驱动程序以 RISC 版本发布，适用于适用于 Windows 95/98 和 Windows NT 3.51 及更高版本操作系统的 Alpha 平台。|  
