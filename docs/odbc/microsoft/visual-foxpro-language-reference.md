---
title: "Visual FoxPro 语言参考 |Microsoft 文档"
ms.custom: 
ms.date: 01/19/2017
...
-   [SET 确切命令](../../odbc/microsoft/set-exact-command.md)  
  
-   [SET 独占命令](../../odbc/microsoft/set-exclusive-command.md)  
  
-   [SET NULL 命令](../../odbc/microsoft/set-null-command.md)  
  
-   [SET 路径命令](../../odbc/microsoft/set-path-command.md)  
  
-   [SET 重新处理命令](../../odbc/microsoft/set-reprocess-command.md)  
  
-   [SET 唯一命令](../../odbc/microsoft/set-unique-command.md)  
  
-   [更新-SQL 命令](../../odbc/microsoft/update-sql-command.md)  
  
-   [Visual FoxPro 字段数据类型](../../odbc/microsoft/visual-foxpro-field-data-types.md)
