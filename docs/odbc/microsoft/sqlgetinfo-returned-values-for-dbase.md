---
description: dBASE 的 SQLGetInfo 返回值
title: SQLGetInfo 返回 dBASE 的值 |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "88421721"
---
# <a name="sqlgetinfo-returned-values-for-dbase"></a>dBASE 的 SQLGetInfo 返回值
...
|SQL_IDENTIFIER_CASE|SQL_IC_UPPER (将以混合大小写形式返回限定符，以便 Windows NT 可以找到目录。 ) |  
