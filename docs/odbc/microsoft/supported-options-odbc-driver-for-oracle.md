---
title: 支持的选项 （Oracle ODBC 驱动程序） |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "62634548"
---
# <a name="supported-options-odbc-driver-for-oracle"></a>支持的选项（Oracle ODBC 驱动程序）
> [!IMPORTANT]  
>  此功能将 Windows 的未来版本中删除。 请避免在新的开发工作中使用该功能，并着手修改当前还在使用该功能的应用程序。 相反，使用提供的 Oracle 的 ODBC 驱动程序。  
  
 Oracle ODBC 驱动程序的 SQLGetConnectOption （） 和 SQLSetConnectOption （） 级别 1 函数支持以下选项：  
  
-   SQL_ACCESS_MODE ([SQLGetConnectOption](../../odbc/microsoft/level-1-api-functions-odbc-driver-for-oracle.md)仅 （))  
...
-   [SQL_TXN_ISOLATION](../../odbc/microsoft/connect-options.md)  
 ...
 Oracle ODBC 驱动程序的 SQLGetStmtOption （） 和 SQLSetStmtOption （） 级别 1 函数支持以下选项：  
