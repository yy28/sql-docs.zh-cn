...
---
# <a name="supported-options-odbc-driver-for-oracle"></a>支持的选项 （适用于 Oracle 的 ODBC 驱动程序）
> [!IMPORTANT]  
>  将 Windows 的未来版本中删除该功能。 请避免在新的开发工作中使用该功能，并着手修改当前还在使用该功能的应用程序。 相反，使用提供的 Oracle 的 ODBC 驱动程序。  
  
 用于 Oracle 的 ODBC 驱动程序 SQLGetConnectOption （） 和 SQLSetConnectOption （） 级别 1 函数支持以下选项：  
...
-   [SQL_TXN_ISOLATION](../../odbc/microsoft/connect-options.md)  
 ...
 用于 Oracle 的 ODBC 驱动程序 SQLGetStmtOption （） 和 SQLSetStmtOption （） 级别 1 函数支持以下选项：  
