---
title: 从 Microsoft Office 访问 Visual FoxPro 数据 |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|若要|请参阅|  
|--------|---------|  
|使用 Microsoft Access|[查询和更新 Visual FoxPro 数据的访问权限](../../odbc/microsoft/querying-and-updating-visual-foxpro-data-from-microsoft-access.md)<br /><br /> [从 Microsoft Access 导入 Visual FoxPro 数据](../../odbc/microsoft/importing-visual-foxpro-data-into-microsoft-access.md)|  
