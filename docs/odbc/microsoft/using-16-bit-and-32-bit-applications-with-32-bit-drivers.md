...
-   [16 位应用程序使用 32 位驱动程序](../../odbc/microsoft/using-16-bit-applications-with-32-bit-drivers.md)  
  
-   [使用 32 位驱动程序的 32 位应用程序](../../odbc/microsoft/using-32-bit-applications-with-32-bit-drivers.md)
