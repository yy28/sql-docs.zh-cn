---
title: SQLColumns （Visual FoxPro ODBC 驱动程序） |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32902202"
---
# <a name="sqlcolumns-visual-foxpro-odbc-driver"></a>SQLColumns （Visual FoxPro ODBC 驱动程序）
> [!NOTE]  
>  本主题包含 Visual FoxPro ODBC 驱动程序相关的信息。 有关此函数的常规信息，请参阅下的相应主题[ODBC API 参考](../../odbc/reference/syntax/odbc-api-reference.md)。  
 ...
 对于表，创建一个结果集，后者指定的表或表的列列表。  
  
 有关详细信息，请参阅[SQLColumns](../../odbc/reference/syntax/sqlcolumns-function.md)中*ODBC 程序员参考*。
