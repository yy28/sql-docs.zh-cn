...
## <a name="accessing-visual-foxpro-data"></a>访问 Visual FoxPro 数据  
 若要访问 Microsoft Visual FoxPro、 FoxPro 2。*x*数据，必须具备以下条件：  
...
-   任何以下类型的数据：  
    ...
    -   Visual FoxPro[数据库](../../odbc/microsoft/visual-foxpro-terminology.md)或目录的[免费表](../../odbc/microsoft/visual-foxpro-terminology.md)  
