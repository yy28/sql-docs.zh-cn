---
title: 确定安装 Oracle 组件 |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32899352"
---
# <a name="determining-installed-oracle-components"></a>确定安装 Oracle 组件
> [!IMPORTANT]  
>  将 Windows 的未来版本中删除该功能。 请避免在新的开发工作中使用该功能，并着手修改当前还在使用该功能的应用程序。 相反，使用提供的 Oracle 的 ODBC 驱动程序。  
  
 若要确定在你的系统 （以及其版本） 上安装的 Oracle 组件，请导航到 Oracle 主目录下的 \Orainst 目录。 打开一个以下文本文件： Nt.rgs、 Win95.rgs 或 Win98.rgs。  
