...
>  此功能将在将来版本的 Windows 中删除。 请避免在新的开发工作中使用该功能，并着手修改当前还在使用该功能的应用程序。 而是使用 Oracle 提供的 ODBC 驱动程序。  
 ...
 要确定系统上安装的 Oracle 组件（及其版本），请导航到 Oracle 主目录下的 @Orainst 目录。 打开以下文本文件之一：Nt.rgs、Win95.rgs 或 Win98.rgs。  
