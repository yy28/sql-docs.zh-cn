...
平平的目的是通知应用程序驱动程序中可以使用哪些功能。 Microsoft ODBC 桌面数据库驱动程序支持所有核心和 1 级功能。  
  
 有关函数和语法的符合性级别的详细信息，请参阅*ODBC 程序员参考中的*["一致性级别](../../odbc/reference/develop-app/conformance-levels.md)"。  
  
 对 ODBC API 功能的支持可以取决于所使用的驱动程序。 下表总结了对函数的支持。 最左侧列提供指向每个函数的一般参考页的链接。 这些参考页按字母顺序列在[ODBC API 参考](../../odbc/reference/syntax/odbc-api-reference.md)部分，在[ODBC 程序员的参考](../../odbc/reference/odbc-programmer-s-reference.md)下。 右侧的列提供有关每个受支持函数的特定于驱动程序的说明的链接。 这些特定于驱动程序的主题列在每个驱动程序的"其他编程详细信息"部分中。 或者，如果有关函数的相同注释适用于所有 ODBC 桌面数据库驱动程序，则最右侧列提供指向一个主题的链接，该主题汇总了桌面数据库驱动程序对该函数的支持。 这些主题列在当前部分的末尾（"支持的 ODBC API 函数"）。  
  
|ODBC 功能|访问特定于驱动程序的注释|dBASE 特定于驱动程序的说明|悖论驱动程序特定注释|文本文件驱动程序特定注释|Excel 特定于驱动程序的注释|与所有驱动程序相关的注释|  
|-------------------|-----------------------------------|----------------------------------|------------------------------------|--------------------------------------|----------------------------------|-----------------------------------|  
...
|[SQLGetInfo](../../odbc/reference/syntax/sqlgetinfo-function.md)|[访问](../../odbc/microsoft/sqlgetinfo-access-driver.md)|[dBASE](../../odbc/microsoft/sqlgetinfo-dbase-driver.md)|[悖论](../../odbc/microsoft/sqlgetinfo-paradox-driver.md)|[文本文件](../../odbc/microsoft/sqlgetinfo-text-file-driver.md)|[Excel](../../odbc/microsoft/sqlgetinfo-excel-driver.md)|
...
|[SQLSet 连接选项](../../odbc/reference/syntax/sqlsetconnectoption-function.md)|[访问](../../odbc/microsoft/sqlsetconnectoption-access-driver.md)|[dBASE](../../odbc/microsoft/sqlsetconnectoption-dbase-driver.md)|[悖论](../../odbc/microsoft/sqlsetconnectoption-paradox-driver.md)|[文本文件](../../odbc/microsoft/sqlsetconnectoption-text-file-driver.md)|[Excel](../../odbc/microsoft/sqlsetconnectoption-excel-driver.md)||  
|[SQLSetCursor 名称](../../odbc/reference/syntax/sqlsetcursorname-function.md)||||||[所有驱动程序](../../odbc/microsoft/sqlsetcursorname-desktop-database-drivers.md)|  
|[SQLSetPos](../../odbc/reference/syntax/sqlsetpos-function.md)||||||[所有驱动程序](../../odbc/microsoft/sqlsetpos-desktop-database-drivers.md)|  
|[SQLSetScroll 选项](../../odbc/reference/syntax/sqlsetscrolloptions-function.md)||||||[所有驱动程序](../../odbc/microsoft/sqlsetscrolloptions-desktop-database-drivers.md)|  
...
|[SQLStatistics](../../odbc/reference/syntax/sqlstatistics-function.md)|[访问](../../odbc/microsoft/sqlstatistics-access-driver.md)|[dBASE](../../odbc/microsoft/sqlstatistics-dbase-driver.md)|[悖论](../../odbc/microsoft/sqlstatistics-paradox-driver.md)|[文本文件](../../odbc/microsoft/sqlstatistics-text-file-driver.md)|[Excel](../../odbc/microsoft/sqlstatistics-excel-driver.md)||  
|[SQLTables](../../odbc/reference/syntax/sqltables-function.md)|[访问](../../odbc/microsoft/sqltables-access-driver.md)|[dBASE](../../odbc/microsoft/sqltables-dbase-driver.md)|[悖论](../../odbc/microsoft/sqltables-paradox-driver.md)|[文本文件](../../odbc/microsoft/sqltables-text-file-driver.md)|[Excel](../../odbc/microsoft/sqltables-excel-driver.md)|  
|[SQLTransact](../../odbc/reference/syntax/sqltransact-function.md)|[访问](../../odbc/microsoft/sqltransact-access-driver.md)|[dBASE](../../odbc/microsoft/sqltransact-dbase-driver.md)|[悖论](../../odbc/microsoft/sqltransact-paradox-driver.md)|[文本文件](../../odbc/microsoft/sqltransact-text-file-driver.md)|[Excel](../../odbc/microsoft/sqltransact-excel-driver.md)||  
  
 以下主题提供有关 ODBC 功能的注释。 这些注释适用于所有 ODBC 桌面数据库驱动程序。  
