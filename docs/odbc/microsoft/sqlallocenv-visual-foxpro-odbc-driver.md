---
title: SQLAllocEnv （视觉福克斯 Pro ODBC 驱动程序） |微软文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "81300687"
---
# <a name="sqlallocenv-visual-foxpro-odbc-driver"></a>SQLAllocEnv（Visual FoxPro ODBC 驱动程序）
> [!NOTE]  
>  本主题包含 Visual FoxPro ODBC 特定于驱动程序的信息。 有关此功能的一般信息，请参阅[ODBC API 参考](../../odbc/reference/syntax/odbc-api-reference.md)下的相应主题。  
 ...
 为环境句柄*henv*分配内存，并初始化 ODBC 调用级别接口供应用程序使用。  
  
 有关详细信息，请参阅*ODBC 程序员参考*中的[SQLAllocEnv。](../../odbc/reference/syntax/sqlallocenv-function.md)
