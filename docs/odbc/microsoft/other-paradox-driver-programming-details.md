---
title: "其他 Paradox 驱动程序编程详细信息 |Microsoft 文档"
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="other-paradox-driver-programming-details"></a>其他 Paradox 驱动程序编程详细信息
> [!NOTE]  
>  本部分提供有关 ODBC 函数和其他编程的详细信息可能是特定于驱动程序信息。 有关函数的常规信息，请参阅下的相应主题[ODBC API 参考](../../odbc/reference/syntax/odbc-api-reference.md)。  
...
-   [为 Paradox 创建索引](../../odbc/microsoft/create-index-for-paradox.md)  
  
-   [多个 hstmts （Paradox 驱动程序）](../../odbc/microsoft/multiple-hstmts-paradox-driver.md)
