---
title: 连接到 Visual FoxPro 数据源 |Microsoft 文档
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
---
# <a name="connecting-to-a-visual-foxpro-data-source"></a>连接到 Visual FoxPro 数据源
你可以连接到 Visual FoxPro 数据源使用 Microsoft Office 应用程序或使用 SQL API。  
