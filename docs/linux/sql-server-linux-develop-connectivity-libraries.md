...
| Node.js | Windows、Linux、macOS | [适用于 SQL Server 的 Node.js 驱动程序](/sql-docs/docs/connect/node-js/node-js-driver-for-sql-server) |  [要开始](https://www.microsoft.com/en-us/sql-server/developer-get-started/node/ubuntu)
| Python | Windows、Linux、macOS | [Python SQL 驱动程序](/sql-docs/docs/connect/python/python-driver-for-sql-server) <br/> \*[pyodbc](http://msdn.microsoft.com/library/mt763257.aspx) |  [要开始](https://www.microsoft.com/en-us/sql-server/developer-get-started/python/ubuntu)
| Ruby | Windows、Linux、macOS | [Ruby Driver for SQL Server](/sql-docs/docs/connect/ruby/ruby-driver-for-sql-server) | [要开始](https://www.microsoft.com/en-us/sql-server/developer-get-started/ruby/ubuntu)
