...
description: 本文提供在 Linux 上运行 SQL Server 2017 的性能最佳实践和准则。
author: rgward
ms.author: bobward
manager: craigg
ms.date: 09/14/2017
...
ms.locfileid: "38057411"
---
# <a name="performance-best-practices-and-configuration-guidelines-for-sql-server-2017-on-linux"></a>性能最佳实践和 SQL Server 2017 Linux 上的配置准则
