...
* **Kubernetes 群集**
   ...
   - 若要使用 `kubectl` 在 AKS 中创建单节点 Kubernetes 群集并连接到此群集，请参阅[部署 Azure Kubernetes 服务 (AKS) 群集](/azure/aks/tutorial-kubernetes-deploy-cluster)。 
...
>[Kubernetes 简介](/azure/aks/intro-kubernetes)
