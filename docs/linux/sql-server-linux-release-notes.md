...
这是 SQL Server 2017 累积更新 12 (CU12) 版本。 对于此版本的 SQL Server 引擎版本是 14.0.3045.24。 有关修补程序和此版本中的改进的信息，请参阅[ https://support.microsoft.com/help/4464082 ](https://support.microsoft.com/help/4464082)。
...
这是 SQL Server 2017 累积更新 11 (CU11) 版本。 对于此版本的 SQL Server 引擎版本是 14.0.3038.14。 有关修补程序和此版本中的改进的信息，请参阅[ https://support.microsoft.com/help/4462262 ](https://support.microsoft.com/help/4462262)。
...
这是 SQL Server 2017 累积更新 10 (CU10) 版本。 对于此版本的 SQL Server 引擎版本是 14.0.3037.1。 有关修补程序和此版本中的改进的信息，请参阅[ https://support.microsoft.com/help/4342123 ](https://support.microsoft.com/help/4342123)。
...
这是 SQL Server 2017 还包括以前发布的 CU (CU9) 的安全更新。 对于此版本的 SQL Server 引擎版本是 14.0.3035.2。 有关修补程序和此版本中的改进的信息，请参阅[ https://support.microsoft.com/help/4293805 ](https://support.microsoft.com/help/4293805)。
...
这是仅包括 SQL Server 2017 GDR2 （和 GDR1） 安全修补程序的安全更新。  对于此版本的 SQL Server 引擎版本是 14.0.2002.14。 有关修补程序和此版本中的改进的信息，请参阅[ https://support.microsoft.com/help/4293803 ](https://support.microsoft.com/help/4293803)。
...
这是 SQL Server 2017 累积更新 9 (CU9) 版本。 对于此版本的 SQL Server 引擎版本是 14.0.3030.27。 有关修补程序和此版本中的改进的信息，请参阅[ https://support.microsoft.com/help/4341265 ](https://support.microsoft.com/help/4341265)。
...
这是 SQL Server 2017 的累积更新 8 (CU8) 发布。 对于此版本的 SQL Server 引擎版本是 14.0.3029.16。 有关修补程序和此版本中的改进的信息，请参阅[ https://support.microsoft.com/help/4338363 ](https://support.microsoft.com/help/4338363)。
...
这是 SQL Server 2017 累积更新 7 (CU7) 版本。 对于此版本的 SQL Server 引擎版本是 14.0.3026.27。 有关修补程序和此版本中的改进的信息，请参阅[ https://support.microsoft.com/help/4229789 ](https://support.microsoft.com/help/4229789)。
...
这是 SQL Server 2017 累积更新 4 (CU4) 版本。 对于此版本的 SQL Server 引擎版本是 14.0.3022.28。 有关修补程序和此版本中的改进的信息，请参阅[ https://support.microsoft.com/help/4056498 ](https://support.microsoft.com/help/4056498)。
...
这是仅包括 SQL Server 2017 的安全修补程序的 GDR1 安全更新。 对于此版本的 SQL Server 引擎版本是 14.0.2000.63。 有关修补程序和此版本中的改进的信息，请参阅[ https://support.microsoft.com/help/4057122 ](https://support.microsoft.com/help/4057122)。
...
这是 SQL Server 2017 累积更新 3 (CU3) 版本。 对于此版本的 SQL Server 引擎版本是 14.0.3015.40。 有关修补程序和此版本中的改进的信息，请参阅[ https://support.microsoft.com/help/4052987 ](https://support.microsoft.com/help/4052987)。
