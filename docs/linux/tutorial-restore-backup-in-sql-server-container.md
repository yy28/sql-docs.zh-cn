...
> [!div class="checklist"]
> * 请求和运行最新的 SQL Server 2017 Linux 容器映像。
...
在本教程中，您学习了如何在 Windows 上备份数据库并将其移到运行 SQL Server 2017 RC2 的 Linux 服务器。 你将了解到：
> [!div class="checklist"]
> * 创建 SQL Server 2017 Linux 容器映像。
