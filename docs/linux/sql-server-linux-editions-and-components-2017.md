...
[下载 SQL Server 自 2017 年 1](http://www.microsoft.com/sql-server/sql-server-2017)
...
## <a name="next-steps"></a>后续步骤 
 [版本和 SQL Server 2017-Windows 的支持的功能](../sql-server/editions-and-components-of-sql-server-2017.md)  
 [版本和 SQL Server 2016 的 Windows 的支持的功能](../sql-server/editions-and-components-of-sql-server-2016.md)  
 [版本和 SQL Server 2014 的 Windows 的支持的功能](http://msdn.microsoft.com/library/cc645993(v=sql.120).aspx)  
