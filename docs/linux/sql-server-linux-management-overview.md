...
有多种方法来管理在 Linux 上的 SQL Server 2017。 以下部分提供不同的管理工具和技术使用指向更多资源的快速概述。
