...
新的 Microsoft SQL Operations Studio (preview) 是用于管理 SQL Server 的跨平台工具。 有关详细信息，请参阅[Microsoft SQL Operations Studio (preview)](../sql-operations-studio/what-is.md)。
