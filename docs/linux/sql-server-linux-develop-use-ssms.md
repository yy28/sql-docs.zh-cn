...
连接到服务器后，可以连接到数据库并运行示例查询。 如果你不熟悉如何编写查询，请参阅[编写 TRANSACT-SQL 语句](https://msdn.microsoft.com/library/ms365303.aspx)。

1. 标识要使用的数据库，再次运行查询。 这可能是您在创建新数据库[TRANSACT-SQL 教程](https://msdn.microsoft.com/library/ms365303.aspx)。 也可能是**AdventureWorks**示例数据库，您[下载并还原](sql-server-linux-migrate-restore-database.md)。
...
如果你不熟悉 T-SQL 的请参阅[教程： 编写 TRANSACT-SQL 语句](https://msdn.microsoft.com/library/ms365303.aspx)和[TRANSACT-SQL 参考 （数据库引擎）](https://msdn.microsoft.com/library/bb510741.aspx)。
