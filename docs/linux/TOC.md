...
### [创建并运行作业](sql-server-linux-run-sql-server-agent-job.md)
...
### [从 Windows 还原](sql-server-linux-migrate-restore-database.md)
...
### [故障转移群集实例](sql-server-linux-shared-disk-cluster-configure.md)
...
### [Active Directory 身份验证](sql-server-linux-active-directory-authentication.md)

## [优化性能](sql-server-linux-performance-get-started.md)
