---
title: Always On 可用性组的 SQL Server 容器
...
有关详细步骤，请参阅[在 Kubernetes 中配置 SQL Server Always On 可用性组，以实现高可用性](tutorial-sql-server-ag-kubernetes.md)。
