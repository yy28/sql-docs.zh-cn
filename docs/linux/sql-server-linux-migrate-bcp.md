...
本主题演示如何使用[bcp](https://msdn.microsoft.com/en-us/library/ms162802.aspx)之间的 Linux 上的 SQL Server 自 2017 年 1 RC2 实例和用户指定的格式中的数据文件大容量复制数据的命令行实用工具。
...
- [bcp 实用工具](https://msdn.microsoft.com/en-us/library/ms162802.aspx)
- [有关兼容性时使用 bcp 数据格式](https://msdn.microsoft.com/en-us/library/ms190759.aspx)
- [导入使用 BULK INSERT 大容量数据](https://msdn.microsoft.com/en-us/library/ms175915.aspx)
- [大容量插入 (Transact SQL)](https://msdn.microsoft.com/en-us/library/ms188365.aspx)
