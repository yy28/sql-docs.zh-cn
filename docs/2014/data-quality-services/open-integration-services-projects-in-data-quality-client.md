...
3.  在 **“打开项目”** 屏幕上，可以通过以下方式之一标识 Integration Services 项目：  
    ...
    2.  **项目类型**：在 "**打开项目**" 屏幕中，Integration Services 项目将**SSIS**作为项目类型。  
  
     选择一个项目，然后单击 **“下一步”**。  
  
4.  Integration Services 项目将打开并进入交互式清理阶段（**“管理和查看结果”** 选项卡）。 您可以对 Integration Services 项目中的数据执行交互式清理。 有关“管理和查看结果”选项卡的详细信息，请参阅**使用 DQS（内部）知识清理数据**中的[交互式清理阶段](../../2014/data-quality-services/cleanse-data-using-dqs-internal-knowledge.md#Interactive)[](../../2014/data-quality-services/cleanse-data-using-dqs-internal-knowledge.md)。  
  
5.  单击 **“下一步”** 以转到 **“导出”** 选项卡，您可以在此处将处理后的数据导出到以下任一位置：SQL Server 数据库中的新表、.csv 文件或 Excel 文件。 有关“导出”选项卡的详细信息，请参阅**使用 DQS（内部）知识清理数据**中的[导出阶段](../../2014/data-quality-services/cleanse-data-using-dqs-internal-knowledge.md#Export)[](../../2014/data-quality-services/cleanse-data-using-dqs-internal-knowledge.md)  
