...
|值为日期/时间|只有具有 SQL Server 日期/时间数据类型的值才有效。 这包括 datetime、time、date 等。|示例操作数：不可用<br /><br /> 有效值：1916-06-04;1916-06-04 18:24:24;2001 年 3 月 21日日;2011 年 5 月 18 日;18:24:24<br /><br /> 无效值：March 213 2006|  
...
|值包含模式|只有包含操作数中的字符、数字和特殊字符的模式的值才有效。|示例操作数：Aa-12 (值包含的模式*任何*再跟一个连字符 （-） 后, 跟两个字符*任何*两位数字。)<br /><br /> 有效值：AAA-01、ab 975-<br /><br /> 无效值：A7、 AA-C-45、 6、c 98|  
|值不包含模式|只有不包含操作数中字符模式的值才有效。|示例操作数：Ab-12 (值不得包含的模式*任何*再跟一个连字符 （-） 后, 跟两个字符*任何*两位数字。)<br /><br /> 有效值：A7、 AA-C-45、 6、c 98<br /><br /> 无效值：AAA-01、ab 975-|  
