...
-   **\<空 >**:如果已通过单击发布该知识库，状态字段为空知识库**发布**在域管理活动中，单击**是-发布知识库并退出**。  
  
-   **在工作中**:通过单击已保存对知识库工作**发布**在域管理活动中，单击**否-保存所做工作知识库并退出**。  
  
-   **域管理**:已为知识库中的域输入数据，但不是发布该知识库，工作仍保留在域管理活动。 知识发现活动不可用。 在 **“域管理”** 屏幕中单击 **“关闭”** 后出现此状态。  
  
-   **发现-映射**:上关闭了知识库**知识库管理：映射**页。 该知识库已锁定，且域管理活动和匹配活动不可用。  
  
-   **发现-发现**:上关闭了知识库**知识库管理：分析**页。 知识库已锁定，且域管理活动不可用。  
  
-   **发现-值管理**:上关闭了知识库**知识库管理：管理域字词**页。 知识库已锁定，且域管理活动不可用。  
  
-   **匹配策略-匹配策略**:上关闭了知识库**匹配策略-匹配策略**页。 该知识库已锁定，且知识发现和域管理活动不可用。  
  
-   **匹配策略-匹配结果**:上关闭了知识库**匹配策略-匹配结果**页。 该知识库已锁定，且知识发现和域管理活动不可用。  
