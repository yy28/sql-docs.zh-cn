...
##  <a name="first-step-start-knowledge-discovery"></a><a name="FirstStep"></a> 第一步：开始知识发现  
...
##  <a name="discover-stage"></a><a name="Discover"></a> 发现阶段  
...
##  <a name="manage-data-discovery-results-stage"></a><a name="Manage"></a> 管理数据发现结果阶段  
...
3.  将 **“筛选器”** 设置为 **“所有值”** ，并验证值的状态是适当的。 若要更改某个值的状态，请选择该值，然后单击 "**将所选域值设为已更正**（检查）" 按钮、"**将所选域值设为错误**（交叉）" 按钮或 "**将所选域值设为无效**（三角形）" 按钮。  
...
##  <a name="follow-up-after-performing-knowledge-discovery"></a><a name="FollowUp"></a> 跟进：执行知识发现后  
