...
-   生成知识库和将知识库应用到数据更正过程是明显不同的过程，这样使您可以灵活决定如何生成和更新知识库。  
 ...
 ![DQS 中的知识库和域](../../2014/data-quality-services/media/dqs-knowledgebasesanddomains.gif "DQS 中的知识库和域")  
...
### <a name="case-insensitivity-in-dqs"></a>DQS 中不区分大小写  
 ...
 不过，您可以在清理结果中控制导出的值的大小写。 为此，需要设置“将输出格式设置为”域属性（请参阅**设置域属性**）或在导出清理结果时使用“标准化输出”复选框（请参阅[使用 DQS（内部）知识清理数据](../../2014/data-quality-services/set-domain-properties.md)）****[](../../2014/data-quality-services/cleanse-data-using-dqs-internal-knowledge.md)。  
