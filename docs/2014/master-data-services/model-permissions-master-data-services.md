...
|**时更新**|在**资源管理器**中，将显示模型，并且用户可以添加和删除成员，可以更新属性值、层次结构成员身份和集合成员身份。|  
|**拒绝**|不显示该模型。|  
...
## <a name="see-also"></a>另请参阅  
 ...
 [&#40;Master Data Services 的集合权限&#41;](../../2014/master-data-services/collection-permissions-master-data-services.md)  
