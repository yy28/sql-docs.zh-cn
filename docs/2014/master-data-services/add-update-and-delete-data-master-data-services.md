...
2.  打开 [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] 并为自己的 [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] 数据库连接到数据库引擎实例。  
     ...
     有关更多信息，请参见 [SQL Server Management Studio](../ssms/sql-server-management-studio-ssms.md)。  
...
4.  通过执行下列任一操作，将数据从临时表加载 [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] 表  
    ...
    -   使用主数据管理的“集成管理”  功能区域。  
         ...
         ![主数据管理器中的“临时批处理”页](../../2014/master-data-services/media/mds-staging-batches.png "Staging Batches Page in Master Data Manager")  
