...
1.  确保工作表中的数据采用您想要共享的格式。 有关筛选数据和对列重新排序的详细信息，请参阅[在加载前筛选数据 &#40;MDS Add-in for Excel&#41;](filter-data-before-exporting-mds-add-in-for-excel.md)并[重新排列列 &#40;MDS Add-in for Excel ](reorder-columns-mds-add-in-for-excel.md)&#41;。  
