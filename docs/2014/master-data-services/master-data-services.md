...
# <a name="master-data-services"></a>Master Data Services
 ...
 通过适当的培训，大多数业务用户应能够实现 [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] 解决方案。 此外，您可以使用 MDS 管理任何域；这一管理并非特定于管理客户、产品或帐户的列表。 首次安装 MDS 时，它不包含任何域的结构-您可以通过为它们创建模型来定义所需的域。
...
-   [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)]，用于执行管理任务（例如创建模型或业务规则）的 web 应用程序，以及用户访问更新数据的应用程序。
...
-   [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)][!INCLUDE[ssMDSXLS](../includes/ssmdsxls-md.md)]，用于管理数据以及创建新实体和属性。

 有关 MDS 资源的摘要，请参阅[SQL Server Master Data Services 门户](https://go.microsoft.com/fwlink/?LinkID=214272)。
