...
# <a name="master-data-services"></a>Master Data Services
 ...
 通过适当的培训，大多数业务用户应能够实现 [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] 解决方案。 此外，您可以使用 MDS 管理任何域；这一管理并非特定于管理客户、产品或帐户的列表。 在首次安装 MDS 时，并不包括针对任何域的结构 - 您通过创建域模型来定义所需的域。  
  
 其他 Master Data Services 功能包括层次结构、粒度安全性、事务、数据版本控制和业务规则。  
  
 [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] 包括以下组件和工具：  
  
-   [!INCLUDE[ssMDScfgmgr](../includes/ssmdscfgmgr-md.md)]用于创建和配置工具[!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)]数据库和 web 应用程序。  
...
-   [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] web 的服务，开发人员可以使用它来扩展或开发的自定义解决方案[!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)]。  
  
-   [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] [!INCLUDE[ssMDSXLS](../includes/ssmdsxls-md.md)]，您可以使用它来管理数据以及创建新实体和属性。  
  
 有关 MDS 资源的摘要，请参阅[SQL Server 主数据服务门户](http://go.microsoft.com/fwlink/?LinkID=214272)。  
