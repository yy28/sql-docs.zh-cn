...
|**RelationshipType**<br /><br /> 必须|正在设置的关系的类型。 可能的值为：<br /><br /> **1**：父级<br /><br /> **2**：同级（同一级）|  
...
|**ParentCode**<br /><br /> 必须|对于父-子关系，是将为子叶成员或合并成员的父级的合并成员代码。<br /><br /> 对于同级关系，为以下同级之一的代码。|  
|**ChildCode**<br /><br /> 必须|对于父-子关系，是将为子级的合并成员或叶成员的代码。<br /><br /> 对于同级关系，为以下同级之一的代码。|  
