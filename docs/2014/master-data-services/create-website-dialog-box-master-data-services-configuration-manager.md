...
## <a name="see-also"></a>另请参阅  
 [网页配置页&#40;主数据服务配置管理器&#41;](../../2014/master-data-services/web-configuration-page-master-data-services-configuration-manager.md)   
 [设置主数据服务的数据库和网站](../../2014/master-data-services/set-up-the-database-and-website-for-master-data-services.md)   
 [Web 应用程序要求&#40;主数据服务&#41;](install-windows/web-application-requirements-master-data-services.md)   
