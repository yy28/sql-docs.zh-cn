...
|配置 Internet Explorer 增强安全性|当你安装[!INCLUDE[ssMDSshort](../../includes/ssmdsshort-md.md)]的 Windows Server 2008 或 Windows Server 2008 R2 计算机上，您可能必须配置 Internet Explorer 增强安全性以允许使用脚本为[!INCLUDE[ssMDSmdm](../../includes/ssmdsmdm-md.md)]应用程序站点。 否则，浏览到服务器计算机上的 [!INCLUDE[ssMDSmdm](../../includes/ssmdsmdm-md.md)] 应用程序站点将失败。|[Internet Explorer：增强安全性配置](http://go.microsoft.com/fwlink/p/?LinkId=223869)|  
