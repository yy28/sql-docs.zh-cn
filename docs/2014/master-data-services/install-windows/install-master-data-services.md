---
title: 安装 Master Data Services |Microsoft 文档
ms.custom: ''
ms.date: 05/24/2017
...
|配置 Internet Explorer 增强安全性|当你安装[!INCLUDE[ssMDSshort](../../includes/ssmdsshort-md.md)]的 Windows Server 2008 或 Windows Server 2008 R2 计算机上，你可能必须配置 Internet Explorer 增强安全性以允许使用脚本为[!INCLUDE[ssMDSmdm](../../includes/ssmdsmdm-md.md)]应用程序站点。 否则，浏览到服务器计算机上的 [!INCLUDE[ssMDSmdm](../../includes/ssmdsmdm-md.md)] 应用程序站点将失败。|[Internet Explorer：增强安全性配置](http://go.microsoft.com/fwlink/p/?LinkId=223869)|  
|安装 [!INCLUDE[ssMDSshort](../../includes/ssmdsshort-md.md)][!INCLUDE[ssMDSXLS](../../includes/ssmdsxls-md.md)]|将使用主数据的用户可以安装 [!INCLUDE[ssMDSXLS](../../includes/ssmdsxls-md.md)]。|[http://go.microsoft.com/fwlink/?LinkId=219530](http://go.microsoft.com/fwlink/?LinkId=219530)|  
...
|部署示例模型|示例模型包与 Master Data Services 一起安装，可以使用 MDSModelDeploy.exe 进行部署。|[SQL Server 中部署 MDS 示例](http://go.microsoft.com/fwlink/?LinkId=251486&clcid=0x409)|  
