---
title: 获取 SQL 服务器帮助 |Microsoft 文档
ms.custom: ''
ms.date: 05/25/2017
...
-   [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 有关其他[!INCLUDE[msCoName](../includes/msconame-md.md)]网站。  
...
-   在 Internet 上的 MSDN Library 和 TechNet Library 中发布 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 联机丛书的副本。 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 联机丛书的这些副本中的主题包括社区评论，如其他客户的附加信息和代码示例。 你可以查看在 MSDN 库副本[SQL Server 2014 联机丛书](http://msdn.microsoft.com/library/ms130214\(v=sql.120\).aspx)。  
  
-   可以使用帮助库管理器在本地计算机上安装 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 联机丛书。 有关详细信息，请参阅[添加或删除 SQL Server 的产品文档](../2014-toc/books-online-for-sql-server-2014.md)。  
...
|[SQL Server TechNet 网站](http://technet.microsoft.com/sqlserver/dn135309)|使用 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 规划、部署、管理和支持系统的管理员和操作员。|  
...
## <a name="see-also"></a>请参阅  
 [使用用于 SQL Server 产品文档](../2014-toc/books-online-for-sql-server-2014.md)  
