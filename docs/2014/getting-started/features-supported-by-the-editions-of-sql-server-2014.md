...
# <a name="features-supported-by-the-editions-of-sql-server-2014"></a>SQL Server 2014 各个版本支持的功能
 ...
 > **请注意：** 在180天试用期内的评估版中提供 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]。 有关详细信息，请参阅 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [试用软件网站](https://go.microsoft.com/fwlink/?LinkId=190955)。  
> 
> **注意：** 对于评估版和开发人员版支持的功能，请参阅 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 企业功能集。  
...
|最大关系数据库大小|524 PB|524 PB|524 PB|524 PB|10 GB|10 GB|10 GB|  
 ...
 <sup>1</sup>企业版 with Server + 客户端访问许可证（CAL）的许可（对新协议不可用），每个 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 实例的最大数目限制为20个。 基于内核的服务器许可模型没有限制。 有关详细信息，请参阅 [Compute Capacity Limits by Edition of SQL Server](../sql-server/compute-capacity-limits-by-edition-of-sql-server.md)。  
...
|智能备份|是|是|是|No||||  
 ...
 <sup>1</sup>有关在 Server Core 上安装 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 的详细信息，请参阅[在 Server core 上安装 SQL Server 2014](../database-engine/install-windows/install-sql-server-on-server-core.md)。  
...
|Contained Databases|是|是|是|是|是|是|是|  
|备份加密|是|是|是|||||  
...
|分布式重播 - 客户端|是|No|是|是||||  
|分布式重播 - 控制器|支持（Enterprise 版支持最多 16 个客户端、Developer 版仅支持 1 个客户端）|No|支持（仅支持 1 个客户端）|支持（仅支持 1 个客户端）||||  
...
|[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Azure 中的数据文件|是|是|是|是|是|是|是|  
 ...
 <sup>2</sup> [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Web、[!INCLUDE[ssExpress](../includes/ssexpress-md.md)]、带工具的 [!INCLUDE[ssExpress](../includes/ssexpress-md.md)] 和具有高级服务的 [!INCLUDE[ssExpress](../includes/ssexpress-md.md)] 可以使用 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Standard edition 和 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Enterprise edition 进行分析。  
...
|[!INCLUDE[ssCrescent](../includes/sscrescent-md.md)] <sup>2</sup>|是|是||||||  
 ...
 <sup>1</sup>有关 [!INCLUDE[ssRSCurrent](../includes/ssrscurrent-md.md)]中支持的数据源的详细信息，请参阅[Reporting Services &#40;SSRS&#41;支持的数据源](../reporting-services/create-deploy-and-manage-mobile-and-paginated-reports.md)。  
  
 <sup>2</sup>需要在 SharePoint 模式下 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]。 有关详细信息，请参阅[Reporting Services Sharepoint 模式&#40;安装 SharePoint 2010 和 sharepoint&#41;2013](../reporting-services/install-windows/install-reporting-services-sharepoint-mode.md)。  
...
## <a name="see-also"></a>另请参阅  
 ...
 [SQL Server 2014  的安装](../database-engine/install-windows/installation-for-sql-server.md)  
