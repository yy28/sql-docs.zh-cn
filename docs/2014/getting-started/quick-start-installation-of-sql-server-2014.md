...
## <a name="ssnoversion-installation"></a>[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 安装  
...
###  <a name="upgrading-to-sscurrent"></a><a name="BKMK_Upgrading"></a>升级到[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]  
...
###  <a name="installing-sscurrent"></a><a name="BKMK_Install"></a>正在[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]  
...
###  <a name="configuring-sscurrent"></a><a name="BKMK_Configure"></a>正在[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]  
