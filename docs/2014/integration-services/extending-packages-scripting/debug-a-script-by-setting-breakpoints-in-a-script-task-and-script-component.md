...
> [!IMPORTANT]  
>  在某些情况下，将忽略脚本任务和脚本组件中的断点。 有关详细信息，请参阅**Debugging the Script Task**主题中[编码和调试脚本任务](../control-flow/script-task.md)和**Debugging the Script Component** [编码中的部分和调试脚本组件] (.../ extending-packages-scripting/data-flow-script-component/coding-and-debugging-the-script-component.md。  
