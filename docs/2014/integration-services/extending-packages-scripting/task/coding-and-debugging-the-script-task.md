...
|<xref:Microsoft.SqlServer.Dts.Tasks.ScriptTask.ScriptObjectModel.ExecutionValue%2A>|提供一种向运行库返回单个对象（除 `TaskResult` 之外）的简单方法，该对象还可用于工作流分支跳转。|
...
## <a name="see-also"></a>另请参阅
 [引用脚本解决方案中的其他程序集](../referencing-other-assemblies-in-scripting-solutions.md)在["脚本任务编辑器" 中配置脚本任务](configuring-the-script-task-in-the-script-task-editor.md)
