...
> [!IMPORTANT]  
>  本教程需要 **AdventureWorksDW2012** 示例数据库。 有关安装和部署**AdventureWorksDW2012**的详细信息，请参阅[Microsoft SQL Server 产品示例： Reporting Services](https://archive.codeplex.com/?p=msftrsprodsamples)。  
