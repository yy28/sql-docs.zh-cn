...
ms.locfileid: "62768653"
---
# <a name="developing-custom-objects-for-integration-services"></a>开发 Integration Services 的自定义对象
  当包含[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]的控制流和数据流对象不能完全满足你的要求时，你可以自行开发多种类型的自定义对象，其中包括：  
