...
## <a name="see-also"></a>请参阅  
 [扩展 with the Script Component 数据流](../../extending-packages-scripting/data-flow-script-component/extending-the-data-flow-with-the-script-component.md   
