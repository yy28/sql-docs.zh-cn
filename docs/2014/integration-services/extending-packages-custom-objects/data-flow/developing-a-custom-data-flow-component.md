...
# <a name="developing-a-custom-data-flow-component"></a>开发自定义数据流组件
  数据流任务由一些组件组成，这些组件用于连接各种数据源，然后快速转换和路由数据。 [!INCLUDE[msCoName](../../../includes/msconame-md.md)]提供一个可扩展的对象模型，使开发人员能够创建可在和已部署的包中[!INCLUDE[ssBIDevStudioFull](../../../includes/ssbidevstudiofull-md.md)]使用的自定义源、转换和目标。 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)] 本节包含的主题将指导您开发自定义数据流组件。  
...
## <a name="see-also"></a>另请参阅  
 [用脚本组件扩展数据流](../../extending-packages-scripting/data-flow-script-component/extending-the-data-flow-with-the-script-component.md   
