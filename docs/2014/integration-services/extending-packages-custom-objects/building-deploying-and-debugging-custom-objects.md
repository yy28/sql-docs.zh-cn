...
##  <a name="top"></a>为 Integration Services 生成、部署和调试自定义对象的步骤  
...
3.  [](#deploying)通过将程序集移动或复制到适当[!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]的文件夹来部署该程序集。  
  
4.  将程序集[安装](#installing)到全局程序集缓存（GAC）中。  
  
     此对象自动添加到工具箱中。  
  
5.  如有必要，[对部署进行故障排除](#troubleshooting)。  
...
## <a name="see-also"></a>另请参阅  
 ...
 [持久保存自定义对象](persisting-custom-objects.md)   
