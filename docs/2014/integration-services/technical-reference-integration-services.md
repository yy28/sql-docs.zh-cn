...
ms.locfileid: "58374634"
---
# <a name="technical-reference-integration-services"></a>技术参考 (Integration Services)
  查找工具、 语言和编程参考文档[!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]中[!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]。  
  
 ![小文件文件夹图标](media/filefolder-small.gif "小文件文件夹图标") **Change Data Capture Service 和 Designer**  
 [6.0 Attunity為Oracle更改數據更改服務](change-data-capture/change-data-capture-service-for-oracle-by-attunity.md)  
