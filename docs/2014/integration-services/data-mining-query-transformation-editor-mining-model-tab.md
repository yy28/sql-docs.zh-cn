---
title: 数据挖掘查询转换编辑器 （挖掘模型选项卡） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>请参阅  
 ...
 [数据挖掘查询转换编辑器（“查询”选项卡）](../../2014/integration-services/data-mining-query-transformation-editor-query-tab.md)  
