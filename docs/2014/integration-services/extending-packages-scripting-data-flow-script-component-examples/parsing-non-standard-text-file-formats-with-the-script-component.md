...
13. 上**脚本**页**脚本转换编辑器**，单击**编辑脚本**然后输入中所示的代码`ScriptMain`类示例。 关闭脚本开发环境和“脚本转换编辑器”。  
...
12. 上**输入和输出**页**脚本转换编辑器**、 选择输出 0，将它重命名为 ParentRecords，并设置其`SynchronousInputID`为 None。 创建 2 个输出列：  
