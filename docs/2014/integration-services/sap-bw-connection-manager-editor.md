...
ms.locfileid: "36025738"
---
# <a name="sap-bw-connection-manager-editor"></a>SAP BW 连接管理器编辑器
  使用 **“SAP BW 连接管理器编辑器”** 指定用于连接 SAP Netweaver BW 版本 7 系统的属性。  
  
 SAP BW 连接管理器向 SAP BW 源或目标提供与 SAP Netweaver BW 7 系统的连接。 若要了解 [!INCLUDE[msCoName](../includes/msconame-md.md)] Connector 1.1 for SAP BW 的 SAP BW 连接管理器的详细信息，请参阅 [SAP BW 连接管理器](connection-manager/sap-bw-connection-manager.md)。  
