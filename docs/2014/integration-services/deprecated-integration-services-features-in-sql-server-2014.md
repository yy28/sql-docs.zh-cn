...
ms.locfileid: "66059592"
---
# <a name="deprecated-integration-services-features-in-sql-server-2014"></a>SQL Server 2014 中不推荐使用的 Integration Services 功能
  本主题介绍的当前[!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]版本[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]中仍然可用的不推荐使用的功能。 按照计划， [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]未来版本将不再具有这些功能。 在新的应用程序中不应使用这些不推荐使用的功能。  
