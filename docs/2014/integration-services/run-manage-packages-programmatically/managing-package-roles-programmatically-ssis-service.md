...
# <a name="managing-package-roles-programmatically-ssis-service"></a>以编程方式管理包角色（SSIS 服务）
 ...
 角色仅适用于存储在  msdb 数据库中的包[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ****。 有关包角色的详细信息，请参阅 [Integration Services 角色（SSIS 服务）](../security/integration-services-roles-ssis-service.md)。  
