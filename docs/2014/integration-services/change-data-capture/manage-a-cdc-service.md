 ...
 **为所选服务创建一个新的 CDC 实例**  
 ...
 单击 **“新建 Oracle CDC 实例”** ，在右侧窗格中为该服务创建一个新的实例。 新建实例向导将打开以便创建该实例。 有关新建实例向导的详细信息，请参阅 [Use the New Instance Wizard](use-the-new-instance-wizard.md)。  
