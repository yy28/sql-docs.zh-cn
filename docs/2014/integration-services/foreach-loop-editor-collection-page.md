...
>   
>  您可以使用表达式来指定要包含在集合中的文件，方法是在 "**集合**" 页上展开 "**表达式**"，选择**FileSpec**属性，然后单击省略号按钮（...）以添加属性表达式。 有关动态选择指定文件的详细信息，请参阅[SSIS-动态设置文件掩码： FileSpec](https://rajsudeep.blogspot.com/2010/09/ssisdynamically-set-file-mask-filespec.html)  
