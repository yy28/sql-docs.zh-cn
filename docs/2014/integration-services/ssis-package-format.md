...
# <a name="ssis-package-format"></a>SSIS 包格式
 ...
 若要查看当前的 DTSX 包文件格式，请参阅 [\[MS-DTSX\]: Data Transformation Services Package XML File Format Specification](http://go.microsoft.com/fwlink/?LinkId=233251)（[MS-DTSX]：Data Transformation Services 包 XML 文件格式规范）。  
  
 下面的列表概述了这些文件格式更改。 若要查看这些更改的代码示例，请参阅 [SQL Server 2012 中的包格式更改](http://go.microsoft.com/fwlink/?LinkId=233255)。  
