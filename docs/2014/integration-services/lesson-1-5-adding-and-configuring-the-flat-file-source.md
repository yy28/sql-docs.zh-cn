...
1.  通过双击`Extract Sample Currency Data`数据流任务或单击 "数据流"**选项卡**，打开 "**数据流设计器"。**  
  
2.  在“SSIS 工具箱”**** 中，展开 **OtherSources**，然后将“平面文件源”**** 拖动到“数据流”**** 选项卡的设计图面上。  
  
3.  在 "**数据流" 设计图面**上，右键单击新添加的 "**平面文件源**"，单击 "**重命名**"， `Extract Sample Currency Data`然后将名称更改为。  
  
4.  双击此平面文件源，打开“平面文件源编辑器”对话框。  
  
5.  在 "**平面文件连接管理器**" 框`Sample Flat File Source Data`中，选择。  
...
9. 在属性窗口中，验证属性是否`LocaleID`设置为 "**英语（美国）**"。  
