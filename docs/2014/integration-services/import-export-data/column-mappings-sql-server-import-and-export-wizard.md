 ...
 **编辑 SQL**  
 使用中的默认语句**Create Table SQL 语句**对话框框中，或对其进行修改您的要求。 如果要修改此语句，还必须对表映射进行相关更改。  
 ...
 **目标**  
 指定在复制操作期间是否忽略列。 你可以通过选择复制列的一个子集**\<忽略 >** 列你想要跳过此列中。 在映射列之前，必须忽略所有不会被映射的列。  
