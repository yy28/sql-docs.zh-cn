...
ms.locfileid: "36128162"
---
# <a name="save-ssis-package-sql-server-import-and-export-wizard"></a>保存 SSIS 包（SQL Server 导入和导出向导）
  使用**保存 SSIS 包**页后，可以名称、 描述和保存[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Integration Services ([!INCLUDE[ssIS](../../includes/ssis-md.md)]) 打包到[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]`msdb`数据库或具有.dtsx 到文件扩展。  
 ...
 **Target**  
 查看目标 ([!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]或文件)，以前为指定的目标文件。  
 ...
 **用户名**  
 在选择[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]目标，并且已指定 SQL Server 身份验证，键入[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]用户名。  
  
 **密码**  
 在选择[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]目标，并且已指定 SQL Server 身份验证，键入[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]密码。  
  
### <a name="target--file-system"></a>目标 = 文件系统  
 **文件名**  
 当你选择了文件目标时，键入目标文件的路径，或使用**浏览**按钮。  
