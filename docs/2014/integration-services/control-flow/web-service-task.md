...
## <a name="related-content"></a>相关内容  
 ...
 curatedviews.cloudapp.net 上的专业回答： [Consume Web Services in SSIS using Scripts](http://go.microsoft.com/fwlink/?LinkId=321996)（通过脚本在 SSIS 中使用 Web 服务）。  
