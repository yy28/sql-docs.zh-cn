...
# <a name="data-sources"></a>“数据源”
  [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]包含可在包中[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]使用的设计时对象：数据源。  
