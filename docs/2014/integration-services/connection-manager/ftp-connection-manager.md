...
ms.locfileid: "62833719"
---
# <a name="ftp-connection-manager"></a>FTP 连接管理器
  FTP 连接管理器使得包可以连接到文件传输协议 (FTP) 服务器。 包含的 FTP 任务[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]使用此连接管理器。 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]  
