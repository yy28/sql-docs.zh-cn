...
-   [数据挖掘模型定型编辑器&#40;连接选项卡&#41;](../data-mining-model-training-editor-connection-tab.md)  
  
-   [数据挖掘模型定型编辑器&#40;列选项卡&#41;](../data-mining-model-training-editor-columns-tab.md)  
