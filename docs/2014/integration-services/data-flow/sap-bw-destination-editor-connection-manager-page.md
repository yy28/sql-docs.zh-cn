...
### <a name="infopackageinfosource-options"></a>InfoPackage/InfoSource 选项  
...
|对象类型|结果|  
|-----------------|------------|  
|**InfoObject**|通过使用 **“创建新 InfoObject”** 对话框创建一个新的 InfoObject。 有关此对话框的详细信息，请参阅 [Create New InfoObject](create-new-infoobject.md)。|  
|**InfoCube**|使用 **“创建事务数据的 InfoCube”** 对话框创建新的 InfoCube。 有关此对话框的详细信息，请参阅 [Create InfoCube for Transaction Data](create-infocube-for-transaction-data.md)。|  
