---
title: 数据挖掘模型定型编辑器 （列选项卡） |Microsoft 文档
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>请参阅  
 ...
 [数据挖掘模型定型编辑器&#40;连接选项卡&#41;](../../2014/integration-services/data-mining-model-training-editor-connection-tab.md)  
