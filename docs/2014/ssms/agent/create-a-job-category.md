...
# <a name="create-a-job-category"></a>创建作业类别
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]代理提供可将作业分配到的内置作业类别，也可以创建作业类别并向其分配作业。 作业类别有助于您组织作业，从而更容易筛选和分组。 例如，可以将所有数据库备份作业组织到“数据库维护”类别中。 此外，还可以创建自己的作业类别。  
