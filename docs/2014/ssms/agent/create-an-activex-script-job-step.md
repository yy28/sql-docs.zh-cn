...
ms.locfileid: "85041274"
---
# <a name="create-an-activex-script-job-step"></a>Create an ActiveX Script Job Step
  本主题介绍如何在中创建和定义 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 代理作业步骤， [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 该步骤使用 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 、或 SQL Server 管理对象执行 ActiveX 脚本 [!INCLUDE[tsql](../../includes/tsql-md.md)] 。  
