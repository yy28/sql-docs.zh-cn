...
ms.locfileid: "85008869"
---
# <a name="define-transact-sql-job-step-options"></a>Define Transact-SQL Job Step Options
  本主题说明如何 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[tsql](../../includes/tsql-md.md)] [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 使用或 SQL Server 管理对象在中定义代理作业步骤的选项 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 。  
