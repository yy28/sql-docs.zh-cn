---
title: 将执行跟踪消息写入到 SQL Server 代理错误日志 (SQL Server Management Studio) |Microsoft 文档
ms.custom: ''
ms.date: 03/06/2017
...
-   [若要执行跟踪消息写入到使用 SQL Server Management Studio SQL Server 代理错误日志](#SSMSProcedure)  
