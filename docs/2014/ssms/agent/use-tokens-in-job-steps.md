...
## <a name="updating-job-steps-to-use-macros"></a>更新作业步骤以使用宏  
 ...
 [!INCLUDE[msCoName](../../includes/msconame-md.md)] 知识库文章 915845：[在 SQL Server 2005 Service Pack 1 中使用标记的 SQL Server 代理作业步骤将失败](https://support.microsoft.com/kb/915845)中提供了脚本。可以使用此脚本通过 ESCAPE_NONE 宏更新所有使用标记的作业步骤  。 使用此脚本之后，我们建议你尽快查看使用标记的作业步骤，并将 **ESCAPE_NONE** 宏替换为适用于作业步骤上下文的转义宏。  
