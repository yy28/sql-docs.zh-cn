...
> [!IMPORTANT]  
>  在授予对[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]**数据库角色****成员的代理**访问权限之前，请考虑安全问题。 **SQLAgentReaderRole** 和 **SQLAgentOperatorRole** 自动成为 **SQLAgentUserRole**的成员。 这意味着 **SQLAgentReaderRole** 和 **SQLAgentOperatorRole** 的成员可以访问已被授予 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SQLAgentUserRole **的所有** 代理，并且可以使用这些代理。  
...
> [!IMPORTANT]  
>  在授予对[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]**数据库角色****成员的代理**访问权限之前，请考虑安全问题。 **SQLAgentReaderRole** 的成员将自动成为 **SQLAgentUserRole**的成员。 这意味着 **SQLAgentReaderRole** 成员可以访问已被授予 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SQLAgentUserRole **的所有** 代理，并且可以使用这些代理。  
...
> [!IMPORTANT]  
>  在授予对[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]**数据库角色****成员的代理**访问权限之前，请考虑安全问题。 **SQLAgentOperatorRole** 的成员将自动成为 **SQLAgentUserRole** 和 **SQLAgentReaderRole**的成员。 这意味着 **SQLAgentOperatorRole** 的成员可以访问已被授予 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SQLAgentUserRole **或** SQLAgentReaderRole **的所有** 代理，并且可以使用这些代理。  
