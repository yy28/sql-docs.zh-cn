...
# <a name="f1-help-for-server-connections-sql-server-management-studio"></a>服务器连接的 F1 帮助 (SQL Server Management Studio)
 ...
 [连接到服务器（“连接属性”页）数据库引擎](connect-to-server-connection-properties-page-database-engine.md)  
 ...
 [连接到服务器（“登录”页）数据库引擎](connect-to-server-login-page-database-engine.md)  
