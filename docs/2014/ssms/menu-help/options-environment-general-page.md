...
-   **打开对象资源管理器**提示连接，然后打开对象资源管理器。  
  
-   **打开新查询窗口**提示进行连接，然后打开 SQL 查询编辑器。  
  
-   **打开连接对象资源管理器和新的查询**提示，然后使用该连接打开对象资源管理器和 SQL 查询编辑器。  
  
-   **打开空环境**将[!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]打开而不使用 SQL 查询编辑器窗口，并且不将对象资源管理器连接到服务器。  
