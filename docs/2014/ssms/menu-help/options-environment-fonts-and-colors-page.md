...
# <a name="options-environment-fonts-and-colors-page"></a>选项（“环境”:“字体和颜色”页）
  使用 "**选项**" 对话框，您可以为中[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]的各种用户界面元素建立自定义字体和配色方案。 在“工具”**** 菜单上，单击“选项”****，展开“环境”**** 文件夹，然后选择“字体和颜色”****。  
