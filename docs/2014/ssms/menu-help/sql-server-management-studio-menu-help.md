...
ms.locfileid: "85062070"
---
# <a name="sql-server-management-studio-menu-help"></a>SQL Server Management Studio 菜单帮助
  本节包含 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] 菜单栏中提供的对话框和页的 F1 帮助。  
