---
title: 索引和密钥对话框 (Visual Database Tools) |Microsoft 文档
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "36127212"
---
# <a name="indexes-and-keys-dialog-box-visual-database-tools"></a>索引和密钥对话框 (Visual Database Tools)
