...
# <a name="set-the-startup-options"></a>设置启动选项
  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]可以配置为在启动时[!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]打开首选配置的设计图面。 通过将 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] 配置为打开首选配置，您可以节省时间。  
