...
-   **当正在运行时，sqlservr.exe 停止响应或停止工作 [!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)] ：** 如果 SQL Server 停止工作，则 sql 代理将正常关闭， [!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)] 同时也将停止，并在 SQL 代理中记录事件。  
