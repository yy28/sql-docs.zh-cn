---
title: 将服务器配置为侦听特定的 TCP 端口（SQL Server 配置管理器） |Microsoft Docs
ms.custom: ''
ms.date: 06/22/2017
...
> [!TIP]  
>  选择端口号时，请查看 [http://www.iana.org/assignments/port-numbers](http://www.iana.org/assignments/port-numbers) 分配给特定应用程序的端口号列表。 选择一个未分配的端口号。 更多详细信息，请参阅 [TCP/IP 的默认动态端口范围在 Windows Vista 和 Windows Server 2008 中已更改](https://support.microsoft.com/kb/929851)。  
...
1.  在 SQL Server 配置管理器的控制台窗格中，依次展开 " **SQL Server 网络配置**"、" ** \<instance name> 协议**"，然后双击 " **tcp/ip**"。  
