...
-   **media retention** 选项可以使用 [BACKUP](/sql/t-sql/statements/backup-transact-sql) 语句的 RETAINDAYS 子句覆盖。  
...
##  <a name="FollowUp"></a> 跟进：在配置 media retention 选项之后  
 该设置将立即生效，无需重新启动服务器。  
