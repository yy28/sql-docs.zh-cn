...
ms.locfileid: "36129037"
---
# <a name="open-projects-from-source-control"></a>从源代码管理打开的项目
...
> [!NOTE]  
>  下列过程只能使用一次。 此后，应打开与任何其他项目一样项目 (通过单击**文件**，**打开**，，然后**项目**)。  
...
3.  在**从 SourceSafe 创建本地项目**对话框框中，打开包含要打开的项目的文件夹。  
  
4.  **的文件夹中创建新项目**框中更改标识将在其中创建项目的本地目录。 如果你想要将项目放置在不同的目录，键入的路径的目录或使用**浏览**按钮以找到您的本地磁盘上的目录。  
  
5.  在**在文件夹框中创建新项目**，确认正确的文件夹会显示，然后单击**确定**。  
  
6.  在**打开解决方案**对话框框中，选择你想要打开，然后单击的项目**打开**。  
  
## <a name="see-also"></a>请参阅  
 [从源代码管理打开的解决方案和项目](../../2014/database-engine/open-solutions-and-projects-from-source-control.md)   
