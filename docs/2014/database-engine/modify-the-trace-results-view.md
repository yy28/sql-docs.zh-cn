...
##  <a name="ChangeColumns"></a>创建、编辑或删除合并列  
...
5.  使用以下选项可指定所需的定义搜索的方式：  
    ...
    1.  **区分大小写**。 使用此选项可显示您在 "**查找内容**" 框中输入的、内容和大小写均匹配的搜索结果。  
