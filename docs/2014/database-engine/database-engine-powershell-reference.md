...
## <a name="database-engine-cmdlets"></a>数据库引擎 Cmdlet  
 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]包含相对较少的[!INCLUDE[ssDE](../includes/ssde-md.md)]cmdlet。 大多数用于 [!INCLUDE[ssDE](../includes/ssde-md.md)] 的 PowerShell 脚本使用 SQL Server PowerShell 提供程序和可管理性对象模型。 有关详细信息，请参阅 [SQL Server PowerShell Provider](../powershell/sql-server-powershell-provider.md)。  
