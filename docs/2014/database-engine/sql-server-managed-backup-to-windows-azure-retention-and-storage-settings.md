...
###  <a name="considerations-for-enabling-ss_smartbackup-for-databases-and-instances"></a><a name="Considerations"></a>为数据库和[!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)]实例启用的注意事项  
...
##  <a name="enable-and-configure-ss_smartbackup-for-a-database"></a><a name="DatabaseConfigure"></a>为数据库启用[!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)]和配置  
...
##  <a name="enable-and-configure-default-ss_smartbackup-settings-for-the-instance"></a><a name="InstanceConfigure"></a>为实例启用和[!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)]配置默认设置  
...
##  <a name="disable-ss_smartbackup-for-a-database"></a><a name="DatabaseDisable"></a>为[!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)]数据库禁用  
...
##  <a name="disable-ss_smartbackup-for-all-the-databases-on-the-instance"></a><a name="DatabaseAllDisable"></a>为[!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)]实例上的所有数据库禁用  
...
##  <a name="disable-default-ss_smartbackup-settings-for-the-instance"></a><a name="InstanceDisable"></a>禁用实例[!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)]的默认设置  
...
##  <a name="pause-ss_smartbackup-at-the-instance-level"></a><a name="InstancePause"></a>在[!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)]实例级别暂停  
