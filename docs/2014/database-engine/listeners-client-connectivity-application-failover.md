...
##  <a name="availability-group-listeners"></a><a name="AGlisteners"></a> 可用性组侦听器  
...
###  <a name="availability-group-listener-configuration"></a><a name="AGlConfig"></a> 可用性组侦听器配置  
 可用性组侦听器由以下各项定义：  
...
###  <a name="selecting-an-availability-group-listener-port"></a><a name="SelectListenerPort"></a> 选择可用性组侦听器端口  
...
##  <a name="using-a-listener-to-connect-to-the-primary-replica"></a><a name="ConnectToPrimary"></a>使用侦听器连接到主副本  
...
##  <a name="using-a-listener-to-connect-to-a-read-only-secondary-replica-read-only-routing"></a><a name="ConnectToSecondary"></a> 使用侦听器连接到只读的辅助副本（只读路由）  
...
###  <a name="to-configure-availability-replicas-for-read-only-routing"></a><a name="ConfigureARsForROR"></a> 为只读路由配置可用性副本  
...
####  <a name="related-tasks"></a><a name="RelatedTasksROR"></a> 相关任务  
...
###  <a name="read-only-application-intent-and-read-only-routing"></a><a name="ReadOnlyAppIntent"></a> 只读应用程序意向和只读路由  
...
####  <a name="related-tasks"></a><a name="RelatedTasksApps"></a> 相关任务  
...
##  <a name="bypassing-availability-group-listeners"></a><a name="BypassAGl"></a>绕过可用性组侦听器  
...
###  <a name="using-database-mirroring-connection-strings-with-availability-groups"></a><a name="DbmConnectionString"></a> 将数据库镜像连接字符串用于可用性组  
...
##  <a name="behavior-of-client-connections-on-failover"></a><a name="CCBehaviorOnFailover"></a>故障转移时的客户端连接行为  
...
##  <a name="supporting-availability-group-multi-subnet-failovers"></a><a name="SupportAgMultiSubnetFailover"></a> 支持可用性组多子网故障转移  
...
##  <a name="availability-group-listeners-and-ssl-certificates"></a><a name="SSLcertificates"></a> 可用性组侦听器和 SSL 证书  
...
##  <a name="availability-group-listeners-and-server-principal-names-spns"></a><a name="SPNs"></a>可用性组侦听器和服务器主体名称（Spn）  
