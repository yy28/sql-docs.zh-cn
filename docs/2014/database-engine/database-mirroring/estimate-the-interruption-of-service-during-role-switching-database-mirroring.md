...
## <a name="see-also"></a>另请参阅
 [在数据库镜像会话过程中，](role-switching-during-a-database-mirroring-session-sql-server.md) [数据库镜像运行模式](database-mirroring-operating-modes.md)角色切换 &#40;SQL Server&#41;[监视数据库镜像 &#40;SQL Server&#41;](monitoring-database-mirroring-sql-server.md)
