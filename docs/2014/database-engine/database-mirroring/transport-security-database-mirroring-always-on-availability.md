---
title: 针对数据库镜像和 AlwaysOn 可用性组 (SQL Server) 传输安全 |Microsoft 文档
ms.custom: ''
ms.date: 03/08/2017
...
## <a name="see-also"></a>请参阅  
 ...
 [解决 AlwaysOn 可用性组配置问题&#40;SQL Server&#41;删除](../availability-groups/windows/troubleshoot-always-on-availability-groups-configuration-sql-server.md)
