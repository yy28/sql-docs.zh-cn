 ...
 **主体日志（** * \<时间>* **）**  
 主体服务器实例上的日志状态，以服务器实例的本地时间为准，由* \<时间>* 指示。 将显示以下参数：  
 ...
 **镜像日志（** * \<时间>* **）**  
 镜像服务器实例上的日志状态，以服务器实例的本地时间为准，由* \<时间>* 指示。 将显示以下参数：  
