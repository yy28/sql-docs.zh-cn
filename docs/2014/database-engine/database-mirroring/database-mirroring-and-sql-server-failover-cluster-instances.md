...
> [!NOTE]  
>  有关数据库镜像的介绍，请参阅 [数据库镜像 (SQL Server)](database-mirroring-sql-server.md)实例的故障转移群集实例。  
...
### <a name="high-safety-mode-session-with-automatic-failover"></a>具有自动故障转移功能的高安全性模式会话  
 ...
 ![群集上的故障转移](../media/dbm-and-failover-clustering.gif "群集上的故障转移")  
