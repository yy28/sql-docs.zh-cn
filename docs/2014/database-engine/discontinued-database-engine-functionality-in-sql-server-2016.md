...
|安全性|`sp_dropalias`|请将别名替换为用户帐户和数据库角色的组合。 使用`sp_dropalias`删除已升级数据库中的别名。|  
|安全性|版本参数**PWDCOMPARE**表示的登录名的值早于[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]2000年已停用。|None|  
