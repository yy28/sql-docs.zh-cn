---
title: 停止使用的 SQL Server 2014 中的数据库引擎功能 |Microsoft 文档
ms.custom: ''
ms.date: 06/13/2017
...
|类别|已不再使用的功能|替代功能|  
|--------------|--------------------------|-----------------|  
|备份和还原|**备份 {数据库&#124;日志} WITH PASSWORD**和**备份 {数据库&#124;日志} WITH MEDIAPASSWORD**不再可。 **还原 {数据库&#124;日志} 与 [MEDIA] PASSWORD**仍弃用。|InclusionThresholdSetting|  
...
|邮件|SQL Mail|使用数据库邮件。 有关详细信息，请参阅[数据库邮件](../relational-databases/database-mail/database-mail.md)和[Use Database Mail Instead of SQL Mail](../relational-databases/policy-based-management/use-database-mail-instead-of-sql-mail.md)。|  
...
|Security|`sp_dropalias`|请将别名替换为用户帐户和数据库角色的组合。 使用`sp_dropalias`升级数据库中删除别名。|  
|Security|版本参数**PWDCOMPARE**表示的登录名的值早于[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]2000年，则停止。|InclusionThresholdSetting|  
...
|XEvents|databases_data_file_size_changed databases_log_file_size_changed<br /><br /> eventdatabases_log_file_used_size_changed<br /><br /> locks_lock_timeouts_greater_than_0<br /><br /> locks_lock_timeouts|Database_file_size_change 事件，database_file_size_change 替换为<br /><br /> database_file_size_change event<br /><br /> lock_timeout_greater_than_0<br /><br /> lock_timeout|  
