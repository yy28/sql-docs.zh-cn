---
title: 添加 / 删除表对话框 (Analysis Services-多维数据) |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
 ...
 **可用对象**  
 ...
 单击“>>”将“可用对象”中列出的所有对象传输到“包含的对象”，或选择一个或多个对象，再单击“>”将所选对象传输到“包含的对象”。  
 ...
 **包含的对象**  
 ...
 单击“<<”将“包含的对象”中列出的所有对象传输到“可用对象”，或选择一个或多个对象，再单击“<”将所选对象传输到“可用对象”。  
