 ...
 **保存到文件**  
 将重播结果保存到文件。 
  [!INCLUDE[ssSqlProfiler](../includes/sssqlprofiler-md.md)] 将显示标准文件对话框，您可以在该对话框中指定文件的保存位置。  
  
 **保存到表**  
 将重播结果保存到表。 
  [!INCLUDE[ssSqlProfiler](../includes/sssqlprofiler-md.md)] 将显示表选择对话框，您可以在该对话框中指定表的保存位置。  
