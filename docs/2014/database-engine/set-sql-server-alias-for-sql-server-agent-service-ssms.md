---
title: 将 SQL Server 别名设置为 SQL Server 代理服务 (SQL Server Management Studio) |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
-   调整进程的内存配额 (SeIncreaseQuotaPrivilege)  
 ...
 有关所需的 Windows 权限的详细信息[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]代理服务帐户，请参阅[为 SQL Server 代理服务选择帐户](../ssms/agent/select-an-account-for-the-sql-server-agent-service.md)和[配置 Windows 服务帐户和权限](configure-windows/configure-windows-service-accounts-and-permissions.md)。  
