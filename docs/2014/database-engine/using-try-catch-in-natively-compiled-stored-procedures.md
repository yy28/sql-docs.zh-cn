---
title: 使用重试...在本机编译存储过程中的 catch |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "48075227"
---
# <a name="using-trycatch-in-natively-compiled-stored-procedures"></a>在本机编译的存储过程中使用 Try..Catch
  您可以在本机编译的存储过程内使用 try..catch 块。 支持以下构造：  
