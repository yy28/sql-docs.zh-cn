...
|DistributionArticle 对象和 DistributionArticle2 对象|已移动到 <xref:Microsoft.SqlServer.Replication> 命名空间。|  
|DistributionDatabase 对象和 DistributionDatabase2 对象|已移动到 <xref:Microsoft.SqlServer.Replication> 命名空间。|  
|DistributionPublication 对象和 DistributionPublication2 对象|已移动到 <xref:Microsoft.SqlServer.Replication> 命名空间。|  
|DistributionSubscription 对象和 DistributionSubscription2 对象|已移动到 <xref:Microsoft.SqlServer.Replication> 命名空间。|  
...
|ReplicationTable 对象和 ReplicationTable2 对象|<xref:Microsoft.SqlServer.Replication.ReplicationTable> 对象。 已移动到 <xref:Microsoft.SqlServer.Replication> 命名空间。|  
