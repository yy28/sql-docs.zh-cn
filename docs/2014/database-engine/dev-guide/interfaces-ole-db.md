...
ms.locfileid: "36016664"
---
# <a name="interfaces-ole-db"></a>接口 (OLE DB)
  除了提供通过 Microsoft 数据访问组件 (MDAC)，OLE DB 接口的核心[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Native Client OLE DB 提供程序实现以下的其他 OLE DB 接口：  
...
## <a name="see-also"></a>请参阅  
 [SQL Server Native Client &#40;OLE DB&#41;引用](../../relational-databases/native-client-ole-db-interfaces/sql-server-native-client-ole-db-interfaces.md)  
