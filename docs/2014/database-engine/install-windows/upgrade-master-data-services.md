...
1.  **仅[!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]适用于**：打开 **"控制面板" "** > **程序和功能**"，然后卸载 Microsoft [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] [!INCLUDE[ssMDSshort](../../includes/ssmdsshort-md.md)]。  
...
##  <a name="twocomputer"></a>在两台计算机的方案中升级  
