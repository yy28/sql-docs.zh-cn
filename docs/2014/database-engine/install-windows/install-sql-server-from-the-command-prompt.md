...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 浏览器服务|/BROWSERSVCSTARTUPTYPE<br /><br /> **可选**|指定 [Browser 服务的](#Accounts) 启动 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 模式。 支持的值：<br /><br /> 自动<br /><br /> 禁用<br /><br /> Manual|  
