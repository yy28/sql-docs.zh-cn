...
|**/IAcceptSQLServerLicenseTerms**|仅在为无人参与安装指定了 /Q 或 /QS 参数时是必需的。|  
 ...
 <sup>1</sup>不能指定此参数，以将更新应用到的已准备实例[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。 必须指定 /instanceID 参数。  
