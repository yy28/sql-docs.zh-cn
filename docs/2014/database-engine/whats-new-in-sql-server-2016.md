---
title: 新增功能&#39;（数据库引擎） |Microsoft Docs
ms.custom: ''
ms.date: 06/22/2016
...
-   新的系统函数[fn_hadr_is_primary_replica](/sql/relational-databases/system-functions/sys-fn-hadr-is-primary-replica-transact-sql)和新的 DMV， [sys.databases dm_io_cluster_valid_path_names](/sql/relational-databases/system-dynamic-management-views/sys-dm-io-cluster-valid-path-names-transact-sql)可用。  
