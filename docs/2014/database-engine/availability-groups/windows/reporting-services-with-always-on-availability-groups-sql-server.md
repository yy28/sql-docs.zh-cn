...
## <a name="see-also"></a>另请参阅  
 [SQL Server Native Client 对高可用性、灾难恢复的支持](../../../relational-databases/native-client/features/sql-server-native-client-support-for-high-availability-disaster-recovery.md)   
  [AlwaysOn 可用性组（SQL Server）](always-on-availability-groups-sql-server.md) [入门与 AlwaysOn 可用性组 &#40;](getting-started-with-always-on-availability-groups-sql-server.md) SQL Server&#41;   
