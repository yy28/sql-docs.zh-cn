---
title: Reporting Services 与 AlwaysOn 可用性组 (SQL Server) |Microsoft 文档
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="reporting-services-with-alwayson-availability-groups-sql-server"></a>Reporting Services 与 AlwaysOn 可用性组 (SQL Server)
 ...
 有关一般信息[!INCLUDE[ssHADR](../../../includes/sshadr-md.md)]，请参阅[适用的 SQL Server 2012 的 AlwaysOn 常见问题 (http://msdn.microsoft.com/sqlserver/gg508768)](http://msdn.microsoft.com/sqlserver/gg508768)。  
...
> **错误消息：** “关键字不受支持的 "applicationintent"”  
 ...
 有关所需修补程序的详细信息，请参阅 [KB 2654347A 修补程序将 SQL Server 2012 中对 AlwaysOn 功能的支持引入 .NET Framework 3.5 SP1](http://go.microsoft.com/fwlink/?LinkId=242896)。  
...
-   SQL Client，已将 .Net 修补程序应用到报表服务器。  
 ...
 ![SSRS 数据源使用可用性组组](../../media/rs-alwayson-basic.gif "SSRS 数据源使用可用性组的组")  
...
-   **报表设计：** [!INCLUDE[ssRBDenali](../../../includes/ssrbdenali-md.md)] 或 [!INCLUDE[ssBIDevStudioFull](../../../includes/ssbidevstudiofull-md.md)] when you are creating new rep或ts. 有关详细信息，请参阅本主题中的“报表设计”部分。  
...
-   每个副本的可用性模式的配置。 可用性模式确定主副本是否在辅助副本将事务写入磁盘之前，等待提交数据库上的事务。 有关详细信息，请参阅：[AlwaysOn 可用性组概述 (SQL Server)](overview-of-always-on-availability-groups-sql-server.md)的“可用性模式”部分。  
...
## <a name="see-also"></a>请参阅  
 [对高可用性、灾难恢复的 SQL Server Native Client 支持](../../../relational-databases/native-client/features/sql-server-native-client-support-for-high-availability-disaster-recovery.md)   
  [AlwaysOn 可用性组 (SQL Server)](always-on-availability-groups-sql-server.md) [Getting Started with AlwaysOn 可用性组&#40;SQL Server&#41;](getting-started-with-always-on-availability-groups-sql-server.md)   
