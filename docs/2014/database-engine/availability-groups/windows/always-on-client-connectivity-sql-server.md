...
|SQL Native Client 11.0 OLEDB|否|是|是|No|否|  
...
## <a name="see-also"></a>另请参阅  
 ...
 [在 Windows Server 2008 R2 中，群集服务需要大约30秒的时间来对 IPv6 IP 地址进行故障转移](https://support.microsoft.com/kb/2578113)   
