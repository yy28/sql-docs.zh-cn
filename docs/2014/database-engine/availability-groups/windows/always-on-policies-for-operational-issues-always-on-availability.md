...
##  <a name="predefined-policies-and-issues"></a><a name="AlwaysOnPBM"></a> 预定义策略和问题  
 下表概述了预定义策略。  
...
##  <a name="alwayson-dashboard"></a><a name="Dashboard"></a>AlwaysOn 面板  
...
##  <a name="extending-the-alwayson-health-model"></a><a name="ExtendHealthModel"></a>扩展 AlwaysOn 运行状况模型  
