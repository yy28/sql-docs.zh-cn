...
> [!NOTE]
>  确保您满足 [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)] 的先决条件。 有关详细信息，请参阅[AlwaysOn 可用性组 &#40;SQL Server&#41;的先决条件、限制和建议](prereqs-restrictions-recommendations-always-on-availability.md)。
...
|[终结点访问（SQL Server 错误1418）](#Msg1418)|包含有关此 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 错误消息的信息。|
...
##  <a name="IsHadrEnabled"></a>AlwaysOn 可用性组未启用
...
##  <a name="JoinDbFails"></a>联接数据库失败（SQL Server 错误35250）
...
## <a name="see-also"></a>另请参阅
 用于[数据库镜像和 AlwaysOn 可用性组 &#40;的传输安全 SQL Server&#41;](../../database-mirroring/transport-security-database-mirroring-always-on-availability.md) [客户端网络配置](../../configure-windows/client-network-configuration.md)[先决条件、限制和建议](prereqs-restrictions-recommendations-always-on-availability.md)AlwaysOn 可用性组 &#40;SQL Server&#41;
