---
title: AlwaysOn 可用性组 (SQL Server) 概述 |Microsoft 文档
ms.custom: ''
ms.date: 10/27/2017
...
-   [Getting Started with AlwaysOn 可用性组&#40;SQL Server&#41;](getting-started-with-always-on-availability-groups-sql-server.md)  
