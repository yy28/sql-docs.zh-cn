...
##  <a name="create-endpoint"></a><a name="CreateEndpoint"></a>创建终结点  
...
##  <a name="create-availability-group"></a><a name="CreateAG"></a>创建可用性组  
...
##  <a name="alter-availability-group"></a><a name="AlterAG"></a>更改可用性组  
...
##  <a name="alter-database--set-hadr-"></a><a name="AlterDb"></a>更改数据库 .。。设置 HADR .。。  
...
##  <a name="drop-availability-group"></a><a name="DropAG"></a>删除可用性组  
...
##  <a name="restrictions-on-the-availability-group-transact-sql-statements"></a><a name="Restrictions"></a>对可用性组 Transact-sql 语句的限制  
