...
-   **[!INCLUDE[ssAoFoAgWiz](../../../includes/ssaofoagwiz-md.md)]页**  
     ...
     [选择新的主副本页面](#SelectNewPrimaryReplica)（在本主题后面部分）  
  
     "[连接到副本" 页](#ConnectToReplica)（稍后在本主题中）  
  
     "[确认可能丢失数据" 页](#ConfirmPotentialDataLoss)（稍后在本主题中）  
     ...
     [&#40;AlwaysOn 可用性组向导&#41;的结果页](results-page-always-on-availability-group-wizards.md)  
...
4.  
  **“简介”** 页面所显示的信息取决于是否有任何辅助副本可用于计划的故障转移。 如果此页面显示“**执行此可用性组的计划故障转移**”，则您可在不造成数据丢失的情况下对可用性组进行故障转移。  
...
###  <a name="SelectNewPrimaryReplica"></a>"选择新主要副本" 页  
