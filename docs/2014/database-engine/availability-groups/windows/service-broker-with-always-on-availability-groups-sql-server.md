---
title: Service Broker 与 AlwaysOn 可用性组 (SQL Server) |Microsoft 文档
ms.custom: ''
ms.date: 06/13/2017
...
-   [设置 AlwaysOn 可用性组或数据库镜像的登录帐户&#40;SQL Server&#41;](../../database-mirroring/set-up-login-accounts-database-mirroring-always-on-availability.md)  
