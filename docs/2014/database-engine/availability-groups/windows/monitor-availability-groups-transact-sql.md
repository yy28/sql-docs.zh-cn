...
##  <a name="monitoring-the-alwayson-availability-groups-feature-on-a-server-instance"></a><a name="AoAgFeatureOnSI"></a>监视服务器实例上的 AlwaysOn 可用性组功能  
...
##  <a name="monitoring-availability-replicas"></a><a name="AvReplicas"></a>监视可用性副本  
...
##  <a name="monitoring-availability-databases"></a><a name="AvDbs"></a>监视可用性数据库  
 若要监视可用性数据库，请使用以下视图：  
