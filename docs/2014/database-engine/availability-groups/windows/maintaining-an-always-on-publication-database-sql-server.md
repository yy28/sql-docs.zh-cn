---
title: 维护 AlwaysOn 发布数据库 (SQL Server) |Microsoft 文档
ms.custom: ''
ms.date: 06/13/2017
...
-   如果从可用性组主副本中删除原始发布服务器上的发布数据库，则必须运行`sp_redirect_publisher`而无需指定的值*@redirected_publisher*参数以删除重定向发布服务器/数据库对。  
