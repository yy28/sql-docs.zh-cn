---
title: 从迁移的先决条件日志传送到 AlwaysOn 可用性组 (SQL Server) |Microsoft 文档
ms.custom: ''
ms.date: 06/14/2017
...
-   [升级日志传送到 SQL Server 2014 &#40;Transact SQL&#41;](../../log-shipping/upgrading-log-shipping-to-sql-server-2016-transact-sql.md)  
