...
## <a name="mining-structure-and-mining-models"></a>挖掘结构和挖掘模型  
 开始创建 DMX 语句之前，了解 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 用来创建挖掘模型的主要对象十分重要。 *挖掘结构*是一种数据结构，用于定义从中生成挖掘模型的数据域。 单个挖掘结构可包含多个共享同一个域的*挖掘模型*。 挖掘模型可向挖掘结构所代表的数据应用挖掘模型算法。  
...
## <a name="what-you-will-learn"></a>学习内容  
 ...
 [第 1 课：创建市场篮挖掘模型](../../2014/tutorials/lesson-1-creating-the-market-basket-mining-structure.md)  
