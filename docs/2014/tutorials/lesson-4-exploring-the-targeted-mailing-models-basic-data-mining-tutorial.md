---
title: 第4课：浏览目标邮件模型（数据挖掘基础教程） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="lesson-4-exploring-the-targeted-mailing-models-basic-data-mining-tutorial"></a>第 4 课：浏览 Targeted Mailing 模型（数据挖掘基础教程）
 ...
 使用[!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]浏览模型时，所创建的每个模型都将列在数据挖掘设计器的 "**挖掘模型查看器**" 选项卡中。 您可以使用查看器来浏览模型。 这些查看器也在 [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] 中提供。  
 ...
 如果要了解详细信息， [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]还提供了一个名为 "**一般内容树查看器**" 的 HTML 查看器，该查看器以半表格格式显示有关模型数据的详细信息以及找到的任何模式。 有关详细信息，请参阅 [使用 Microsoft 一般内容树查看器浏览模型](../../2014/analysis-services/data-mining/browse-a-model-using-the-microsoft-generic-content-tree-viewer.md)。  
...
-   [浏览 Naive Bayes 模型 &#40;基本数据挖掘教程&#41;](../../2014/tutorials/exploring-the-naive-bayes-model-basic-data-mining-tutorial.md)  
 ...
 所有这三种模型都可以使用**一般内容树查看器**进行查看，以提取公式、数据值等。  
