---
title: 第 1 课：创建 Azure 存储对象 |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
1.  使用帐户登录到 Azure 管理门户。 如果你没有 Azure 帐户, 请[访问 azure 3 个月免费试用版](https://go.microsoft.com/fwlink/?LinkId=271927)。  
