---
title: 第2课：生成预测方案（数据挖掘中级教程） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
-   第二部分将指导您基于所有区域创建常规时序模型。 您可以将此常规模型用于*交叉预测*。  
 ...
 若要完成本课中的任务（如下所列），您将使用您[!INCLUDE[ssSampleDBDWobject](../includes/sssampledbdwobject-md.md)]在[第1课：创建中级数据挖掘解决方案 &#40;中级数据挖掘教程&#41;](../../2014/tutorials/lesson-1-create-solution-intermediate-data-mining-tutorial.md)中创建的数据源。  
