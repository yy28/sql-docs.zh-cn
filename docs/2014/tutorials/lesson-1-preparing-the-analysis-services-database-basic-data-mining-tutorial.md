...
# <a name="lesson-1-preparing-the-analysis-services-database-basic-data-mining-tutorial"></a>第 1 课：准备 Analysis Services 数据库（数据挖掘基础教程）
 ...
 在中[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]设计此应用程序时，将[!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]基于用于[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]多维建模和数据[!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]挖掘的项目模板在[!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]项目中创建。 创建 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 项目后，再定义一个或多个数据源。 然后，从数据源中选择的表和视图中定义称为*数据源视图*的元数据视图。  
