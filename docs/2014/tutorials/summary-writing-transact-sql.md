...
# <a name="summary-writing-transact-sql"></a>摘要：编写 Transact-SQL
  查询编辑器是一项[!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]用于开发更复杂的创作环境的重要步骤。 您可以将查询编辑器轻松切换为全屏显示模式以查看代码，或将连接快速切换到另一个服务器。 可从 "**工具**" 菜单上的 "**选项**" 对话框中找到其他功能。  
