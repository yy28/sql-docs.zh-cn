...
-   
 ...
 ![内存状态的配置设置](../media/rs-memoryconfigurationzones.gif "内存状态的配置设置")  
  
 下表介绍了 `WorkingSetMaximum`、`WorkingSetMinimum`、`MemorySafetyMargin` 和 `MemoryThreshold` 设置。 配置设置是在 [RSReportServer.config 文件](rsreportserver-config-configuration-file.md)中指定的。  
