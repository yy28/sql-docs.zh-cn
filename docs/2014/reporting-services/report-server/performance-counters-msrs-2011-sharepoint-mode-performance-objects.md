...
##  <a name="msrs-2014-web-service-sharepoint-mode-performance-counters"></a><a name="bkmk_webservice"></a>MSRS 2014 Web Service SharePoint 模式性能计数器
...
##  <a name="msrs-2014-windows-service-sharepoint-mode-performance-counters"></a><a name="bkmk_windowsservice"></a>MSRS 2014 Windows Service SharePoint Mode 性能计数器
