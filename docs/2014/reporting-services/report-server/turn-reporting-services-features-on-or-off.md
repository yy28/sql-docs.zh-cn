...
2.  若要打开报表服务器 Web 服务，设置`IsWebServiceEnabled`到`true`:  
...
4.  在 **“方面属性”** 下：  
    ...
    -   若要打开报表服务器 Web 服务，设置**WebServiceAndHTTPAccessEnabled**到`True`。  
  
    -   若要关闭报表服务器 Web 服务，设置**WebServiceAndHTTPAccessEnabled**到`False`。  
...
4.  在 **“方面属性”** 下：  
    ...
    -   若要打开预定的事件和传递，设置**ScheduleEventsAndReportDeliveryEnabled**到`True`。  
  
    -   若要关闭预定的事件和传递，设置**ScheduleEventsAndReportDeliveryEnabled**到`False`。  
...
2.  若要打开报表管理器，设置`IsReportManagerEnabled`到`true`:  
  
    ```  
    <IsReportManagerEnabled>true</IsReportManagerEnabled>  
    ```  
  
3.  若要关闭报表管理器，设置`IsReportManagerEnabled`到`false`:  
...
4.  在 **“方面属性”** 下：  
    ...
    -   若要打开报表管理器，设置**ReportManagerEnabled**到`True`。  
  
    -   若要关闭报表管理器，设置**ReportManagerEnabled**到`False`。  
