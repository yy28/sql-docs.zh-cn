...
|**浏览器**|**Windows 8 和 8.1**|**Windows 7**|**Windows Server 2012 和 2012 R2**|**Windows Server 2008 R2**|**Windows 2008 Server**|**Mac OS X 10.6-10。9**|  
|-----------------|---------------------------|-------------------|-----------------------------------------|--------------------------------|-----------------------------|------------------------------|  
...
##  <a name="report-manager-browser-requirements-native-mode"></a><a name="bkmk_reportmanager"></a>报表管理器浏览器要求（本机模式）
...
|**浏览器**|**Windows 8 和 8.1**|**Windows 7**|**Windows Server 2012 和 2012 R2**|**Windows Server 2008 R2**|**Windows 2008 Server**|**Mac OS X 10.6-10。9**|**适用于 iPad 的 iOS 6-7**|  
|-----------------|---------------------------|-------------------|-----------------------------------------|--------------------------------|-----------------------------|------------------------------|----------------------------|  
 ...
 **注意** 如果从 Macintosh 计算机访问报表服务器，则建议使用 Safari。 如果你使用的是与[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]集成的 SharePoint 产品，请参阅[计划浏览器支持（Windows SharePoint Services）](https://go.microsoft.com/fwlink/?LinkId=183583)。  
