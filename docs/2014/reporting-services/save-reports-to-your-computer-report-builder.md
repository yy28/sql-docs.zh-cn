---
title: 将报表保存到您的计算机 （报表生成器） |Microsoft Docs
ms.custom: ''
ms.date: 03/08/2017
...
2.  （可选） 单击**桌面**，**我的文档**，或**我的电脑**若要将报表保存到其中一个文件夹。  
  
3.  找到计算机上要保存该报表的位置。 在 **“名称”** 中，键入报表的名称。  
...
3.  在 **“名称”** 中，键入报表的名称。 （可选） 单击**桌面**，**我的文档**，或**我的电脑**若要将报表保存到其中一个文件夹。  
