...
5.  对于 **“连接字符串”**，指定报表服务器用于连接数据源的连接字符串。 下面的示例演示用于连接到的连接字符串[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)][!INCLUDE[ssSampleDBobject](../../../includes/sssampledbobject-md.md)]数据库：  
