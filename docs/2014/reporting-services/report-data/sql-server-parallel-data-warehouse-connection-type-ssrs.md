...
##  <a name="related-sections"></a><a name="Related"></a>相关部分
 ...
 [报表嵌入数据集和共享数据集 &#40;报表生成器和 SSRS&#41;](report-embedded-datasets-and-shared-datasets-report-builder-and-ssrs.md)提供有关嵌入数据集和共享数据集的信息。
...
## <a name="see-also"></a>另请参阅
 [报表参数 &#40;报表生成器和报表设计器&#41;](../report-design/report-parameters-report-builder-and-report-designer.md) [对数据进行筛选、分组和排序 &#40;](../report-design/filter-group-and-sort-data-report-builder-and-ssrs.md)报表生成器和 ssrs&#41;&#40;报表生成器[和 ssrs](../report-design/expressions-report-builder-and-ssrs.md)&#41;
