...
##  <a name="supported-versions"></a><a name="support"></a>支持的版本  
...
|`UniqueName`|`String`|返回级别的完全限定名称。 例如，雇员的`UniqueName`值可能是 *[0D_Company]. [10D_Department]。[11]*。|  
