...
|![删除所选字段中的筛选器](../media/rsqdicon-removefilter.gif "删除所选字段中的筛选器")|在标记为具有筛选器的关系图窗格中删除所选列的筛选器（![所选的筛选器列旁边的筛选器图形](../media/rsqdicon-filter.gif "所选的筛选器列旁边的筛选器图形")）。|  
