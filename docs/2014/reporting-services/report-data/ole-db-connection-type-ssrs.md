...
-   [Analysis Services OLE DB 访问接口&#40;Analysis Services-多维数据&#41;](../../analysis-services/dev-guide/analysis-services-ole-db-provider-analysis-services-multidimensional-data.md)  
