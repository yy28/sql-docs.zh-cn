...
- 数据源和数据集在报表中创作，并且从客户端创作工具发布到报表服务器或 SharePoint 站点。 可以直接在报表服务器上创建数据源。 在发布后，您可以在报表服务器上配置凭据和其他属性。 有关详细信息，请参阅 Reporting Services 和[Reporting Services 工具](../tools/reporting-services-tools.md)[中的数据连接、数据源和连接字符串](../data-connections-data-sources-and-connection-strings-in-reporting-services.md)。  
...
|-|-|  
|**常见任务**|**链接**|  
|创建数据连接|[Data Connections, Data Sources, and Connection Strings in Reporting Services](../data-connections-data-sources-and-connection-strings-in-reporting-services.md)|  
