...
#### <a name="example"></a>示例  
 下面的查询返回的最后一个名称，从列表[!INCLUDE[ssSampleDBobject](../../../includes/sssampledbobject-md.md)] **2008年**数据库`ContactType`表`Person`架构。  
...
#### <a name="example"></a>示例  
 以下查询将调用[!INCLUDE[ssSampleDBobject](../../../includes/sssampledbobject-md.md)] **2008年**存储过程`uspGetWhereUsedProductID`。 在运行查询时，您必须为产品标识号参数输入一个值。  
...
#### <a name="example"></a>示例  
 对于数据源类型 OLE DB，以下数据集查询返回的结果中的所有联系人类型集[!INCLUDE[ssSampleDBobject](../../../includes/sssampledbobject-md.md)] **2008年**数据库。  
