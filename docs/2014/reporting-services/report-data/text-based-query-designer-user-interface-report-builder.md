...
-   **查询**显示查询文本、表名或存储过程的名称，具体取决于查询类型。 并非所有查询类型都适用于所有数据源类型。 例如，只有数据源类型 OLE DB 支持表名。  
...
|**Import**|从文件或报表中导入现有的查询。 仅支持 sql 和 rdl 文件类型|  
...
### <a name="command-type-storedprocedure"></a>命令类型 StoredProcedure  
 ...
 ![基于文本的查询设计器中的存储过程](https://docs.microsoft.com/analysis-services/analysis-services/media/rs-relational-text-sp.gif "基于文本的查询设计器中的存储过程")  
...
## <a name="see-also"></a>另请参阅  
 [关系查询设计器用户界面 &#40;报表生成器&#41;](relational-query-designer-user-interface-report-builder.md)   
