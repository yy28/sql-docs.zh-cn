...
> [!NOTE]  
>  若要完成此教程，您必须在本机模式下运行 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]。 如果在 SharePoint 集成模式下运行 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]，则使用报表服务器 URL 的步骤无效。 有关[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]模式的详细信息，请参阅[Reporting Services 报表服务器](reporting-services-report-server.md)。  
