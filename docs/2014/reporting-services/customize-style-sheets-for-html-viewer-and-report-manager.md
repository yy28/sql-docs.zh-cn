...
## <a name="reporting-services-style-sheets"></a>Reporting Services 样式表  
 下表描述中使用的样式表 (.css) 文件[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]安装。  
...
> [!NOTE]  
>  下列样式表用于报表管理器联机文档，并且在任何时候都不应该修改：Sql.css 和 Mailto.css。 其他样式表为在 SharePoint Web 部件中打开的报表和报表管理器定义样式。 这些样式表包括 Rswebparts.css、Sp_full.css 和 Sp_small.css。 建议不要修改 SharePoint 样式表。 有关如何使用 Web 部件的详细信息，请参阅[查看和浏览本机模式报表使用 SharePoint Web 部件&#40;SSRS&#41;](reports/view-and-explore-native-mode-reports-using-sharepoint-web-parts-ssrs.md)。  
