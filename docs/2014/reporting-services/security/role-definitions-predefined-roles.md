...
##  <a name="predefined-role-definitions"></a><a name="bkmk_rolelist"></a>预定义的角色定义  
...
|[“系统管理员”角色](#bkmk_systemadministrator)|System|分配了此角色的用户可以启用功能并设置默认值、设置站点范围的安全性、在 Management Studio 中创建角色定义以及管理作业。|  
|[系统用户角色](#bkmk_systemuser)|System|分配了此角色的用户可以查看有关报表服务器的基本信息，例如某个共享计划中的计划信息。|  
  
##  <a name="content-manager-role"></a><a name="bkmk_content"></a>内容管理员角色  
...
##  <a name="publisher-role"></a><a name="bkmk_publisher"></a>发布者角色  
...
##  <a name="browser-role"></a><a name="bkmk_browser"></a>Browser 角色  
...
##  <a name="report-builder-role"></a><a name="bkmk_reportbuilder"></a>报表生成器角色  
...
##  <a name="my-reports-role"></a><a name="bkmk_myreports"></a>我的报表角色  
...
##  <a name="system-administrator-role"></a><a name="bkmk_systemadministrator"></a>系统管理员角色  
