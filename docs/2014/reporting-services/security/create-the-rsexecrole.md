...
## <a name="create-rsexecrole-in-master"></a>在 Master 中创建 RSExecRole  
 [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)]使用代理服务的[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]扩展存储过程来支持计划操作。 下列步骤说明如何向 `RSExecRole` 角色授予这些过程的执行权限。  
...
1.  启动[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]并连接到承载[!INCLUDE[ssDE](../../../includes/ssde-md.md)] Report Server 数据库的实例。  
...
8.  在 "**角色名称**" `RSExecRole`中，键入。  
  
9. 在 "**所有者**" 中，键入**DBO**。  
  
10. 单击 **“安全对象”**。  
  
11. 单击 **“搜索”** 。 此时，将显示 **“添加对象”** 对话框。 
  **“指定对象”** 选项默认情况下处于选中状态。  
...
20. 对于其余的每个存储过程，重复此操作。 必须向 `RSExecRole` 授予全部三个存储过程的执行权限。  
 ...
 ![数据库角色属性页](../media/rsexecroledbproperties.gif "数据库角色属性页")  
...
## <a name="see-also"></a>另请参阅  
 [将报表服务器数据库移动到另一台计算机 &#40;SSRS 本机模式&#41;](../report-server/moving-the-report-server-databases-to-another-computer-ssrs-native-mode.md)   
