...
1.  单击 "**开始**"，指向[!INCLUDE[ssCurrentUI](../includes/sscurrentui-md.md)]"**所有程序**"，指向 ""，然后单击 " **SQL Server Data Tools**"。 如果这是你首次打开[!INCLUDE[ssBIDevStudio](../includes/ssbidevstudio-md.md)]，请单击 "默认环境设置" 的 "**商业智能设置**"。  
