...
-   **纯文本**将占位符显示为简单文本。 HTML 被视为文字文本。  
  
-   **HTML** 将占位符显示为 HTML。 如果占位符的表达式值包含有效的 HTML 标记，则这些标记呈现为 HTML。  
...
## <a name="see-also"></a>另请参阅  
 ...
 [将 HTML 导入到报表中 &#40;报表生成器和 SSRS&#41;](report-design/importing-html-into-a-report-report-builder-and-ssrs.md)  
