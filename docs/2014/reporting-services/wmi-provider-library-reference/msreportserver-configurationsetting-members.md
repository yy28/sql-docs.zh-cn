...
|||  
|-|-|  
|[ConnectionPoolSize](configurationsetting-property-connectionpoolsize.md)|返回 Report Server 与承载 Report Server 数据库的[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssDE](../../includes/ssde-md.md)]实例进行通信时使用的连接池大小。 只读。|  
|[DatabaseLogonAccount](configurationsetting-property-databaselogonaccount.md)|指定 Report Server 用于连接到[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssDE](../../includes/ssde-md.md)]承载 Report Server 数据库的实例的登录帐户。 只读。|  
...
|[DatabaseQueryTimeout](configurationsetting-property-databasequerytimeout.md)|指定命令失败或超时之前必须经过的秒数。Report Server 针对 Report Server 数据库（而不是报表的数据源）处理进程。|  
...
|[&#40;WMI&#41;的 MachineAccountIdentity 属性](configurationsetting-property-machineaccountidentity.md)|获取安装了报表服务器的计算机的计算机帐户标识。|  
...
|[&#40;WMI MSReportServer_ConfigurationSetting 的 CreateSSLCertificateBinding 方法&#41;](configurationsetting-method-createsslcertificatebinding.md)|创建 SSL 证书绑定。|  
...
|[&#40;WMI&#41;的 GetAdminSiteUrl 方法](configurationsetting-method-getadminsiteurl.md)|获取管理中心网站的绝对 URL。|  
...
|[&#40;WMI&#41;的 ListInstalledSharePointVersions 方法](configurationsetting-method-listinstalledsharepointversions.md)|返回一组标记，这些标记表示与 Report Server [!INCLUDE[winSPServ](../../includes/winspserv-md.md)] [!INCLUDE[offSPServ](../../includes/offspserv-md.md)]安装[!INCLUDE[SPF2010](../../includes/spf2010-md.md)]在同一[!INCLUDE[SPS2010](../../includes/sps2010-md.md)]台计算机上的、或版本。|  
|[&#40;WMI MSReportServer_ConfigurationSetting 的 ListIPAddresses 方法&#41;](configurationsetting-method-listipaddresses.md)|列出计算机的 IP 地址。|  
...
|[&#40;WMI MSReportServer_ConfigurationSetting 的 ListReservedURLs 方法&#41;](configurationsetting-method-listreservedurls.md)|列出为报表服务器上所有应用程序保留的 URL。|  
|[&#40;WMI MSReportServer_ConfigurationSetting 的 ListSSLCertificateBindings 方法&#41;](configurationsetting-method-listsslcertificatebindings.md)|列出 HTTP.SYS 中存在的以及 rsreportserver.config 中应有的 SSL 证书绑定。|  
|[&#40;WMI MSReportServer_ConfigurationSetting 的 ListSSLCertificates 方法&#41;](configurationsetting-method-listsslcertificates.md)|列出计算机上安装的 SSL 证书。|  
...
|[&#40;WMI MSReportServer_ConfigurationSetting 的 RemoveSSLCertificateBindings 方法&#41;](configurationsetting-method-removesslcertificatebinding.md)|删除 SSL 证书绑定。|  
|[RemoveUnattendedExecutionAccount](configurationsetting-method-removeunattendedexecutionaccount.md)|从报表服务器配置中删除无人参与的执行帐户条目。|  
|[&#40;WMI MSReportServer_ConfigurationSetting 的 RemoveURL 方法&#41;](configurationsetting-method-removeurl.md)|删除为报表服务器保留的 URL。|  
|[&#40;WMI MSReportServer_ConfigurationSetting 的 ReserveURL 方法&#41;](configurationsetting-method-reserveurl.md)|为给定的应用程序添加一个 URL 预留。|  
...
|[&#40;WMI MSReportServer_ConfigurationSetting 的 SetVirtualDirectory 方法&#41;](configurationsetting-method-setvirtualdirectory.md)|设置应用程序的虚拟目录。|  
