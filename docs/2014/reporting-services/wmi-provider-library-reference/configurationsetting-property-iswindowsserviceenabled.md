...
ms.locfileid: "66097594"
---
# <a name="iswindowsserviceenabled-property-wmi-msreportserver_configurationsetting"></a>IsWindowsServiceEnabled 属性 (WMI MSReportServer_ConfigurationSetting)
