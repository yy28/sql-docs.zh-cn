...
|[&#40;WMI&#41;的 ListInstalledSharePointVersions 方法](configurationsetting-method-listinstalledsharepointversions.md)|返回一组标记，这些标记表示与 Report Server 安装[!INCLUDE[winSPServ](../../includes/winspserv-md.md)] [!INCLUDE[offSPServ](../../includes/offspserv-md.md)]在[!INCLUDE[SPF2010](../../includes/spf2010-md.md)]同一台[!INCLUDE[SPS2010](../../includes/sps2010-md.md)]计算机上的 Microsoft、或版本。|  
