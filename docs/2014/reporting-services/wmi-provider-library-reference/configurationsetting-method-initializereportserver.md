...
## <a name="remarks"></a>Remarks  
 ...
 如果报表服务器的[IsInitialized](configurationsetting-property-isinitialized.md)属性设置为`true`当调用 InitializeReportServer 方法时，方法会成功返回而不会尝试加密密钥进行加密。  
