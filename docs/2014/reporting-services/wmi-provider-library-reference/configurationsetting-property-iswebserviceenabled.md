...
ms.locfileid: "66097651"
---
# <a name="iswebserviceenabled-property-wmi-msreportserver_configurationsetting"></a>IsWebServiceEnabled 属性 (WMI MSReportServer_ConfigurationSetting)
