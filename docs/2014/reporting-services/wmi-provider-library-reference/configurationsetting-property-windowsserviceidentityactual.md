...
ms.locfileid: "66097407"
---
# <a name="windowsserviceidentityactual-property-wmi-msreportserver_configurationsetting"></a>WindowsServiceIdentityActual 属性 (WMI MSReportServer_ConfigurationSetting)
...
## <a name="property-values"></a>属性值  
 包含用于运行报表服务器 Windows 服务的标识的 `String` 对象。  
