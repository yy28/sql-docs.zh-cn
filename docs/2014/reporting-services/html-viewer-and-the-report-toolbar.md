...
> [!NOTE]  
>  尽管您不能修改报表工具栏，但是可以配置报表 URL 的参数以在报表中隐藏工具栏。 隐藏报表工具栏的详细信息，请参阅[URL Access Parameter Reference](url-access-parameter-reference.md)。  
...
|![报表工具栏上的浏览器“刷新”按钮](media/htmlviewer-refresh.GIF "Browser refresh button on report toolbar")|**报表刷新图标**|刷新报表。 实时报表的数据将相应刷新。 缓存报表将从其存储位置重新加载。|  
...
|“导出”|在 [!INCLUDE[msCoName](../includes/msconame-md.md)] Excel 中查看报表。|  
