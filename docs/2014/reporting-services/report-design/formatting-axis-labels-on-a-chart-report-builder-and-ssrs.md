...
## <a name="see-also"></a>另请参阅
 [设置图表格式 &#40;报表生成器和 ssrs&#41;](formatting-a-chart-report-builder-and-ssrs.md) [图表 &#40;报表生成器和 ssrs](charts-report-builder-and-ssrs.md)&#41;&#40;[和 Ssrs 的图表上的数据点格式](formatting-data-points-on-a-chart-report-builder-and-ssrs.md)报表生成器
