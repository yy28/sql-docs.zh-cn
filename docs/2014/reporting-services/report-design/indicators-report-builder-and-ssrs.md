...
##  <a name="SizingIndicatators"></a>调整指示器大小以最大程度地提高视觉效果  
...
-   [使用 &#40;报表生成器和 SSRS 的表达式指定指示器的大小&#41;](specify-the-size-of-an-indicator-using-an-expression-report-builder-and-ssrs.md)  
  
-   [在仪表面板中包含指示器和仪表 &#40;报表生成器和 SSRS&#41;](include-indicators-and-gauges-in-a-gauge-panel-report-builder-and-ssrs.md)  
