...
# <a name="add-bevel-emboss-and-texture-styles-to-a-chart-report-builder-and-ssrs"></a>向图表添加凹凸效果、阳文和纹理样式（报表生成器和 SSRS）
 ...
 除了上述绘制样式外，还可以向许多图表元素添加边框和阴影，以制造一种具有深度的错觉。 有关设置图表格式的其它方法的详细信息，请参阅 [设置图表格式（报表生成器和 SSRS）](formatting-a-chart-report-builder-and-ssrs.md)。  
...
>  不能在同一个图表上具有三维和凹凸效果或阳文样式。 如果已为图表启用三维样式，将看不到 PieDrawingStyle 属性。  
 ...
 ![具有凹形绘制样式的饼图](../media/rs-piedrawingeffects-concave.gif "具有凹形绘制样式的饼图")  
