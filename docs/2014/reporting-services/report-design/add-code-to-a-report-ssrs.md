...
-   使用 [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)]提供自定义代码程序集。 如果提供自定义程序集，则必须同时在创作报表的计算机上和查看报表的报表服务器上安装该自定义程序集。 有关详细信息，请参阅[使用 Custom Assemblies with Reports](../custom-assemblies/using-custom-assemblies-with-reports.md)。  
...
## <a name="see-also"></a>请参阅  
 [报表属性对话框中代码](../report-properties-dialog-box-code.md)   
