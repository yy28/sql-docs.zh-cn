...
# <a name="keep-headers-visible-when-scrolling-through-a-report-report-builder-and-ssrs"></a>在滚动报表时保持标题可见（报表生成器和 SSRS）
 ...
 如果将报表导出到 Excel，则不会自动冻结标头。 可以冻结 Excel 中的窗格。 有关详细信息，请参阅**导出到 Microsoft Excel（报表生成器和 SSRS）** 的“页眉和页脚”节[](../report-builder/exporting-to-microsoft-excel-report-builder-and-ssrs.md)。  
...
## <a name="see-also"></a>另请参阅  
 ...
 [使用组 &#40;报表生成器和 SSRS 显示标头和组尾&#41;](display-headers-and-footers-with-a-group-report-builder-and-ssrs.md)   
 [在多个页上显示行标题和列标题 &#40;报表生成器和 SSRS&#41;](display-row-and-column-headers-on-multiple-pages-report-builder-and-ssrs.md)   
