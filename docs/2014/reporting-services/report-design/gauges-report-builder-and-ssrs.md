...
-   在一个仪表面板中使用多个仪表比较各字段之间的数据。
 ...
 ![仪表元素关系图](../media/gauge-elements-diagram.gif "仪表元素关系图")
...
##  <a name="GaugeTypes"></a> 仪表类型
 ...
 除了上述差异外，这两种仪表类型可互换。 但是，如果您需要在报表中使用简单仪表，则应考虑使用指示器来代替仪表。 有关详细信息，请参阅[指示器（报表生成器和 SSRS）](indicators-report-builder-and-ssrs.md)。
...
### <a name="considerations-when-adding-data-to-the-gauge"></a>向仪表添加数据时的注意事项
...
-   右键单击仪表指针，然后选择 **“指针属性”** 。 对于`Value`，请从下拉列表中选择一个字段，或者单击 "**表达式**" （*fx*）按钮来定义字段表达式。
...
-   [在仪表 &#40;报表生成器和 SSRS 上设置对齐间隔&#41;](../set-a-snapping-interval-on-a-gauge-report-builder-and-ssrs.md)

-   [指定一个图像作为仪表上的指针 &#40;报表生成器和 SSRS&#41;](../specify-an-image-as-a-pointer-on-a-gauge-report-builder-and-ssrs.md)
...
## <a name="see-also"></a>另请参阅
 [表达式 &#40;报表生成器和 ssrs&#41;](expressions-report-builder-and-ssrs.md) [筛选、分组和排序数据 &#40;报表生成器和 Ssrs](filter-group-and-sort-data-report-builder-and-ssrs.md)&#41;[报表参数](report-parameters-report-builder-and-report-designer.md)&#40;报表生成器和报表设计器[&#41;&#40;](charts-report-builder-and-ssrs.md)报表生成器&#41;&#40;报表生成器&#41;[](tables-matrices-and-lists-report-builder-and-ssrs.md)
