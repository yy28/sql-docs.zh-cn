...
##  <a name="comparing-external-embedded-and-data-bound-images"></a><a name="ComparingImages"></a> 比较外部图像、嵌入图像和数据绑定图像  
...
##  <a name="images-as-report-parts"></a><a name="ImagesReportParts"></a> 作为报表部件的图像  
 您可以将图像作为报表部件与报表分开保存。 [!INCLUDE[ssRBrptparts](../../includes/ssrbrptparts-md.md)]  
  
 
  
##  <a name="embedding-images"></a><a name="EmbedImages"></a> 嵌入图像  
...
##  <a name="external-images"></a><a name="ExternalImages"></a> 外部图像  
...
##  <a name="background-images"></a><a name="BackgroundImages"></a> 背景图像  
...
##  <a name="data-bound-images"></a><a name="DataboundImages"></a> 数据绑定图像  
