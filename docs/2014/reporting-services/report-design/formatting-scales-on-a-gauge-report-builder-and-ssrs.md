...
2.  如果没有为 Interval 指定值，则默认值为 "自动"。这意味着，应用程序将根据第一步中指定的最小值和最大值计算间隔数量的间隔。 如果指定了间隔值，仪表将计算最大值和最小值的差，并用该数字除以在“间隔”属性中指定的值。  
...
##  <a name="ReducingCollisions"></a>减少带有乘数的标签冲突  
...
##  <a name="PositioningLabels"></a>以线性或径向刻度定位标签  
