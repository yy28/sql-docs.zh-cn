...
4.  **选择与数据源的连接**。 选择或创建一个与包含要在地图上显示的分析数据的外部数据源的数据源连接。  
...
###  <a name="Shapefile"></a>什么是 ESRI 形状文件？  
...
###  <a name="GetShapefiles"></a>在哪里可以获得 ESRI 形状文件？  
...
###  <a name="MapType"></a>基本地图、气泡图和分析图之间有什么区别？  
...
###  <a name="Diff"></a>空间数据与分析数据之间的区别是什么？  
...
###  <a name="Legends"></a>地图预览中的图例和刻度有哪些？  
