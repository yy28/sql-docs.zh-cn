...
# <a name="reporting-services-soapexception-class"></a>Reporting Services SoapException 类
 ...
 为了轻松捕获特定错误情况，[!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] 使用 SoapException 类的属性分类异常的错误代码，并返回错误的分类****。 有关详细信息，请参阅 SDK 文档中的[!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] "SoapException 类"。  
