...
-   主报表和所有子报表都不能升级。 处理它们[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]2005年[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]报表处理器。  
