 ...
 **当前 SMTP 传递方法**  
 ...
 在配置文件中，通过设置传递方法`SendUsing`配置设置。 有关指定详细信息`SendUsing`设置，请参见[为电子邮件传递配置报表服务器&#40;SSRS 配置管理器&#41;](../../sql-server/install/configure-a-report-server-for-e-mail-delivery-ssrs-configuration-manager.md)。  
