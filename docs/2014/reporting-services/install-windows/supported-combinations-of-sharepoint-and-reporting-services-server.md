---
title: SharePoint 和 Reporting Services 服务器及外接程序 (SQL Server 2014) 的支持的组合 |Microsoft 文档
ms.custom: ''
ms.date: 05/24/2017
...
|11|[!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] SP2|[!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 和 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] SP2|SharePoint 2007|是|  
 ...
 有关详细信息[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]功能和报表服务器模式，请参阅[Reporting Services 报表服务器](../reporting-services-report-server.md)。  
