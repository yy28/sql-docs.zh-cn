---
title: 多维数据集选择对话框 |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>请参阅  
 ...
 [针对 MDX 的 Analysis Services 连接类型 (SSRS)](report-data/analysis-services-connection-type-for-mdx-ssrs.md)  
