...
4.  在中**To**文本框中，在收件人的收件人姓名： 字段是使用您的域用户帐户自行填写地址。 报表服务器配置设置决定“收件人”字段是否使用你的用户帐户自行填写地址。  有关更改配置设置电子邮件地址的详细信息，请参阅[为电子邮件传递配置报表服务器&#40;SSRS 配置管理器&#41;](../../sql-server/install/configure-a-report-server-for-e-mail-delivery-ssrs-configuration-manager.md)。  
