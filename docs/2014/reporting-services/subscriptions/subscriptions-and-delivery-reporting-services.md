...
# <a name="subscriptions-and-delivery-reporting-services"></a>订阅和传递 (Reporting Services)
 ...
 ![ssrs 订阅流示例](../media/ssrs-subscription-example-flow.png "ssrs 订阅流示例")  
...
-   [Reporting Services 中的 SharePoint 库传递](sharepoint-library-delivery-in-reporting-services.md)介绍到 SharePoint 库的订阅传递。  
