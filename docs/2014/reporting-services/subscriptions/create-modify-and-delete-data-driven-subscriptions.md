...
3.  选择要修改的订阅。 以下图标表示数据驱动订阅：![数据驱动订阅图标](../media/hlp-16subscriptiondd.gif "Data-driven subscription icon")  
...
## <a name="see-also"></a>请参阅  
 ...
 [“订阅”页（报表管理器）](../subscriptions-page-report-manager.md)   
