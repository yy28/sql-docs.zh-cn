...
##  <a name="overview-of-managing-shared-schedules"></a><a name="bkmk_overview"></a>管理共享计划概述  
...
##  <a name="create-and-manage-shared-schedules-sharepoint-mode"></a><a name="bkmk_sharepoint"></a>创建和管理共享计划（SharePoint 模式）  
...
##  <a name="create-and-manage-shared-schedules-native-mode"></a><a name="bkmk_native"></a>创建和管理共享计划（本机模式）  
...
3.  右键单击 "共享计划" 文件夹，然后单击 "**新建计划**"。 将显示 **“新建共享计划”** 对话框的“常规”页。  
