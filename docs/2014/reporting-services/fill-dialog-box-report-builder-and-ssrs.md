...
## <a name="options"></a>选项  
 **填充颜色**  
 单击此颜色按钮可为矩形选择填充颜色。 单击“表达式”**(fx)** 按钮可编辑表达式，此表达式可以是 RGB 颜色的十六进制值，也可以是“表达式”对话框中提供的预定义的颜色名称之一。__**** 若要查看预定义的颜色的列表，请在 **“项”** 窗格中选择 **Web**。 可在表达式文本窗格中键入 **“标题”** 窗格中列出的颜色名称。 键入颜色名称时请勿使用等号 (=) 或引号 ("")。  
