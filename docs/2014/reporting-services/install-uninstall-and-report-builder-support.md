...
### <a name="installing-the-stand-alone-version-of-report-builder-directly-on-your-computer"></a>直接在计算机上安装报表生成器的独立版本  
 您可以从下载站点、 [Microsoft 下载中心](http://go.microsoft.com/fwlink/?LinkID=186083)下载并安装报表生成器，或者管理员将 ReportBuilder3.msi 文件（报表生成器的 Windows Installer 包）放在某个共享位置上，您可以从中进行安装。  
