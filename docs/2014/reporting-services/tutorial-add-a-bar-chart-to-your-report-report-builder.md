...
1.  单击 **“开始”**，依次指向 **“程序”**、 **Microsoft SQL Server 2012 Report Builder**，再单击 **“报表生成器”**。  
    ...
    > [!NOTE]  
    >  如果 "**入门**" 对话框未出现，请单击 "报表生成器" 按钮，然后单击 "**新建**"。  
...
2.  单击“条形图”，然后单击“下一步”********。  
     ...
     在 "**排列图表字段**" 页上，"**可用字段**" 窗格中有4个字段： FirstName、LastName、SalesYear2009 和 SalesYear2008。  
...
2.  选择图表顶部的词语 "**图表标题**"，然后键入以下文本： " **2008" 和 "2009**" 的销售额。  
...
2.  沿图表底部单击水平轴，以选择它。  
     ...
     在功能区上，在 "**主页**" 选项卡上的 "**数字**" 组中，单击 "**货币**" 按钮。 水平轴标签将更改为货币。  
...
8.  在 "**标题" 文本框**中，键入**Sales in 上千**，然后单击 **"确定"**。  
...
2.  键入**Sales Bar Chart**，按 enter，然后键入**2009 的前五个卖方**，如下所示：  
...
4.  选择**2009 的前五个卖方**，然后在 "**主页**" 选项卡的 "**字体**" 部分中，将字号设置为**10**。  
