...
2.  在 " `Name`类型" 框中，键入： **listdatasource。**
...
2.  在列表内单击，右键单击列表顶部，然后单击 **“Tablix 属性”**。
     ...
     ![正在添加列表](../../2014/tutorials/media/tutorial-addinglistwithnumbers.png "正在添加列表")
...
5.  单击 **“仅删除列”**。
     ...
     !["删除列" 对话框](../../2014/tutorials/media/tutorial-deletecolumnsdialog.png "“删除列”对话框")
...
1.  在功能区的 "**插入**" 选项卡上，单击 "**矩形**"，然后将一个矩形拖到该列表的左上角。 使该矩形 7 英寸高，1 英寸宽。
...
10. 将 FullName 字段拖到该文本框，将其置于您在步骤 9 中键入的文本之后，然后键入一个逗号 (,)。
     ...
     ![添加“全名”字段](../../2014/tutorials/media/tutorial-addfullnamefield.png "添加“全名”字段")
...
22. 突出显示 "销售额" 字段，右键单击该字段，然后单击 "**表达式**"。
...
24. [!INCLUDE[clickOK](../includes/clickok-md.md)]
     ...
     ![向 sales 字段添加表达式](../../2014/tutorials/media/tutorial-addexpressiontosalesfield.png "向 sales 字段添加表达式")
...
4.  在 "排列图表字段" 页上，将 "Product" 字段拖到 "**类别**"。
...
1.  单击你在本课程前面部分添加的矩形。
     ...
     ![矩形名称](../../2014/tutorials/media/tutorial-rectanglename.png "矩形名称")

2.  单击饼图。

3.  在 "**属性**" 窗格中，确认`Parent`属性包含矩形的名称。

     ![饼图父属性](../../2014/tutorials/media/tutorial-piechart-parentproperty.png "饼图父属性")
...
3.  单击 **“运行”** 以预览报表。
 ...
 ![SSRS 教程，自由格式报告](../../2014/tutorials/media/tutorial-reportfinal.png "SSRS 教程，自由格式报告")
...
## <a name="see-also"></a>另请参阅
 [SQL Server 2014 中](report-builder/report-builder-in-sql-server-2016.md)[报表生成器&#41;报表生成器教程 &#40;](report-builder-tutorials.md)
