...
## <a name="see-also"></a>另请参阅
 <xref:ReportExecution2005.ReportExecutionService.Render%2A>[使用 REPORTING SERVICES SOAP 标头](../report-server-web-service-net-framework-soap-headers/using-reporting-services-soap-headers.md) [&#40;SSRS&#41;的技术参考](../../../2014/reporting-services/technical-reference-ssrs.md)
