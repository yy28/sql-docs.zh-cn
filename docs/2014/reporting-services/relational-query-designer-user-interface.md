...
>  [!INCLUDE[ssDWfull](../includes/ssdwfull-md.md)] 不支持存储过程或表值函数。  
 ...
 ![用于查询的图形设计器](../analysis-services/media/rsqd-relational-graphical.gif "用于查询的图形设计器")  
  
 下图显示了用于存储过程或表值函数的图形查询设计器。  
  
 ![图形查询设计器中的存储过程](../analysis-services/media/rs-relational-graphical-sp.gif "图形查询设计器中的存储过程")  
...
#### <a name="group-and-aggregate"></a>分组和聚合  
 ...
 [!INCLUDE[ssDWfull](../includes/ssdwfull-md.md)] 使用 [!INCLUDE[tsql](../includes/tsql-md.md)]，[!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssDWfull](../includes/ssdwfull-md.md)] 使用 [!INCLUDE[DWsql](../includes/dwsql-md.md)]。 SQL 语言的这两种分支都支持查询设计器提供的子句、关键字和聚合。  
...
###  <a name="relationships-pane"></a><a name="Relationships"></a>关系窗格  
