...
## <a name="wmi-provider-overview"></a>WMI 提供程序概述  
 用于获取本主题中所示代码示例中的 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 的相关信息的命名空间为 **** 中的 System.Management 命名空间[!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)]。 System.Management 命名空间提供一组托管代码类，** 应用程序可通过这些类访问和操作管理信息**[!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)]。 有关使用采用 System.Management 命名空间的 Reporting Services WMI 类的详细信息，请参阅 **** SDK 中的“使用 System.Managment 访问管理信息”[!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)]。  
