...
2.  [使用新的表或矩阵向导组织数据并选择布局和样式](#Groups)  
...
1.  单击 **“开始”**，依次指向 **“程序”**、 **Microsoft SQL Server 2012 Report Builder**，再单击 **“报表生成器”**。  
    ...
    > [!NOTE]  
    >  此时应显示 **“入门”** 对话框。 如果没有，请单击 "报表生成器" 按钮，单击 "**新建**"。  
...
4.  将 "产品 **" 拖到 "列组"，** 然后将其置于子类别下。  
  
     字段在**列组**中的列出顺序定义组层次结构。  
...
2.  单击表体顶部包含 "**单击以添加标题**" 的文本框，然后按 Delete 键。  
  
3.  在功能区的 "**插入**" 选项卡上，单击 "**页眉**"，然后单击 "**添加标头**"。  
...
8.  在 "**字体**" 列表中，选择 " **New Roman**";**大小**选择**24 pt**，在 "**颜色**" 中选择 "**褐紫红色**"，在 "**样式**" 中选择 "**斜体**"。  
...
3.  在 "属性" 窗格中，找到 "WritingMode" 属性，然后在其下拉列表中选择 " **Rotate270**"。  
  
     如果“属性”窗格未打开，请单击功能区的“视图”**** 选项卡，然后选择“属性”****。  
  
4.  验证 CanGrow 属性是否设置为`True`。  
