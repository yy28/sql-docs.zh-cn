...
2.  如果尚未打开 "属性" 窗格，请在 "**视图**" 选项卡上选择 "**属性**"。  
  
3.  双击饼图本身。 饼图的序列属性将会显示在“属性”窗格中。  
  
4.  在“属性”窗格中，展开 **CustomAttributes** 节点。  
  
5.  将**PieDrawingStyle**设置为**SoftEdge**。  
  
    > [!NOTE]  
    >  绘图效果和三维效果是相互排斥的选项。 如果图表应用了三维效果，则 "属性" 窗格上的 " **PieDrawingStyle** " 不可用。  
...
3.  选择 **"摄像机和摄像机销售**"，然后在功能区的 "**主页**" 选项卡的 "**字体**" 部分中单击 "**粗体**" 按钮。  
  
4.  选择 "**按总销售额的百分比**"，然后在 "**主页**" 选项卡的 "**字体**" 部分中，将字号设置为**10**。  
