 ...
 **<sup>2</sup>**[power BI q&a： 优化的 Power BI 工作簿 （云建模）](https://support.office.com/article/Power-BI-Q-A-Optimize-a-Power-BI-workbook-cloud-modeling--96dc5941-d0f1-44e2-9d9d-c038a3a55849?ui=en-US&rs=en-US&ad=US)。    
  
 **<sup>3</sup>**[介绍适用于 Office 365 的 Power View 中的功能的新预测](http://blogs.msdn.com/b/powerbi/archive/2014/05/08/introducing-new-forecasting-capabilities-in-power-view-for-office-365.aspx)。    
 ...
 **<sup>2</sup>**[PowerPivot 工作簿作为数据源  ](http://blogs.technet.com/b/excel_services__powerpivot_for_sharepoint_support_blog/archive/2013/02/15/powerpivot-workbook-as-a-data-source.aspx)  
  
 **<sup>3</sup>**[跨商业智能 (BI) 工具的移动支持](http://msdn.microsoft.com/library/dn151146\(v=sql.110\).aspx)并[规划 Reporting Services 和 Power View 浏览器支持 (Reporting Services 2014)](http://msdn.microsoft.com/library/ms156511.aspx)。    
...
-   [Microsoft BI 报告和分析工具简介](http://go.microsoft.com/fwlink/p/?LinkId=617093)  
