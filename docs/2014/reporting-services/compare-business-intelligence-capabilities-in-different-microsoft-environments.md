...
|利用基于行的 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 多维数据集的安全性|用户帐户控制|否|否|  
...
|Excel 工作薄，其中 [!INCLUDE[ssGemini](../includes/ssgemini-md.md)] 作为数据源 **<sup>2</sup>**|用户帐户控制|否|否|  
...
-   [Microsoft BI 报告和分析工具简介](https://go.microsoft.com/fwlink/p/?LinkId=617093)  
