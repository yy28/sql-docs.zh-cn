---
title: 什么&#39;Report Builder for SQL Server 2014 中的 |Microsoft 文档
ms.custom: ''
ms.date: 05/24/2017
...
ms.locfileid: "36137912"
---
# <a name="what39s-new-in-report-builder-for-sql-server-2014"></a>什么&#39;Report Builder for SQL Server 2014 中的
  [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 引入了许多 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 功能。  
  
 有关此版本中，其他功能信息[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]产品和技术，请参阅[What's New in SQL Server 2014](../sql-server/what-s-new-in-sql-server-2016.md)。  
  
> [!TIP]  
>  有关最新信息和有关此版本中的新功能的资源，请参阅[最新信息在 SQL Server Reporting Services (SSRS) 的其他信息](http://go.microsoft.com/fwlink/?LinkId=207147)。  
  
##  <a name="ExcelRenderer"></a> Excel 呈现器中以便用于 Microsoft Excel 2007-2010年和 Microsoft Excel 2003  
...
##  <a name="WordRenderer"></a> 为 Microsoft Word 2007-2010年和 Microsoft Word 2003 Word 呈现器  
