 ...
 **启用特别报告**  
 ...
 关闭此选项可缓解恶意用户通过重载与报表服务器启动拒绝服务攻击的凭此威胁`LoadReportDefinition`请求。  
...
## <a name="see-also"></a>请参阅  
 ...
 [指定凭据和报表数据源的连接信息](../report-data/specify-credential-and-connection-information-for-report-data-sources.md[报表服务器中管理 Studio F1 帮助](report-server-in-management-studio-f1-help.md)  
