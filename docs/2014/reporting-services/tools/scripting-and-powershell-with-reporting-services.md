...
ms.locfileid: "36027585"
---
# <a name="scripting-and-powershell-with-reporting-services"></a>脚本编写和带 Reporting Services 的 PowerShell
  [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] 支持范围广泛的开发和管理方案通过脚本，包括 rs.exe 命令行实用工具、 适用于 SharePoint 模式报表服务器，PowerShell cmdlet 和利用[!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)]从这两个本机的 PowerShell 对象模型和SharePoint 模式。  
