...
> [!IMPORTANT]  
>  当[!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]运行作为 RemoteApp，报表不显示在**预览**中查看[!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]。 RemoteApp 程序是通过远程桌面服务进行远程访问的程序。 有关详细信息，请参阅[TS RemoteApp 分步指南](http://technet.microsoft.com/library/cc730673\(WS.10\).aspx)。  
