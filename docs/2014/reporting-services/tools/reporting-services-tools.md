...
|PowerShell Cmdlet|使用 PowerShell cmdlet 可为 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]创建、查询和管理共享服务应用程序。<br /><br /> 有关详细信息，请参阅[Reporting Services SharePoint 模式的 PowerShell cmdlet](../powershell-cmdlets-for-reporting-services-sharepoint-mode.md)。|SharePoint 2010 Management Shell|  
...
|工具|Description|如何访问|  
|----------|-----------------|-------------------|  
|报表服务器 Web 服务 URL|使用此工具可在一般的项导航页中浏览报表目录中的内容。<br /><br /> 有关详细信息，请参阅[报表服务器 Web 服务](../report-server-web-service/report-server-web-service.md)。|浏览者|  
