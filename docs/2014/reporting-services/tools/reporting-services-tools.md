...
# <a name="reporting-services-tools"></a>Reporting Services 工具
 ...
 若要立即找到一种工具，请参阅[教程：如何查找并启动 Reporting Services 工具&#40;SSRS&#41;](tutorial-how-to-locate-and-start-reporting-services-tools-ssrs.md)。  
...
|工具|Description|如何访问|  
|----------|-----------------|-------------------|  
|[!INCLUDE[ssCrescent](../../includes/sscrescent-md.md)]|交互式数据浏览和直观显示体验，为使您可基于 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 表格模型创建报表和与报表交互而专门设计。<br /><br /> 注意：要求 SharePoint 模式下的 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]。|具有 Silverlight 的浏览器。|  
