...
## <a name="tools-for-report-server-administration"></a>用于报表服务器管理的工具  
 一组图形和脚本工具可用于管理中[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]的 Report Server。 您使用的工具取决于您的报表服务器的部署模式。  
...
## <a name="tools-for-report-content-management"></a>用于报表内容管理的工具  
 提供了一组图形和脚本编写工具来管理中[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]的内容。 您使用的工具取决于您的报表服务器的部署模式。  
