---
title: 配置和管理报表服务器（SharePoint 模式 Reporting Services） |Microsoft Docs
ms.custom: ''
ms.date: 11/25/2019
...
# <a name="configuration-and-administration-of-a-report-server-reporting-services-sharepoint-mode"></a>配置和管理报表服务器（Reporting Services SharePoint 模式）
  [!INCLUDE[msCoName](../includes/msconame-md.md)][!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]是一种基于服务器的报表平台，它提供了各种现成可用的工具和服务，可帮助您创建、部署和管理组织的报表，以及使您能够扩展和自定义报表功能的编程[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]功能。 您可以将您的报表环境与 SharePoint 产品相集成，体验使用 SharePoint 站点提供的协作环境所带来的好处。  
...
-   SharePoint 文档库中的菜单选项  
    ...
    -   [创建和管理 SharePoint 模式报表服务器的订阅](subscriptions/create-and-manage-subscriptions-for-sharepoint-mode-report-servers.md)  
  
    -   [从 SharePoint 站点更新报表数据源中的凭据](report-data/update-credentials-in-report-data-sources-from-a-sharepoint-site.md)  
    ...
    -   [在 SharePoint 集成模式下 &#40;Reporting Services 设置处理选项&#41;](../../2014/reporting-services/set-processing-options-reporting-services-in-sharepoint-integrated-mode.md)  
