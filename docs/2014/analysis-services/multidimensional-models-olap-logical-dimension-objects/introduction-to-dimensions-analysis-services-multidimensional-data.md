...
## <a name="dimension-based-on-a-star-schema-design"></a>基于星型架构设计的维度  
 ...
 ![事实维度关系的逻辑架构](../../../2014/analysis-services/dev-guide/media/dimfactrelationship.gif "逻辑架构事实维度关系")  
...
## <a name="dimension-based-on-a-snowflake-schema-design"></a>基于雪花型架构设计的维度  
 ...
 ![为 AdventureWorksAS 产品维度表](../../../2014/analysis-services/dev-guide/media/dimproduct.gif "AdventureWorksAS 产品维度的表")  
...
## <a name="snowflake-schema-versus-reference-relationship"></a>雪花型架构与引用关系  
 ...
 ![示例引用维度的逻辑架构](../../../2014/analysis-services/dev-guide/media/dimindirect.gif "逻辑架构示例引用的维度")  
...
## <a name="security"></a>Security  
 维度的所有从属对象（包括层次结构、级别以及成员）都使用 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 中的角色进行保护。 维度安全性可应用于数据库中使用该维度的所有多维数据集，或者只应用于特定的多维数据集。 有关维度安全性的详细信息，请参阅[授予维度的权限&#40;Analysis Services&#41;](../multidimensional-models/grant-permissions-on-a-dimension-analysis-services.md)。  
