---
title: 使用 Windows PowerShell 的 PowerPivot 配置 |Microsoft 文档
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="view-a-list-of-the-powerpivot-cmdlets-on-a-server"></a>查看服务器上 PowerPivot Cmdlet 的列表  
 若要查看内容和示例的[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]cmdlet，请参阅[PowerPivot for SharePoint 的 PowerShell 参考](/sql/analysis-services/powershell/powershell-reference-for-power-pivot-for-sharepoint)。  
