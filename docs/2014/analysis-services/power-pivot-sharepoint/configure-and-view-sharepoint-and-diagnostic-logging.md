...
##  <a name="log-file-location"></a><a name="bkmk_filelocation"></a>日志文件位置  
...
##  <a name="modify-diagnostic-logging-levels-for-individual-event-categories"></a><a name="bkmk_modifyloglevels"></a>修改各个事件类别的诊断日志记录级别  
