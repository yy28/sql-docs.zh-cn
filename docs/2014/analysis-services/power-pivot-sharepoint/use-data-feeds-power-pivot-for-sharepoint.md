...
##  <a name="rsreport"></a>从 Reporting Services 报表创建数据馈送  
 ...
 有关如何从报表导出数据馈送的说明，请参阅[报表生成器帮助文件](../../reporting-services/report-builder/generate-data-feeds-from-a-report-report-builder-and-ssrs.md)中的[基于报表生成数据馈送（报表生成器和 SSRS）](https://go.microsoft.com/fwlink/?LinkId=154494)。  
...
5.  指定一个或多个提供馈送的 URL：  
    ...
    1.  **基 URL**是可选的。 如果数据服务文档提供多个馈送，则应该指定此选项。 基本 URL 应该指定所有馈送共有的 URL 部分（例如服务器名称和站点）。 如果按照 Reporting Services 报表创建数据服务文档，则基本 URL 将是报表服务器 URL 和报表。  
