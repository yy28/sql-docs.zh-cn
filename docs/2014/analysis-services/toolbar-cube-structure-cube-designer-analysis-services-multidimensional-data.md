...
|**隐藏表**|单击此项可隐藏 **“数据源视图”** 窗格中所选的表。<br /><br /> 注意：如果在未选择任何表，将禁用此选项**数据源视图**窗格。|  
|**查找表**|单击此项可显示 **“查找表”** 对话框，并在 **“数据源视图”** 窗格中查找表。|  
|**缩放**|单击此项可循环显示 **“数据源视图”** 窗格的缩放百分比选项，或为该窗格选择一个可用的缩放百分比选项。|  
|**显示**|单击此项可循环显示以下选项，或选择其中任一个选项以更改 **“数据源视图”** 窗格的视图：<br /><br /> **树视图**：在一个树视图中显示表、命名查询、列、命名计算和关系。<br /><br /> **关系图视图**：在一个数据库关系图中显示表、命名查询、列、命名计算和关系。|  
