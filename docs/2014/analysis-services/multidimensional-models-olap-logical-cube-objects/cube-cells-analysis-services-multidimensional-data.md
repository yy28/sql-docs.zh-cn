...
# <a name="cube-cells-analysis-services---multidimensional-data"></a>多维数据集单元（Analysis Services - 多维数据）
 ...
 ![标识单个单元的多维数据集关系图](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-cubeintro5.gif "标识单个单元的多维数据集关系图")  
...
-   包成员。  
 ...
 ![“下半年”成员的“第三季度”和“第四季度”单元](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-cubeintro6.gif "“下半年”成员的“第三季度”和“第四季度”单元")  
...
## <a name="empty-cells"></a>空单元  
 ...
 ![标识空单元的多维数据集关系图](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-cubeintro7.gif "标识空单元的多维数据集关系图")  
