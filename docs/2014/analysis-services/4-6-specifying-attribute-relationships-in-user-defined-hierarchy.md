...
## <a name="next-task-in-lesson"></a>课程中的下一个任务  
 [定义未知成员和 Null 处理属性](https://docs.microsoft.com/analysis-services/lesson-4-7-defining-the-unknown-member-and-null-processing-properties)  
