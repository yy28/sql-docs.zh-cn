...
ms.locfileid: "36313265"
---
# <a name="data-mining-tutorials-analysis-services"></a>数据挖掘教程 (Analysis Services)
  [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 可以轻松创建复杂的数据挖掘解决方案。 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 中的工具帮助您设计、创建和管理使用关系数据或多维数据集数据的数据挖掘模型。 您可以管理对数据挖掘模型的客户端访问并从多个客户端创建预测查询。  
...
-   [中间数据挖掘教程&#40;Analysis Services-数据挖掘&#41;](../tutorials/intermediate-data-mining-tutorial-analysis-services-data-mining.md)  
...
## <a name="see-also"></a>请参阅  
 ...
 [Microsoft SQL Server 数据挖掘的资源](http://go.microsoft.com/fwlink/?LinkId=97965)   
