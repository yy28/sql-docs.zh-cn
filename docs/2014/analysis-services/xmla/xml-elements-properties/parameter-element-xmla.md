...
ms.locfileid: "36125222"
---
# <a name="parameter-element-xmla"></a>Parameter 元素 (XMLA)
  包含的名称和使用的参数的值[执行](../xml-elements-methods-execute.md)方法。  
...
## <a name="remarks"></a>Remarks  
 一些 XML Analysis (XMLA) 命令，如[过程](../xml-elements-commands/process-element-xmla.md)命令，也可以要求的其他信息。 `Parameter` 元素可提供一种机制，从而为 XMLA 命令提供附加信息，包括成块信息。  
