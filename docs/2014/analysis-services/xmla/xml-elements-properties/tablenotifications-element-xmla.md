...
ms.locfileid: "36025514"
---
# <a name="tablenotifications-element-xmla"></a>TableNotifications 元素 (XMLA)
  包含一套[TableNotification](tablenotification-element-xmla.md)所使用的元素[NotifyTableChange](../xml-elements-commands/notifytablechange-element-xmla.md)命令。  
