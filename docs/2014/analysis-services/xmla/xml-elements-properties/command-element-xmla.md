...
ms.locfileid: "36027072"
---
# <a name="command-element-xmla"></a>Command 元素 (XMLA)
  包含要执行的命令[执行](../xml-elements-methods-execute.md)方法。  
