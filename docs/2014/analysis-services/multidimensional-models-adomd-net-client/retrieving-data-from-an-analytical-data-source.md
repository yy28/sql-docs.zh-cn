...
|------------|-------------------|--------------|----------------------------|-----------------------|  
|<xref:Microsoft.AnalysisServices.AdomdClient.CellSet>|最高|比较高，这会导致最慢的数据检索速度|用户帐户控制|[使用 CellSet 检索数据](retrieving-data-using-the-cellset.md)|  
...
|<xref:System.Xml.XmlReader>|最低|最低，这会导致最快的数据检索速度|用户帐户控制|[使用 XmlReader 检索数据](retrieving-data-using-the-xmlreader.md)|  
