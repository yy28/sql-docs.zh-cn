---
title: 成员筛选对话框 (Analysis Services-多维数据) |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|术语|定义|  
|----------|----------------|  
|**筛选器表达式**|显示一个网格，其中包含用于构造筛选表达式的属性、运算符和值。 请注意，添加一行之后，无法删除该行。 必须关闭并重新打开该对话框，才可指定新的筛选表达式。 该网格包含以下列：<br /><br /> “属性”：选择要用于筛选表达式的成员的属性。<br /><br /> “运算符”：选择要用于筛选表达式的运算符。<br /><br /> “值”：键入“属性”中所选属性的值，以使用在“运算符”中指定的运算符进行计算。|  
|**测试窗格**|单击 **“测试”** 时，此窗格将显示筛选表达式所返回的成员。 如果使用在 **“筛选表达式”** 中指定的条件没有返回任何成员，则会显示警告。|  
|**测试**|单击此项可以测试在 **“筛选表达式”** 中指定的条件。|  
