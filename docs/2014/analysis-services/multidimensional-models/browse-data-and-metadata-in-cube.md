...
-   在 "**筛选器**" 窗格的 "**维度**" 列中，单击 **\<Select dimension>** 并从列表中选择一个维度，然后 **\<Select hierarchy>** 在 "**层次结构**" 列中单击并从列表中选择一个层次结构。  
  
 指定层次结构后，指定运算符和筛选表达式。 下表介绍了各个运算符和筛选表达式。  
  
|运算符|筛选表达式|说明|  
|--------------|-----------------------|-----------------|  
|Equal|一个或多个成员|值必须等于指定的成员。<br /><br /> （为属性层次结构提供多个成员选择，但是父子层次结构除外，为其他层次结构提供单个成员选择。）|  
|Not Equal|一个或多个成员|值必须不等于指定的成员。<br /><br /> （为属性层次结构提供多个成员选择，但是父子层次结构除外，为其他层次结构提供单个成员选择。）|  
|在|一个或多个命名集|值必须在指定的命名集中。<br /><br /> （仅支持属性层次结构。）|  
