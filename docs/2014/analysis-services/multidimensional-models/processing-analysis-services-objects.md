...
##  <a name="processing-a-database"></a><a name="bkmk_procdb"></a> 处理数据库  
...
##  <a name="processing-a-cube"></a><a name="bkmk_proccube"></a> 处理多维数据集  
...
##  <a name="processing-a-measure-group"></a><a name="bkmk_procmeasure"></a>处理度量值组  
...
##  <a name="processing-a-partition"></a><a name="bkmk_procpartition"></a>处理分区  
...
##  <a name="processing-data-mining-structures-and-models"></a><a name="bkmk_procdm"></a> 处理数据挖掘结构和模型  
