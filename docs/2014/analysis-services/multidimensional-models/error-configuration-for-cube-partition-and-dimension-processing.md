...
##  <a name="default-behaviors"></a><a name="bkmk_default"></a>默认行为  
...
##  <a name="error-configuration-properties"></a><a name="bkmk_props"></a>错误配置属性  
...
##  <a name="where-to-set-error-configuration-properties"></a><a name="bkmk_tools"></a>在何处设置错误配置属性  
