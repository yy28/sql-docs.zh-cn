...
# <a name="understanding-microsoft-olap-architecture"></a>了解 Microsoft OLAP 体系结构
 ...
 [服务器对象&#40;Analysis Services 多维数据&#41;](../olap-logical/server-objects-analysis-services-multidimensional-data.md)  
 ...
 [多维数据&#40;集对象 Analysis Services 多维数据&#41;](../../multidimensional-models-olap-logical-cube-objects/cube-objects-analysis-services-multidimensional-data.md)  
  
 [更多信息...](../olap-logical/understanding-microsoft-olap-logical-architecture.md)  
  
 ![小文件文件夹图标](../../../integration-services/media/filefolder-small.gif "小文件文件夹图标")**物理体系结构**  
 [OLAP 引擎服务器组件](olap-engine-server-components.md)  
  
 [本地多维&#40;数据集 Analysis Services 多维数据&#41;](local-cubes-analysis-services-multidimensional-data.md)  
