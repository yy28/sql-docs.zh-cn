...
-   向 Analysis Services 实例发送操作命令（如 `Create`、`Alter` 或 `Process`）的命令语言。 此命令语言述[XML for Analysis &#40;XMLA&#41;引用](../../xmla/xml-for-analysis-xmla-reference.md)。  
