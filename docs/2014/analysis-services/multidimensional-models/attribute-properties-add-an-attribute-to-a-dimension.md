...
# <a name="add-an--attribute-to-a-dimension"></a>向维度中添加属性
 ...
 若要手动创建属性，请将 **“属性”** 窗格设置为网格视图。 在网格中最后一行的 "名称" 列中，单击 " ** \<新建属性">** 项。 为新属性键入名称。 这样便可创建未映射到列的特性，并且该特性的所有属性都具有默认设置。 在 **的** “属性” [!INCLUDE[ssBIDevStudio](../../includes/ssbidevstudio-md.md)] 窗口中，您可以通过配置新特性的 **KeyColumns** 属性来设置映射。  
