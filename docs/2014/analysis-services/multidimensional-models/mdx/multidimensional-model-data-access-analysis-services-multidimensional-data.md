...
##  <a name="client-applications"></a><a name="bkmk_clientapps"></a>客户端应用程序  
...
##  <a name="query-languages"></a><a name="bkmk_querylang"></a>查询语言  
...
##  <a name="programmatic-interfaces"></a><a name="bkmk_api"></a>编程接口  
