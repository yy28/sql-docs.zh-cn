...
|**\\**|显示格式字符串中的下一个字符。<br /><br /> 若要将具有特殊含义的字符显示为文字字符，请在该字符前加上一个反斜杠 (**\\**)。 反斜杠本身不显示。 使用反斜杠与将下一个字符放在双引号中的作用是相同的。 若要显示反斜杠，请使用两个反斜杠 (**\\\\**)。 不能显示为文字字符的字符示例包括下列字符：<br /><br /> 日期格式和时间格式的字符—**a**、 **c**、 **d**、 **h**、 **m**、 **n**、 **p**、 **q**、 **s**、 **t**、 **w**、 **y**、 **/** 和 **:**<br /><br /> 数值格式的字符—**#**、 **0**、 **%**、 **E**、 **e**、 **逗号**和 **句点**<br /><br /> 字符串格式的字符—**@**、 **&**、 **\<**、 **>** 和 **!**|  
