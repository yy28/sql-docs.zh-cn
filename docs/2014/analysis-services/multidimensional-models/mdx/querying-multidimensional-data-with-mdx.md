...
> [!NOTE]  
>  有关详细信息，请参阅其他资源部分[SQL Server 2005 – Analysis Services](http://go.microsoft.com/fwlink/?LinkId=80853) Microsoft TechNet 网站上的页。 有关与 MDX 查询和计算相关的性能问题的详细信息，请参阅 [SQL Server 2005 Analysis Services 性能指南](http://go.microsoft.com/fwlink/?LinkId=81621)中的“编写有效的 MDX”。  
