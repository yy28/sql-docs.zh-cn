...
> [!NOTE]  
>  详细信息，请参阅其他资源部分上[SQL Server 2005-Analysis Services](https://go.microsoft.com/fwlink/?LinkId=80853) Microsoft TechNet 网站上的页。 有关与 MDX 查询和计算相关的性能问题的详细信息，请参阅"编写有效的 MDX"一节中[SQL Server 2005 Analysis Services 性能指南](https://go.microsoft.com/fwlink/?LinkId=81621)。  
