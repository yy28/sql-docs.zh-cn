...
## <a name="restoring-databases-using-xmla"></a>使用 XMLA 还原数据库  
 使用 XMLA Restore 命令，可基于 .abf 文件运行还原，从而实现还原过程的自动化。 Restore 命令具有许多属性，可设置这些属性以指定安全性定义、应存储远程分区的位置以及 OLAP (ROLAP) 关系对象的重定位。 有关详细信息，请参阅[还原元素&#40;XMLA&#41;](../xmla/xml-elements-commands/restore-element-xmla.md)。  
