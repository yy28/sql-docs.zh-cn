...
##  <a name="choose-a-data-provider"></a><a name="bkmk_provider"></a>选择数据访问接口  
...
##  <a name="set-credentials-and-impersonation-options"></a><a name="bkmk_impersonation"></a>设置凭据和模拟选项  
...
##  <a name="create-a-data-source-using-the-data-source-wizard"></a><a name="bkmk_steps"></a>使用数据源向导创建数据源  
...
##  <a name="view-or-edit-connection-properties"></a><a name="bkmk_ConnectionString"></a>查看或编辑连接属性  
...
##  <a name="add-multiple-data-sources-to-a-model"></a><a name="bkmk_multipleDS"></a>将多个数据源添加到模型  
