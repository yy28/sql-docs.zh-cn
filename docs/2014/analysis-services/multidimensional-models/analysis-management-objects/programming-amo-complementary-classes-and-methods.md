...
3.  根据需要启动和停止跟踪。  
     ...
     即使在停止跟踪之后，跟踪还会存在于服务器中，如果跟踪定义为 AutoRestart=`true`，则跟踪还会重新启动。  
