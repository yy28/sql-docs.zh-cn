...
3.  将操作添加到多维数据集集合，并更新多维数据集。 操作是一个不可更新对象。  
 ...
 测试操作需要另一个编程应用程序。 可以在 [!INCLUDE[ssBIDevStudioFull](../../../includes/ssbidevstudiofull-md.md)] 中测试操作。 首先，必须安装[!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)]示例，请参阅[多维模型对象处理](../processing-a-multidimensional-model-analysis-services.md)。  
...
|OnlineMode|MOLAP 图像何时可用。<br /><br /> 可以是`Immediate`或`OnCacheComplete`。|  
