 ...
 **Power View 字段列表中的度量值组**  
 ...
 ![Power View 中的字段列表](../media/daxmd-powerviewfieldlist.gif "Power View 中的字段列表")  
 ...
 **SSDT 和 Power View 字段列表中的维度属性地理类型**  
 ...
 ![维度特性地理类型](../media/daxmd-ssdt-attribute-geog-types.gif "维度特性地理类型")  
...
## <a name="perspectives-and-translations"></a>透视和翻译  
 ...
 多维数据集可以具有元数据和为模型内各种语言指定的数据翻译。 若要查看翻译（数据和元数据），需要在 .RSDS 文件中将可选的 "区域设置标识符" 属性添加到连接字符串，如下所示。  
