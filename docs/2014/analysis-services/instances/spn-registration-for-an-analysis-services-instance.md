...
##  <a name="when-spn-registration-is-required"></a><a name="bkmk_scnearios"></a> 在需要 SPN 注册时  
...
##  <a name="spn-format-for-analysis-services"></a><a name="bkmk_SPNSyntax"></a>Analysis Services 的 SPN 格式  
...
##  <a name="spn-registration-for-a-domain-account"></a><a name="bkmk_domain"></a>域帐户的 SPN 注册  
...
##  <a name="spn-registration-for-a-named-instance"></a><a name="bkmk_spnNamed"></a>命名实例的 SPN 注册  
...
##  <a name="spn-registration-for-ssas-instances-configured-for-http-access"></a><a name="bkmk_spnHTTP"></a> 针对为 HTTP 访问配置的 SSAS 实例的 SPN 注册  
...
##  <a name="spn-registration-for-ssas-instances-listening-on-fixed-ports"></a><a name="bkmk_spnFixedPorts"></a>针对在固定端口上侦听的 SSAS 实例的 SPN 注册  
