...
-   [使用 SQL Server Management Studio (SSMS) 连接](#bkmk_SSMS)  
...
-   [MDX &#40;Analysis Services 连接类型&#41;](../../reporting-services/report-data/analysis-services-connection-type-for-mdx-ssrs.md)  
