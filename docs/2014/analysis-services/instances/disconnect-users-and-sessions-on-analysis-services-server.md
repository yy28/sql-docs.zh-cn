...
2.  按 F5 执行取消命令。  
 ...
 有关本主题中引用的 XMLA 的详细信息，请参阅[执行方法 (XMLA)](../xmla/xml-elements-methods-execute.md) 和[取消元素 (XMLA)](../xmla/xml-elements-commands/cancel-element-xmla.md)。  
