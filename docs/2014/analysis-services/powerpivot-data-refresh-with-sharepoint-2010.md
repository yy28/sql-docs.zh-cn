 ...
 **您是否在使用凭据选项 3，以便使用 Secure Store Service 目标应用程序来提供用来运行数据刷新作业的用户身份？**  
...
## <a name="see-also"></a>另请参阅  
 ...
 [配置专用数据刷新或仅限查询的处理 &#40;PowerPivot for SharePoint&#41;](configure-dedicated-data-refresh-query-only-processing-powerpivot-sharepoint.md)   
