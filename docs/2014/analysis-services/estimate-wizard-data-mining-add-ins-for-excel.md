---
title: 估计向导 （数据挖掘外接程序 excel） |Microsoft 文档
ms.custom: ''
ms.date: 12/29/2017
 ...
 **估计**向导帮助您创建估算模型。 估计模型从数据中提取模式，并使用这些模式预测将影响结果的因素。  
...
2.  在**选择源数据**对话框框中，选择要使用的源数据。 你可以在 Excel 中使用数据**表**，Excel**数据范围**，或从**外部数据源**。  
  
     如果使用外部数据源，您可以创建自定义视图或查询并将其另存为 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 数据源。  
  
3.  在**估计**对话框中，选择**用于分析的列**。  
...
5.  **估计**向导会选择数据集的最佳算法。 不过，您可以单击**参数**以打开**算法参数**对话框，并设置高级选项。  
  
6.  如果你的数据是数值，并且你可以使用 Microsoft 线性回归方法，你可以检查**回归量**知道 （或强怀疑） 的任何数值列的框中有对应关系的可预测的值。  
...
7.  上**将数据拆分为定型集和测试集**页上，指定是否想要创建用于测试的数据的一小部分。  
  
8.  上**完成**页上，提供新的挖掘结构和挖掘模式下，名称或接受提供的默认名称。  
...
-   Microsoft Neural 网络算法  
 ...
 在**算法参数**对话框中，你可以设置其他高级的选项，具体取决于哪种算法中，你将选择。 有关每种算法的选项的信息，请参阅 SQL Server 联机丛书中的下列主题：  
...
## <a name="see-also"></a>请参阅  
 ...
 [决策树图演练&#40;数据挖掘外接程序&#41;](decision-tree-diagram-walkthrough-data-mining-add-ins.md)  
