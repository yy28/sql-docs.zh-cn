...
###  <a name="NodeScore"></a> 节点分数  
 ...
 有多种方式计算拆分分数，具体选择哪种方式取决于您选择的算法参数。 有关如何针对每种评分方法计算分数的讨论不属于本主题的讨论范围。 有关详细信息，请参阅"[学习 Bayesian 网络：组合的知识和统计数据](https://go.microsoft.com/fwlink/?LinkId=45963)"，然后在[!INCLUDE[msCoName](../../includes/msconame-md.md)]Research Web 站点。  
...
|如果 n > 10|关系可以以公式 2 表示|  
 ...
 有关回归节点的详细信息，请参阅[线性回归模型的挖掘模型内容（Analysis Services - 数据挖掘）](mining-model-content-for-linear-regression-models-analysis-services-data-mining.md)。  
