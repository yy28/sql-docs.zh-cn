...
##  <a name="bkmk_PredQuery"></a>基本预测查询设计  
...
###  <a name="bkmk_BatchQuery"></a>批处理预测查询  
...
-   *替换模型事例*意味着保留训练的模型，但将基础事例替换为一组新的事例数据。 如果您希望保留模型中的趋势但将其应用到不同的一组数据，则此选项很有用。  
...
##  <a name="bkmk_WorkResults"></a>使用预测查询的结果  
