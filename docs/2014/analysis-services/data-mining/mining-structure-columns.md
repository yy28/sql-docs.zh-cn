...
|介绍嵌套表的概念，并说明如何将嵌套表作为挖掘结构列添加到数据源。|[分类列&#40;数据挖掘&#41;](classified-columns-data-mining.md)|  
...
|说明已分类列，可以使用这种特殊列类型将一个挖掘结构列与另一个挖掘结构列关联。|[分类列&#40;数据挖掘&#41;](classified-columns-data-mining.md)|  
