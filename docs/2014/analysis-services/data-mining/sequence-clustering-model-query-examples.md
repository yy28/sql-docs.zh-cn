...
##  <a name="finding-information-about-the-sequence-clustering-model"></a><a name="bkmk_ContentQueries"></a>查找有关顺序分析和聚类分析模型的信息  
...
###  <a name="sample-query-1-using-the-data-mining-schema-rowset-to-return-model-parameters"></a><a name="bkmk_Query1"></a>示例查询1：使用数据挖掘架构行集返回模型参数  
...
###  <a name="sample-query-2-getting-a-list-of-sequences-for-a-state"></a><a name="bkmk_Query2"></a>示例查询2：获取状态的序列列表  
...
###  <a name="sample-query-3-using-system-stored-procedures"></a><a name="bkmk_Query3"></a>示例查询3：使用系统存储过程  
...
###  <a name="sample-query-4-predict-next-state-or-states"></a><a name="bkmk_Query4"></a>示例查询4：预测下一状态或状态  
