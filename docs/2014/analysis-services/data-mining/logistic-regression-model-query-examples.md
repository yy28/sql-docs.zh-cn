...
##  <a name="getting-information-about-the-logistic-regression-model"></a><a name="bkmk_top"></a>获取有关逻辑回归模型的信息  
...
###  <a name="sample-query-1-retrieving-model-parameters-by-using-the-data-mining-schema-rowset"></a><a name="bkmk_Query1"></a>示例查询1：使用数据挖掘架构行集检索模型参数  
...
###  <a name="sample-query-2-finding-additional-detail-about-the-model-by-using-dmx"></a><a name="bkmk_Query2"></a>示例查询2：使用 DMX 查找有关模型的其他详细信息  
...
###  <a name="sample-query-3-making-predictions-for-a-continuous-value"></a><a name="bkmk_Query3"></a>示例查询3：对连续值进行预测  
...
###  <a name="sample-query-4-making-predictions-for-a-discrete-value"></a><a name="bkmk_Query4"></a>示例查询4：对离散值进行预测  
...
> [!NOTE]  
>  对于神经网络模型和逻辑回归模型， [PredictSupport (DMX)](/sql/dmx/predictsupport-dmx) 函数将返回表示整个模型的定型集大小的单个值。  
