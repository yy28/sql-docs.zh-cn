 ...
 **内容查询**  
 ...
 [从数据挖掘架构行集中检索模型参数](#bkmk_Query1)  
  
 [使用 DMX 获取有关模型中的树的详细信息](#bkmk_Query2)  
...
###  <a name="bkmk_Query1"></a>示例查询1：从数据挖掘架构行集中检索模型参数  
...
###  <a name="bkmk_Query2"></a>示例查询2：使用 DMX 返回有关模型内容的详细信息  
...
|NODE_NAME|NODE_CAPTION|T.ATTRIBUTE_NAME|T.ATTRIBUTE_VALUE|支持|  
|----------------|-------------------|-----------------------|------------------------|-------------|  
...
|00000000101|Number Cars Owned = 3|Bike Buyer|1|473|  
 ...
 根据这些结果，你可以判断买了自行车的客户（= 1）`[Bike Buyer]` ，1067的客户有0个汽车，473个客户有3辆车。  
  
###  <a name="bkmk_Query3"></a>示例查询3：从模型中检索子树  
...
###  <a name="bkmk_Query4"></a>示例查询4：返回具有概率的预测  
...
###  <a name="bkmk_Query5"></a>示例查询5：根据决策树模型预测关联  
...
###  <a name="bkmk_Query6"></a>示例查询6：从决策树模型中检索回归公式  
