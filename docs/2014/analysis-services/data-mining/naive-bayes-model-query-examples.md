...
###  <a name="bkmk_Query2"></a>示例查询2：检索定型数据的摘要  
...
###  <a name="bkmk_Query3"></a>示例查询3：查找有关属性的详细信息  
...
###  <a name="bkmk_Query4"></a>示例查询4：使用系统存储过程  
...
###  <a name="bkmk_Query5"></a>示例查询5：使用单独查询预测结果  
...
###  <a name="bkmk_Query6"></a>示例查询6：获取具有概率和支持值的预测  
...
###  <a name="bkmk_Query7"></a>示例查询7：预测关联  
...
|[预测 &#40;DMX&#41;](/sql/dmx/predict-dmx)|返回指定列的一个预测值或一组值。|  
