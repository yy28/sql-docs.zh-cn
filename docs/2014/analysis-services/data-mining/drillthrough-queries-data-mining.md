...
-   钻取到 **结构事例**  
 ...
 [使用 DMX 创建钻取查询](#bkmk_DMX)  
  
 [使用钻取时的注意事项](#bkmk_Considerations)  
...
##  <a name="bkmk_DMX"></a>使用 DMX 创建钻取查询  
...
##  <a name="bkmk_Considerations"></a>使用钻取时的注意事项  
...
|使用 DMX WITH DRILLTHROUGH 子句对挖掘模型启用钻取。|[创建挖掘结构 &#40;DMX&#41;](/sql/dmx/create-mining-structure-dmx)|  
