...
### <a name="lift-chart-with-target-value"></a>带有目标值的提升图  
 下图显示了在 **Basic Data Mining Tutorial** 中创建的[目标邮递](../../tutorials/basic-data-mining-tutorial.md)模型的提升图。 在此图中，目标属性为 [Bike Buyer]，并且目标值为 1，表示预测客户将会购买自行车。 因此，此提升图显示了在标识这些可能的客户时模型提供的改进。  
