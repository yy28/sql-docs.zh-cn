...
## <a name="see-also"></a>另请参阅
 [Microsoft 时序算法](microsoft-time-series-algorithm.md)[时序模型查询示例](time-series-model-query-examples.md) [&#40;Analysis Services 数据挖掘的时序模型的挖掘模型内容&#41;](mining-model-content-for-time-series-models-analysis-services-data-mining.md)
