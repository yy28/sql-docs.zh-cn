---
title: Analysis Services 教程 (SSAS) |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
# <a name="analysis-services-tutorials-ssas"></a>Analysis Services 教程 (SSAS)
 ...
 [Codeplex 上的 AdventureWorks 示例数据库](http://go.microsoft.com/fwlink/?linkID=335807)  
 此链接将您带入 codeplex 下载页面，其中具有适用于 [!INCLUDE[ssSQL14](../includes/sssql14-md.md)] 的 AdventureWorks 示例数据库。  
  
 [以编程方式创建表格模型的 AMO 示例代码](http://go.microsoft.com/fwlink/?linkID=221036)  
 此链接将您带入一个 Codeplex 下载页面，其中具有适用于 [!INCLUDE[ssSQL14](../includes/sssql14-md.md)] 的 AMO 示例。  
  
 [SQL Server 2008 R2 教程](http://go.microsoft.com/fwlink/?linkID=220944)  
...
## <a name="see-also"></a>请参阅  
 ...
 [Picnic 数据集 （示例数据）](http://go.microsoft.com/fwlink/?linkID=219108)  
