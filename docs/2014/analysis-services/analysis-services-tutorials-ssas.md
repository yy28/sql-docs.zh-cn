...
# <a name="analysis-services-tutorials-ssas"></a>Analysis Services 教程 (SSAS)
 ...
 [&#40;艾德作品的表格建模教程&#41;](tabular-modeling-adventure-works-tutorial.md)  
 ...
 [Codeplex 上的 AdventureWorks 示例数据库](https://go.microsoft.com/fwlink/?linkID=335807)  
 此链接将您带入 codeplex 下载页面，其中具有适用于 [!INCLUDE[ssSQL14](../includes/sssql14-md.md)] 的 AdventureWorks 示例数据库。  
  
 [以编程方式创建表格模型的 AMO 示例代码](https://go.microsoft.com/fwlink/?linkID=221036)  
