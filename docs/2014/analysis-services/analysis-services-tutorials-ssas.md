...
# <a name="analysis-services-tutorials-ssas"></a>Analysis Services 教程 (SSAS)
 ...
 此链接将带您到 GitHub 下载页面，该页面具有[!INCLUDE[ssSQL14](../includes/sssql14-md.md)]的 AdventureWorks 示例数据库。  
...
## <a name="see-also"></a>另请参阅  
 [技术网 WIKI： SQL 服务器 2012 示例](https://go.microsoft.com/fwlink/?linkID=220734)   
 [野餐数据集（示例数据）](https://go.microsoft.com/fwlink/?linkID=219108)  
