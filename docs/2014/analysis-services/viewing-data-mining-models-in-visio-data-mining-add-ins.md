---
title: 在 Visio （数据挖掘外接程序） 中查看数据挖掘模型 |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="building-a-model-diagram"></a>生成模型关系图  
 当打开包含 Visio 数据挖掘形状的文件**形状**窗格将显示以下形状。  
...
-   每个关系图类型都具有针对形状的快捷菜单，可用于访问特殊选项。 尽管此菜单中的许多选项是所有 Visio 形状共有的某些选项是唯一的数据挖掘模板  
