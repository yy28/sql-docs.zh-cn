...
|Value|说明|  
|-----------|-----------------|  
|**属性**|从列表中选择输入属性。 如果将选定内容保留为默认值， ** \<所有>**，则图表将显示所有输入属性的列表（按其对可预测属性的影响进行排名）。|  
|**值**|为输入属性选择值。|  
...
|Value|说明|  
|-----------|-----------------|  
|**属性**|显示您在 **“属性”** 中选择的输入属性的名称。|  
|**值**|显示选定输入属性的值。|  
|**优选\<值 1>**|显示一个条形，该条形指示此特定属性-值组合影响“值 1”**** 中选择的目标结果的程度。|  
|**优选\<值 2>**|显示一个条形，该条形指示此特定属性-值组合影响“值 2”**** 中选择的目标结果的程度。|  
