---
title: 处理对话框 (Analysis Services-多维数据) |Microsoft 文档
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="see-also"></a>请参阅  
 ...
 [处理进度对话框&#40;Analysis Services-多维数据&#41;](process-progress-dialog-box-analysis-services-multidimensional-data.md)  
