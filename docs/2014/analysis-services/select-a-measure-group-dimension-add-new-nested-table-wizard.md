---
title: 选择度量值组维度 （添加新的嵌套的表向导） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "66069793"
---
# <a name="select-a-measure-group-dimension-add-new-nested-table-wizard"></a>选择度量值组维度（添加新的嵌套表向导）
  可以使用 **“选择度量值组维度”** 页，从度量值组中选择要用作嵌套表的维度。  
