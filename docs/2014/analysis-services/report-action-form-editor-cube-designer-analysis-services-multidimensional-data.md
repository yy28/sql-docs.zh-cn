 ...
 **目标对象**  
 选择要与该操作关联的对象。 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 实例仅将应用于所选对象的操作返回到客户端。 可用对象列表受所选 **“目标类型”** 的约束。  
