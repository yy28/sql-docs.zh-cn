...
1.  右键单击 "**脚本组织**程序" 窗格中的 `[Core Products]`，然后单击 "**新建命名集**"。  
...
12. 在 "**计算工具**" 窗格的 "**元数据**" 选项卡上，展开 "**分销商**" 维度中**的员工数**，展开 "`Members`"，然后展开 "**所有分销商**"。  
     ...
     此属性层次结构的成员已分组，因为 DiscretizationBucketCount 属性设置为 `5` 并且 DiscretizationMethod 属性设置为 "**自动**"。  
...
5.  展开“产品”维度，然后将“类别”和“子类别”添加到行区域中，如下图所示。  
     ...
     ![子类别特性的成员](../../2014/tutorials/media/l6-named-set-03.gif "子类别特性的成员")  
...
6.  在“元数据”窗格的“产品”维度中，将“核心产品”拖到筛选器区域。  
     ...
     ![核心产品命名集的成员](../../2014/tutorials/media/l6-named-set-04.gif "核心产品命名集的成员")  
