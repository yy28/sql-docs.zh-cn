---
title: 添加表对话框 (Analysis Services-多维数据) |Microsoft 文档
ms.custom: ''
ms.date: 03/06/2017
...
|**“添加”**|单击此项将添加当前所选项。 **注意：** 仅当选择了某个项时，才启用此选项。|  
  
## <a name="see-also"></a>请参阅  
 [Analysis Services 设计器和对话框&#40;多维数据&#41;](analysis-services-designers-and-dialog-boxes-multidimensional-data.md)   
 [创建或编辑命名的查询对话框&#40;Analysis Services-多维数据&#41;](create-or-edit-named-query-dialog-box-analysis-services-multidimensional-data.md)   
