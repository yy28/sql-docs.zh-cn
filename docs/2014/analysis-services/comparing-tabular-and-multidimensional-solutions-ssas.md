...
##  <a name="server-deployment-modes-for-multidimensional-and-tabular-solutions"></a><a name="bkmk_deploymentmode"></a>针对多维和表格解决方案的服务器部署模式  
...
##  <a name="hosting-platforms"></a><a name="bkmk_sharePoint"></a>托管平台  
...
##  <a name="next-step-build-a-solution"></a><a name="bkmk_Next"></a>下一步：构建解决方案  
