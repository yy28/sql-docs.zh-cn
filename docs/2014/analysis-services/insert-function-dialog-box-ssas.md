---
title: 插入函数对话框 (SSAS) |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|-|-|  
|项|Description|  
|**选择一个类别**|如果您大致确定所需函数的类型，则从列表中选择一个类别；或者选择 **“全部”** 以便查看函数的字母顺序列表。|  
|**选择一个函数**|显示所选类别中函数的列表。|  
|**Description**|显示函数功能的说明以及任何必需或可选参数，例如列名和表达式。|  
