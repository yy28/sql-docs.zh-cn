...
|其他|CELL_EVALUATION_LIST 内部单元属性|最初提供了一个适用于单元格的计算公式的列表。 它在此版本的 Analysis Services 中为空白。  现在已在 MDX 脚本中指定了解决顺序。 有关详细信息，请参阅[理解传递次序和求解次序&#40;MDX&#41;](multidimensional-models/mdx/mdx-data-manipulation-understanding-pass-order-and-solve-order.md)|  
