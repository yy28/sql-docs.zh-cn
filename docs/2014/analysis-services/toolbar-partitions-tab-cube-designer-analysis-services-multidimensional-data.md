...
|**基于使用情况的优化**|单击此项可显示 **基于使用情况的优化向导** ，并基于现有使用模式为所选分区创建聚合设计。<br /><br /> 注意：只有在“度量值组”  窗格中，在度量值组的“分区”  网格中选择分区的任意单元时，才会启用此选项。<br /><br /> 另请注意，是否选择了写回分区，则将禁用此选项。|  
