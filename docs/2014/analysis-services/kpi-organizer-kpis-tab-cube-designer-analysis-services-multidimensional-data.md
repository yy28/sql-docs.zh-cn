...
|**上移**|选择此选项可在 **KPI 组织程序** 中将所选 KPI 向上移动一个位置，并确定 KPI 在 **KPI 浏览器**中的显示顺序。<br /><br /> 注意：如果无法进一步移动所选的 KPI，将禁用此选项。|  
|**“下移”**|选择此选项可在 **KPI 组织程序** 中将所选 KPI 向下移动一个位置，并确定 KPI 在 **KPI 浏览器**中的显示顺序。<br /><br /> 注意：如果无法进一步移动所选的 KPI，将禁用此选项。|  
|**删除**|选择此选项可删除所选 KPI。|  
