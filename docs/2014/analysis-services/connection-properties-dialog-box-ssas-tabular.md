---
title: 连接属性对话框 (SSAS-表格) |Microsoft 文档
ms.custom: ''
ms.date: 06/13/2017
...
|**隔离**|有效值为 ReadCommitted 或 Snapshot。 有关详细信息，请参阅 [Isolation 元素 (ASSL)](scripting/properties/isolation-element-assl.md)。|  
