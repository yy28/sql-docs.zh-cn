...
>  [!INCLUDE[ssDWfull](../includes/ssdwfull-md.md)] 不支持存储过程或表值函数。  
 ...
 ![用于查询的图形设计器](media/rsqd-relational-graphical.gif "用于查询的图形设计器")  
  
 下图显示了用于存储过程或表值函数的图形查询设计器。  
  
 ![图形查询设计器中的存储过程](media/rs-relational-graphical-sp.gif "图形查询设计器中的存储过程")  
...
#### <a name="command-type-text"></a>命令类型 Text  
 ...
 ![用于关系数据查询的通用查询设计器](media/rsqd-dsaw-sql-generic.gif "用于关系数据查询的通用查询设计器")  
