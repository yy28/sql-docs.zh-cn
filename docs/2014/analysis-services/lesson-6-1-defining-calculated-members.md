...
6.  在 "**表达式**" 框中,`+`在 **[度量值]. ["Internet 销售-销售额**"。  
...
9. 在“非空行为”列表中，选中“Internet Sales-Sales Amount”和“Reseller Sales-Sales Amount”的复选框，然后单击“确定”。  
     ...
     ![填充的 "计算表达式" 窗格](../../2014/tutorials/media/l6-calculatedmembers-03.gif "填充的 \"计算表达式\" 窗格")  
...
12. 在 "**计算**" 选项卡的工具栏上, 单击 "**窗体视图** `[Total Sales Amount]` ", 确认已在 "**脚本组织**程序" 窗格中选择, 然后单击 "**新建计算成员**"。  
...
8.  将“Total GPM”、“Internet GPM”和“Reseller GPM”度量值添加到“值”区域，然后检查结果。  
     ...
     ![显示分销商销售额的数据窗格](../../2014/tutorials/media/l6-calculatedmembers-7b.gif "显示分销商销售额的数据窗格")  
