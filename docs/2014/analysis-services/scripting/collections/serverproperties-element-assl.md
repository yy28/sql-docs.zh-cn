...
ms.locfileid: "37323087"
---
# <a name="serverproperties-element-assl"></a>ServerProperties 元素 (ASSL)
  包含的集合[ServerProperty](../objects/serverproperty-element-assl.md)与关联的元素[Server](../objects/server-element-assl.md)元素。  
...
## <a name="remarks"></a>Remarks  
 在 Analysis Management Objects (AMO) 对象模型中的相应元素是<xref:Microsoft.AnalysisServices.ServerPropertyCollection>。  
