...
ms.locfileid: "36026214"
---
# <a name="partition-element-assl"></a>Partition 元素 (ASSL)
  定义的分区[MeasureGroup](group-element-assl.md)元素或扩展的行中的分区绑定[MeasureGroupBinding](../data-type/measuregroupbinding-data-type-out-of-line-assl.md)元素。  
