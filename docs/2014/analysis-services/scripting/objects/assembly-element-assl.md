...
ms.locfileid: "36016471"
---
# <a name="assembly-element-assl"></a>Assembly 元素 (ASSL)
  表示[!INCLUDE[msCoName](../../../includes/msconame-md.md)][!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)]程序集或 COM 动态链接库 (DLL) 与关联[服务器](server-element-assl.md)元素或[数据库](database-element-assl.md)元素。  
