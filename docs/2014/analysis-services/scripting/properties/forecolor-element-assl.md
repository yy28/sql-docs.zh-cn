...
ms.locfileid: "36018298"
---
# <a name="forecolor-element-assl"></a>ForeColor 元素 (ASSL)
  介绍颜色相关显示特征[CalculationProperty](../objects/calculationproperty-element-assl.md)或[度量值](../objects/measure-element-assl.md)父元素。  
...
## <a name="remarks"></a>Remarks  
 `ForeColor`属性包含的多维表达式 (MDX) 表达式，并将应用于`CalculationProperty`元素具有[CalculationType](calculationtype-element-assl.md)的*成员*或*单元格*.  
