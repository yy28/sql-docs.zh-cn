---
title: 关键绩效指标表示形式（表格） |Microsoft Docs
ms.custom: ''
ms.date: 04/27/2017
...
## <a name="key-performance-indicator-representation"></a>关键绩效指标表示形式  
 在表格对象模型中，关键绩效指标-kpi-是一个度量值，其中包含客户端应用程序以图形方式显示的其他信息。 KPI 通常包含关于要实现的目标和度量值相对于目标的状态的信息，以及客户端工具如何以图形方式显示状态的信息。  
