...
> [!NOTE]  
>  [!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows 防火墙关闭端口 445 默认情况下。 因为[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]通信通过端口 445，您必须重新打开该端口如果[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]配置为侦听传入客户端连接使用命名的管道。 有关配置防火墙的信息，请参阅 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 联机丛书中的“如何将防火墙配置为允许 SQL Server 访问”，或者查阅防火墙文档。  
...
> [!NOTE]  
>  若要指定作为网络协议**sqlcmd**参数，请参阅"如何： 数据库引擎使用 sqlcmd.exe 连接到"中[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]联机丛书。  
