...
|关系|元素|  
|------------------|--------------|  
|**父元素**|[&#40;DTA&#41;创建元素](create-element-dta.md)<br /><br /> `Drop`Element. 有关详细信息，请参阅数据库引擎优化顾问 XML 架构。|  
|**子元素**|[用于索引 &#40;DTA&#41;的名称元素](name-element-for-index-dta.md)<br /><br /> [用于索引 &#40;DTA&#41;的列元素](column-element-for-index-dta.md)<br /><br /> `PartitionScheme`Element. 有关详细信息，请参阅数据库引擎优化顾问 XML 架构。<br /><br /> `PartitionColumn`Element. 有关详细信息，请参阅数据库引擎优化顾问 XML 架构。<br /><br /> [用于索引 &#40;DTA&#41;的文件组元素](filegroup-element-for-index-dta.md)<br /><br /> `NumberOfReferences`Element. 有关详细信息，请参阅数据库引擎优化顾问 XML 架构。<br /><br /> `PercentUsage`Element. 有关详细信息，请参阅数据库引擎优化顾问 XML 架构。|  
