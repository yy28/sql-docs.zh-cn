...
3.  在 " ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Distributed Replay 控制器" 属性**"窗口中的"**登录**"选项卡上，选择"**此帐户**"，键入或单击"**浏览**"以输入新的登录帐户，然后单击 **" 确定 "**。  
...
3.  在 " ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Distributed Replay 客户端属性**" 窗口中的 "**登录**" 选项卡上，选择 "**此帐户**"，键入或单击 "**浏览**" 以输入新的登录帐户，然后单击 **"确定"**。  
