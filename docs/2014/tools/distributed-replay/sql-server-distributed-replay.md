...
# <a name="sql-server-distributed-replay"></a>SQL Server 分布式重播
  Distributed Replay 功能可帮助你评估将来[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]升级的影响。 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 您还可以使用它来帮助评估硬件和操作系统升级以及 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 优化的影响。  
...
## <a name="benefits-of-distributed-replay"></a>分布式重播的优点  
 ...
 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] Distributed Replay 功能可以使用多台计算机重播跟踪数据，并模拟任务关键型工作[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]负荷。 可使用分布式重播进行应用程序兼容性测试、性能测试或容量规划。  
  
## <a name="when-to-use-distributed-replay"></a>何时使用分布式重播  
 [!INCLUDE[ssSqlProfiler](../../../includes/sssqlprofiler-md.md)]和 Distributed Replay 提供某些功能重叠。  
...
-   **Distributed Replay 控制器**：运行名为[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Distributed Replay 控制器的 Windows 服务的计算机。 Distributed Replay 控制器协调分布式的重播客户端的操作。 在每个 Distributed Replay 环境中只能有一个控制器实例。  
...
-   **目标服务器**： Distributed Replay 客户端[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]可用来重播跟踪数据的实例。 建议将目标服务器置于测试环境中。  
...
|任务说明|主题|  
|----------------------|-----------|  
|介绍如何配置分布式重播。|[Configure Distributed Replay](configure-distributed-replay.md)|  
