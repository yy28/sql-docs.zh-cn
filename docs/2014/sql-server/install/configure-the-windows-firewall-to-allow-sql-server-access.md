...
---
# <a name="configure-the-windows-firewall-to-allow-sql-server-access"></a>配置 Windows 防火墙以允许 SQL Server 访问
...
-   **“控制面板”中的“Windows 防火墙”项**  
    ...
    -   设置一些范围限制  
     ...
     “控制面板”中的 **“Windows 防火墙”** 项最适合于防火墙配置经验不足的用户以及要为非移动的计算机配置基本防火墙选项的用户。 你还可以通过使用以下过程，从 "`run`" 命令打开 "控制面板" 中的 " **Windows 防火墙**" 项：  
...
2.  浏览到要通过防火墙允许的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 实例的位置，例如**C:\Program FILES\MICROSOFT SQL Server\MSSQL12. < instance_name > \MSSQL\Binn**，选择 " **sqlservr.exe**"，然后单击 "**打开"** .  
