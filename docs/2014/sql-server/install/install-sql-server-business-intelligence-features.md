...
|[验证或排除 SQL Server BI 功能安装问题](../../../2014/sql-server/install/verify-or-troubleshoot-sql-server-bi-feature-installation-problems.md)|本节包括用于验证安装的步骤。 本节还提供指向 Web 上的问题解决信息的链接。|  
