 ...
 **实例 ID**  
 与文件系统中的某一文件夹对应，该文件夹用于存储您所连接到的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 实例的程序文件。 **INSTANCE-ID**值由安装程序分配格式*组件*。*实例*，其中*组件*是一个值，表示[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]组件并*实例*为实例名称。 默认实例名为 MSSQLSERVER。 例如，如果安装的默认实例[!INCLUDE[ssDE](../../includes/ssde-md.md)]， [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]，和[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]组件，对应的文件夹名称如下：  
