...
## <a name="options"></a>选项  
 **SQL Server 实例**  
 显示当前连接的报表服务器实例的有关信息。 报表服务器实例的名称基于 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 命名实例。 默认实例为 MSSQLSERVER。 命名实例将是您在安装过程中指定的值。 有关实例的详细信息，请参阅联机丛书中[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]的[使用多个版本和实例 SQL Server](../../../2014/sql-server/install/work-with-multiple-versions-and-instances-of-sql-server.md) 。  
