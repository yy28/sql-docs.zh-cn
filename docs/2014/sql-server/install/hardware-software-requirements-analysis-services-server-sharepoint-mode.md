...
-   [SQL Server 2014 授权数据表](https://download.microsoft.com/download/6/6/F/66FF3259-1466-4BBA-A505-2E3DA5B2B1FA/SQL_Server_2014_Licensing_Datasheet.pdf)（@no__t 为-1。  
  
-   @no__t-购买0How：SQL Server 许可模式支持 @ no__t-0 （@no__t 为-1。  
