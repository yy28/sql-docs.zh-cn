...
## <a name="uninstall-native-mode"></a>卸载本机模式  
 ...
 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]是实例功能，因此未在 Windows "控制面板" 的 "程序和功能" 中列出。 卸载 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 本机模式：  
