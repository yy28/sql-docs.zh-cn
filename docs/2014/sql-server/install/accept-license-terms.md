...
-   来自出错进程的内存或文件的信息。  
 ...
 [!INCLUDE[msCoName](../../includes/msconame-md.md)] 不会有意收集你的文件、 名称、 地址、 电子邮件地址或任何其他形式的个人信息。 但是，错误报告可能包含来自导致错误的进程的内存或文件中的个人信息。 虽然使用这些信息有可能确定您的身份，但 [!INCLUDE[msCoName](../../includes/msconame-md.md)] 不会将这些信息用于此目的。  
