...
-   查看分析结果。  
 ...
 升级顾问包含一个分析器和一个查看器。 升级顾问分析向导会分析您选择的组件。 然后，分析器生成有关升级到 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 之前必须解决的问题的自定义报表。 可以使用升级顾问报表查看器查看自定义报表。 有关哪些升级顾问分析检测的详细信息，请参阅[解决升级问题](../../../2014/sql-server/install/resolving-upgrade-issues.md)。  
...
|主题|Description|  
|-----------|-----------------|  
|[升级顾问的概述](../../../2014/sql-server/install/overview-of-upgrade-advisor.md)|概要介绍升级过程、升级顾问分析向导以及升级顾问报表查看器。|  
|[升级顾问操作指南主题](../../../2014/sql-server/install/upgrade-advisor-how-to-topics.md)|提供执行升级顾问常用步骤的说明。|  
|[升级顾问用户界面参考](../../../2014/sql-server/install/upgrade-advisor-user-interface-reference.md)|包含一些主题，如果按 F1 键或单击显示**帮助**升级顾问分析向导页上。|  
