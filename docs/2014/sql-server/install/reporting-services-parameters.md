...
# <a name="reporting-services-parameters"></a>Reporting Services 参数
  若要[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]分析，必须指定的[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]实例，并提供有关如何连接到该实例的信息。  
