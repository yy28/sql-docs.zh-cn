...
# <a name="reporting-services-parameters"></a>Reporting Services 参数
  若要分析[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]，必须指定的实例[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]并提供有关如何连接到该实例信息。  
