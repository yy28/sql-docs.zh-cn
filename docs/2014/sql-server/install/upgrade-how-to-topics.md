...
|[使用命令提示符安装 SQL Server 2014](../../database-engine/install-windows/install-sql-server-from-the-command-prompt.md)。|提供在命令提示符处安装 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 的示例语法。|  
