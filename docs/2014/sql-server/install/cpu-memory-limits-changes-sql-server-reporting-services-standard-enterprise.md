---
title: 对 SQL Server Reporting Services Standard 和 Enterprise 的 CPU 和内存限制的更改 |Microsoft 文档
ms.custom: ''
ms.date: 06/13/2017
...
### <a name="description"></a>Description  
 ...
 有关的其他版本的 CPU 和内存限制的详细信息[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]，请参阅[Compute Capacity Limits by Edition of SQL Server](../compute-capacity-limits-by-edition-of-sql-server.md)，和[内存支持的 SQL Server 的版本](http://go.microsoft.com/fwlink/?LinkId=212633)。  
