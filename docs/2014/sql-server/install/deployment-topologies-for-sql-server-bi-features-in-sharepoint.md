---
title: 共享点中 SQL Server BI 功能的部署拓扑 |微软文档
ms.custom: ''
ms.date: 03/06/2017
...
##  <a name="sharepoint-2013-example-deployment-topologies"></a><a name="bkmk_example_deployments_2013"></a>SharePoint 2013 示例部署拓扑  
 ...
 SharePoint 模式需要 SharePoint 服务器 2013 并使用 SharePoint 服务应用程序体系结构。 ** [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] **  
  
 下面的部分说明了典型的部署拓扑：  
  
###  <a name="powerpivot-for-sharepoint-2013-and-reporting-services-three-server-deployment"></a><a name="bkmk_bi_Sharepoint2013_3tier"></a>用于 SharePoint 2013 的 PowerPivot 和报告服务三个服务器部署  
...
|**(5)**|运行**spPowerPivot.msi**以安装数据提供程序、[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]配置工具、[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]库和计划数据刷新。|  
|**(6)**|[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]服务器处于共享点模式。 将 Excel Services 应用程序 **“数据模型设置”** 配置为使用此服务器。|  
|**(7)**|SharePoint 内容、配置和服务应用程序数据库。|  
  
 ![共享点设置](../../analysis-services/media/as-sharepoint2013-settings-gear.gif "SharePoint 设置")[通过 Microsoft SQL 服务器连接提交反馈和联系信息](https://connect.microsoft.com/SQLServer/Feedback)（ 。https://connect.microsoft.com/SQLServer/Feedback)  
  
###  <a name="powerpivot-for-sharepoint-2013-single-server-deployment"></a><a name="bkmk_powerpivot_sharepoint2013_1server"></a>用于 SharePoint 2013 单服务器部署的电源透视  
...
###  <a name="powerpivot-for-sharepoint-2013-two-server-deployment"></a><a name="bkmk_powerpivot_sharepoint2013_2server"></a>SharePoint 2013 两个服务器部署的 PowerPivot  
 ...
 该安装程序包作为 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 功能包的一部分提供。 功能包可以从 Microsoft ® SQL [!INCLUDE[msCoName](../../includes/msconame-md.md)] Server 下载中心下载[® 2014 PowerPivot®适用于 Microsoft ® SharePoint®](https://go.microsoft.com/fwlink/?LinkID=296473) （HYPERLINK"<https://go.microsoft.com/fwlink/?LinkID=296473> <https://go.microsoft.com/fwlink/?LinkID=296473>"_blank"）。  
...
|**(1)**|Excel Service 应用程序。 作为 SharePoint 安装的一部分创建的服务应用程序。|  
|**(2)**|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]服务应用程序。 默认名称为 **“默认的 PowerPivot 服务应用程序”**。|  
|**(3)**|运行**spPowerPivot.msi**以安装数据提供程序、[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]配置工具、[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]库和计划数据刷新。|  
|**(4)**|SharePoint 模式下的 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 服务器。 将 Excel Services 应用程序 **“数据模型设置”** 配置为使用此服务器。|  
|**(5)**|SharePoint 内容、配置和服务应用程序数据库。|  
  
###  <a name="powerpivot-for-sharepoint-2013-three-server-deployment"></a><a name="bkmk_powerpivot_sharepoint2013_3server"></a>用于 SharePoint 2013 三个服务器部署的 PowerPivot  
...
###  <a name="powerpivot-for-sharepoint-2013-and-reporting-services-single-server-deployment"></a><a name="bkmk_powerpivot_ssrs_sharepoint2013_1server"></a>用于 SharePoint 2013 和报告服务单服务器部署的 PowerPivot  
 单服务器部署用于测试目的，不建议在生产部署中采用。  
  
 ![SSAS 和 SSRS 共享点模式 1 服务器部署](../../../2014/sql-server/install/media/as-and-rs-1server-deployment.gif "SSAS 和 SSRS 共享点模式 1 服务器部署")  
...
###  <a name="powerpivot-for-sharepoint-2013-and-reporting-services-two-server-deployment"></a><a name="bkmk_powerpivot_ssrs_sharepoint2013_2server"></a>用于 SharePoint 2013 和报告服务的 PowerPivot 两个服务器部署  
 在下面的双服务器部署中，SQL Server 数据库引擎和在 SharePoint 模式下运行的 Analysis Services 服务器与 SharePoint 分别运行在不同的服务器上。 SharePoint 2013 安装程序包 **（spPowerPivot.msi）** 的 PowerPivot 必须在 SharePoint 服务器上运行。  
...
##  <a name="single-server-deployments"></a><a name="bkmk_sharepoint2010_1server"></a>单个服务器部署  
 ...
 若要在一台服务器上安装所有功能，请依次在同一物理服务器上安装 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 和 [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] 。 有关独立服务器配置的说明，请参阅[部署检查表：共享点的报告服务、电源视图和 PowerPivot](deployment-checklist-reporting-services-power-view-power-pivot-for-sharepoint.md)。  
  
##  <a name="two-tier-deployment"></a><a name="bkmk_sharepoint2010_2server"></a>两层部署  
...
##  <a name="three-tier-deployment"></a><a name="bkmk_sharepoint2010_3server"></a>三层部署  
 ...
 ![3 服务器顶部](../../../2014/sql-server/install/media/sql11bisetup-3server.gif "3 服务器顶部")  
  
##  <a name="three-tier-scale-out-deployment"></a><a name="bkmk_sharepoint2010_scaleserver"></a>三层横向扩展部署  
...
## <a name="see-also"></a>另请参阅  
 ...
 [用于 SharePoint 2013 安装的电源透视](https://docs.microsoft.com/analysis-services/instances/install-windows/install-analysis-services-in-power-pivot-mode)   
