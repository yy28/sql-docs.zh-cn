...
|**(6)**|[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]SharePoint 模式下的服务器。 将 Excel Services 应用程序 **“数据模型设置”** 配置为使用此服务器。|  
...
###  <a name="bkmk_powerpivot_sharepoint2013_1server"></a>PowerPivot for SharePoint 2013 单一服务器部署  
 ...
 ![PowerPivot for SharePoint 单一服务器部署](../../../2014/sql-server/install/media/as-powerpivot-mode-1server-deployment.gif "PowerPivot for SharePoint 单一服务器部署")  
...
###  <a name="bkmk_powerpivot_sharepoint2013_2server"></a>PowerPivot for SharePoint 2013 2 服务器部署  
 ...
 该安装程序包作为 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 功能包的一部分提供。 此功能包可从 "下载中心" [!INCLUDE[msCoName](../../includes/msconame-md.md)]下载, 网址为 microsoft [® SQL Server® 2014 PowerPivot®适用于 microsoft® SharePoint®](https://go.microsoft.com/fwlink/?LinkID=296473) (<https://go.microsoft.com/fwlink/?LinkID=296473>超链接 "" \t <https://go.microsoft.com/fwlink/?LinkID=296473>"_blank")。  
...
###  <a name="bkmk_powerpivot_sharepoint2013_3server"></a>PowerPivot for SharePoint 2013 3 服务器部署  
 ...
 ![作为 PowerPivot Mode3 服务器部署](../../../2014/sql-server/install/media/as-powerpivot-mode-3server-deployment.gif "作为 PowerPivot Mode3 服务器部署")  
