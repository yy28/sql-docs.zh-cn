...
###  <a name="bkmk_powerpivot_sharepoint2013_2server"></a>PowerPivot for SharePoint 2013 2 服务器部署  
 ...
 该安装程序包作为 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 功能包的一部分提供。 可从 microsoft [® SQL Server® 2014 PowerPivot® microsoft® SharePoint](https://go.microsoft.com/fwlink/?LinkID=296473) ®（HYPERLINK "<https://go.microsoft.com/fwlink/?LinkID=296473>" \t "_blank" <https://go.microsoft.com/fwlink/?LinkID=296473>）下载 [!INCLUDE[msCoName](../../includes/msconame-md.md)] 下载中心中的功能包。  
