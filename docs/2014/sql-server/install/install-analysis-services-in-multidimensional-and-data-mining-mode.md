...
-   客户端工具连接组件, 用于客户端和服务器之间的通信, 包括用于 DB-LIBRARY、ODBC 和 OLE DB 的网络库。  
...
|[从安装向导&#40;安装&#41;程序安装 SQL Server 2014](../../database-engine/install-windows/install-sql-server-from-the-installation-wizard-setup.md)。|运行 SQL Server 安装程序以便安装该软件。|  
