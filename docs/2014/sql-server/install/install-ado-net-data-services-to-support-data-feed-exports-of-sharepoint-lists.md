...
# <a name="install-adonet-data-services-to-support-data-feed-exports-of-sharepoint-lists"></a>安装 ADO.NET Data Services 以支持 SharePoint 列表的数据馈送导出
 ...
 如果没有此先决条件，则当你尝试使用已导出为数据馈送的 SharePoint 列表时，你将收到以下错误："出于安全原因，DTD 在此 XML 文档中被禁止。 若要启用 DTD 处理，请将 XmlReaderSettings 的 ProhibitDtd 属性设置为 false，并将设置传递到 XmlReader.Create 方法。“  
