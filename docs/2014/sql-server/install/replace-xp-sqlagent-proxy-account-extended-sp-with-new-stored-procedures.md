---
title: 将所用扩展存储的过程的新的存储过程的 xp_sqlagent_proxy_account |Microsoft 文档
ms.custom: ''
ms.date: 06/13/2017
...
> [!NOTE]  
>  升级到之后[!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)]，使用任何语句**对 xp_sqlagent_proxy_account**不起作用的扩展存储的过程。 使用**sp_xp_cmdshell_proxy_account**而不是**对 xp_sqlagent_proxy_account**设置的代理**xp_cmdshell**。  
