---
title: 配置报表服务器以进行电子邮件传递（SSRS Configuration Manager） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
##  <a name="configuration-requirements"></a><a name="bkmk_configuration_requirements"></a>配置要求  
...
##  <a name="configuring-a-report-server-for-local-or-remote-smtp-service"></a><a name="bkmk_configure_for_local_or_remote_SMTP"></a>为本地或远程 SMTP 服务配置报表服务器  
...
##  <a name="setting-configuration-options-for-e-mail-delivery"></a><a name="bkmk_setting_email_delivery"></a>为电子邮件传递设置配置选项  
...
##  <a name="example-report-server-e-mail-configuration"></a><a name="bkmk_example_config_file"></a>报表服务器电子邮件配置示例  
...
##  <a name="configuration-options-for-setting-the-to-field-in-a-message"></a><a name="bkmk_setting_TO_field"></a>用于在消息中设置 "到：" 字段的配置选项  
 根据 "**管理单独的订阅**" 任务授予的权限创建的用户定义订阅包含基于域用户帐户的预设用户名。 用户创建订阅时，“收件人:” **** 字段中的收件人姓名会使用创建该订阅的人员的域用户帐户自行转换为地址。  
...
##  <a name="configuration-options-for-remote-smtp-service"></a><a name="bkmk_options_remote_SMTP"></a>远程 SMTP 服务的配置选项  
...
##  <a name="configuration-options-for-local-smtp-service"></a><a name="bkmk_options_local_SMTP"></a>本地 SMTP 服务的配置选项  
...
##  <a name="to-configure-report-server-e-mail-using-the-reporting-services-configuration-manager"></a><a name="bkmk_use_configuration_manager"></a>使用 Reporting Services 配置管理器配置 Report Server 电子邮件  
...
##  <a name="to-configure-a-remote-smtp-service-for-the-report-server"></a><a name="bkmk_confiugre_remote_SMTP"></a>为 Report Server 配置远程 SMTP 服务  
...
##  <a name="to-configure-a-local-smtp-service-for-the-report-server"></a><a name="bkmk_confiugre_local_SMTP"></a>为 Report Server 配置本地 SMTP 服务  
