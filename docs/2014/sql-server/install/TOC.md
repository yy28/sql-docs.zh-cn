# [SQL Server 2014 升级顾问](sql-server-2014-upgrade-advisor.md)
# [安装升级顾问](installing-upgrade-advisor.md)
## [升级顾问必备组件](upgrade-advisor-prerequisites.md)
## [从命令提示符安装升级顾问](installing-upgrade-advisor-from-the-command-prompt.md)

# [使用升级顾问](working-with-upgrade-advisor.md)
# [升级顾问概述](overview-of-upgrade-advisor.md)
## [升级过程概述](upgrade-process-overview.md)
## [升级顾问概述](upgrade-advisor-overview.md)
## [运行升级顾问（用户界面）](running-upgrade-advisor-user-interface.md)
## [运行升级顾问（命令提示符）](running-upgrade-advisor-command-prompt.md)
## [使用报表](using-reports.md)
## [升级顾问错误](upgrade-advisor-errors.md)
# [升级顾问操作指南主题](upgrade-advisor-how-to-topics.md)
## [如何安装升级顾问](how-to-install-upgrade-advisor.md)
## [如何启动升级顾问](how-to-launch-upgrade-advisor.md)
## [如何运行升级顾问分析向导](how-to-run-the-upgrade-advisor-analysis-wizard.md)
## [如何查看升级顾问报表](how-to-view-an-upgrade-advisor-report.md)
## [如何筛选报表](how-to-filter-reports.md)
## [如何导出报表](how-to-export-reports.md)
# [用户界面参考](upgrade-advisor-user-interface-reference.md)
## [SQL Server 组件](sql-server-components.md)
## [连接参数](connection-parameters.md)
## [SQL Server 参数](sql-server-parameters.md)
## [Analysis Services 参数](analysis-services-parameters.md)
## [Reporting Services 参数](reporting-services-parameters.md)
## [Integration Services 参数](integration-services-parameters.md)
...
### [升级后日志传送不会运行](log-shipping-will-not-run-after-upgrading.md)
...
### [删除根据保留的 GEOMETRY 和 GEOGRAPHY 数据类型命名的 UDT](remove-udts-named-after-the-reserved-geometry-and-geography-data-types.md)
...
### [自 SQL Server 2008 起，全文搜索已发生变化](full-text-search-has-changed-since-sql-server-2008.md)
...
### [未指定虚拟目录（升级顾问）](virtual-directories-are-unspecified-upgrade-advisor.md)
...
# [安装程序和安装服务](setup-and-servicing-installation.md)
...
## [数据库引擎配置 - 用户实例](database-engine-configuration-user-instance.md)
## [Distributed Replay 控制器配置](distributed-replay-controller-configuration.md)
## [Distributed Replay 客户端配置](distributed-replay-client-configuration.md)
## [版本升级规则](edition-upgrade-rules.md)
## [故障转移群集报告](failover-cluster-report.md)
## [查看功能](feature-review.md)
## [安装规则](installation-rules.md)
## [功能规则](feature-rules.md)
## [功能选择](feature-selection.md)
## [功能选择（卸载）](feature-selection-uninstall.md)
## [选择功能（升级）](select-features-upgrade.md)
## [全文搜索升级选项](full-text-search-upgrade-options.md)
## [完成 - 安装](complete-installation.md)
## [安装必备组件](installation-prerequisites.md)
## [安装进度](installation-progress.md)
## [安装类型](installation-type.md)
## [实例配置](instance-configuration.md)
## [实例选择（卸载）](instance-selection-uninstall.md)
## [实例选择（升级）](instance-selection-upgrade.md)
## [选择实例](select-instance.md)
## [卸载后](post-uninstall.md)
## [准备映像进度](prepare-image-progress.md)
## [准备映像规则](prepare-image-rules.md)
## [准备映像类型](prepare-image-type.md)
## [产品密钥](product-key.md)
## [进度（卸载）](progress-uninstall.md)
## [已准备好完成映像](ready-to-complete-image.md)
## [准备安装](ready-to-install.md)
## [已可以准备映像](ready-to-prepare-image.md)
## [准备修复](ready-to-repair.md)
