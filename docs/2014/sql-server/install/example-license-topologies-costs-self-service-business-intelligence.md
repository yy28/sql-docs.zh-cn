---
title: 许可证拓扑示例和成本的 SQL Server 2014 自助服务商业智能 |Microsoft 文档
ms.custom: ''
ms.date: 05/24/2017
...
-   [使用单独的 PowerPivot 服务器的 3 层拓扑](#bkmk_3tier_powerpivot)  
...
-   SharePoint 模式下的 Reporting Services，包括数据警报。  
 ...
 有关详细信息，请参阅中的功能表[安装与 SharePoint SQL Server BI 功能&#40;PowerPivot 和 Reporting Services&#41;](../../../2014/sql-server/install/install-sql-server-bi-features-sharepoint-powerpivot-reporting-services.md)。  
...
-   [虚拟环境的授权](http://www.microsoft.com/licensing/about-licensing/virtualization.aspx)(http://www.microsoft.com/licensing/about-licensing/virtualization.aspx)。  
...
-   [SharePoint 的许可的完整列表](http://technet.microsoft.com/en-in/library/jj819267.aspx#bkmk_FeaturesOnPremise)(http://technet.microsoft.com/en-in/library/jj819267.aspx#bkmk_FeaturesOnPremise)。  
  
-   [如何购买 SharePoint](http://sharepoint.microsoft.com/en-in/Pages/buy.aspx) (http://sharepoint.microsoft.com/en-in/Pages/buy.aspx)。  
  
##  <a name="bkmk_3tier_powerpivot"></a> 3 层拓扑具有单独[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]服务器  
...
-   [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] for SharePoint 运行在单独的服务器 (3) 上。 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] for SharePoint 2013 运行在 SharePoint 场之外，可以在不包含 SharePoint 安装，提高性能的服务器上安装。  
...
-   Analysis Services 正在 PowerPivot 模式下场外部的 (2) 运行，但运行 PowerPivot**上的同一物理**中的其他应用程序角色的服务器。  
  
-   数据库角色 (3) 使用 SQL Server Enterprise 以便[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]均提供功能，AlwaysOn 可用性组。  
...
-   [有关许可： 客户端访问许可证和管理许可证](http://www.microsoft.com/licensing/about-licensing/client-access-license.aspx)(http://www.microsoft.com/licensing/about-licensing/client-access-license.aspx)。  
  
-   [有关许可： 产品许可搜索](http://www.microsoftvolumelicensing.com/default.aspx)(http://www.microsoftvolumelicensing.com/default.aspx)。  
  
-   [批量许可： 定价和如何购买](http://www.microsoft.com/licensing/how-to-buy/how-to-buy.aspx)(http://www.microsoft.com/licensing/how-to-buy/how-to-buy.aspx)。  
...
-   [SQL Server 2014 许可更改](http://www.brentozar.com/archive/2014/04/sql-server-2014-licensing-changes)(http://www.brentozar.com/archive/2014/04/sql-server-2014-licensing-changes)。  
  
-   [SQL server 2014 的授权更改](https://www.directionsonmicrosoft.com/sites/default/files/PDFs/Licensing_Changes_for_SQL_Server_2014.pdf)(https://www.directionsonmicrosoft.com/sites/default/files/PDFs/Licensing_Changes_for_SQL_Server_2014.pdf)。  
  
-   [估计 SharePoint 2013 许可成本](http://www.degdigital.com/blog/sharepoint-2013-licensing-for-dummies/)(http://www.degdigital.com/blog/sharepoint-2013-licensing-for-dummies/)。  
