...
|Business Intelligence（64 位和 32 位）|[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Business Intelligence 版提供了综合性平台，可支持组织构建和部署安全、可扩展且易于管理的 BI 解决方案。 它提供了令人兴奋的功能，如基于浏览器的数据浏览和可视化。强大的数据混合功能，以及增强的集成管理。|  
...
## <a name="specialized-editions-of-sscurrent"></a>[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 的专业版本  
...
## <a name="breadth-editions-of-sscurrent"></a> 的扩展版本  
...
## <a name="see-also"></a>另请参阅  
 [规划 SQL Server 安装](install/planning-a-sql-server-installation.md)   
