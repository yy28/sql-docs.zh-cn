 ...
 **默认池**  
 ...
 默认池是第一个预定义的用户池。 在进行任何配置之前，默认池只包含默认组。 不能创建或删除默认池，但可以更改。 默认池除了包含默认组，还可以包含用户定义的组。  
...
|任务说明|主题|  
|----------------------|-----------|  
|说明如何创建一个资源池。|[创建资源池](create-a-resource-pool.md)|  
|说明如何更改资源池设置。|[更改资源池设置](change-resource-pool-settings.md)|  
