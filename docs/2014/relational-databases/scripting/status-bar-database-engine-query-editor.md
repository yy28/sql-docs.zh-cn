...
2.  **若要在中设置服务器状态颜色：**  [对象资源管理器](#SetOEServerColor)，[已注册的服务器](#SetRegServerColor)  
  
3.  **若要使用状态颜色：** 使用[服务器颜色打开查询编辑器](#OpenServerColor)，请[打开查询编辑器并指定状态颜色](#OpenSpecColor)    
...
##  <a name="SetRegServerColor"></a>为已注册的服务器设置状态颜色  
 **为已注册服务器设置服务器颜色**  
...
##  <a name="OpenSpecColor"></a>打开编辑器，指定状态颜色  
 **打开编辑器窗口并且指定状态颜色**  
