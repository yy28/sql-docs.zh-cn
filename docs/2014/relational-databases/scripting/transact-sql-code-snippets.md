...
|任务说明|主题|  
|----------------------|-----------|  
|介绍如何插入现有代码段，如 CREATE TABLE 或 SELECT 代码段。|[插入 Transact-sql 代码段](insert-transact-sql-snippets.md)|  
|介绍如何在 BEGIN、IF 或 WHILE 块中加入一组 [!INCLUDE[tsql](../../includes/tsql-md.md)] 语句。|[插入外侧 Transact-sql 代码段](insert-surround-with-transact-sql-snippets.md)|  
|介绍如何在插入代码段后完成生成完整的 [!INCLUDE[tsql](../../includes/tsql-md.md)] 语句或语句块。|[完成 Transact-sql 代码段](complete-transact-sql-snippets.md)|  
|介绍如何生成自己的自定义代码段，并将其添加到一组 SQL Server 代码段。|[添加 Transact-sql 代码段](add-transact-sql-snippets.md)|  
