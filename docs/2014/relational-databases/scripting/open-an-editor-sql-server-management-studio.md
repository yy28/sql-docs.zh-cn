...
## <a name="before-you-begin"></a>开始之前  
 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]支持四种编辑器： [!INCLUDE[ssDE](../../includes/ssde-md.md)]用于编辑[!INCLUDE[tsql](../../includes/tsql-md.md)]脚本的查询编辑器、用于编辑使用这些语言的脚本的 DMX 和 MDX 编辑器、以及用于编辑 xml/a 脚本或 xml 文件的 xml/a 编辑器。 任何编辑器都还可以用于编辑文本文件。  
...
-   **使用当前连接进行查询**-打开一个新的编辑器窗口，其中包含与中[!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]的当前连接关联的类型。 该编辑器窗口使用与当前连接相同的身份验证信息。 例如，如果[!INCLUDE[ssDE](../../includes/ssde-md.md)]在对象资源管理器中选择一个实例，然后使用 "使用**当前连接查询**"， [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]将使用相同的[!INCLUDE[ssDE](../../includes/ssde-md.md)]身份验证信息打开一个连接到同一实例的查询编辑器。  
  
-   **数据库引擎查询**-打开一个新[!INCLUDE[ssDE](../../includes/ssde-md.md)]的查询编辑器和一个对话框，以获取连接到实例所需的信息[!INCLUDE[ssDE](../../includes/ssde-md.md)]。  
  
-   **ANALYSIS SERVICES Mdx 查询**-打开一个新[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]的 mdx 查询编辑器和一个对话框，以获取连接到实例所需的信息[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]。  
  
-   **ANALYSIS SERVICES Dmx 查询**-打开一个新[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]的 dmx 查询编辑器和一个对话框，以获取连接到实例所需的信息[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]。  
  
-   **Analysis Services 的 xml/a 查询**-打开一个[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]新的 Xml/a 查询编辑器和一个对话框，以获取连接到实例所需的[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]信息。  
  
### <a name="using-the-fileopen-menu"></a>使用“文件”/“打开”菜单  
 在 **“文件”** 菜单上，单击 **“打开”**，然后浏览到一个文件并打开它。 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]为文件扩展名打开相应类型的编辑器，将该文件的内容复制到编辑器窗口中，如果需要，还会打开一个连接对话框。 例如，如果打开了一个扩展名为 .sql 的文件， [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] 将打开一个 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 查询编辑器窗口，并将该 .sql 文件的内容复制到其中，然后打开一个连接对话框。 如果您打开的文件的扩展名不与特定编辑器相关联， [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] 将打开一个文本编辑器窗口并将该文件的内容复制到其中。  
...
-   **新查询**-在中[!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]，打开与当前连接相关联的类型的新编辑器窗口。 该编辑器窗口使用与当前连接相同的身份验证信息。 例如，如果您在对象资源管理器中选择一个 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 实例，然后单击 **“新建查询”** 按钮， [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] 将使用相同的身份验证信息打开一个连接到同一实例的 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 查询编辑器。  
