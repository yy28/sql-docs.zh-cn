...
## <a name="what-you-will-learn"></a>学习内容  
 ...
 [第 1 课：创建 Windows Azure 存储对象](../tutorials/lesson-1-create-windows-azure-storage-objects.md)  
 ...
 [第 3 课：将完整数据库备份写入到 Windows Azure Blob 存储服务](../tutorials/lesson-3-write-a-full-database-backup-to-the-windows-azure-blob-storage-service.md)  
