...
|[使用 WMI 提供程序管理服务和网络设置](managing-services-and-network-settings-by-using-wmi-provider.md)|介绍使用 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 对象（该对象表示配置管理的 WMI 提供程序）对 <xref:Microsoft.SqlServer.Management.Smo.Wmi.ManagedComputer> 的实例保持跟踪的若干方法。|  
...
|[脚本编写](scripting.md)|介绍如何在 SMO 中为对象编写脚本和发现对象之间的依赖关系。|  
