...
## <a name="in-this-section"></a>本节内容  
 ...
 [&#40;SQLXML 4.0&#41;在 XPath 查询中指定轴](specifying-axes-in-xpath-queries-sqlxml-4-0.md)  
 说明如何在 XPath 查询中指定轴。  
  
 [&#40;SQLXML 4.0&#41;在 XPath 查询中指定布尔值谓词](specifying-boolean-valued-predicates-in-xpath-queries-sqlxml-4-0.md)  
 说明如何在 XPath 查询中指定布尔值谓词。  
  
 [&#40;SQLXML 4.0&#41;在 XPath 查询中指定关系运算符](specifying-relational-operators-in-xpath-queries-sqlxml-4-0.md)  
 说明如何在 XPath 查询中指定关系运算符。  
  
 [&#40;SQLXML 4.0&#41;在 XPath 查询中指定算术运算符](specifying-arithmetic-operators-in-xpath-queries-sqlxml-4-0.md)  
 说明如何在 XPath 查询中指定算术运算符。  
  
 [&#40;SQLXML 4.0&#41;在 XPath 查询中指定显式转换函数](specifying-explicit-conversion-functions-in-xpath-queries-sqlxml-4-0.md)  
 说明如何在 XPath 查询中指定显式转换函数。  
  
 [在 &#40;SQLXML 4.0&#41;的 XPath 查询中指定布尔运算符](specifying-boolean-operators-in-xpath-queries-sqlxml-4-0.md)  
 说明如何在 XPath 查询中指定布尔运算符。  
  
 [&#40;SQLXML 4.0&#41;在 XPath 查询中指定布尔函数](specifying-boolean-functions-in-xpath-queries-sqlxml-4-0.md)  
 说明如何在 XPath 查询中指定布尔函数。  
  
 [在 &#40;SQLXML 4.0&#41;的 XPath 查询中指定 XPath 变量](specifying-xpath-variables-in-xpath-queries-sqlxml-4-0.md)  
