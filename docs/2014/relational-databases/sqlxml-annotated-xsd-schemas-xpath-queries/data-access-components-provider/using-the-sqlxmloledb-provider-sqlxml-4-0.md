...
2.  部署和安装 SQLXML 4.0 和 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client。  
     ...
     有关详细信息，请参阅上[SQLXML 4.0 编程概念](../../sqlxml/sqlxml-4-0-programming-concepts.md)和[安装 SQL Server Native Client](../../native-client/applications/installing-sql-server-native-client.md)。  
...
## <a name="in-this-section"></a>本节内容  
 ...
 [执行包含 SQL 查询模板&#40;SQLXMLOLEDB Provider&#41;](executing-templates-that-contain-sql-queries-sqlxmloledb-provider.md)  
 ...
 [执行包含 XPath 查询模板&#40;SQLXMLOLEDB Provider&#41;](executing-templates-that-contain-xpath-queries-sqlxmloledb-provider.md)  
