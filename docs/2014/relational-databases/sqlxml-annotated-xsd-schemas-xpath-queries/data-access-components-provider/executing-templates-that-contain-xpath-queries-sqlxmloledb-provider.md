...
-   映射架构  
 ...
 在此示例 ADO 应用程序中，包含 XPath 查询 （根） 的 XML 模板指定针对中所述的 XSD 映射架构 (MySchema.xml)[执行 XPath 查询&#40;SQLXMLOLEDB Provider&#41; ](executing-xpath-queries-sqlxmloledb-provider.md).  
