 ...
 **id**  
 此属性用于对中的元素进行配对** \<>** 和** \< DataInstance>** 块。  
...
|删除|当元素出现在** \< before>** 块中，但不在相应的** \< DataInstance>** 块中时，DiffGram 指示删除操作。 在这种情况下，DiffGram 将从数据库中删除在** \< 前面>** 块中指定的记录实例。 有关工作示例，请参阅[SQLXML 4.0&#41;的 DiffGram 示例 &#40;](diffgram-examples-sqlxml-4-0.md)。<br /><br /> 如果在** \<>块之前**指定了**diffgr： Parentid** ，则由**parentID**指定的元素的父子关系用于确定删除记录的顺序。|  
