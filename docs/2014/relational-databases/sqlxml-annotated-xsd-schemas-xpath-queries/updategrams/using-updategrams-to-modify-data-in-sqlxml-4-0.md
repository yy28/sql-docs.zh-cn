...
## <a name="in-this-section"></a>本节内容  
 ...
 [将参数传递到 Updategram &#40;SQLXML 4.0&#41;](passing-parameters-to-updategrams-sqlxml-4-0.md)  
 说明如何将参数传递到 updategram 并提供有关示例。  
  
 [处理数据库并发问题在 Updategram 中的&#40;SQLXML 4.0&#41;](handling-database-concurrency-issues-in-updategrams-sqlxml-4-0.md)  
