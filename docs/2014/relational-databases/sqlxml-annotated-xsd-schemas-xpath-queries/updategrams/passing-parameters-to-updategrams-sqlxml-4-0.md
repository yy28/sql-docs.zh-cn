...
ms.locfileid: "36028753"
---
# <a name="passing-parameters-to-updategrams-sqlxml-40"></a>将参数传递给 Updategram (SQLXML 4.0)
  Updategram 为模板，因此您可以向其传递参数。 有关将参数传递给模板的详细信息，请参阅[属的 Updategram 安全注意事项&#40;SQLXML 4.0&#41;](../security/updategram-security-considerations-sqlxml-4-0.md)。  
...
-   此示例使用默认映射（即未在 updategram 中指定映射架构）。 有关使用映射架构的 updategram 的更多示例，请参阅[指定批注映射架构中属的 Updategram &#40;SQLXML 4.0&#41;](specifying-an-annotated-mapping-schema-in-an-updategram-sqlxml-4-0.md)。  
...
2.  在准备 SQLXML 4.0 测试脚本 (Sqlxml4test.vbs)[到执行 SQLXML 4.0 查询使用 ADO](../../sqlxml/using-ado-to-execute-sqlxml-4-0-queries.md) ，通过添加以下行后的执行属的 updategram `cmd.Properties("Output Stream").Value = outStream`:  
