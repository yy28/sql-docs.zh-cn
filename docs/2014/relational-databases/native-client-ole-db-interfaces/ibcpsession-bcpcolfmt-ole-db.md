...
> [!NOTE]  
>  [IBCPSession::BCPColumns](ibcpsession-bcpcolumns-ole-db.md)必须任何调用之前调用方法**BCPColFmt**。 必须调用**BCPColFmt**一次针对每个列中的用户文件。 调用**BCPColFmt**不止一次的任何用户文件列会导致错误。  
 ...
 **请注意** [IBCPSession::BCPWriteFmt](ibcpsession-bcpwritefmt-ole-db.md)函数可以用于持久保存通过提供的格式规范**BCPColFmt**。  
...
## <a name="return-code-values"></a>返回代码值  
 ...
 E_FAIL  
 提供程序特定错误的发生，有关详细的信息的使用[ISQLServerErrorInfo](../../database-engine/dev-guide/isqlservererrorinfo-ole-db.md)接口。  
