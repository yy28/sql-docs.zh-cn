...
## <a name="returns"></a>返回  
 ...
 如果该参数属于 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 数据类型之一，则此函数返回以下值。  
  
|新数据类型|返回数据长度|  
|--------------------|------------------------|  
|`BITN`|**NULL：***len* = 0, data = IG, RET = 0<br /><br /> **ZERO：** 不可用<br /><br /> **>=255：** 不可用<br /><br /> **<255：** 不可用|  
