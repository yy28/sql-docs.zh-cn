...
|---------------|--------------------------|-----------------|  
|SRVBIGBINARY|`binary`|
  `binary` 数据类型，长度为 0 至 8000 个字节。|  
|SRVBIGCHAR|`char`|
  `character` 数据类型，长度为 0 至 8000 个字节。|  
