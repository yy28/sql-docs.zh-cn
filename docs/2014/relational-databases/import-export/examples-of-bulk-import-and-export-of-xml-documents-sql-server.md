...
-   A. [大容量导入 XML 数据作为二进制字节流](#binary_byte_stream)  
...
###  <a name="file_contains_dtd"></a> C. 从包含 DTD 的文件中大容量导入 XML 数据  
...
###  <a name="field_terminator_in_format_file"></a> D. 使用格式化文件显式指定字段终止符  
...
###  <a name="bulk_export_xml_data"></a> E. 大容量导出 XML 数据  
