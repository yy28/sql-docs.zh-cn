...
-   受 ALTER PARTITION FUNCTION 的所有文件组必须处于联机状态。  
...
3.  将以下示例复制并粘贴到查询窗口中，然后单击“执行” 。  
 ...
 有关详细信息，请参阅 [ALTER PARTITION FUNCTION (Transact SQL)](/sql/t-sql/statements/alter-partition-function-transact-sql)。  
