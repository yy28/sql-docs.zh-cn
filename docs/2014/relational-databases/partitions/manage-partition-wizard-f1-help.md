...
# <a name="manage-partition-wizard-f1-help"></a>“管理分区向导”的 F1 帮助
  使用**管理分区向导**可以通过分区切换或实现可调窗口应用场景来管理和修改现有的已分区表。 使用此向导，可以轻松管理分区，并可简化表中数据的定期迁入和迁出。  
...
##  <a name="SelectPartitionAction"></a>"选择分区操作" 页  
 ...
 **管理滑动窗口应用场景中的分区数据**  
 ...
 [此部分中与 "](#Top) ![返回页首" 链接一起使用的箭头图标](../../2014-toc/media/uparrow16x16.gif "用于返回页首链接的箭头图标")  
  
##  <a name="SwitchIn"></a>选择分区切换选项页  
...
##  <a name="Progress"></a> “进度”页  
 使用 **“进度”** 页可以监视有关 **“管理分区向导”** 操作的状态信息。 根据在向导中选择的选项，"**进度**" 页可能会包含一个或多个操作。 最上面的方框显示向导的总体状态和向导已接收到的状态、错误和警告消息数。  
...
## <a name="see-also"></a>另请参阅  
 [已分区表和索引](partitioned-tables-and-indexes.md)  
