...
## <a name="benefits-of-activity-monitor"></a>活动监视器的优点  
 活动监视器是一个选项卡式的文档窗口，有以下可展开和折叠窗格：**概述**，**活动用户任务**，**资源等待**，**数据文件 I/O**，并且**最近消耗资源的查询**。 展开任何窗格时，活动监视器都将查询实例以获取相关信息。 折叠窗格时，该窗格的所有查询活动都将停止。 还可以同时展开一个或多个窗格，以查看实例上不同种类的活动。  
