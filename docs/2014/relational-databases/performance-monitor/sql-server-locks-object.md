...
|**Number of Deadlocks/sec**|每秒导致死锁的锁请求数。|  
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]可以锁定这些资源。  
  
|Item|说明|  
|----------|-----------------|  
|**_Total**|所有锁的信息。|  
|**分配单元**|分配单元的锁。|  
|**Application**|锁定指定了应用程序的资源。|  
