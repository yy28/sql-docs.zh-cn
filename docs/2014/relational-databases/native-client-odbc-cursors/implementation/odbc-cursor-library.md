...
# <a name="odbc-cursor-library"></a>ODBC 游标库
 ...
 应用程序通过调用的基于连接的连接是光标库[SQLSetConnectAttr](../../native-client-odbc-api/sqlsetconnectattr.md)连接到数据源之前设置 SQL_ATTR_ODBC_CURSORS 连接属性。 SQL_ATTR_ODBC_CURSORS 设置为下列三个值之一：  
