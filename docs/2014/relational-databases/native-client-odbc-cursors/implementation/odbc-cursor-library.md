...
# <a name="odbc-cursor-library"></a>ODBC 游标库
 ...
 具有应用程序通过调用游标库基于连接的连接[SQLSetConnectAttr](../../native-client-odbc-api/sqlsetconnectattr.md)之前连接到数据源设置 SQL_ATTR_ODBC_CURSORS 连接属性。 SQL_ATTR_ODBC_CURSORS 设置为下列三个值之一：  
