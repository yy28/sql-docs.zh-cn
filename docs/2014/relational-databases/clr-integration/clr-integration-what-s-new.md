...
-   下面的列已添加到[sys.dm_clr_appdomains](/sql/relational-databases/system-dynamic-management-views/sys-dm-clr-appdomains-transact-sql): `total_processor_time_ms`， `total_allocated_memory_kb`，和`survived_memory_kb`。  
