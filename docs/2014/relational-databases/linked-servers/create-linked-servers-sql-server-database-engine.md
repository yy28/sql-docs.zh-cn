...
##  <a name="follow-up-steps-to-take-after-you-create-a-linked-server"></a><a name="FollowUp"></a>跟进：在创建链接服务器后要执行的步骤  
