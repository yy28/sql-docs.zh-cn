...
|**BinaryData**|**image**|会话级别设置，包括 ANSI nulls、ANSI padding、cursor close on commit、null concatenation 和 quoted identifiers。|2|是|  
...
|**TextData**|**ntext**|用分号分隔的所有集选项的列表。|@shouldalert|是|  
