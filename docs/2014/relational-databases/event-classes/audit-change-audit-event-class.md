...
|**SessionLoginName**|**nvarchar**|发起会话的用户的登录名。 例如，如果使用 Login1 连接到[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]并以 Login2 的身份执行语句，则**则 sessionloginname 将**将显示 Login1 和**LoginName**显示 Login2。 此列将同时显示 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 登录名和 Windows 登录名。|64|是|  
