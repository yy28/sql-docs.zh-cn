...
ms.locfileid: "63012195"
---
# <a name="audit-schema-object-gdr-event-class"></a>Audit Schema Object GDR 事件类
  每当中[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]的任何用户对架构对象权限发出 GRANT、REVOKE 或 DENY 时，都会发生**Audit Schema Object GDR**事件类。  
