...
|EventSubClass|`int`|事件子类的类型。<br /><br /> 0 = 递归<br /><br /> 1 = 释放|21|用户帐户控制|  
...
|IntegerData|`int`|递归级数（仅限于哈希递归）。|25|用户帐户控制|  
...
|ObjectID|`int`|重新分区所涉及的哈希组的根节点 ID。 与 Showplan 中的节点 ID 对应。|22|用户帐户控制|  
