...
|DatabaseID|`int`|此资源所属的数据库的 ID。 [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]如果在跟踪中捕获到 ServerName 数据列并且服务器可用，则将显示数据库的名称。 可使用 DB_ID 函数来确定数据库的值。|3|是|  
...
|TextData|`ntext`|依赖于资源类型的文本值。|1|是|  
