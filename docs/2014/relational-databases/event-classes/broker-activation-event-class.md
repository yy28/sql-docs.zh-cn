...
|**EventSubClass**|`nvarchar`|此事件报告的特定操作。 可以是以下值之一：<br /><br /> **启动**: <br />                [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 已启动激活存储过程。<br /><br /> **结束**:激活存储过程已正常退出。<br /><br /> **中止**:激活存储过程因出现错误而退出。|21|否|  
