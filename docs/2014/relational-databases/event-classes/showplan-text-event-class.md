...
ms.locfileid: "62692076"
---
# <a name="showplan-text-event-class"></a>Showplan Text 事件类
  当执行 SQL 语句时[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ，会发生显示计划文本事件类。 所包含的信息是 Showplan All、Showplan XML Statistics Profile 或 Showplan XML 事件类中可用信息的子集。  
