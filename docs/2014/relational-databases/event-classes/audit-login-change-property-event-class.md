...
ms.locfileid: "62991251"
---
# <a name="audit-login-change-property-event-class"></a>Audit Login Change Property 事件类
  当使用**sp_defaultdb**存储过程、 **sp_defaultlanguage**存储过程或 ALTER login 语句来修改登录名的属性时，将发生**Audit login Change Property**事件类。  
