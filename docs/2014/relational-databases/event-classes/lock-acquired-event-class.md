...
|持续时间|`bigint`|从发出锁请求到获得锁的时间（微秒）。|13|是|  
...
## <a name="see-also"></a>另请参阅  
 [Lock：已释放事件类](lock-released-event-class.md)   
