...
ms.locfileid: "48109457"
---
# <a name="scanstarted-event-class"></a>Scan:Started 事件类
  开始扫描表或索引时，会发生 Scan:Started 事件类。  
...
|IndexID|`int`|正在扫描的索引（如果存在索引的话）。|24|用户帐户控制|  
...
|ObjectID|`int`|系统为正在扫描的对象分配的 ID。|22|用户帐户控制|  
