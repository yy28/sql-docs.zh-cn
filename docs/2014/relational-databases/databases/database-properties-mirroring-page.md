...
## <a name="see-also"></a>请参阅  
 [针对数据库镜像和 AlwaysOn 可用性组传输安全&#40;SQL Server&#41;](../../database-engine/database-mirroring/transport-security-database-mirroring-always-on-availability.md)   
