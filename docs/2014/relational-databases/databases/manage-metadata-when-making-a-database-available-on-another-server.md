...
##  <a name="cross-database-queries"></a><a name="cross_database_queries"></a>跨数据库查询  
...
##  <a name="encrypted-data"></a><a name="encrypted_data"></a>加密数据  
...
##  <a name="user-defined-error-messages"></a><a name="user_defined_error_messages"></a>用户定义的错误消息  
...
##  <a name="extended-stored-procedures"></a><a name="extended_stored_procedures"></a>扩展存储过程  
...
##  <a name="full-text-engine-for-sql-server-properties"></a><a name="ifts_service_properties"></a>SQL Server 属性的全文引擎  
...
##  <a name="replication-settings"></a><a name="replication_settings"></a>复制设置  
...
##  <a name="service-broker-applications"></a><a name="sb_applications"></a>Service Broker 应用程序  
 [!INCLUDE[ssSB](../../includes/sssb-md.md)] 应用程序的许多相关内容都将随数据库一起移动。 但是，应用程序的某些相关内容必须在新位置重新创建或重新配置。  
  
 [[返回页首]](#information_entities_and_objects)  
  
##  <a name="startup-procedures"></a><a name="startup_procedures"></a>启动过程  
...
##  <a name="triggers-at-server-level"></a><a name="triggers"></a>触发器（服务器级）  
