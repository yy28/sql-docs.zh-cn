 ...
 *eOption*  
 ...
 BCPDELAYREADFMT  
 布尔值，如果设置为 true，将导致[bcp_readfmt](bcp-readfmt.md)读取在执行。 如果为 false （默认值），bcp_readfmt 立即将读取格式化文件。 如果 BCPDELAYREADFMT 为 true，并且你调用 bcp_columns 或 bcp_setcolfmt，将发生序列错误。  
...
## <a name="remarks"></a>Remarks  
 ...
 仅当在用户文件和 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 表之间进行复制时，这些控制参数才有意义。 控制参数设置对行复制到没有影响[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]与[bcp_sendrow](bcp-sendrow.md)。  
