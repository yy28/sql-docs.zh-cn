...
# <a name="call-stored-procedures-odbc"></a>调用存储过程 (ODBC)
 ...
 有关演示此功能的示例应用，请参阅[过程返回代码和输出参数&#40;ODBC&#41;](running-stored-procedures-process-return-codes-and-output-parameters.md)。  
...
2.  调用[SQLBindParameter](../native-client-odbc-api/sqlbindparameter.md)对于每个输入中，输入/输出和输出参数，和有关该过程返回值 （如果有）。  
