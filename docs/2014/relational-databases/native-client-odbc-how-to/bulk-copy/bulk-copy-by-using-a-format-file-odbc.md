---
title: 通过使用格式化文件 (ODBC) 大容量复制 |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
3.  连接到 Microsoft?? SQL Server 批处理。  
...
5.  调用[bcp_readfmt](../../native-client-odbc-extensions-bulk-copy-functions/bcp-readfmt.md)读取描述通过大容量复制操作使用的数据文件的格式文件。  
