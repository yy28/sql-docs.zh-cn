...
ms.locfileid: "36017707"
---
# <a name="execute-user-defined-functions"></a>执行用户定义函数
  你可以执行中的用户定义函数[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]使用[!INCLUDE[tsql](../../includes/tsql-md.md)]。  
...
#### <a name="to-execute-a-user-defined-function"></a>若要执行用户定义函数  
