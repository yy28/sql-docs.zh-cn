...
-   执行速度更快。  
     ...
     和用于计算任务、字符串操作和业务逻辑的 [!INCLUDE[tsql](../../includes/tsql-md.md)] 函数相比，CLR 函数具有显著的性能优势。 
  [!INCLUDE[tsql](../../includes/tsql-md.md)] 函数更适用于数据访问密集型逻辑。  
...
|介绍如何修改 Transact-SQL 用户定义函数。|[修改用户定义函数](../user-defined-functions/user-defined-functions.md)|  
|介绍如何删除用户定义函数。|[删除用户定义函数](../user-defined-functions/delete-user-defined-functions.md)|  
|介绍如何执行用户定义函数。|[执行用户定义函数](../user-defined-functions/execute-user-defined-functions.md)|  
