...
-   [&#40;transact-sql&#41;的 database_files](/sql/relational-databases/system-catalog-views/sys-database-files-transact-sql) （请参阅日志文件或文件的**大小**、 **max_size**和**增长**列）。  
