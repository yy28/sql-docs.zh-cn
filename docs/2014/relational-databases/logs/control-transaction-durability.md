...
-   事务提交成功后，该事务所做的更改就对系统中的其他事务可见。 有关详细信息，请参阅主题[事务隔离级别](../../database-engine/transaction-isolation-levels.md)。  
...
### <a name="sql-server-shutdown-and-restart"></a>SQL Server 关闭并重新启动  
