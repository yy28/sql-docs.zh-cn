---
title: 使用 IROWSETFASTLOAD 和 ISEQUENTIALSTREAM 将 BLOB 数据发送到 SQL SERVER （OLE DB） |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
# <a name="send-blob-data-to-sql-server-using-irowsetfastload-and-isequentialstream-ole-db"></a>使用 IROWSETFASTLOAD 和 ISEQUENTIALSTREAM 将 BLOB 数据发送到 SQL SERVER (OLE DB)
 ...
 有关详细信息，请参阅 [BLOB 对象和 OLE 对象](../native-client-ole-db-blobs/blobs-and-ole-objects.md)。  
