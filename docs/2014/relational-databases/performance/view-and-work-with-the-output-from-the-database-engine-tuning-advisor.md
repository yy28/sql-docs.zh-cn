 ...
 **详细信息**  
 “建议目标”的说明。 可能的值包括聚集索引、索引视图或空值, 指示非聚集索引。 还指示索引是否是唯一的。  
