...
-   [修改现有跟踪 (Transact-SQL)](../sql-trace/modify-an-existing-trace-transact-sql.md)  
  
-   [查看保存的跟踪 (Transact-SQL)](../sql-trace/view-a-saved-trace-transact-sql.md)  
  
-   [查看筛选器信息 (Transact-SQL)](../sql-trace/view-filter-information-transact-sql.md)  
  
-   [删除跟踪 (Transact-SQL)](../sql-trace/delete-a-trace-transact-sql.md)  
