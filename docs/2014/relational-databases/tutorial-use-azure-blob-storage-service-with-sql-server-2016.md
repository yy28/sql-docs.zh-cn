---
title: 在 Windows Azure 存储服务的教程： SQL Server 数据文件 |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
 ...
 **[第 7 课： 将数据文件移到 Windows Azure 存储](../relational-databases/lesson-6-generate-activity-and-backup-log-using-file-snapshot-backup.md)**  
