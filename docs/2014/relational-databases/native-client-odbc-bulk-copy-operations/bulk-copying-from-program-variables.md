...
```  
 ...
 应用程序可以使用[bcp_colptr](../native-client-odbc-extensions-bulk-copy-functions/bcp-colptr.md)函数需要更改中最初指定的数据变量的地址随时**bcp_bind** *pData*参数。 应用程序可以使用[bcp_collen](../native-client-odbc-extensions-bulk-copy-functions/bcp-collen.md)函数需要更改中最初指定的数据长度随时 **bcp_bind * * * cbData*参数。  
