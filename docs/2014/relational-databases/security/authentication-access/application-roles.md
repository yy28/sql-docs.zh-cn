...
# <a name="application-roles"></a>应用程序角色
 ...
 在 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]中，应用程序角色无法访问服务器级元数据，因为它们不与服务器级主体关联。 若要禁用此限制，从而允许应用程序角色访问服务器级元数据，请设置全局标志 4616。 有关详细信息，请参阅[跟踪标志 (Transact-SQL)](/sql/t-sql/database-console-commands/dbcc-traceon-trace-flags-transact-sql) 和 [DBCC TRACEON (Transact-SQL)](/sql/t-sql/database-console-commands/dbcc-traceon-transact-sql)。  
...
|||  
|-|-|  
|创建应用程序角色。|[创建应用程序角色](create-an-application-role.md)和 [CREATE APPLICATION ROLE (Transact-SQL)](/sql/t-sql/statements/create-application-role-transact-sql)|  
|更改应用程序角色。|[ALTER APPLICATION ROLE (Transact-SQL)](/sql/t-sql/statements/alter-application-role-transact-sql)|  
|删除应用程序角色。|[DROP APPLICATION ROLE (Transact-SQL)](/sql/t-sql/statements/drop-application-role-transact-sql)|  
|使用应用程序角色。|[sp_setapprole (Transact-SQL)](/sql/relational-databases/system-stored-procedures/sp-setapprole-transact-sql)|  
