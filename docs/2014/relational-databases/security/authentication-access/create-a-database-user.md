...
4.  在“常规”页上的“数据库用户 - 新建”对话框中，从“用户类型”列表中选择以下一个用户类型：**带登录名的 SQL 用户**，**不带登录名的 SQL 用户**，**用户映射到证书**，**映射到非对称密钥的用户**，或**Windows 用户**.  
 ...
 **数据库用户-新建**对话框还提供了四个其他页面上的选项：**拥有的架构**，**成员资格**，**安全对象**，并且**扩展属性**。  
