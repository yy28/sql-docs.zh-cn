...
5.  在 **“用户名”** 框中，输入新用户的名称。 如果你从“用户类型”列表中选择了“Windows 用户”，则还可以单击省略号 (…) 打开“选择用户或组”对话框****************。  
  
6.  在 **“登录名”** 框中，输入用户的登录名。 或者，单击省略号 (…) 以打开“选择登录名”对话框********。 如果从 "**用户类型**" 列表中选择 "**带登录名的 SQL 用户**" 或 " **Windows 用户**"，则可以使用**登录名**。  
  
7.  在 **“默认架构”** 框中，指定此用户所创建的对象所属的架构。 或者，单击省略号 (…) 以打开“选择架构”对话框********。 如果从 "**用户类型**" 列表中选择 "**带登录名**的 sql 用户"、"**不登录的 Sql 用户**" 或 " **Windows 用户**"，则可以使用**默认架构**。  
  
8.  在 **“证书名称”** 框中，输入要用于数据库用户的证书。 或者，单击省略号 (…) 以打开“选择证书”对话框********。 如果从 "**用户类型**" 列表中选择 "**用户映射到证书**"，则**证书名称**可用。  
  
9. 在“非对称密钥名称” ****  框中，输入要用于数据库用户的密钥。 或者，单击省略号 (…) 以打开“选择非对称密钥”对话框********。 如果从 "**用户类型**" 列表中选择 "**映射到非对称密钥的用户**"，则 "**非对称密钥名称**" 可用。  
  
10. [!INCLUDE[clickOK](../../../includes/clickok-md.md)]  
  
### <a name="additional-options"></a>其他选项  
 "**数据库用户-新建**" 对话框还提供了其他四个页面上的选项： "**拥有的架构**"、"**成员身份**"、**安全对象**和 "**扩展属性**"。  
