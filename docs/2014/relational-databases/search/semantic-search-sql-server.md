...
##  <a name="what-can-i-do-with-semantic-search"></a><a name="whatcanido"></a>语义搜索有哪些用途？  
...
###  <a name="find-the-key-phrases-in-a-document"></a><a name="find1"></a>查找文档中的关键短语  
...
###  <a name="find-similar-or-related-documents"></a><a name="find2"></a>查找相似或相关文档  
...
###  <a name="find-the-key-phrases-that-make-documents-similar-or-related"></a><a name="find3"></a>查找使文档相似或相关的关键短语  
...
##  <a name="storing-documents-in-sql-server"></a><a name="store"></a>将文档存储在 SQL Server  
