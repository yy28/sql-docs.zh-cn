...
###  <a name="HowToIdentifySimilar"></a> 示例： 查找类似于另一个文档顶级文档  
...
###  <a name="HowToQuerySimilarity"></a> 如何： 查找有关文档相似或相关使用 SEMANTICSIMILARITYDETAILSTABLE 的方式的信息  
...
###  <a name="HowToSimilarPhrases"></a> 示例： 查找最相似的文档之间的关键短语  
