---
title: 将 XSD 数据类型映射到 XPath 数据类型（SQLXML 4.0） |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
|-------------------|-------------------|------------------------------------|--------------------------------------------|  
|`Base64Binary`<br /><br /> `HexBinary`|`None`<br /><br /> `bin.base64bin.hex`|`Not applicable`|无<br /><br /> EmployeeID|  
