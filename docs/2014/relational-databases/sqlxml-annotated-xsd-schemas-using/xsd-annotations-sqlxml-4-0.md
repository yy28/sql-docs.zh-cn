...
|`sql:inverse`|指示 updategram 逻辑反转使用指定的父子关系的解释 **\<sql:relationship>** 。|[在 sql： relationship 上指定 sql：反向特性 &#40;SQLXML 4.0&#41;](specifying-the-sql-inverse-attribute-on-sql-relationship-sqlxml-4-0.md)|不支持|  
