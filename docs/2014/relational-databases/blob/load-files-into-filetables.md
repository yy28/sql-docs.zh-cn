...
###  <a name="how-to-bulk-load-files-into-a-filetable"></a><a name="HowToBulkLoad"></a> 如何大容量加载文件到 FileTable  
...
###  <a name="how-to-disable-filetable-constraints-for-bulk-loading"></a><a name="disabling"></a> 如何禁用针对大容量加载的 FileTable 约束  
