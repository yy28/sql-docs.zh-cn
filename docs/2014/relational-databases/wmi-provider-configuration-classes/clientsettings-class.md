...
ms.locfileid: "63242877"
---
# <a name="clientsettings-class"></a>ClientSettings 类
  [ClientSettings 类](clientsettings-class.md)表示客户端[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]上的设置。  
