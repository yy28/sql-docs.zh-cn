---
title: InstanceName 属性（ClientSettings 类） |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="parts"></a>组成部分  
 *对象*  
 一个表示 `ClientSettings` 客户端实例上的设置的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 对象。  
