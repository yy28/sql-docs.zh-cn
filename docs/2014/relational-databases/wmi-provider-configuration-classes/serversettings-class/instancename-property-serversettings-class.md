---
title: InstanceName 属性 （ServerSettings 类） |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "53366389"
---
# <a name="instancename-property-serversettings-class"></a>InstanceName 属性（ServerSettings 类）
  获取的实例的名称[!INCLUDE[msCoName](../../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]服务器设置所适用。  
