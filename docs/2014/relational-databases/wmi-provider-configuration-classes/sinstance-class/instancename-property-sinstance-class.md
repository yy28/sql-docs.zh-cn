---
title: InstanceName 属性（SInstance 类） |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "63136485"
---
# <a name="instancename-property-sinstance-class"></a>InstanceName 属性（SInstance 类）
  获取实例[!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]的名称。  
