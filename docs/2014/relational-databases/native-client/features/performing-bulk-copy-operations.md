...
# <a name="performing-bulk-copy-operations"></a>执行大容量复制操作
 ...
 有关演示此功能的示例应用程序，请参阅[使用 IRowsetFastLoad &#40;批量复制数据 OLE DB&#41;](../../native-client-ole-db-interfaces/irowsetfastload-ole-db.md)。  
...
-   将数据加载到程序变量中，然后使用大容量复制函数将数据导入表或视图中，以便一次一行执行大容量复制。  
 ...
 编写应用程序以使用大容量复制函数的程序员应当遵从常规规则，以获得良好的大容量复制性能。 有关中[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]的大容量复制操作支持的详细信息，请参阅[批量导入和导出数据 &#40;SQL Server&#41;](../../import-export/bulk-import-and-export-of-data-sql-server.md)。  
...
### <a name="using-memory-based-bulk-copy-operations"></a>使用基于内存的大容量复制操作  
 Native Client OLE DB 提供程序实现了**IRowsetFastLoad**接口，以公开对[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]基于内存的大容量复制操作的支持。 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] IRowsetFastLoad 接口实现了 **IRowsetFastLoad::Commit** 和 [IRowsetFastLoad::InsertRow](../../native-client-ole-db-interfaces/irowsetfastload-commit-ole-db.md) 方法[](../../native-client-ole-db-interfaces/irowsetfastload-insertrow-ole-db.md)。  
...
### <a name="using-file-based-bulk-copy-operations"></a>使用基于文件的大容量复制操作  
 Native Client OLE DB 提供程序实现了**IBCPSession**接口，以公开对[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]基于文件的大容量复制操作的支持。 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] IBCPSession 接口实现了 **IBCPSession::BCPColFmt**、[IBCPSession::BCPColumns](../../native-client-ole-db-interfaces/ibcpsession-bcpcolfmt-ole-db.md)、[IBCPSession::BCPControl](../../native-client-ole-db-interfaces/ibcpsession-bcpcolumns-ole-db.md)、[IBCPSession::BCPDone](../../native-client-ole-db-interfaces/ibcpsession-bcpcontrol-ole-db.md)、[IBCPSession::BCPExec](../../native-client-ole-db-interfaces/ibcpsession-bcpdone-ole-db.md)、[IBCPSession::BCPInit](../../native-client-ole-db-interfaces/ibcpsession-bcpexec-ole-db.md)、[IBCPSession::BCPReadFmt](../../native-client-ole-db-interfaces/ibcpsession-bcpinit-ole-db.md) 和 [IBCPSession::BCPWriteFmt](../../native-client-ole-db-interfaces/ibcpsession-bcpreadfmt-ole-db.md) 方法[](../../native-client-ole-db-interfaces/ibcpsession-bcpwritefmt-ole-db.md)。  
  
## <a name="sql-server-native-client-odbc-driver"></a>SQL Server Native Client ODBC 驱动程序  
 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] NATIVE Client ODBC 驱动程序保持与早期版本的[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] ODBC 驱动程序中的大容量复制操作的支持相同。 有关使用[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] NATIVE Client ODBC 驱动程序进行大容量复制操作的详细信息，请参阅[&#40;ODBC&#41;执行大容量复制操作](../../native-client-odbc-bulk-copy-operations/performing-bulk-copy-operations-odbc.md)。  
  
## <a name="see-also"></a>另请参阅  
 [SQL Server Native Client 功能](sql-server-native-client-features.md)   
 [数据源属性 &#40;OLE DB&#41;](../../native-client-ole-db-data-source-objects/data-source-properties-ole-db.md)   
 [大容量导入和导出数据 &#40;SQL Server&#41;](../../import-export/bulk-import-and-export-of-data-sql-server.md)   
