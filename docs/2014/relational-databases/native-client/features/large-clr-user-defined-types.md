...
# <a name="large-clr-user-defined-types"></a>大型 CLR 用户定义类型
 ...
 有关详细信息，请参阅[Large CLR User-Defined 类型&#40;OLE DB&#41; ](../ole-db/large-clr-user-defined-types-ole-db.md)和[Large CLR User-Defined 类型&#40;ODBC&#41;](../odbc/large-clr-user-defined-types-odbc.md)。  
