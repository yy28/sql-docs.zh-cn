...
|*MachineName* $@*域*|计算机帐户的直接规范。<br /><br /> （如果要连接到的服务器在 "本地系统" 或 "网络服务" 帐户下运行，若要获取 Kerberos 身份验证， `ServerSPN` 可以采用*MachineName* $@ *域*格式。）|  
...
-   [客户端连接中的服务主体名称 (SPN) (ODBC)](../odbc/service-principal-names-spns-in-client-connections-odbc.md)  
