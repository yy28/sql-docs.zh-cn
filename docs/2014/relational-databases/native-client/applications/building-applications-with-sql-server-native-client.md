...
## <a name="in-this-section"></a>本节内容  
 ...
 [使用 SQL Server Native Client 头文件和库文件](using-the-sql-server-native-client-header-and-library-files.md)  
 讨论如何在应用程序中使用 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 头文件和库文件。  
  
 [将应用程序从 MDAC 更新到 SQL Server Native Client](updating-an-application-to-sql-server-native-client-from-mdac.md)  
 ...
 [将 ADO 用于 SQL Server Native Client](using-ado-with-sql-server-native-client.md)  
