...
-   `DataTypeCompatibility=80`  
 ...
 有关 Native Client 中支持的 ADO 连接字符串关键字的详细信息 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] ，请参阅将[连接字符串关键字用于 SQL Server Native Client](using-connection-string-keywords-with-sql-server-native-client.md)。  
