---
title: SQL Server Native Client 编程 |Microsoft 文档
ms.custom: ''
ms.date: 04/27/2017
...
> [!NOTE]  
>  有关之间的差异的列表[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]本机客户端和 Windows DAC，以及有关问题的信息更新到 Windows DAC 应用程序之前要考虑[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]本机客户端，请参阅[更新到 SQL Server 的应用程序本机客户端从 MDAC](applications/updating-an-application-to-sql-server-native-client-from-mdac.md)。  
...
## <a name="in-this-section"></a>本节内容  
 ...
 讨论如何[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]适应 Microsoft 数据访问技术，本机客户端如何它将与 Windows DAC 和 ADO.NET，进行比较并提供数据访问技术，可使用指针来确定。  
...
## <a name="see-also"></a>请参阅  
 [更新应用程序从 SQL Server 2005 的本机客户端](applications/updating-an-application-from-sql-server-2005-native-client.md)   
