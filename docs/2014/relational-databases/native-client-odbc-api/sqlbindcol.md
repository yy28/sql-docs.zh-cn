...
# <a name="sqlbindcol"></a>SQLBindCol
 ...
 开发人员可以使用*TargetType* `SQL_C_BINARY`值[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]将列绑定到特定的 C 数据类型。 不可移植绑定到 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 特定类型的列。 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 特定的已定义 ODBC C 数据类型与 DB-Library 的类型定义匹配，移植应用程序的 DB-Library 开发人员可能需要利用此功能。  
