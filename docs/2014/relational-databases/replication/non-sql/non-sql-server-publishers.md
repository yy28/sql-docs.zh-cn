...
ms.locfileid: "63022098"
---
# <a name="non-sql-server-publishers"></a>非 SQL Server 发布服务器
  通过从非[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]源发布数据，您可以在中[!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]合并数据。 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]可以订阅从 Oracle 数据库发布的快照或事务数据。 有关从 Oracle 发布的详细信息，请参阅 [Oracle 发布概述](oracle-publishing-overview.md)。  
