...
-   复制 [!INCLUDE[tsql](../../../includes/tsql-md.md)] 编程：[为合并项目指定不应跟踪删除（复制 Transact-SQL 编程）](../publish/specify-that-deletes-should-not-be-tracked-for-merge-articles.md)  
