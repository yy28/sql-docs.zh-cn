...
---
# <a name="sql-server-replication-add-publisher-dialog-box"></a>SQL Server 复制 "添加发布服务器" 对话框 
  通过 "**添加发布服务器**" 对话框，您可以将一个或多个发布服务器添加到复制监视器的左窗格中。 添加发布服务器之后，如果在左窗格中选择发布服务器，将在右窗格中显示该发布服务器的有关信息。  
