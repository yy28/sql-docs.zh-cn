...
> [!NOTE]  
>  复制不会自动切换更新模式。 必须通过 SQL Server Management Studio 设置更新模式，否则你的应用程序必须调用 [sp_setreplfailovermode &#40;Transact-SQL&#41;](/sql/relational-databases/system-stored-procedures/sp-setreplfailovermode-transact-sql) 来切换更新模式。  
...
[切换可更新事务性订阅的更新模式](../administration/switch-between-update-modes-for-an-updatable-transactional-subscription.md)  
