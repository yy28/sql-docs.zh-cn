...
|合并发布分区的快照代理|**Dyn_\<发布服务器>\<->\<发布数据库>-\<GUID>**|[Replication Snapshot Agent](replication-snapshot-agent.md)|  
...
|推送订阅的分发代理|**\<\<\<发布服务器>-发布数据库> 发布>-订阅服务器>\<整数>1 \<** <sup></sup>|[Replication Distribution Agent](replication-distribution-agent.md)|  
|请求订阅的分发代理|**\<\<\<\<发布服务器>-发布数据库> 发布>-订阅服务器>-订阅数据库>\<-GUID>2 \<** <sup></sup>|[Replication Distribution Agent](replication-distribution-agent.md)|  
