...
-   合并复制允许使用下列类型的项目冲突解决程序：  
    ...
    -   基于 COM 的标准冲突解决程序，包含在中 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 。  
...
##  <a name="using-sql-server-management-studio"></a><a name="SSMSProcedure"></a> 使用 SQL Server Management Studio  
 注册冲突解决程序之后，指定项目应使用 "**项目属性- \<Article> ** " 对话框的 "**冲突解决程序**" 选项卡上的 "冲突解决程序" 选项卡，该对话框在新建发布向导和 "**发布属性- \<Publication> **对话框" 中提供。 有关如何使用该向导和如何访问该对话框的详细信息，请参阅[创建发布](create-a-publication.md)和[查看和修改发布属性](view-and-modify-publication-properties.md)。  
...
5.  如果冲突解决程序为业务逻辑处理程序，则将程序集部署在与合并代理可执行文件（replmerg.exe）相同的文件夹中，并将该程序集部署在与调用合并代理的应用程序相同的文件夹中，或部署在步骤3中为该参数指定的文件夹中 **@dotnet_assembly_name** 。  
