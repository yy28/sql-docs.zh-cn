...
-   只能从在服务器实例当前运行的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 版本上创建的备份中还原系统数据库。 例如，若要还原在 SP1 上运行的服务器实例上的系统数据库 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 。  
