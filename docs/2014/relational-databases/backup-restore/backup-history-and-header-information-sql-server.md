...
> [!IMPORTANT]  
>  为了规避丢失对备份和还原历史记录的最新更改的风险，请经常备份 **msdb** 。 有关必须备份哪些系统数据库的信息，请参阅[备份和还原系统数据库 (SQL Server)](back-up-and-restore-of-system-databases-sql-server.md)。  
...
|[backupmediafamily](/sql/relational-databases/system-tables/backupmediafamily-transact-sql)|每个介质簇在表中占一行。 如果介质簇驻留在镜像介质集中，则对于介质集中的每个镜像，该介质簇都具有一个单独的行。|  
|[backupmediaset](/sql/relational-databases/system-tables/backupmediaset-transact-sql)|每个备份介质集在表中占一行。|  
|[backupset](/sql/relational-databases/system-tables/backupset-transact-sql)|每个备份集在表中占一行。|  
|[restorefile](/sql/relational-databases/system-tables/restorefile-transact-sql)|每个已还原的文件在表中占一行。 这包括按文件组名称间接还原的文件。|  
|[restorefilegroup](/sql/relational-databases/system-tables/restorefilegroup-transact-sql)|每个已还原的文件组在表中占一行。|  
|[restorehistory](/sql/relational-databases/system-tables/restorehistory-transact-sql)|每个还原操作在表中占一行。|  
