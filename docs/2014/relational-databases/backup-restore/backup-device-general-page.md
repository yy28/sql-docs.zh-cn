 ...
 **磁带**  
 在“磁带”**** 列表中查看或选择目标磁带设备。 仅当磁带驱动器连接到运行实例[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]的计算机时，此选项才可用。  
