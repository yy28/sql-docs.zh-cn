...
2.  在“SQL Server 配置管理器”中，展开“SQL Server 网络配置”，然后单击“\<InstanceName> 的协议”************ __。  
...
> [!NOTE]  
>  端口号分配由 Internet 号码分配机构管理，并在中列出 [http://www.iana.org](https://go.microsoft.com/fwlink/?LinkId=48844) 。应从数字49152到65535分配端口号。  
...
##  <a name="opening-ports-in-the-firewall"></a><a name="firewall"></a>打开防火墙中的端口  
...
4.  在 **“协议和端口”** 对话框中，选择 **TCP**。 选择“特定本地端口”****，然后键入 [!INCLUDE[ssDE](../includes/ssde-md.md)] 实例的端口号。 为默认实例键入 1433。 `49172`如果要配置命名实例，并在上一个任务中配置了固定端口，请键入。 单击“下一步”。  
...
##  <a name="connecting-to-the-database-engine-from-another-computer"></a><a name="otherComp"></a>从另一台计算机连接到数据库引擎  
