...
1.  通过运行 **sp_syscollector_stop_collection_set** 存储过程停止要向其中添加收集项的收集组。 例如，若要停止名为“Test Collection Set”的收集组，请运行下列语句：  
    ...
    > [!NOTE]  
    >  还可以通过使用 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]中的对象资源管理器来停止收集组。 有关详细信息，请参阅 [启动或停止收集组](start-or-stop-a-collection-set.md)。  
