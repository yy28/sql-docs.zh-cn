...
-   “从 Microsoft Azure 导入” - 从 Microsoft Azure 容器中导入一个 BACPAC 文件。 若要验证此选项，则您必须连接到 Microsoft Azure 容器。 请注意，此选项还要求您为临时文件指定一个本地目录。 将在指定位置创建临时文件，并且在操作完成后，临时文件将保留在该位置。  
...
-   **[!INCLUDE[ssSDS](../../includes/sssds-md.md)] 版本** – 指定 [!INCLUDE[ssSDS](../../includes/sssds-md.md)] Business 或 [!INCLUDE[ssSDS](../../includes/sssds-md.md)] Web。 有关 [!INCLUDE[ssSDS](../../includes/sssds-md.md)]版本的详细信息，请参阅此 [SQL Database](http://www.windowsazure.com/home/tour/database/) 网站。  
