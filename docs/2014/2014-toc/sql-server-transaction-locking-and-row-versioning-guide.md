...
##  <a name="locking-in-the-database-engine"></a><a name="Lock_Engine"></a>锁定数据库引擎  
...
-   **多重活动结果集 (MARS) 资源**。 这些资源用于控制在 MARS 下交叉执行多个活动请求。 有关详细信息，请参阅[SQL Server 中的多个活动结果集（MARS）](https://msdn.microsoft.com/library/ms345109(v=SQL.90).aspx)。  
...
##  <a name="row-versioning-based-isolation-levels-in-the-database-engine"></a><a name="Row_versioning"></a>数据库引擎中基于行版本控制的隔离级别  
...
###  <a name="customizing-locking-for-an-index"></a><a name="Customize"></a> 自定义索引的锁定  
...
##  <a name="advanced-transaction-information"></a><a name="Advanced"></a> 高级事务信息  
