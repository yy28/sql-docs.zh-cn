...
ms.locfileid: "33041405"
---
# <a name="sql-server-management-studio-menu-help"></a>SQL Server Management Studio 菜单帮助
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
本节介绍了 [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] [!INCLUDE[ssManStudio](../../includes/ssmanstudio_md.md)]菜单栏中提供的对话框和页的 F1 帮助。  
