---
title: "SQL Server Management Studio 菜单帮助 | Microsoft Docs"
ms.custom: 
ms.date: 01/19/2017
...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] 本节介绍了 [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] [!INCLUDE[ssManStudio](../../includes/ssmanstudio_md.md)] 菜单栏中提供的对话框和页的 F1 帮助。  
