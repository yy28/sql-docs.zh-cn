...
## <a name="downloadssdtmediadownloadpng-sql-server-management-studio-170-releasehttpgomicrosoftcomfwlinklinkid847722"></a>![下载](../ssdt/media/download.png) [ SQL Server Management Studio 17.0 版本](http://go.microsoft.com/fwlink/?LinkID=847722)

**版本信息**  
  
*此版本的 SSMS 使用 Visual Studio 2015 独立 shell。*  
版本号：17.0  
此版本的内部版本号为：14.0.17099.0

## <a name="changelog"></a>更改日志  

请参阅 [17.0](sql-server-management-studio-changelog-ssms.md#ssms-170-release)。
