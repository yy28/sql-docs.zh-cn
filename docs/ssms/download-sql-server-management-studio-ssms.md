...
## <a name="ssms-180-preview"></a>SSMS 18.0（预览版）

现已推出 SSMS 18.0 公共预览版 4，并且是最新一代的 SQL Server Management Studio，可支持 [!INCLUDE[sql-server-2019](..\includes\sssqlv15-md.md)]！
...
## <a name="available-languages-ssms-180-preview"></a>可用语言（SSMS 18.0 预览版）
...
## <a name="new-in-this-release-ssms-180-preview"></a>此版本（SSMS 18.0 预览版）中的新增功能
...
## <a name="supported-sql-offerings-ssms-180-preview"></a>受支持的 SQL 产品/服务（SSMS 18.0 预览版）
...
## <a name="supported-operating-systems-ssms-180-preview"></a>受支持的操作系统（SSMS 18.0 预览版）
...
## <a name="ssms-installation-tips-and-issues-ssms-180-preview"></a>SSMS 安装提示和问题（SSMS 18.0 预览版）
...
## <a name="release-notes-ssms-180-preview"></a>发行说明（SSMS 18.0 预览版）
