...
[!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull_md.md)] 的“连接到”对话框将最常用的连接字符串值作为选项提供。 使用“其他连接参数”页可以将更多连接参数添加到连接字符串。  
...
1.  在 [!INCLUDE[ssManStudio](../../includes/ssmanstudio_md.md)] 的“查询”菜单上指向“连接”，然后单击“连接”。  
...
若要连接到名为 ACCOUNTING 的服务器上的 [!INCLUDE[ssSampleDBnormal](../../includes/sssampledbnormal_md.md)] 数据库，请在“其他连接参数”页中输入以下内容：  
