...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] 可以在数据库关系图中快速对表进行排列以清楚地查看每个表和关系。  
  
### <a name="to-arrange-tables-in-diagrams"></a>在关系图中排列表  
