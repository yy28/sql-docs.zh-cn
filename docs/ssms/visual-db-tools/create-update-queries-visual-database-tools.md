...
2.  在“查询设计器”****菜单中，指向“更改类型”****，再单击“更新”****。  
    ...
    > [!NOTE]  
    > 如果启动“更新”查询时“关系图”窗格中显示有多个表，则查询和视图设计器将显示“选择插入值的目标表”对话框[](../../ssms/visual-db-tools/choose-target-table-for-insert-values-dialog-box-visual-database-tools.md)，以提示你输入要更新的表名。  
