...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] 以下基本操作适用于大部分或全部查询。  
...
[停止查询 (Visual Database Tools)](../../ssms/visual-db-tools/stop-a-query-visual-database-tools.md)  
介绍在查询运行时将其暂停的步骤。  
  
[保存查询 (Visual Database Tools)](../../ssms/visual-db-tools/save-queries-visual-database-tools.md)  
介绍将新查询或修改后的查询保存到数据库项目的步骤。  
  
[验证查询 (Visual Database Tools)](../../ssms/visual-db-tools/verify-queries-visual-database-tools.md)  
介绍验证查询的 SQL 语法的步骤。  
  
[修改查询 (Visual Database Tools)](../../ssms/visual-db-tools/modify-queries-visual-database-tools.md)  
介绍打开现有查询以进行修改的步骤。  
  
[删除查询 (Visual Database Tools)](../../ssms/visual-db-tools/delete-queries-visual-database-tools.md)  
介绍从项目中删除查询的步骤。  
  
[复制查询 (Visual Database Tools)](../../ssms/visual-db-tools/copy-queries-visual-database-tools.md)  
介绍将 SQL 代码从一个查询复制并粘贴到另一个查询的步骤。  
  
[重命名查询 (Visual Database Tools)](../../ssms/visual-db-tools/rename-queries-visual-database-tools.md)  
介绍重命名现有查询的步骤  
  
[放弃对查询所做的更改 (Visual Database Tools)](../../ssms/visual-db-tools/discard-changes-made-to-queries-visual-database-tools.md)  
介绍将查询恢复为其上次更改状态的步骤。  
...
[创建列别名 (Visual Database Tools)](../../ssms/visual-db-tools/create-column-aliases-visual-database-tools.md)  
介绍为查询中包括的列创建别名的步骤。  
...
[使用表以外的对象创建查询 (Visual Database Tools)](../../ssms/visual-db-tools/create-queries-using-something-besides-a-table-visual-database-tools.md)  
介绍创建使用表值对象（如表值函数和视图）的查询的步骤。  
  
[在“关系图”窗格中显示列名 (Visual Database Tools)](../../ssms/visual-db-tools/show-column-names-in-the-diagram-pane-visual-database-tools.md)  
介绍自定义表和表值对象在“关系图”窗格中的外观的步骤。  
  
[对国际数据使用查询和视图设计器 (Visual Database Tools)](../../ssms/visual-db-tools/use-the-query-and-view-designer-with-international-data-visual-database-tools.md)  
