...
有关如何使用 [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull_md.md)]的详细信息，请参阅 [使用 SQL Server Management Studio 进行开发和实现](http://msdn.microsoft.com/c4f5a06b-e2e4-4660-a3a8-6fd356742c02)  
...
-   [管理报表服务器数据库](http://msdn.microsoft.com/97b2e1b5-3869-4766-97b9-9bf206b52262)  
  
-   [如何创建 RSExecRole](http://msdn.microsoft.com/7ac17341-df7e-4401-870e-652caa2859c0)  
...
[使用 SQL Server Data Tools 进行开发和实现](http://msdn.microsoft.com/132ed779-3ec8-4734-9698-802116d1b017)  
[SQL Server Data Tools 中的 Reporting Services](http://msdn.microsoft.com/0903c7b2-ac59-45f1-b7d0-922ecd9d76f8)  
