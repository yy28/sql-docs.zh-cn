...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] 本节包含 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] 代理的 F1 帮助。 按 F1 键或在对话框中单击“帮助”即可从用户界面中查看这些主题。  
