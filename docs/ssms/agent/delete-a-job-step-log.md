...
本主题介绍如何删除 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] 代理作业步骤日志。  
...
有关详细信息，请参阅 [sp_delete_jobsteplog (Transact-SQL)](http://msdn.microsoft.com/e9ef4c99-abde-4038-b6a3-a25dcbaf0958)。  
