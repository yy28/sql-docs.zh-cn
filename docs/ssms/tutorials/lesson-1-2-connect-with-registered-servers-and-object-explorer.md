...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] 本教程演示如何使用已注册的服务器和对象资源管理器。  
...
[更改环境布局](../../tools/sql-server-management-studio/lesson-1-3-change-the-environment-layout.md)  
