...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] 可以配置代码窗口，以多种方式显示多个代码窗口。  
...
[编写表脚本](../../tools/sql-server-management-studio/lesson-2-6-script-a-table.md)  
