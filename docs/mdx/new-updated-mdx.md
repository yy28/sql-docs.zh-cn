---
title: "已更新-SQL Server 文档的 MDX |Microsoft 文档"
description: "显示有关最近更改中的文档，为多维表达式 (MDX) 的 Microsoft SQL Server 的更新内容的代码段。"
services: na
documentationcenter: 
author: MightyPen
manager: jhubbard
...
---
# <a name="new-and-recently-updated-multidimensional-expressions-mdx-for-sql-server"></a>新的和最近的更新： SQL Server 的多维表达式 (MDX)
