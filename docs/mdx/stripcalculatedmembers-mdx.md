...
## <a name="remarks"></a>备注  
 **StripCalculatedMembers**函数从集中删除计算的成员。 计算成员可以通过使用添加到一组[AddCalculatedMembers](../mdx/addcalculatedmembers-mdx.md)函数，返回的服务器，定义的计算的成员或通过使用 WITH 添加在查询自身中的计算的成员成员的语法。  
