---
title: MDX 数据操作语句 (MDX) |Microsoft 文档
ms.custom: ''
ms.date: 03/02/2016
...
|[清除计算语句&#40;MDX&#41;](../mdx/mdx-data-manipulation-clear-calculations.md)|从多维数据集中删除所有计算，并将多维数据集恢复为计算传递 0。|  
|[钻取语句&#40;MDX&#41;](../mdx/mdx-data-manipulation-drillthrough.md)|检索用来在多维数据集中创建指定单元的行集。|  
|[SELECT 语句 & #40;MDX & #41;](../mdx/mdx-data-manipulation-select.md)|从指定多维数据集中检索数据。|  
