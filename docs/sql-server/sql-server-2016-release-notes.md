...
[![下载 SSMS](../ssms/download-sql-server-management-studio-ssms.md) **SSMS：**若要获取最新版本的 SQL Server Management Studio，请参阅**[下载 SQL Server Management Studio (SSMS)](../ssms/download-sql-server-management-studio-ssms.md)**。   
