...
[![下载 SSMS](../analysis-services/media/download.png)](https://msdn.microsoft.com/library/mt238290.aspx) **SSMS：**若要获取最新版本的 SQL Server Management Studio，请参阅**[下载 SQL Server Management Studio (SSMS)](https://msdn.microsoft.com/library/mt238290.aspx)**。   
    
 有关新增功能的信息，请参阅[《What's New in SQL Server 2016》](What's%20New%20in%20Report%20Builder%20for%20SQL%20Server%202016.md)（SQL Server 2016 的新增功能）。
    
##  <a name="a-namebkmktopa-sections-in-this-topic"></a><a name="bkmk_top"></a>本主题的内容：    
...
## <a name="a-namebkmk2016sp1asql-server-2016-service-pack-1-sp1-available"></a><a name="bkmk_2016sp1"></a>SQL Server 2016 Service Pack 1 (SP1) 可用
...
- [SQL Server 2016 Service Pack 1 release information](https://support.microsoft.com/en-us/kb/3182545)（SQL Server 2016 Service Pack 1 发布信息） 列出了 SP1 中修复或更改的单个 bug #s 和问题。
 - ![info_tip](../sql-server/media/info-tip.png) 有关所有受支持版本的链接和信息（包括 [!INCLUDE[ssNoVersion_md](../includes/ssnoversion-md.md)] 的 Service Pack），请参阅 [SQL Server 更新中心](https://msdn.microsoft.com/library/ff803383.aspx) 
    
    
##  <a name="a-namebkmk2016gaa-sql-server-2016-release---general-availability-ga"></a><a name="bkmk_2016_ga"></a>SQL Server 2016 版本 - 正式发布版 (GA)
...
### <a name="repliconwarnimagerepliconwarngif-a-namebkmkgainstalpatcha-install-patch-requirement-ga"></a>![repl_icon_warn](../database-engine/availability-groups/windows/media/repl-icon-warn.png) <a name="bkmk_ga_instalpatch"></a> 安装修补程序要求 (GA) 
...
### <a name="a-namebkmkgaquerystoreaquery-store"></a><a name="bkmk_ga_query_store"></a>查询存储
...
###  <a name="a-namebkmkgadocsa-product-documentation-ga"></a><a name="bkmk_ga_docs"></a>产品文档 (GA) 
...
##  <a name="a-namebkmk2016rc3a-sql-server-2016-release-candidate-3-rc3"></a><a name="bkmk_2016_rc3"></a>SQL Server 2016 候选发布版 3 (RC3)    
-   [产品文档 (RC2)](#bkmk_rc3_docs)    
-   [PolyBase (RC3)](#bkmk_rc3_polybase) 

    
###  <a name="a-namebkmkrc3docsa-product-documentation-rc3"></a><a name="bkmk_rc3_docs"></a>产品文档 (RC3)    
 **问题及其对客户的影响：** 尚未提供可下载的 SQL Server 2016 文档版本。 当你尝试使用帮助库管理器 **联机安装内容**时，你将看到 SQL Server 2012 和 SQL Sever 2014 文档，但没有 SQL Server 2016 文档的选项。    
