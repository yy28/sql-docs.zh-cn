...
ms.topic: "article"
helpviewer_keywords: 
  - "高可用性 [SQL Server], 解决方案"
  - "数据库引擎 [SQL Server], 可用性"
  - "数据库可用性 [SQL Server]"
  - "可用性 [SQL Server]"
  - "服务器可用性 [SQL Server]"
...
>  **注意！** 想要知道哪个 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 版本支持给定的高可用性解决方案？ 请参阅 [SQL Server 2016 各个版本支持的功能](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md)中的“高可用性 (AlwaysOn)”部分。    
