...
helpviewer_keywords: 
  - "群集 [SQL Server], 虚拟服务器"
  - "重命名虚拟服务器"
  - "虚拟服务器 [SQL Server], 故障转移群集"
  - "故障转移群集 [SQL Server], 虚拟服务器"
 ...
 **[!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)]：** 在您使用 Windows 群集管理器工具更改某一 [!INCLUDE[ssASCurrent](../../../includes/ssascurrent-md.md)] 故障转移群集实例的网络名称后，将来的升级或卸载操作可能会失败。 若要解决此问题，请按照[此文章](http://go.microsoft.com/fwlink/?LinkId=244002) (http://go.microsoft.com/fwlink/?LinkId=244002) 的解决方法部分中的说明更新 **ClusterName** 注册表项。  
