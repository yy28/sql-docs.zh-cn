...
(1) 要使用 Visual Studio 2019 或 2017 安装 Help Viewer，请在“Visual Studio 安装程序”的“各个组件”选项卡上，选择“代码工具”下的“Help Viewer”，然后单击“安装”   。

(2) 表示 SQL Server 安装程序中的“文档组件”选项。

>[!NOTE]
> - SQL Server 2016 可安装 Help Viewer 1.1，但后者不支持 SQL Server 2016 帮助内容。 有关详细信息，请参阅 [SQL Server 2016 发行说明](sql-server-2016-release-notes.md)。  要查看 SQL Server 2016 的内容，需要 Help Viewer 的 v2.x 版本。 
...
早期版本的 SSMS 和 VS 使用 Help Viewer 1.x，该查看器支持 SQL Server 2014 和 2012 帮助内容。 
