...
- 在“帮助”菜单中单击“查看帮助”。 浏览器中将显示最新的 SQL Server 2016/2017 文档（来源：[https://docs.microsoft.com/zh-cn/sql/sql-server/sql-server-technical-documentation](https://docs.microsoft.com/en-us/sql/sql-server/sql-server-technical-documentation)）。 
