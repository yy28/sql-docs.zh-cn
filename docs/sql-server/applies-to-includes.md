---
title: SQL Server 文档 include 文件 | Microsoft Docs
ms.custom: ''
ms.date: 08/15/2018
ms.prod: sql
...
要详细了解如何使用这些 include 文件，请参阅 [Applies-to include](sql-server-docs-contribute.md#applies-to-includes)。
