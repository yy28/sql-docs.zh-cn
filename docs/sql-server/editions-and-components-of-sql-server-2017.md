...
|备份压缩|用户帐户控制|是|否|否|否| 
|数据库快照|用户帐户控制|是|是|是|用户帐户控制|
|AlwaysOn 故障转移群集实例<sup>2</sup>|用户帐户控制|是|否|否|否|  
|AlwaysOn 可用性组<sup>3</sup>|用户帐户控制|否|否|否|否|
|基本可用性组<sup>4</sup>|否|是|否|否|否|
|联机页面和文件还原|用户帐户控制|否|否|否|否|
|联机索引|用户帐户控制|否|否|否|否|
|可恢复的联机索引重新生成|用户帐户控制|否|否|否|否|
...
|无群集的可用性组|用户帐户控制|是|否|否|否|否|
|最小副本提交可用性组|用户帐户控制|是|是|否|否|否|
...
|功能|Enterprise|Standard|Web|Express with Advanced Services|Express|  
|-------------|----------------|--------------|---------|------------------------------------|------------------------| 
|列存储 <sup>1</sup>|用户帐户控制|是|是|是|用户帐户控制|  
|聚集列存储索引中的大型对象二进制文件|用户帐户控制|是|是|是|用户帐户控制|  
|联机非聚集列存储索引重新生成|用户帐户控制|否|否|否|否|
|内存中 OLTP <sup>1</sup>|用户帐户控制|是|是|是，<sup>2</sup>|用户帐户控制|
|Stretch Database|用户帐户控制|是|是|是|用户帐户控制|
|永久性主内存|用户帐户控制|是|是|是|用户帐户控制|
|多实例支持|50|50|50|50|50|
|表和索引分区|用户帐户控制|是|是|是|用户帐户控制|  
|数据压缩|用户帐户控制|是|是|是|用户帐户控制|
|资源调控器|用户帐户控制|否|否|否|否|  
|已分区表并行度|用户帐户控制|否|否|否|否|
|多个 Filestream 容器|用户帐户控制|是|是|是|用户帐户控制|
|NUMA 感知、大型页内存和缓冲区数组分配|用户帐户控制|否|否|否|否|
|缓冲池扩展|用户帐户控制|是|否|否|否|
|IO 资源调控|用户帐户控制|否|否|否|否|  
|延迟持续性|用户帐户控制|是|是|是|用户帐户控制|
|自动优化|用户帐户控制|否|否|否|否|
|批处理模式自适应联接|用户帐户控制|否|否|否|否|
|批处理模式内存授予反馈|用户帐户控制|否|否|否|否|
|多语句表值函数的交错执行|用户帐户控制|是|是|是|用户帐户控制|
|大容量插入改进|用户帐户控制|是|是|是|用户帐户控制|
...
|-------------|----------------|--------------|---------|-------------|------------------------------------| 
|行级安全性|用户帐户控制|是|是|是|用户帐户控制|  
|始终加密|用户帐户控制|是|是|是|用户帐户控制| 
|动态数据屏蔽|用户帐户控制|是|是|是|用户帐户控制|   
|基本审核|用户帐户控制|是|是|是|用户帐户控制| 
|精细审核|用户帐户控制|是|是|是|用户帐户控制| 
...
|PowerShell 脚本支持<sup>2</sup>|用户帐户控制|是|是|是|用户帐户控制| 
