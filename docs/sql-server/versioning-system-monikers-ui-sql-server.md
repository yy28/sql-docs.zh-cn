---
title: SQL 文档的版本控制系统 | Microsoft Docs
ms.date: 08/09/2019
ms.prod: sql
ms.technology: ''
ms.custom: ''
...
出于此原因和其他原因，SQL Server 2016 的文档文件也适用于 2017、2019，可能还适用于 \<vNext\>。 这种合并是切实可行的，因为我们现在已将版本控制名字对象  分配给了 SQL Server 文档文件。 无论给定文档文件的粒度如何，都可指定或显式嵌入版本控制名字对象。
...
`https` 地址中的名字对象代码  始终与版本控制中显示的名字对象名称  匹配。
...
- 2016 及更高版本：  &nbsp; SQL Server 2016 及更高版本已完全实现版本控制系统。
    - [欢迎使用 2016 及更高版本的 SQL Server 文档](/sql/sql-server/sql-server-technical-documentation?view=sql-server-2016)
