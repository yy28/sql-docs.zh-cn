...
默认情况下，使用 SQL Server 和关联的数据库引擎服务的典型端口是：TCP **1433年**， **4022**， **135**， **1434年**，UDP **1434年**。 下表介绍了这些端口的更详细地介绍。 命名的实例使用[动态端口](#BKMK_dynamic_ports)。
...
默认情况下，使用 SQL Server Reporting SErvices 和关联的服务的典型端口是：TCP **80**， **443**。 下表介绍了这些端口的更详细地介绍。 
