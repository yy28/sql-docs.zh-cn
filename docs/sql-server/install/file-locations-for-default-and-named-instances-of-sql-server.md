...
|[!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]|\<安装目录>\130\DTS\|可配置*|  
|客户端组件（bcp.exe 和 sqlcmd.exe 除外）|\<安装目录>\130\Tools\|可配置*|  
...
## <a name="see-also"></a>另请参阅  
 [数据库引擎配置 - 数据目录](http://msdn.microsoft.com/library/9b1fa0fc-623b-479a-afc3-4f13bd850487)   
