---
title: "备份已启用延伸的数据库 (Stretch Database) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "06/14/2016"
...
> [!TIP] 备份仅仅是完整的高可用性和业务连续性解决方案的一部分。 有关高可用性的详细信息，请参阅[高可用性解决方案](../../sql-server/failover-clusters/high-availability-solutions-sql-server.md)。
...
> [!NOTE] 增加 Stretch Database 暂时保留到临时表中的已迁移数据的数量会增加 SQL Server 所需的空间大小。
