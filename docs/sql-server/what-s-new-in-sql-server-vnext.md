...
---
# <a name="what39s-new-in-sql-server-vnext"></a>SQL Server vNext 中的新增功能
...
## <a name="whats-new-in-sql-server-vnext-ctp-14-march-2017"></a>SQL Server vNext CTP 1.4 中的新增功能（2017 年 3 月）
...
- 此 CTP 中没有新的 SSAS 功能。  
- 有关更多详细信息（包括 SSDT 和 SSMS 的最新预览版中 Analysis Services 的新增功能），请参阅 [Analysis Services vNext 中的新增功能](../analysis-services/what-s-new-in-sql-server-analysis-services-vnext.md)。  
...
## <a name="see-also"></a>另请参阅    
 + [![发行说明](../analysis-services/instances/install-windows/media/ssrs-fyi-note.png)] [SQL Server VNext 发行说明](../sql-server/sql-server-vnext-release-notes.md)。 
+ [版本支持的功能](https://msdn.microsoft.com/library/cc645993.aspx)
 ...
 + [安装向导](../database-engine/install-windows/install-sql-server-from-the-installation-wizard-setup.md)
