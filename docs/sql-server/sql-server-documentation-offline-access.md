...
![加载脱机内容](../sql-server/media/load-offline-content.png) 
 ...
 >** 重要说明!!** 单击“更新”后，HelpViewer 最终将冻结/挂起。 仍会下载并安装你选择的文档。 **若要解决此问题**，在任务管理器中结束 HelpViewer，然后按照上面的步骤 3 重启 HelpViewer。 HelpViewer 初次冻结/挂起时，也请按照[这些步骤](https://msdn.microsoft.com/library/mt654096.aspx)进行操作。 只需执行一次这些步骤，但每次更新内容时，可能都需要在任务管理器中结束 HelpViewer。  
