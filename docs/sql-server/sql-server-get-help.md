...
我们很期待收到有关我们产品和文档的改进建议。 我们无法确保一一答复，但会确保相关负责人或团队收到你的反馈。 

## <a name="i-want-to-give-feedback-on-sql-server"></a>我想提供有关 SQL Server 的反馈
...
企业用户请查看[支持选项](https://support.microsoft.com/gp/support-options-for-business?forceorigin=esmc)。
...
### <a name="blogs"></a>博客
有多个 SQL Server 博客提供有关 SQL Server 的最新信息。 
