...
SQL Server 是 Microsoft 数据平台的核心部分。 SQL Server是操作数据库管理系统（ODBMS）的行业领导者。 本文档可帮助你在 Windows 和 Linux 上安装、配置和使用 SQL Server。 内容包括端到端示例、代码示例和视频。 有关 SQL Server 语言的主题，请参阅 [语言参考](../t-sql/language-reference.md)。
::: moniker-end
