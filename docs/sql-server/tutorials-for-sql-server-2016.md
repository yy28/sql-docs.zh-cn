...
我们计划在未来提供更多的教程。 同时，你可以继续通过为以前版本发布的教程进行学习。 在某些情况下，你可能会发现 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 与以前版本的用户界面之间存在很小的差异，而教程必备条件也存在细微的差异。 如果教程使用 [!INCLUDE[ssSampleDBCoShort](../includes/sssampledbcoshort-md.md)] 数据库之一，则应下载和使用 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 版本。  
  
如果你使用的是 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 服务器，则安装了 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 数据访问接口。 为了使教程正常发挥作用，需要使用这些访问接口的 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 示例数据库，或者需要使用示例数据库的以前版本的数据访问接口。  
