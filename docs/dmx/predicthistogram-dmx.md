...
## <a name="scalar-columns"></a>标量列  
 对于标量列引用 >, PredictHistogram 函数返回的直方图包含以下列: \<  
...
-   **$AdjustedProbability**  
     ...
     **$AdjustedProbability**列是[!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]数据挖掘规范的[!INCLUDE[msCoName](../includes/msconame-md.md)] OLE DB 的扩展。  
