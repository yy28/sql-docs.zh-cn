...
## <a name="examples"></a>示例  
 下面的示例使用`Targeted Mailing`中创建的挖掘结构[数据挖掘基础教程](http://msdn.microsoft.com/library/6602edb6-d160-43fb-83c8-9df5dddfeb9c)。 查询将返回该结构中所有用于测试的事例。  
