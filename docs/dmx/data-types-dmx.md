...
-   Date  
 ...
 有关支持的数据类型的详细信息 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] ，请参阅数据 [挖掘&#41;&#40;数据类型 ](/analysis-services/data-mining/data-types-data-mining)。  
