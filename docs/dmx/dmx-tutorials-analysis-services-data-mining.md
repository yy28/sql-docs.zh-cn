...
## <a name="in-this-section"></a>本节内容  
 [自行车购买者 DMX 教程](https://msdn.microsoft.com/library/4b634cc1-86dc-42ec-9804-a19292fe8448)  
  
 在本教程中，您将学习如何使用 DMX 查询语言来创建、定型和浏览挖掘模型。 然后，还要使用这些挖掘模型创建有关客户是否可能购买特定产品的预测。  
  
 [市场篮 DMX 教程](https://msdn.microsoft.com/library/6e262a1d-c89e-4033-8368-46cf25168ef5)  
...
## <a name="see-also"></a>请参阅  
 ...
 [数据挖掘基础教程](https://msdn.microsoft.com/library/6602edb6-d160-43fb-83c8-9df5dddfeb9c)  
