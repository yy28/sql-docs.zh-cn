...
-   **仅预测**  
 ...
 有关支持的列使用类型的详细信息 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] ，请参阅 [挖掘模型列](/analysis-services/data-mining/mining-model-columns)。  
