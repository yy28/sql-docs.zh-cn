---
title: 数据挖掘扩展插件 (DMX) 运算符参考 |Microsoft Docs
ms.date: 06/07/2018
ms.prod: sql
...
|[-&#40;中减去&#41; &#40;DMX&#41;](../dmx/subtract-dmx.md)|从一个数中减去另一个数的算术运算符。|  
|[&#42;&#40;乘以&#41; &#40;DMX&#41;](../dmx/multiply-dmx.md)|将一个数与另一个数相乘的算术运算符。|  
|[&#40;除&#41; &#40;DMX&#41;](../dmx/divide-dmx.md)|将一个数除以另一个数的算术运算符。|  
|[&#60;&#40;小于&#41; &#40;DMX&#41;](../dmx/less-than-dmx.md)|一个比较运算符。 对于计算结果为非 null 值的参数，返回 TRUE 左侧参数的值是否小于右侧; 参数的值否则返回 FALSE。 如果其中一个参数的计算结果为 Null 值或这两个参数的计算结果均为 Null 值，则该运算符返回 Null 值。|  
...
|[&#60;=&#40;小于或等于&#41; &#40;DMX&#41;](../dmx/less-than-or-equal-to-dmx.md)|一个比较运算符。 如果在左侧参数的值小于或等于右侧; 参数的值，则对于计算结果为非 null 值的参数，返回 TRUE否则返回 FALSE。 如果其中一个参数的计算结果为 Null 值或这两个参数的计算结果均为 Null 值，则该运算符返回 Null 值。|  
...
|[或者&#40;DMX&#41;](../dmx/or-dmx.md)|对两个数值表达式执行“或”运算的逻辑运算符。|  
|[+&#40;正&#41; &#40;DMX&#41;](../dmx/positive-dmx.md)|一元运算符，返回数值表达式的正值。|  
|[-&#40;负&#41; &#40;DMX&#41;](../dmx/negative-dmx.md)|一元运算符，返回数值表达式的负值。|  
|[双斜杠&#40;注释&#41; &#40;DMX&#41;](../dmx/double-slash-comment-dmx.md)|指示 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 不应执行的文本字符串。 您可以在 DMX 语句中嵌入注释，将其加在代码行末尾，或者单独插入一行。|  
...
|[斜杠星型&#40;注释&#41; &#40;DMX&#41;](../dmx/slash-star-comment-dmx.md)|指示 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 不应执行的文本字符串。 您可以在 DMX 语句中嵌入注释，将其加在代码行末尾，或者单独插入一行。|  
