---
description: '选择 "从 &lt; 模型 &gt; 预测联接 (DMX) '
title: 选择 "从 &lt; 模型 &gt; 预测联接 (DMX) |Microsoft Docs
ms.date: 06/07/2018
ms.prod: sql
...
ms.locfileid: "88413293"
---
# <a name="select-from-ltmodelgt-prediction-join-dmx"></a>选择 "从 &lt; 模型 &gt; 预测联接 (DMX) 
