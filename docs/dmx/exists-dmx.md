...
## <a name="see-also"></a>请参阅  
 ...
 [模型筛选器语法和&#40;示例 Analysis Services-数据挖掘&#41;](https://docs.microsoft.com/analysis-services/data-mining/model-filter-syntax-and-examples-analysis-services-data-mining)  
