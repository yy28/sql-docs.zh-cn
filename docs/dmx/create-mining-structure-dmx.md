...
### <a name="example-1-adding-a-structure-with-no-training-set"></a>示例 1：添加无定型集的结构  
...
### <a name="example-3-specifying-holdout-percentage-and-max-cases"></a>示例 3:指定维持百分比和最大事例  
