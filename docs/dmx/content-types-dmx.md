...
[!INCLUDE[ssas-appliesto-sqlas](../includes/ssas-appliesto-sqlas.md)]
 ...
 有关[!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]支持的内容类型的完整说明, 请参阅[内容&#40;类型数据挖掘&#41;](https://docs.microsoft.com/analysis-services/data-mining/content-types-data-mining)。  
