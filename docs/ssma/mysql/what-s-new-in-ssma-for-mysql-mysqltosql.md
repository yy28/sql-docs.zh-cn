...
SSMA for MySQL 的 v8.1 版本已使用一组目标的设计用于提高质量和转换指标，以及针对修补程序的修补程序进行增强：
...
SSMA for MySQL 的 v8.1 版本增强了能够提高质量和转换的度量值的目标修补。
...
SSMA for MySQL 的 v8.0 版本增强了设计用于提高质量和转换的度量值的目标修补。 此版本还提供了以下新功能：
...
MySQL 的 SSMA 的 2016 年 3 月预览版本将对迁移的支持添加到 SQL Server 2016。 
