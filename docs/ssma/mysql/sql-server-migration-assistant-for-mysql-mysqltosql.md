...
|-|-|  
|**部分**|**Description**|  
|[什么是适用于 MySQL 的 SSMA 中的新增功能](http://msdn.microsoft.com/1451a0b0-6713-4d0c-954f-ea3d8fce1d31)|什么是此版本的适用于 MySQL 的 SSMA 中的新增功能|  
...
|[获取 MySQL 协助的 SSMA](http://go.microsoft.com/fwlink/?LinkID=708538&clcid=0x409)|提供有关获取其他帮助信息。|  
