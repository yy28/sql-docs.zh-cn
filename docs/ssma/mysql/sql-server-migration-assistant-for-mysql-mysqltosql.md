...
|[安装适用于 MySQL SSMA &#40;MySqlToSql&#41;](../../ssma/mysql/installing-ssma-for-mysql-mysqltosql.md)|包含为运行 SQL Server 的计算机上安装 MySQL 客户端和所需的组件 SSMA 提供系统必备组件和说明的主题。|  
|[入门 MySQL SSMA &#40;MySQLToSQL&#41;](../../ssma/mysql/getting-started-with-ssma-for-mysql-mysqltosql.md)|引入了用户界面、 项目和配置选项。|  
|[迁移的 MySQL 数据库移到 SQL Server 的 Azure SQL DB &#40;MySQLToSql&#41;](../../ssma/mysql/migrating-mysql-databases-to-sql-server-azure-sql-db-mysqltosql.md)|提供转换过程和过程中每个步骤的详细的信息的概述。|  
