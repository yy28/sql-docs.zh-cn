...
|[在 SQL Server 上安装 SSMA 组件（MySQL 到 SQL）](https://msdn.microsoft.com/6772d0c5-258f-4d7b-afb0-b5f810e71af1)|提供有关在的[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]实例上安装扩展包的和说明的信息。|  
