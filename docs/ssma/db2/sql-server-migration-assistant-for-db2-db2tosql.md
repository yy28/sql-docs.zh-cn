...
DB2 的 @no__t @no__t 迁移助手（SSMA）是一种工具，用于将 DB2 数据库迁移到 [!INCLUDE[msCoName](../../includes/msconame_md.md)] @ no__t-3 2012，[!INCLUDE[msCoName](../../includes/msconame_md.md)] @ 2014 no__t 2016 2017，在 Windows 和 Linux 上的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]0 @ no__t-11 2019、Windows 和 Linux 上 0 @ no__t-11 或Azure SQL 数据库。 SSMA for DB2 将 DB2 数据库对象转换为 @no__t 0 的数据库对象，在 @no__t 中创建这些对象，然后将数据从 DB2 迁移到 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 或 Azure SQL 数据库。  
...
|[安装 SSMA for DB2 Client &#40;DB2ToSQL&#41;](../../ssma/db2/installing-ssma-for-db2-client-db2tosql.md)|包含一些文章，这些文章提供了在运行 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的计算机上为 DB2 客户端和必需组件安装 SSMA 的先决条件和说明。|  
