...
|部分|描述|  
|-----------|---------------|  
|[SSMA for DB2 中的新增功能](https://msdn.microsoft.com/1cc38f85-3caa-42d0-8c76-a380c1d15c67)|什么是此版本的适用于 DB2 的 SSMA 中的新增功能|  
...
|[获取 DB2 协助的 SSMA](https://go.microsoft.com/fwlink/?LinkID=708538&clcid=0x409)|提供有关获取其他帮助信息。|  
