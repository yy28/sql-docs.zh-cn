...
将从中执行迁移步骤在计算机上安装客户端应用程序。 扩展包部署的客户端，并不需要单独安装。  
  
## <a name="upgrading-ssma-for-db2"></a>升级适用于 DB2 的 SSMA  
...
|[删除 SSMA for DB2 组件&#40;DB2ToSQL&#41;](../../ssma/db2/removing-ssma-for-db2-components-db2tosql.md)|说明如何卸载客户端程序和扩展包。|  
