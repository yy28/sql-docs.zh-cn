---
title: SSMA For Sybase 中的新 GUI 功能（SybaseToSQL） |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "76909980"
---
# <a name="new-gui-features-in-ssma-for-sybase-sybasetosql"></a>SSMA For Sybase 中的新 GUI 功能（SybaseToSQL）
本章介绍 SSMA 用户界面的新增功能。  
