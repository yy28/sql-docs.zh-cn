...
|主题|Description|  
|---------|---------------|  
|[高级的对象选择 &#40;SybaseToSQL &#41;](../../ssma/sybase/advanced-object-selection-sybasetosql.md)|使用**高级对象选择**对话框中，若要使用筛选器条件查找数据库对象，然后选择或清除这些对象。|  
...
|[保存元数据 &#40;SybaseToSQL &#41;](../../ssma/sybase/save-metadata-sybasetosql.md)|**保存元数据**对话框中将显示当你保存缺少元数据的项目。|  
