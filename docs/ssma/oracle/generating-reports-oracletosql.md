---
title: 生成报表 (OracleToSQL) |Microsoft 文档
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "34777483"
---
# <a name="generating-reports-oracletosql"></a>生成报表 (OracleToSQL)
...
1.  指定**摘要-报表-向其写入**参数。 相关的报表，存储作为文件名称 （如果指定） 或指定的文件夹中。 文件名称是系统预定义的位置下, 表中所述**&lt;n&gt;** 是唯一的文件数以每次执行同一命令与数字递增。  
    ...
    （从 Sl 输出报告命令选项。 否。 上面的 2-4)，请参阅[执行 SSMA 控制台&#40;OracleToSQL&#41; ](../../ssma/oracle/executing-the-ssma-console-oracletosql.md)部分。  
