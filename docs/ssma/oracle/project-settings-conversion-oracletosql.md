...
|**默认架构映射**|此设置指定如何将 Oracle 架构映射到 SQL Server 架构。 此设置中提供了两个选项：<br /><br />**到数据库的架构：** 在此模式下的 Oracle 架构 sch1 将映射到 SQL Server 数据库 sch1' 中 'dbo' SQL Server 架构的默认情况下。<br /><br />**对架构的架构：** 在此模式下的 Oracle 架构 sch1 将映射到连接对话框中提供的默认 SQL Server 数据库中的 sch1 SQL Server 架构的默认情况下。<br /><br />当选择中的转换模式**模式下**框，SSMA 适用以下设置：<br /><br />**默认/Optimistic/Full 模式：** 到数据库的架构|  
|**MERGE 语句的转换方法**|如果选择**使用 INSERT、 UPDATE、 DELETE 语句**、 SSMA 合并语句转换为 INSERT、 UPDATE、 DELETE 语句。<br /><br />如果选择**使用 MERGE 语句**，SSMA 将 MERGE 语句中转换为合并语句[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。<br /><br />**注意：** 此项目设置选项是仅适用于[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]2008年[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]2012 中， [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 2014年。<br /><br />当选择中的转换模式**模式下**框，SSMA 适用以下设置：<br /><br />**默认/Optimistic/Full 模式：** 使用 MERGE 语句|  
...
|**在替换函数调用中使用 ISNULL**|替换为函数调用中使用 ISNULL 语句来模拟 Oracle 行为。 以下选项是存在此设置：<br /><br />YES<br /><br />是<br /><br />当选择中的转换模式**模式下**框，SSMA 适用以下设置：<br /><br />**默认/乐观模式：** 否<br /><br />**完整模式：** 是|  
|**CONCAT 函数调用中使用 ISNULL**|CONCAT 函数调用中使用 ISNULL 语句来模拟 Oracle 行为。 以下选项是存在此设置：<br /><br />YES<br /><br />是<br /><br />当选择中的转换模式**模式下**框，SSMA 适用以下设置：<br /><br />**默认/乐观模式：** 否<br /><br />**完整模式：** 是|  
