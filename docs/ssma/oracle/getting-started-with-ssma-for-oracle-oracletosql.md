...
-   选择数据迁移的表，然后将数据迁移到这些表从[!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)]。 有关详细信息，请参阅[迁移到 SQL Server 的 Oracle 数据&#40;OracleToSQL&#41;](../../ssma/oracle/migrating-oracle-data-into-sql-server-oracletosql.md)。  
