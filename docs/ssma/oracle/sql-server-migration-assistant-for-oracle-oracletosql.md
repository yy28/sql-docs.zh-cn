...
本文档介绍了适用于 Oracle 的 SSMA 并提供了分步说明将 Oracle 数据库迁移到[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。 下表显示了主题，以帮助您了解详细信息：  
...
|[获取以 Oracle 获得帮助的 SSMA](https://go.microsoft.com/fwlink/?LinkID=708538&clcid=0x409)|提供有关获取其他帮助信息。|  
