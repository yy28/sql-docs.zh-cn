...
有关命令行选项的信息，请参阅[SSMA 控制台 &#40; OracleToSQL &#41; 中的命令行选项](../../ssma/oracle/command-line-options-in-ssma-console-oracletosql.md)。  
  
示例控制台脚本文件的信息，请参阅[使用控制台中的示例脚本文件 &#40; OracleToSQL &#41;](../../ssma/oracle/working-with-the-sample-console-script-files-oracletosql.md)  
