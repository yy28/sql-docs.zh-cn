...
本部分包括有关[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Access 迁移助手（SSMA）的帮助主题。  
...
|[连接到 SQL Server](https://msdn.microsoft.com/ceb77a97-d6d5-4a92-90a6-342e97d12b54)|使用 "**连接到 SQL Server** " 对话框连接到要迁移[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]到的实例。|  
...
|[项目设置（迁移）](https://msdn.microsoft.com/4caebc9c-8680-4b99-a8fa-89c43161c95d)|使用 "**项目设置**" 对话框的 "迁移" 页可以指定迁移批大小、表锁定、约束检查、插入触发器触发、标识和 null 值处理，以及如何处理超出[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]范围的日期。|  
