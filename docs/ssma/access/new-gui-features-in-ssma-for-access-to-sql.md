---
title: SSMA for Access to SQL 中的新增 GUI 功能 |Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "63453458"
---
# <a name="new-gui-features-in-ssma-for-access-to-sql"></a>SSMA for Access to SQL 中的新增 GUI 功能
本章节介绍了 SSMA 用户界面的新功能  
  
## <a name="layouts"></a>布局  
此功能，可选择一个预定义的两个窗口排列或创建自己的布局。 若要访问布局子菜单，请在视图菜单上指向布局。 您可以选择一个现有的布局，添加当前布局或管理布局。  
  
### <a name="add-current-layout"></a>添加当前布局  
若要保存当前窗口布局，在视图菜单中指向布局，然后单击添加当前布局。  
  
### <a name="choose-predefined-layout"></a>选择预定义的布局  
若要选择一个预定义的布局，在视图菜单中指向布局，然后单击默认布局或没有资源管理器。 您还可以使用快捷方式 Ctrl + Alt + 1 或 Ctrl + Alt + 2 的预定义的布局分别。  
