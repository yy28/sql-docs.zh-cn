...
|资源管理器布局的情况下选中|Alt + V + L + W 或 CTRL + ALT + 2|  
...
|显示项目设置对话框。|ALT + T + P|  
|显示默认项目设置对话框。|ALT + T + J|  
|显示查找数据库向导对话框。|ALT + T + F|  
|显示转换、 加载和迁移向导对话框。|ALT + T + V|  
|链接表或链接表。|ALT + T + L|  
|取消链接表或取消链接表。|ALT + T + U|  
|导出的架构。|ALT + T + E|  
|本地删除。|ALT + T + D|  
