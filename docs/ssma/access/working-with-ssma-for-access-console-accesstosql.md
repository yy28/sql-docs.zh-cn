...
|-|-|  
|**主题**|**Description**|  
|[用于访问控制台 &#40; 入门 SSMAAccessToSQL &#41;](../../ssma/access/getting-started-with-ssma-for-access-console-accesstosql.md)|说明要执行的控制台应用程序的过程。|  
|[SSMA 控制台 &#40; 中的命令行选项AccessToSQL &#41;](../../ssma/access/command-line-options-in-ssma-console-accesstosql.md)|描述用于运行 SSMA 控制台应用程序的命令行选项和参数。|  
