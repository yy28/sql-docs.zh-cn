---
title: 已更新-SQL Server 文档用于 XQuery |Microsoft 文档
description: 显示有关 Microsoft SQL Server 的 XQuery 中最近更改文档的更新内容的代码的段。
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "32739299"
---
# <a name="new-and-recently-updated-xquery-for-sql-server"></a>新的和最近的更新： SQL Server 的 XQuery
