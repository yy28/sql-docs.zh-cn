...
ms.locfileid: "51670086"
---
# <a name="xquery-functions-against-the-xml-data-type"></a>针对 xml 数据类型的 XQuery 函数
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]

  本主题及其副主题描述指定 XQuery 时可以使用的函数**xml**数据类型。 有关 W3C 规范，请参阅[ https://www.w3.org/TR/2004/WD-xpath-functions-20040723 ](https://go.microsoft.com/fwlink/?LinkId=4873)。  
  
 XQuery 函数属于 https://www.w3.org/2004/07/xpath-functions命名空间。 W3C 规范使用“fn:”命名空间前缀来说明这些函数。 使用这些函数时，不必显式指定“fn:”命名空间前缀。 由于这个原因，也为了提高可读性，此文档中通常不使用命名空间前缀。  
...
|基于布尔值的函数|[不](../xquery/functions-on-boolean-values-not-function.md)|  
...
|[基于序列的函数](https://msdn.microsoft.com/library/672d2795-53ab-49c2-bf24-bc81a47ecd3f)|[为空](../xquery/functions-on-sequences-empty.md)|  
