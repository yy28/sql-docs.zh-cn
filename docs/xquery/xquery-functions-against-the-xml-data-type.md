...
|类别|函数名称|  
|--------------|-------------------|  
|[对数字值的函数](http://msdn.microsoft.com/library/d5740a32-b174-43b9-b64d-1cc6edc50cff)|[上限](../xquery/numeric-values-functions-ceiling.md)|  
||[floor](../xquery/numeric-values-functions-floor.md)|  
||[舍入](../xquery/numeric-values-functions-round.md)|  
|[基于字符串值的 XQuery 函数](http://msdn.microsoft.com/library/2dccefef-5d90-4f56-bda7-4c1954d8a730)|[concat](../xquery/functions-on-string-values-concat.md)|  
...
|[与 Qname 相关的函数&#40;XQuery&#41;](http://msdn.microsoft.com/library/7e07eb26-f551-4b63-ab77-861684faff71)|[展开的 QName (XQuery)](../xquery/functions-related-to-qnames-expanded-qname.md)|  
