...
---
# <a name="submit-spark-jobs-on-includebig-data-clusters-2019includesssbigdataclusters-ss-novermd-in-intellij"></a>在 IntelliJ 中的[!INCLUDE[big-data-clusters-2019](../includes/ssbigdataclusters-ss-nover.md)]中提交 Spark 作业

[!INCLUDE[tsql-appliesto-ssver15-xxxx-xxxx-xxx](../includes/tsql-appliesto-ssver15-xxxx-xxxx-xxx.md)]

的关键方案[!INCLUDE[big-data-clusters-2019](../includes/ssbigdataclusters-ss-nover.md)]之一是能够提交 Spark 作业。 Spark 作业提交功能可用于提交本地 Jar 或 Py 文件, 其中包含对[!INCLUDE[big-data-clusters-2019](../includes/ssbigdataclusters-ss-nover.md)]的引用。 它还允许你执行已经位于 HDFS 文件系统中的 Jar 或 Py 文件。 
...
有关 SQL Server 大数据群集和相关方案的详细信息, 请参阅[什么[!INCLUDE[big-data-clusters-2019](../includes/ssbigdataclusters-ver15.md)]是](big-data-cluster-overview.md)？
