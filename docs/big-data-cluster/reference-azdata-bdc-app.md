---
title: azdata bdc app 参考
titleSuffix: SQL Server big data clusters
description: azdata bdc app 命令的参考文章。
author: MikeRayMSFT
ms.author: mikeray
...
ms.locfileid: "74820952"
---
# <a name="azdata-bdc-app"></a>azdata bdc app

[!INCLUDE[tsql-appliesto-ssver15-xxxx-xxxx-xxx](../includes/tsql-appliesto-ssver15-xxxx-xxxx-xxx.md)]  

以下文章提供了 `bdc app` 工具中 `azdata` 命令的参考。 有关其他 `azdata` 命令的详细信息，请参阅 [azdata 参考](reference-azdata.md)

## <a name="commands"></a>命令
|     |     |
| --- | --- |
[azdata bdc app status](reference-azdata-bdc-app-status.md) | 应用服务状态命令。
