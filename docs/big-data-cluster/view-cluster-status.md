...
1. 通过 [azdata login](reference-azdata.md) 登录到大数据群集。 将 --controller-endpoint  参数设置为控制器终结点的外部 IP 地址。
...
有关大数据集群的更多详细信息，请参阅[什么是 SQL Server 大数据集群](big-data-cluster-overview.md)。
