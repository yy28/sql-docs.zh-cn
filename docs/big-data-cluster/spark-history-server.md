...
+ 将“进度”  保留为默认值。 在“显示”下拉列表中选择“读取”或“写入”，用户可以检查数据流   。
...
* [SQL Server 大数据群集入门](https://docs.microsoft.com/en-us/sql/big-data-cluster/deploy-get-started?view=sqlallproducts-allversions)
