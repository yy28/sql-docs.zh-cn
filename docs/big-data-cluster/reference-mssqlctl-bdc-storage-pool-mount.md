...
|     |     |
| --- | --- |
[mssqlctl bdc storage-pool mount create](#mssqlctl-bdc-storage-pool-mount-create) | 在 HDFS 中创建的远程存储的装载。
[mssqlctl bdc storage-pool mount delete](#mssqlctl-bdc-storage-pool-mount-delete) | 删除远程存储在 HDFS 中的装载。
