...
description: '[!INCLUDE[big-data-clusters-2019](../includes/ssbigdataclusters-ss-nover.md)]在 Azure Data Studio 中提交 Spark 作业。'
author: jejiang
ms.author: jejiang
ms.reviewer: mikeray
ms.date: 08/21/2019
...
ms.locfileid: "69653337"
---
# <a name="submit-spark-jobs-on-includebig-data-clusters-2019includesssbigdataclusters-ss-novermd-in-azure-data-studio"></a>[!INCLUDE[big-data-clusters-2019](../includes/ssbigdataclusters-ss-nover.md)]在 Azure Data Studio 中提交 Spark 作业
