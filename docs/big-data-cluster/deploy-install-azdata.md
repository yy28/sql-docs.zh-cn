...
ms.locfileid: "73532064"
---
# <a name="install-azdata-for-includebig-data-clusters-2019includesssbigdataclusters-ss-novermd-using-pip"></a>使用 `pip` 为 [!INCLUDE[big-data-clusters-2019](../includes/ssbigdataclusters-ss-nover.md)] 安装 `azdata`
...
## <a id="macOSX"></a> 在 macOS 或 OS X 上安装 `azdata`
