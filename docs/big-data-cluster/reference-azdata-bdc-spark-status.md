---
title: azdata bdc spark status 参考
titleSuffix: SQL Server big data clusters
description: azdata bdc spark status 命令的参考文章。
author: MikeRayMSFT
ms.author: mikeray
...
ms.locfileid: "74821233"
---
# <a name="azdata-bdc-spark-status"></a>azdata bdc spark status

[!INCLUDE[tsql-appliesto-ssver15-xxxx-xxxx-xxx](../includes/tsql-appliesto-ssver15-xxxx-xxxx-xxx.md)]  

以下文章提供了 `bdc spark status` 工具中 `azdata` 命令的参考。 有关其他 `azdata` 命令的详细信息，请参阅 [azdata 参考](reference-azdata.md)

## <a name="commands"></a>命令
|     |     |
| --- | --- |
[azdata bdc spark status show](#azdata-bdc-spark-status-show) | Spark 服务状态。
