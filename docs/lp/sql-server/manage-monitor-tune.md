...
layout: HubPage
hide_bc: true
title: 管理、监视、优化 SQL Server
description: 发现可帮助管理、监视和优化 SQL Server 的功能。
ms.topic: hub-page
ms.prod: sql
author: MashaMSFT
ms.author: mathoma
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>数据库生命周期管理</h3>
                                                    <p>管理数据库应用程序的数据库架构、数据和元数据的一套全面的方法</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>数据压缩</h3>
                                                    <p>SQL Server 的一项功能，它有助于压缩数据，从而减少磁盘的占用空间。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>数据库邮件</h3>
                                                    <p>从 SQL Server 数据库引擎发送电子邮件的企业解决方案。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>基于策略的管理</h3>
                                                    <p>用于管理一个或多个 SQL Server 实例的基于策略的系统。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Server 代理</h3>
                                                    <p>SQL Server 的一项功能，用于执行计划的管理任务。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQLDiag</h3>
                                                    <p>一种常规用途实用程序，用于从 SQL Server 收集日志和数据。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Profiler</h3>
                                                    <p>创建、管理、分析和替换 SQL Server 活动所进行的跟踪。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>自动优化</h3>
                                                    <p>SQL 2017 的一项新功能，可自动检测潜在的性能问题。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>计划指南</h3>
                                                    <p>SQL Server 的一项功能，允许手动输入特定查询的执行计划。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>指定应用程序请求可以使用的 CPU、IO 和内存量的限制。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>统计信息</h3>
                                                    <p>告诉 SQL Server 引擎如何分发和使用数据来创建执行计划。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
