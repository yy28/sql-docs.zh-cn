                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>BCP</h3>
                                                    <p>以指定格式在数据文件和 SQL 数据库之间批量复制数据。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>导入平面文件向导</h3>
                                                    <p>使用向导可以轻松地将数据从平面文件（.csv、.txt）复制到 SQL 数据库。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>导入和导出向导</h3>
                                                    <p>使用向导可以轻松地将数据从各种源复制到 SQL 数据库。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>提取和转换来自多种源（如平面文件和关系数据源）的数据，然后将这些数据加载到 SQL 数据库。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
