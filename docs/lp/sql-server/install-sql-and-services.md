...
layout: HubPage
hide_bc: true
title: SQL Server - 安装和更新
description: 查找有助于安装或升级 SQL Server 及相关服务的内容。
ms.topic: hub-page
ms.prod: sql
author: MashaMSFT
ms.author: mathoma
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>安装 SQL Server</h3>
                                                    <p>概述了用于安装 SQL Server 的不同安装选项。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>安装 SQL Server Analysis Services (SSAS)</h3>
                                                    <p>分析数据引擎，可为业务报告和客户端应用程序（如 Power BI、Excel、Reporting Services 和其他数据可视化报告）提供企业级语义数据模型。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>安装 SQL Server Integration Services (SSIS)</h3>
                                                    <p> 使用 Integration Services 可解决复杂的业务问题，具体表现为：复制或下载文件，加载数据仓库，清除和挖掘数据以及管理 SQL Server 对象和数据。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>升级 SQL Server Analysis Services (SSAS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>升级 SQL Server Integration Services (SSIS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>升级 SQL Server Reporting Services (SSRS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure 数据库迁移服务</h3>
                                                    <p>可以从多个数据库源无缝迁移到 Azure数据平台，最大限度地减少停机时间。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>数据库迁移助手 (DMA)</h3>
                                                    <p>检测到兼容性问题，建议对目标环境进行改进，并移动数据库和数据。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Server 迁移助手 (SSMA)</h3>
                                                    <p>自动将数据库从 Microsoft Access、DB2、MySQL、Oracle 和 SAP ASE 迁移到 SQL Server。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
