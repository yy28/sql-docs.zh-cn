                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>全文搜索</h3>
                                                    <p>全文检索包括表中的一个或多个基于字符的列，全文搜索允许你查询它们。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>联接</h3>
                                                    <p>探讨 SQL Server 在使用联接时执行的不同排序、交集和联合操作。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>脚本编写</h3>
                                                    <p>探讨 SQL Server 支持的各种脚本语言，例如 Powershell 和 xQuery。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>子查询</h3>
                                                    <p> 子查询是一个嵌套在 SELECT、INSERT、UPDATE 或 DELETE 语句或其他子查询中的查询。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>同义词</h3>
                                                    <p>一个数据库对象，它提供抽象层以免对客户端应用程序基对象的名称或位置进行更改。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
