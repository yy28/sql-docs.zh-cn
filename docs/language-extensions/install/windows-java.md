---
title: 在 Windows 上安装 SQL Server Java 语言扩展
titleSuffix: ''
description: 了解如何通过运行 SQL Server 安装向导在 Windows 上安装 SQL Server 的 Java 语言扩展功能。
author: cawrites
ms.author: chadam
ms.date: 09/17/2020
ms.topic: conceptual
...
ms.locfileid: "92155543"
---
# <a name="install-sql-server-language-java-extensions-on-windows"></a>在 Windows 上安装 SQL Server 的 Java 语言扩展功能
...
> [!NOTE]
> 本文适用于在 Windows 上安装 SQL Server 语言扩展。 对于 Linux，请参阅[在 Linux 上安装 SQL Server 2019 语言扩展 (Java)](../../linux/sql-server-linux-setup-language-extensions-java.md)
...
2. 在“控制面板”中，依次打开“系统和安全”、“系统”，然后选择“高级系统属性”。
