...
# 使用“将副本添加到可用性组向导”(SQL Server Management Studio)
  使用“将副本添加到可用性组向导”可帮助你将新的辅助副本添加到现有 Always On 可用性组。  
...
-   **若要添加副本，请使用：**  [将副本添加到可用性组向导 (SQL Server Management Studio)](#SSMSProcedure)  
...
10. “进度”页将显示创建可用性组的各步骤（配置端点、创建可用性组和将次要副本联接到该组）的进度。  
...
> [!IMPORTANT]  
>  添加副本后，请参阅[将辅助副本添加到可用性组 (SQL Server)](../../../database-engine/availability-groups/windows/add-a-secondary-replica-to-an-availability-group-sql-server.md) 中的“跟进：添加副本后”部分。  
