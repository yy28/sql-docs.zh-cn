...
# [升级 AlwaysOn 可用性组副本实例](upgrading-always-on-availability-group-replica-instances.md)
...
# [输入密码页（添加副本向导）](enter-passwords-page-add-replica-wizard.md)
# [将辅助副本联接到可用性组](join-a-secondary-replica-to-an-availability-group-sql-server.md)
...
# [“结果”页（Always On 可用性组向导）](progress-page-always-on-availability-group-wizards.md)
...
# [AlwaysOn 故障转移群集实例](always-on-client-connectivity-sql-server.md)
# [Always On 可用性组的 PowerShell Cmdlet 概述](overview-of-powershell-cmdlets-for-always-on-availability-groups-sql-server.md)
...
# [查看可用性组侦听器属性](view-availability-group-listener-properties-sql-server.md)
# [Always On 可用性组](always-on-availability-groups-sql-server.md)
# [用于 AlwaysOn 可用性组和数据库镜像的跨数据库事务和分布式事务 (SQL Server)](transactions - always on availability and database mirroring.md)
...
# [AlwaysOn 可用性组配置疑难解答](troubleshoot-always-on-availability-groups-configuration-sql-server.md)
...
# [“连接到现有的辅助副本”页（添加副本向导：添加数据库向导）](connect to existing secondary replicas page.md)
...
# [活动辅助副本：辅助副本备份](active-secondaries-backup-on-secondary-replicas-always-on-availability-groups.md)
# [使用“将数据库添加到可用性组向导”](use-the-add-database-to-availability-group-wizard-sql-server-management-studio.md)
...
# [活动辅助副本：可读辅助副本](active-secondaries-readable-secondary-replicas-always-on-availability-groups.md)
# [可用性组侦听器、客户端连接和应用程序故障转移](listeners, client connectivity, application failover.md)
# [调整可用性组的压缩](tune-compression-for-availability-group.md)
# [配置可用性副本备份](configure-backup-on-availability-replicas-sql-server.md)
# [含有 Always On 可用性组的数据库快照](database-snapshots-with-always-on-availability-groups-sql-server.md)
# [策略评估结果 (AlwaysOn)](policy-evaluation-result-always-on.md)
# [使用 Always On 策略查看可用性组的运行状况](use-always-on-policies-to-view-the-health-of-an-availability-group-sql-server.md)
...
# [自动初始化 Always On 可用性组](自动初始化-always-on-可用性组.md)
# [将辅助副本添加到可用性组](add-a-secondary-replica-to-an-availability-group-sql-server.md)
...
# [为 Always On 可用性组创建数据库镜像端点 (SQL Server PowerShell)](database mirroring - always on availability groups- powershell.md)
...
# [选项（SQL Server AlwaysOn、“面板”页）](options-sql-server-always-on-dashboard-page.md)
# [执行可用性组的计划手动故障转移](perform-a-planned-manual-failover-of-an-availability-group-sql-server.md)
...
# [从可用性组中删除辅助副本](remove-a-secondary-replica-from-an-availability-group-sql-server.md)
# [Always On 可用性组入门 (SQL Server)](getting-started-with-always-on-availability-groups-sql-server.md)
...
# [创建或配置可用性组侦听器](create-or-configure-an-availability-group-listener-sql-server.md)
# [将数据库添加到可用性组](add-a-database-to-an-availability-group-sql-server.md)
...
# [AlwaysOn 故障转移群集实例](analysis-services-with-always-on-availability-groups.md)
...
# [具有 AlwaysOn 可用性组的加密数据库](encrypted-databases-with-always-on-availability-groups-sql-server.md)
