---
title: "AlwaysOn 可用性组的 Transact-SQL 语句概述 (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
helpviewer_keywords: 
  - "可用性组 [SQL Server], 关于"
  - "可用性组 [SQL Server], TRANSACT-SQL 语句"
...
##  <a name="AlterDb"></a> 更改数据库… SET HADR …  
 使用 ALTER DATABASE 语句的 [SET HADR](../Topic/ALTER%20DATABASE%20SET%20HADR%20\(Transact-SQL\).md) 子句的选项，您可以将辅助数据库联接到相应主数据库的可用性组、删除已联接的数据库、在已联接的数据库上挂起数据同步以及继续数据同步。  
