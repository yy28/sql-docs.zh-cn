---
title: Always On 可用性组策略 (SQL Server) | Microsoft Docs
ms.custom: ag-guide
ms.date: 06/13/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "32858292"
---
# <a name="always-on-availability-groups-policies"></a>Always On 可用性组策略
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
  Always On 仪表板使用 Always On 可用性组系统策略向用户提供有关可用性组运行状况的信息。 它们对可用性组运行问题的初始故障排除非常有用。 可扩展这些策略并将其用于自定义 Always On 仪表板，也可立即运行这些策略以报告所需运行状况信息。  
...
## <a name="next-steps"></a>后续步骤  
 [Always On 运行状况模型，第 2 部分：扩展运行状况模型](http://blogs.msdn.com/b/sqlalwayson/archive/2012/02/13/extending-the-alwayson-health-model.aspx)。  
