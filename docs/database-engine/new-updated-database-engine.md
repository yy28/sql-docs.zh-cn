...
1. [次要副本的自动种子设定](availability-groups/windows/automatic-seeding-secondary-replicas.md)
2. [为分布式事务配置可用性组](availability-groups/windows/configure-availability-group-for-distributed-transactions.md)
3. [配置分布式可用性组](availability-groups/windows/configure-distributed-availability-groups.md)
4. [分布式可用性组](availability-groups/windows/distributed-availability-groups.md)
5. [域独立可用性组](availability-groups/windows/domain-independent-availability-groups.md)
6. [SQL Server 2017 中弃用的数据库引擎功能](deprecated-database-engine-features-in-sql-server-2017.md)
