---
title: "修复失败的 SQL Server 2016 安装 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
### 从安装中心修复失败的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 安装  
...
### 使用命令提示符修复失败的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 安装  
