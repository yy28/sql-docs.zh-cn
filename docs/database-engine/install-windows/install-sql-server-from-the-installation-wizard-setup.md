...
10. 在“安装类型”上，选择执行新安装，或向现有安装添加功能。 单击“下一步” 。 
...
14. 使用“服务器配置 — [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 服务帐户”页指定服务的登录帐户。 此页上配置的实际服务取决于您选择安装的功能。  
...
15. 使用“ [!INCLUDE[ssDE](../../includes/ssde-md.md)] 配置 - 服务器配置”页指定以下各项：  
