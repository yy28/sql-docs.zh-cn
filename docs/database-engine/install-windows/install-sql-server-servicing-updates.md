...
> 有关其他信息，请参阅 [2017 年 9 月针对 SQL Server 的现代服务模型 (MSM) 的公告](https://blogs.msdn.microsoft.com/sqlreleaseservices/announcing-the-modern-servicing-model-for-sql-server/)。
