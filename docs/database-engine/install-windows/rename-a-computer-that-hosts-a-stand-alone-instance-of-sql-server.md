---
title: 重命名计算机托管实例
description: 重命名托管 SQL Server 实例的计算机时，更新 sys.servers 中存储的系统元数据。
...
## <a name="rename-a-computer-that-hosts-a-stand-alone-instance-of-ssnoversion"></a>重命名托管 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 独立实例的计算机  
