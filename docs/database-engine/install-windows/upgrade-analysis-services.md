...
helpviewer_keywords: 
  - "升级数据库"
  - "数据库 [Analysis Services], 升级"
  - "安装 [Analysis Services], 并行安装"
  - "Analysis Services 升级"
  - "Analysis Services 升级, 关于升级 Analysis Services"
  - "SSAS, 数据库迁移"
  - "升级 Analysis Services"
  - "安装 Analysis Services, 升级"
  - "SSAS, 升级"
...
---
# 升级 Analysis Services
  可以将 Analysis Services 实例升级到具有相同服务器模式的 SQL Server 2016 版本，以充分利用当前版本中引入的功能，如 [What's New in Analysis Services](../../analysis-services/what-s-new-in-analysis-services.md)中所述。  
...
-   [SQL Server 2016 发行说明](http://go.microsoft.com/fwlink/?LinkID=398124) 描述了已知的问题和解决方法。  
...
4.  重新打开 **DirectQuery** 。 请参阅 [DirectQuery for Tabular 1200 models](../Topic/DirectQuery%20for%20Tabular%201200%20models.md) 获取更多指导。  
...
## 另请参阅  
 ...
 [在多维和数据挖掘模式下安装 Analysis Services](../Topic/Install%20Analysis%20Services%20in%20Multidimensional%20and%20Data%20Mining%20Mode.md)   
