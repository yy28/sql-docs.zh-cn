---
title: "防止 SQL Server 实例自动启动（SQL Server 配置管理器） | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
manager: "jhubbard"
---
# 防止 SQL Server 实例自动启动（SQL Server 配置管理器）
...
3.  在“详细信息”窗格中，右键单击“MSSQLServer”，再单击“属性”。  
  
4.  在“SQL Server”\<“实例名”>“属性”对话框中，将“启动模式”设置为“自动”。  
  
5.  单击“确定”以关闭“SQL Server”**<**\<“实例名”>“属性”对话框，然后再关闭 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 配置管理器。  
