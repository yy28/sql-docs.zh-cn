...
9. 右键单击导入的证书，指向“所有任务”  ，然后单击“管理私钥”  。 在“安全”对话框中，为  **服务帐户使用的用户帐户添加读取权限**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。  
...
2. 在“**实例名称> 协议属性”对话框中的“证书”选项卡上，从“证书”框的下拉菜单中选择所需证书，然后单击“确定”** _\<_     。  
