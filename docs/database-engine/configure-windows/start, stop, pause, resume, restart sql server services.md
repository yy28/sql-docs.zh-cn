...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server 配置管理器, 启动和停止服务"
  - "停止 SQL Server 代理"
  - "参数 [SQL Server], 启动选项"
  - "SQL Server, 启动选项"
  - "数据库引擎 [SQL Server], 启动和停止服务"
  - "暂停 SQL Server"
  - "PowerShell [SQL Server], 启动和停止服务"
  - "单用户模式 [SQL Server], 启动模式"
  - "SQL Server Management Studio [SQL Server], 启动和停止服务"
  - "停止 SQL Server Browser 服务"
  - "启动 SQL Server 代理"
  - "默认实例 [SQL Server], 启动和停止"
  - "SQL Server 代理, 启动和停止"
  - "命令提示符 [SQL Server], 启动和停止 SQL Server 服务"
  - "继续 SQL Server"
  - "启动 SQL Server 数据库引擎"
  - "net stop 命令 [SQL Server]"
  - "命令提示符 [SQL Server], SQL Browser 服务"
  - "配置管理器, 启动和停止服务"
  - "继续 SQL Server"
  - "启动选项 [SQL Server]"
  - "命名实例 [SQL Server], 启动和停止"
  - "net start 命令 [SQL Server]"
  - "SQL Server, 启动和停止"
  - "停止 SQL Server"
  - "启动 SQL Server Browser 服务"
  - "SQL Server 数据库引擎设置启动选项"
  - "管理 SQL Server, 启动和停止服务"
  - "Management Studio [SQL Server], 启动和停止服务"
...
#### 启动 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 配置管理器  
...
#### 启动、停止、暂停、继续或重新启动 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]  
...
> [!NOTE]  
>  若要使用启动选项启动一个 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] 的实例，请参阅[配置服务器启动选项（SQL Server 配置管理器）](../../database-engine/configure-windows/configure-server-startup-options-sql-server-configuration-manager.md)。  
  
#### 启动、停止、暂停、继续或重新启动 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser 或 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 代理实例  
...
#### 启动、停止或重新启动 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 代理实例  
...
#### 使用 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 停止 [!INCLUDE[tsql](../../includes/tsql-md.md)]  
...
#### 启动和停止 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 服务  
...
## 另请参阅  
 [SQL Server 安装文档概述](../Topic/Overview%20of%20SQL%20Server%20Setup%20Documentation.md)   
