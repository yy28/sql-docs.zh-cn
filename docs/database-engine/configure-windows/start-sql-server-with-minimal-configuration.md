...
-   审核将处于禁用状态，但仍可发出审核 DDL。 实际上，-m 应该足以满足大多数需要 SQL Server 审核重新配置的情况。 有关审核配置中的安全性的更多详细信息，请参阅 [SQL Server 中的审核](/previous-versions/sql/sql-server-2008/dd392015(v=sql.100)#security)。
