...
-   若要下载并安装 SQL Server 2016 Express，请转到**[下载中心](http://www.microsoft.com/download/details.aspx?id=52679)**。 LocalDB 是在安装期间选择的功能。 在**下载中心**中，可以从“自定义安装”，或在下载媒体时获取 LocalDB。 如果下载媒体，则选择“Express Advanced”或“LocalDB”包。 
  
-   是否拥有 Azure 帐户？  然后转到 **[此处](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016ctp33evaluationwindowsserver2012r2/?wt.mc_id=sqL16_vm)** ，以加速已安装有 [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] 的虚拟机。  
