...
keywords: 
  - "服务器配置 (SQL Server)"
helpviewer_keywords: 
  - "外围应用配置 [SQL Server]，sp_configure"
  - "配置选项 [SQL Server]，生效时间"
  - "服务器管理 [SQL Server]，配置选项"
  - "SQL Server Management Studio [SQL Server]，服务器"
  - "服务器 [SQL Server]，配置"
  - "配置选项 [SQL Server]，设置"
  - "选项 [SQL Server]，配置"
  - "RECONFIGURE 语句"
  - "性能 [SQL Server]，服务器"
  - "配置选项 [SQL Server]"
  - "RECONFIGURE WITH OVERRIDE 语句"
  - "SQL Server, 配置"
  - "sp_configure"
  - "存储过程 [SQL Server]，配置选项"
  - "服务器配置 [SQL Server]"
  - "管理 SQL Server，配置选项"
