...
## <a name="server-level-roles"></a><a name="Security"></a> 服务器级别角色  
...
## <a name="sql-server-configuration-manager"></a><a name="PowerShellProcedure"></a>SQL Server 配置管理器  
