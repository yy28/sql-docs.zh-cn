---
title: "filestream access level 服务器配置选项 | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
---
# filestream access level 服务器配置选项
...
## 另请参阅  
 [数据库引擎配置 - 文件流](../Topic/Database%20Engine%20Configuration%20-%20Filestream.md)   
