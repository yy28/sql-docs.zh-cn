...
helpviewer_keywords: 
  - "SQL Server 配置管理器，访问"
  - "数据库引擎 [SQL Server]，服务"
  - "管理服务 [SQL Server]，关于服务管理"
  - "服务 [SQL Server]"
  - "SQL Server 代理服务，管理"
  - "SQL Server 服务，关于 SQL Server 服务"
  - "MSSQLServer"
  - "服务器配置 [SQL Server]"
  - "管理服务 [SQL Server]"
  - "SQL Server 代理服务"
...
|[在网络上或不在网络上运行 SQL Server](../../database-engine/configure-windows/run-sql-server-with-or-without-a-network.md)|[配置服务器启动选项（SQL Server 配置管理器）](../../database-engine/configure-windows/configure-server-startup-options-sql-server-configuration-manager.md)|  
...
|[数据库引擎服务启动选项](../../database-engine/configure-windows/database-engine-service-startup-options.md)|[配置 SQL Server 错误日志](../../database-engine/configure-windows/configure-sql-server-error-logs.md)|  
...
|[连接到其他计算机（SQL Server 配置管理器）](../../database-engine/configure-windows/connect-to-another-computer-sql-server-configuration-manager.md)|[登录到 SQL Server 实例（命令提示符）](../../database-engine/configure-windows/log-in-to-an-instance-of-sql-server-command-prompt.md)|  
