...
helpviewer_keywords: 
  - "命名管道 [SQL Server], 配置"
  - "连接 [SQL Server], 服务器网络配置"
  - "数据库引擎 [SQL Server], 网络配置"
  - "服务器网络配置 [SQL Server]"
  - "协议 [SQL Server], 选择"
  - "端口 [SQL Server], 更改"
  - "服务器配置 [SQL Server]"
