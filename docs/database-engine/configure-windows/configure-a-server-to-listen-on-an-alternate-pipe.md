...
5.  在详细信息窗格中，右键单击 “SQL Server（\< 实例名称>）”，然后单击“重新启动”以停止并重新启动[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。  
