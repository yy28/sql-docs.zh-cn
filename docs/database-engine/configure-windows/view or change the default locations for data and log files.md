...
ms.topic: "article"
helpviewer_keywords: 
  - "日志文件 [SQL Server], 更改默认位置"
  - "数据文件 [SQL Server], 更改默认位置"
...
# 查看或更改数据文件和日志文件的默认位置 (SQL Server Management Studio)
  本主题说明如何使用 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 在 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 中查看和更改新的数据文件和日志文件的默认位置。 默认路径从注册表中获得。 在更改位置后，如果未指定其他位置，在 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 实例中创建的所有新数据库将使用该位置。  
