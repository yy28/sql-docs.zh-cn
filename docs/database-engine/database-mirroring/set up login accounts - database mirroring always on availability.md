---
title: "设置数据库镜像或 AlwaysOn 可用性组的登录帐户 (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx_md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]
  ...
  [](../../database-engine/database-mirroring/the-database-mirroring-endpoint-sql-server.md "The Database Mirroring Endpoint (SQL Server)") 为了使两个服务器实例能够连接到彼此的数据库镜像端点，每个实例的登录帐户都要具有访问另一实例的权限。 每个登录帐户还要具有可以连接到另一实例的数据库镜像端点的权限。  
