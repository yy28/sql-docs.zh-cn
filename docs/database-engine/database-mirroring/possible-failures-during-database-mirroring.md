...
ms.topic: "article"
helpviewer_keywords: 
  - "超时期限 [SQL Server 数据库镜像]"
  - "软错误 [SQL Server]"
  - "数据库镜像 [SQL Server], 故障排除"
  - "超时错误 [SQL Server]"
  - "故障排除 [SQL Server], 数据库镜像"
  - "硬错误"
  - "失败的数据库镜像会话 [SQL Server]"
...
-   在 [sys.database_mirroring](../../relational-databases/system-catalog-views/sys-database-mirroring-transact-sql.md) 中查询 **mirroring_connection_timeout**。  
