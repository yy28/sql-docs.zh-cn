...
> [!NOTE]  
> 从 [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 查询编辑器中导入 [!INCLUDE[tsql](../../includes/tsql-md.md)] 脚本时，数据库引擎优化顾问可接受 XML 文件作为输入。 有关详细信息，请参阅[启动并使用数据库引擎优化顾问](../../relational-databases/performance/start-and-use-the-database-engine-tuning-advisor.md)中的“从 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 查询编辑器中启动数据库引擎优化顾问”一节。  
  
## 课程中的下一个任务  
[设置工具选项和布局](../../tools/dta/setting-tool-options-and-layout.md)  
