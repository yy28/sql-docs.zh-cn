...
---
# <a name="lesson-1-1---tuning-a-workload"></a>第 1-1 课 - 优化工作负荷
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]可以使用数据库引擎优化顾问，针对选择进行优化的数据库和表来找到查询性能最佳的物理数据库设计。  
