---
title: TestServer 元素 (DTA) |Microsoft 文档
ms.custom: ''
ms.date: 03/01/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]指定测试服务器优化生产服务器时使用。  
...
|**默认值**|无。|  
|**出现次数**|選擇性。 对于每个 **TuningOptions** 元素可以使用一次。|  
