...
ms.topic: "reference"
helpviewer_keywords: 
  - "SQL Server Management Studio [SQL Server], 帮助"
  - "已注册的服务器 [SQL Server], 帮助"
  - "SQL Server Management Studio 帮助 [SQL Server], 已注册的服务器"
...
# “已注册的服务器”组件的 F1 帮助
 ...
 ## Reporting Services 新建或编辑服务器注册（“常规”选项卡） 
 ...
 **测试**  
 ...
 ## Analysis Services – 多维数据新建或编辑服务器注册（“常规”选项卡）
