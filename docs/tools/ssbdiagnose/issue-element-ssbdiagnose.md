...
helpviewer_keywords: 
  - "issue 元素"
  - "XML 输出文件格式 [ssbdiagnose], Issue 元素"
  - "ssbdiagnose"
...
|Attribute|说明|  
|---------------|-----------------|  
|**type**|标识 Issue 元素报告的问题类别：<br /><br /> **“诊断”** 报告在分析 [!INCLUDE[ssSB](../../includes/sssb-md.md)] 配置时发现的配置问题。<br /><br /> “问题” 报告阻止 **ssbdiagnose** 完成其分析的问题。 更正问题并重新运行 **ssbdiagnose**。<br /><br /> **“事件”**报告在运行 **-RUNTIME** 检查时发现的 [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] 事件。 仅当指定了 **-SHOWEVENTS** 时才报告事件。|  
|**代码**|标识消息的错误号。|  
