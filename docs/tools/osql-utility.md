...
helpviewer_keywords: 
  ...
  - "EXIT 命令"
  - "操作系统 [SQL Server]，命令"
  - "osql 实用工具 [SQL Server]"
  - "存储过程 [SQL Server]，命令提示符"
  - "脚本 [SQL Server]，命令提示符"
  - "RESET 命令"
  - "GO 命令"
  - "命令提示实用工具 [SQL Server]，osql"
  - "CTRL+C 命令"
...
## 插入注释  
 可以在 **osql** 提交给 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 的 Transact-SQL 语句中包含注释。 允许使用两种类型的注释样式：-- 和 /*...\*/。  
