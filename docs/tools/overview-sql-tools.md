...
- 若要管理的 SQL Server 实例或数据库，请在 Windows、 Linux 或 Mac 上的轻量编辑器吗？ 选择[[!INCLUDE[name-sos](../includes/name-sos.md)]](../sql-operations-studio/download.md) | [!INCLUDE[name-sos](../includes/name-sos-short.md)] 
