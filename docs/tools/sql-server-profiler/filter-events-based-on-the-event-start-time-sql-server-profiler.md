...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]本主题介绍如何筛选跟踪事件通过使用基于事件开始时间[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]。  
