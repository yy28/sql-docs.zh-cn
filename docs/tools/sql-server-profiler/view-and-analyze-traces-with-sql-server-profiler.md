...
ms.topic: "article"
helpviewer_keywords: 
  - "Profiler [SQL Server Profiler]，查看跟踪内容"
  - "SQL Server Profiler，查看跟踪内容"
  - "跟踪内容 [SQL Server]，查看"
  - "SQL Server Profiler，故障排除"
  - "故障排除 [SQL Server]，跟踪内容"
  - "事件 [SQL Server]，在跟踪内容中查找"
  - "Profiler [SQL Server Profiler]，故障排除"
  - "跟踪内容 [SQL Server]，事件"
