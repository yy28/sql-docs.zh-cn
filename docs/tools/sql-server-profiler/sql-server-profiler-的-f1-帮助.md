...
helpviewer_keywords: 
  - "Profiler [SQL Server Profiler], 帮助"
  - "SQL Server Profiler, 帮助"
  - "“跟踪属性”对话框"
  - "“跟踪模板属性”对话框"
  - "“跟踪文件属性”对话框"
  - "性能计数器列表对话框"
 ...
 **启用跟踪停止时间**  
 为跟踪设置日期和时间，以便到时候终止并关闭此跟踪。 使用 **“跟踪属性”** 对话框的 **“事件选择”** 选项卡可以查看或指定跟踪的事件和数据列。  
...
#### 选项  
 ...
 通过单击数据列标题并输入筛选条件指定筛选器。 筛选出来的数据列由 **“编辑筛选器”** 对话框中列标签左边的筛选器图标指示。 有关详细信息，请参阅 [SQL Server Profiler - 编辑筛选器](../Topic/SQL%20Server%20Profiler%20-%20Edit%20Filter.md)。  
...
## 跟踪模板属性（“常规”选项卡）
  通过使用下列选项，使用 **“跟踪模板属性”** 对话框的 **“常规”** 选项卡可以创建新的跟踪模板。 若要访问此对话框，请在 [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]“文件”菜单上，指向“模板”，再单击“新建模板”。  
...
## 编辑“跟踪模板属性”（“常规”选项卡）
 通过使用下列选项，使用 **“跟踪模板属性”** 的 **“常规”** 选项卡可以查看或编辑现有跟踪模板。 若要访问此对话框，请在[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]“文件”菜单上，指向“模板”，再单击“编辑模板”。  
...
2.  选中要与 [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] 跟踪文件关联的计数器。  
 ...
 ## SQL Server Profiler - 工具/选项（“常规选项”页）
...
> **注意：**切换此复选框将更改时间列的显示格式，如 **StartTime** 和 **EndTime**。 但是，此操作不会更改语言事件或远程过程调用 (RPC) 中的 **DateTime** 值参数。  
 ...
 **默认 Health Monitor 轮询间隔(秒)**  
 ...
 ## SQL Server Profiler - 源表/数据库引擎优化顾问 - 选择工作负荷表
...
#### 选项  
 **SQL Server**  
 指定当前连接的 SQL Server 的实例。 此字段将自动填充，并且无法更新。  
 ...
 **表**  
 ...
 ## SQL Server Profiler - 重播配置（基本重播选项）
 ...
 **显示重播结果**  
 ...
 ## SQL Server Profiler - 重播配置（高级重播选项）
 ...
 **在列中搜索**  
 单击要搜索的数据列，或者单击“\<All columns>”以搜索跟踪中的所有数据列。  
...
> **注意：**对于字符串类型数据列，筛选条件将显示为 LIKE 或 NOT LIKE 字符串值。  

## 选择模板名称
  使用 **“选择模板名称”** 对话框，可以选择现有的 [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] 跟踪模板以导出到操作系统的文件中。 当编辑现有的跟踪模板时，还可以使用此对话框选择或输入不同的名称来另存跟踪模板。 若要在导出模板时访问此对话框，请在 [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]“文件”菜单上，指向“模板”，再单击“导出模板”。 若要在更改模板名称时访问此对话框，请在 **“文件”** 菜单上，依次指向 **“模板”**和 **“编辑模板”**，再单击 **“另存为”**。  
