...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]本主题介绍如何通过使用创建新的跟踪模板[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]。  
