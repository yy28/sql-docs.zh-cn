...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]本主题介绍如何通过使用指定的跟踪的事件类和数据列[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]。  
