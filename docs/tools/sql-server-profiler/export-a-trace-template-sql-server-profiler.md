---
title: "导出跟踪模板 （SQL Server 事件探查器） |Microsoft 文档"
ms.custom: 
ms.date: 03/01/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]本主题介绍如何导出要将另存为模板文件 (.tdf) 使用的现有跟踪模板[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]。 导出跟踪模板并将其保存为文件后，可以将该模板用于另一个 [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]实例。  
