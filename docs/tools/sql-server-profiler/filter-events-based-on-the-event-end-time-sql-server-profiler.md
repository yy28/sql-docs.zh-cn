...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]本主题介绍如何筛选跟踪事件基于事件结束时间使用[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]。  
