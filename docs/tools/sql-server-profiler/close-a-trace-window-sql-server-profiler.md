...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]本主题介绍如何关闭跟踪窗口是否正在运行或已保存跟踪的跟踪查看使用[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]。  
