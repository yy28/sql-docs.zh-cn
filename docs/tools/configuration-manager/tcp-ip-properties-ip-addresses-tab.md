...
# TCP/IP Properties (IP Addresses Tab)
 ...
 更改在重启 SQL Server 后生效。 有关启动和停止 SQL Server Browser 服务的信息，请参阅[启动和停止 SQL Server Browser 服务](https://msdn.microsoft.com/library/hh403394.aspx)。  
 ...
 **已启用**  
 如果“TCP/IP 属性(‘协议’选项卡)”上的“全部侦听”属性设为“否”，则此属性指示 SQL Server 是否侦听 IP 地址。 如果“TCP/IP 属性(‘协议’选项卡)”上的“全部侦听”属性设为“是”，则表示忽略该属性。 不适用于 **“IPAll”**。  
