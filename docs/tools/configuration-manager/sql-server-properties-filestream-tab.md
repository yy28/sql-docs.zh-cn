---
title: "SQL Server 属性 （FILESTREAM 选项卡） |Microsoft 文档"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]使用此页的此安装启用 FILESTREAM [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]。  
