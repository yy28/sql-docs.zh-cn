...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]使用**服务**选项卡上[!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]**属性**对话框中，可以查看或指定以下选项。  
