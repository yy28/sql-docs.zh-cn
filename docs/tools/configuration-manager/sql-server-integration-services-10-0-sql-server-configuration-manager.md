---
title: "SQL Server Integration Services 10.0 （SQL Server 配置管理器） |Microsoft 文档"
ms.custom: 
ms.date: 03/01/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]这是支持的服务[!INCLUDE[ssIS](../../includes/ssis-md.md)]。 若要查看此服务的属性，请在详细信息窗格中右键单击此服务，再单击 **“属性”**。  
