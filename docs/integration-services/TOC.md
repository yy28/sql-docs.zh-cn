...
## [在 Azure 中运行包](lift-shift/ssis-azure-run-packages.md)
...
# [包](integration-services-ssis-packages.md)
...
## [包升级向导 F1 帮助](ssis-package-upgrade-wizard-f1-help.md)
## [包和项目参数](integration-services-ssis-package-and-project-parameters.md)

# [连接](../integration-services/connection-manager/integration-services-ssis-connections.md)
# [控制流](../integration-services/control-flow/control-flow.md)
# [数据流](../integration-services/data-flow/data-flow.md)

# [变量](integration-services-ssis-variables.md)
## [“变量”窗口](variables-window.md)
## [系统变量](system-variables.md)
# [表达式](../integration-services/expressions/integration-services-ssis-expressions.md)
# [事件处理程序](integration-services-ssis-event-handlers.md)
# [查询](integration-services-ssis-queries.md)
# [中的](integration-services-transactions.md)
# [部署包](packages/deploy-integration-services-ssis-projects-and-packages.md)
# [运行包](packages/run-integration-services-ssis-packages.md)
...
## [以编程方式生成包](../integration-services/building-packages-programmatically/adding-connections-programmatically.md)
...
# [教程](integration-services-tutorials.md)
