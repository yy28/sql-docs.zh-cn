...
## <a name="see-also"></a>另请参阅  
 [在完全缓存模式下使用 OLE DB 连接管理器来实现查找转换](../../integration-services/connection-manager/lookup-transformation-full-cache-mode-ole-db-connection-manager.md)   
