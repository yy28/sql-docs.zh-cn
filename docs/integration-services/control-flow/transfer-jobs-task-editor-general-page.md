---
title: "传输作业任务编辑器（“常规”页） | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# 传输作业任务编辑器（“常规”页）
  可以使用 **“传输作业任务编辑器”** 对话框的 **“常规”** 页，对传输作业任务进行命名和说明。 有关传输作业任务的详细信息，请参阅 [Transfer Jobs Task](../../integration-services/control-flow/transfer-jobs-task.md)。  
