...
helpviewer_keywords: 
  - "任务 [Integration Services], 优先约束"
  - "控制流 [Integration Services], 优先约束"
  - "优先约束 [Integration Services]"
  - "约束 [Integration Services]"
  - "序列执行选项 [Integration Services]"
  - "容器 [Integration Services], 优先约束"
...
## 优先约束的配置  
 ...
 有关可以在 [!INCLUDE[ssIS](../../includes/ssis-md.md)] 设计器中设置的属性的信息，请参阅[优先约束编辑器](../Topic/Precedence%20Constraint%20Editor.md)。  
...
-   [设置优先约束的属性](../Topic/Set%20the%20Properties%20of%20a%20Precedence%20Constraint.md)  
  
-   [使用快捷菜单设置优先约束的值](../Topic/Set%20the%20Value%20of%20a%20Precedence%20Constraint%20by%20Using%20the%20Shortcut%20Menu.md)  
...
## 另请参阅  
 [将表达式添加到优先约束](../Topic/Add%20Expressions%20to%20Precedence%20Constraints.md)   
 [多个优先约束](../Topic/Multiple%20Precedence%20Constraints.md)  
