...
helpviewer_keywords: 
  - "预测查询 [Integration Services]"
  - "数据挖掘查询任务 [Integration Services]"
...
-   [数据挖掘查询任务编辑器（“输出”选项卡）](../../integration-services/control-flow/data-mining-query-task-editor-output-tab.md)  
