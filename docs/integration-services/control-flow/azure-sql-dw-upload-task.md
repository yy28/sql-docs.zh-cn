...
“Azure SQL DW 上传任务”是适用于 Azure for SQL Server 2016 的 SQL Server Integration Services (SSIS) 功能包的组成部分。 从 [此处](http://go.microsoft.com/fwlink/?LinkID=626967)下载功能包。
...
ColumnDelimiter|指定标记每一列末尾的一个或多个字符。 例如 &#124; 表示竖线字符，\t 表示制表位字符，&#124;\t 表示竖线-制表位字符顺序。
