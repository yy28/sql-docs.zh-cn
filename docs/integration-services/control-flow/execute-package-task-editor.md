...
#### 位置 = SQL Server  
 **连接**  
 在列表中选择一个 OLE DB 连接管理器，或单击“\<新建连接…>”创建新的连接管理器。  
...
##  <a name="parameter"></a> 设置“参数绑定”页上的选项  
 ...
 有关将项目转换为项目部署模型的信息，请参阅[将项目部署到 Integration Services 服务器](../../integration-services/packages/deploy-projects-to-integration-services-server.md)。  
