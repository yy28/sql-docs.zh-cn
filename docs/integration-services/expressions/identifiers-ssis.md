...
ms.topic: "article"
helpviewer_keywords: 
  - "规则标识符 [Integration Services]"
  - "变量 [Integration Services]，表达式"
  - "标识符 [Integration Services]"
  - "表达式 [Integration Services]，变量"
  - "沿袭标识符"
  - "列 [Integration Services]，标识符"
  - "名称 [Integration Services]"
  - "表达式 [Integration Services]，标识符"
  - "限定标识符 [Integration Services]"
...
## 唯一变量名  
 ...
 所有变量都有作用域并属于某个命名空间。 变量的作用域可以是包或者包中的容器或任务。 [!INCLUDE[ssIS](../../includes/ssis-md.md)] 设计器中的表达式生成器仅列出作用域内变量。 有关详细信息，请参阅 [Integration Services (SSIS) 变量](../../integration-services/integration-services-ssis-variables.md)和[在包中使用变量](../Topic/Use%20Variables%20in%20Packages.md)。  
