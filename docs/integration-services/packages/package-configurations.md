...
ms.topic: "article"
helpviewer_keywords: 
  - "包配置语法 [Integration Services]"
  - "SQL Server Integration Services 包，配置"
  - "SSIS 包，配置"
  - "XML [Integration Services]"
  - "Integration Services 包，配置"
  - "配置语法 [Integration Services]"
  - "间接配置 [Integration Services]"
  - "配置 [Integration Services]"
  - "直接配置 [Integration Services]"
  - "包 [Integration Services]，配置"
...
-   不能使用 **/ConfigFile** 选项加载用来替换在设计时指定的配置的配置。  
 ...
 有关这些选项以及其在 [!INCLUDE[ssISCurrent](../../includes/ssiscurrent-md.md)] 和早期版本中的行为的区别的详细信息，请参阅 [SQL Server 2016 中 Integration Services 功能的行为更改](../Topic/Behavior%20Changes%20to%20Integration%20Services%20Features%20in%20SQL%20Server%202016.md)。  
