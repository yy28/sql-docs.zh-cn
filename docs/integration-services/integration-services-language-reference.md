...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
 ...
 [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] 在称为 [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] 目录的数据库中存储对象、设置和操作数据。 默认名称[!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]目录是 SSISDB。 目录中存储的对象包括项目、包、参数环境和操作历史记录。  
