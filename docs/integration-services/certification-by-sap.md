...
# <a name="certification-by-sap"></a>SAP 认证
 ...
 ![SAP 认证-与 SAP NetWeaver 集成](../integration-services/media/sapcertifiedforssis11.gif "SAP 认证-与 SAP NetWeaver 的集成")  
  
 下表说明了该认证的详细信息。  
  
|SAP 接口|SAP 版本级别|认证日期|相关组件|  
|-------------------|------------------------|------------------------|-----------------------|  
|BW_OHS 7.0 - SAP NetWeaver Business Intelligence - Open Hub Service 7.0|Business Intelligence 7.0|2012 年 12 月|数据源|  
