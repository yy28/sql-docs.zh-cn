...
ms.topic: "article"
helpviewer_keywords: 
  - "进度报告 [Integration Services]"
  - "断点 [Integration Services]"
  - "调试 [Integration Services], 控制流"
  - "控制流 [Integration Services], 调试"
  - "具有颜色编码的进度报告 [Integration Services]"
  - "“设置断点”对话框"
...
-   [通过在任务或容器上设置断点调试包](../../integration-services/troubleshooting/debug-a-package-by-setting-breakpoints-on-a-task-or-a-container.md)  
  
## 进度报告  
 [!INCLUDE[ssIS](../../includes/ssis-md.md)] 设计器中包含两种类型进度报告：“控制流”选项卡设计图面上的颜色编码和“进度”选项卡上的进度消息。  
