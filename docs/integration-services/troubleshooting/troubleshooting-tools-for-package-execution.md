---
title: "对包执行进行故障排除的工具 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "08/26/2016"
...
-   **启用日志记录**。 您可以只选择所要捕获的事件以及只选择所要捕获的信息项，以修改日志记录输出。 有关详细信息，请参阅 [Integration Services (SSIS) 日志记录](https://msdn.microsoft.com/library/ms140246.aspx)。  
  
-   **选择包的“诊断”事件对访问接口问题进行故障排除。** 一些日志记录消息可以帮助您对包与外部数据源的交互情况进行故障排除。 有关详细信息，请参阅 [Troubleshooting Tools Package Connectivity](https://msdn.microsoft.com/library/cc879309.aspx)。  
...
||  
|-|  
|![集成服务图标(小)](../../integration-services/troubleshooting/media/dts-16.png "集成服务图标(小)")  **掌握集成服务的最新信息**<br /> 若要从 Microsoft 获得最新的下载内容、文章、示例和视频，以及从社区获得所选解决方案，请访问 MSDN 上的 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 页：<br /><br /> -   [访问 MSDN 上的 Integration Services 页](http://go.microsoft.com/fwlink/?LinkId=136655)<br /><br /> 若要获取这些更新的自动通知，请订阅该页上提供的 RSS 源。|  
