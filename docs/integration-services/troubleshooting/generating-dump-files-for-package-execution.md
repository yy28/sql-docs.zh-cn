...
-   .tmp 调试转储文件。 这是一个文本格式文件。  
 ...
 默认情况下，[!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]将这些文件存储在文件夹中， *\<驱动器 >:*files\microsoft SQL Server\110\Shared\ErrorDumps。  
