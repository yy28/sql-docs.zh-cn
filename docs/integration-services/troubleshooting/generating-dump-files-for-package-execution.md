---
title: 生成 SSIS 包执行的转储文件
description: 了解如何使用“出错时转储”选项来对 SQL Server Integration Services 进行故障排除。 这些选项会生成一个 .mdmp 调试转储文件和一个文本 .tmp 调试转储文件。 了解调试转储文件格式。
ms.date: 08/24/2016
ms.prod: sql
