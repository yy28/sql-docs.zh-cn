---
title: "分区处理目标编辑器 （映射页） |Microsoft 文档"
ms.custom: 
ms.date: 03/01/2017
...
## <a name="see-also"></a>另请参阅  
 ...
 [分区处理目标编辑器 &#40;连接管理器页 &#41;](../../integration-services/data-flow/partition-processing-destination-editor-connection-manager-page.md)   
 [分区处理目标编辑器 &#40;高级页 &#41;](../../integration-services/data-flow/partition-processing-destination-editor-advanced-page.md)  
