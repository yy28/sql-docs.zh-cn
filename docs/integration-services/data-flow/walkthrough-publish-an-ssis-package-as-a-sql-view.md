...
## 步骤 2：使用 SSIS 数据馈送发布向导将 SSIS 包发布为 SQL 视图  
...
3.  右键单击向导创建的“\<向导创建的视图>”，然后单击创建“选择前 1000 行”。  
...
### 使用 OLE DB Provider for SSIS 创建链接服务器  
