...
helpviewer_keywords: 
  - "脚本转换"
  - "脚本 [Integration Services], 转换"
  - "脚本组件 [Integration Services], 关于脚本组件"
  - "脚本组件 [Integration Services]"
...
## 相关内容  
 ...
 [用脚本组件扩展数据流](../../../integration-services/extending-packages-scripting/data-flow-script-component/extending-the-data-flow-with-the-script-component.md)  
