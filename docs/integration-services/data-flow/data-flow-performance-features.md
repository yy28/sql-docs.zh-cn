...
helpviewer_keywords: 
  ...
  - "Integration Services 程序包, 性能"
  - "性能 [Integration Services]"
  - "数据流 [Integration Services], 故障排除"
  - "SQL Server Integration Services 包, 性能"
  - "加载数据"
  - "控制流 [Integration Services], 故障排除"
  - "SSIS 程序包, 性能"
  - "程序包 [Integration Services], 性能"
  - "查询 [Integration Services], 故障排除"
  - "对数据进行排序 [Integration Services]"
  - "聚合 [Integration Services]"
