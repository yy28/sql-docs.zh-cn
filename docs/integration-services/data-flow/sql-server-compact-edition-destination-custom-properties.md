---
title: "SQL Server Compact Edition 目标自定义属性 |Microsoft 文档"
ms.custom: 
ms.date: 03/14/2017
...
|-------------------|---------------|-----------------|  
|TableName|字符串|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Compact 数据库中目标表的名称。<br /><br /> 此属性的值可以使用属性表达式来指定。|  
