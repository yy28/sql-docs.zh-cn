...
## <a name="see-also"></a>另请参阅  
 ...
 [OLE DB 目标编辑器 &#40;映射页 &#41;](../../integration-services/data-flow/ole-db-destination-editor-mappings-page.md)   
 [OLE DB 目标编辑器 &#40;错误输出页 &#41;](../../integration-services/data-flow/ole-db-destination-editor-error-output-page.md)   
 [通过使用 OLE DB 目标加载数据](../../integration-services/data-flow/load-data-by-using-the-ole-db-destination.md)  
