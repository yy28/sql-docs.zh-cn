...
### 在 SQL Server Management Studio 中查看 Integration Services 的服务事件  
...
### 在 Windows 事件查看器中查看 Integration Services 的服务事件  
...
## 另请参阅  
 ...
 [添加数据流性能计数器的日志](../../integration-services/performance/add-a-log-for-data-flow-performance-counters.md)  
