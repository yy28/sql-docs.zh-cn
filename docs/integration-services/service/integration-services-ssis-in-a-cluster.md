...
---
# 群集中的 Integration Services (SSIS)
...
## <a name="related-tasks"></a>相关任务  
 有关在群集中配置 Integration Services 服务的分步说明，请参阅 [将 Integration Services 服务配置为群集资源](../../integration-services/service/configure-the-integration-services-service-as-a-cluster-resource.md)。  
