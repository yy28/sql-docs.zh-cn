...
-   将 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 服务作为群集资源联机。  
 ...
 在群集或任何服务器上配置 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 服务后，可能需要配置 DCOM 权限才能从客户端计算机连接到该服务。 有关详细信息，请参阅[连接到远程 Integration Services 服务器（SSIS 服务）](../../integration-services/service/connect-to-a-remote-integration-services-server-ssis-service.md)。  
