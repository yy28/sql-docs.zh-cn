...
## <a name="enable-package-logging-in-sql-server-data-tools"></a><a name="ssdt"></a> 在 SQL Server Data Tools 中启用包日志记录
...
###  <a name="configure-the-options-on-the-details-tab"></a><a name="detail"></a> 配置“详细信息”选项卡上的选项  
