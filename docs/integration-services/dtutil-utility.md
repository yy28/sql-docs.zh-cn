...
>  此示例中用到的哈希并不是真正的哈希。  
 ...
 有关详细信息，请参阅 [使用 Authenticode 签名和检查代码](/previous-versions/windows/internet-explorer/ie-developer/platform-apis/ms537364(v=vs.85))中的 CertMgr 部分。  
