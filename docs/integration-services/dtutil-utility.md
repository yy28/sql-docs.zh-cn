...
helpviewer_keywords: 
  ...
  - "检查包"
  - "移动包"
  - "程序包 [Integration Services], 命令行选项"
  - "命令提示 [Integration Services]"
  - "SQL Server Integration Services 包, 命令行选项"
  - "复制包"
  - "存在性测试 [Integration Services]"
  - "Integration Services 包, 命令行选项"
  - "SSIS 包, 命令行选项"
  - "删除包"
  - "dtutil 实用工具"
  - "删除包"
