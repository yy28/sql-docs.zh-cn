...
---
# Integration Services 设计器选项的“常规”页
 ...
 **加载包时检查数字签名**  
 ...
 有关数字证书和包的详细信息，请参阅[使用数字签名标识包的源](../integration-services/packages/identify-the-source-of-packages-with-digital-signatures.md)。  
 ...
 **更新连接字符串以使用新的提供程序名称**  
 对于当前版本的 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)][!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]，打开或升级 [!INCLUDE[ssISversion2005](../includes/ssisversion2005-md.md)] 包时，请将连接字符串更新为使用下列提供程序的名称：  
