...
-   [步骤 1：复制部署捆绑](../integration-services/step-1-copying-the-deployment-bundle.md)  
  
-   [步骤 2：运行包安装向导](../integration-services/step-2-running-the-package-installation-wizard.md)  
  
-   [步骤 3：测试已部署的包](../integration-services/step-3-testing-the-deployed-packages.md)  
