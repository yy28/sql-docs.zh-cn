...
-   [步骤 1：创建工作文件夹和环境变量](../integration-services/step-1-creating-working-folders-and-environment-variables.md)  
  
-   [步骤 2：创建部署项目](../integration-services/step-2-creating-the-deployment-project.md)  
  
-   [步骤 3：添加包和其他文件](../integration-services/step-3-adding-packages-and-other-files.md)  
  
-   [步骤 4：添加包配置](../integration-services/step-4-adding-package-configurations.md)  
