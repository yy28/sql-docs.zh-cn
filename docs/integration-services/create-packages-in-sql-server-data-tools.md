---
title: "在 SQL Server Data Tools 中创建包 |Microsoft 文档"
ms.custom: 
ms.date: 03/14/2017
...
若要安装 SQL Server Data Tools (SSDT)，请参阅 [下载 SQL Server Data Tools (SSDT)](/sql-docs/docs/ssdt/download-sql-server-data-tools-ssdt)。
