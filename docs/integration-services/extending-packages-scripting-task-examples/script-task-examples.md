...
### <a name="example-topics"></a>示例主题  
 ...
 从基于的值的 Active Directory 中检索用户信息[!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]变量，通过使用 System.DirectoryServices 命名空间中的类。  
 ...
 创建自定义性能计数器可以用于跟踪的执行进度[!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]包，通过使用 System.Diagnostics 命名空间中的类。  
  
 [使用脚本任务处理图像](../../integration-services/extending-packages-scripting-task-examples/working-with-images-with-the-script-task.md)  
 将映像压缩到 JPEG 格式，并且通过使用 System.Drawing 命名空间中的类来从它们，创建缩略图图像。  
 ...
 查找支持特定纸张大小 System.Drawing.Printing 命名空间中使用类的已安装的打印机。  
