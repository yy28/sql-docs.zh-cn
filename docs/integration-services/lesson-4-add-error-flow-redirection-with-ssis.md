...
-   [步骤 1：复制 Lesson 3 包](../integration-services/step-1-copying-the-lesson-3-package.md)  
  
-   [步骤 2：创建损坏的文件](../integration-services/step-2-creating-a-corrupted-file.md)  
  
-   [步骤 3：添加错误流重定向](../integration-services/step-3-adding-error-flow-redirection.md)  
  
-   [步骤 4：添加平面文件目标](../integration-services/step-4-adding-a-flat-file-destination.md)  
  
-   [步骤 5：测试第 4 课教程包](../integration-services/step-5-testing-the-lesson-4-tutorial-package.md)  
