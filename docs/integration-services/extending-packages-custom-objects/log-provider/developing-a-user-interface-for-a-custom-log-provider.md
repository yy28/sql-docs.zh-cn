---
title: "开发的自定义日志提供程序的用户界面 |Microsoft 文档"
ms.custom: 
ms.date: 03/14/2017
...
# <a name="developing-a-user-interface-for-a-custom-log-provider"></a>为自定义日志提供程序开发用户界面
  许多[!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)]日志提供程序具有实现的自定义用户界面<xref:Microsoft.SqlServer.Dts.Runtime.Design.IDtsLogProviderUI>，并替换**配置**文本框中**配置 SSIS 日志**与筛选的下拉列表的可用连接管理器的对话框。 但是，在中未实现自定义日志提供程序的自定义用户界面[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)]。  
