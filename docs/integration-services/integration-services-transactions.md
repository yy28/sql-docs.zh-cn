...
ms.topic: "article"
helpviewer_keywords: 
  - "容器 [Integration Services], 事务"
  - "事务 [Integration Services], 关于包中的事务"
  - "任务 [Integration Services], 事务"
  - "事务 [Integration Services]"
...
-   [将包配置为使用事务](../Topic/Configure%20a%20Package%20to%20Use%20Transactions.md)  
...
## 另请参阅  
 [继承的事务](../Topic/Inherited%20Transactions.md)   
 [多个事务](../Topic/Multiple%20Transactions.md)  
