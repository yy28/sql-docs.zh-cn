...
> [!NOTE]
> 无论 SQL Server 是源还是目标，此数据提供程序的连接选项是相同的。 也就是说，在向导的“选择数据源”页和“选择目标”页上看到的选项都是相同的。
...
> [!NOTE]
> 无论 SQL Server 是源还是目标，ODBC 驱动程序的连接选项是相同的。 也就是说，在向导的“选择数据源”页和“选择目标”页上看到的选项都是相同的。
