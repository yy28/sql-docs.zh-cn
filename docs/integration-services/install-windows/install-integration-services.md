...
helpviewer_keywords: 
  ...
  - "SSIS, 安装"
  - "安装集成服务, 关于安装集成服务"
  - "SQL Server Integration Services, 安装"
  - "安装程序 [Integration Services], 关于安装集成服务"
  - "安装集成服务"
  - "安装程序 [集成服务]"
...
>     
>  有关如何授予权限的说明，请参阅 [Grant Permissions to Integration Services Service](../../integration-services/service/grant-permissions-to-integration-services-service.md)。    
...
> [!IMPORTANT]    
>  [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)][!INCLUDE[vcpritanium](../../includes/vcpritanium-md.md)] 64 位操作系统上不支持 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 包的 32 位开发环境，因此不能将其安装在 [!INCLUDE[vcpritanium](../../includes/vcpritanium-md.md)] 服务器上。    
