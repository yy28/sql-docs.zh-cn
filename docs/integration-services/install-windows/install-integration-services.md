...
## <a name="installing-standalone-or-side-by-side"></a>独立安装或并行安装    
...
### <a name="installing-a-dedicated-server-for-etl"></a>为 ETL 安装专用服务器
...
## <a name="a-complete-installation-of-integration-services"></a>完整安装 Integration Services
