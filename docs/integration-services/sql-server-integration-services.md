---
title: "SQL Server Integration Services |Microsoft 文档"
ms.custom: 
ms.date: 03/14/2017
...
# <a name="sql-server-integration-services"></a>SQL Server Integration Services
 ...
 > 与以前版本的 SQL Server 相关的内容，请参阅[SQL Server Integration Services](https://msdn.microsoft.com/en-US/library/ms141026(SQL.120).aspx)。
...
- [![从评估中心下载](../includes/media/download2.png)](http://go.microsoft.com/fwlink/?LinkID=829477)[下载自 2017 年或 2016年的 SQL Server](https://www.microsoft.com/evalcenter/evaluate-sql-server)
...
- [For SSIS 的 MSDN 论坛上提问](https://social.msdn.microsoft.com/Forums/en-us/home?forum=sqlintegrationservices)
- [SSDT 和 SSMS-的 MSDN 论坛上提问](https://social.msdn.microsoft.com/Forums/en-US/home?forum=sqltool)
- [堆栈溢出 (标记*ssis*)-提问](http://stackoverflow.com/questions/tagged/ssis)
...
- [适用于业务用户的 Microsoft 支持选项](https://support.microsoft.com/gp/support-options-for-business)
- [业务用户的联系人 Microsoft 选项](https://support.microsoft.com/gp/contactus81?Audience=Commercial)
