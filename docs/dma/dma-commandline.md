...
|`/AzureAuthenticationInteractiveAuthentication` | 设置为 true 可弹出窗口。 | Y <br> （适用于最新价格） <br>（选择3个身份验证选项中的一个选项-选项1）
|`/AzureAuthenticationCertificateStoreLocation` | 设置为证书存储位置（例如 "CurrentUser"）。 | Y <br>（适用于最新价格） <br> （选择3个身份验证选项之一-选项2）
|`/AzureAuthenticationCertificateThumbprint` | 设置为证书指纹。 | Y <br> （适用于最新价格） <br>（选择3个身份验证选项之一-选项2）
|`/AzureAuthenticationToken` | 设置为证书标记。 | Y <br> （适用于最新价格） <br>（选择3个身份验证选项之一-选项3）
