...
# <a name="technical-reference-ssrs"></a>技术参考 (SSRS)
  ...
  使用或管理 SQL Server Reporting Services 中查找的工具和 PowerShell 参考文档。  
 ...
 [报表向导帮助](http://msdn.microsoft.com/library/68287bcf-f91a-429f-bb7c-48c029b041fa)  
 ...
 ![较小的文件的文件夹图标](../analysis-services/media/filefolder-small.png "Small File Folder Icon")**报告服务器命令提示实用工具**  
 ...
 ![较小的文件的文件夹图标](../analysis-services/media/filefolder-small.png "Small File Folder Icon") **Reporting Services WMI 提供程序类库**  
