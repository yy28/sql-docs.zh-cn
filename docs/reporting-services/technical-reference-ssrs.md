---
title: 技术参考 | Microsoft Docs
description: 了解有关使用 SQL Server Reporting Services 或管理 SQL Server Reporting Services 的工具和 PowerShell 参考文档。
ms.date: 05/30/2017
...
# <a name="technical-reference-ssrs"></a>技术参考 (SSRS)
 ...
 [报表向导帮助](https://msdn.microsoft.com/library/68287bcf-f91a-429f-bb7c-48c029b041fa)  
 ...
 ![小文件文件夹图标](https://docs.microsoft.com/analysis-services/analysis-services/media/filefolder-small.png "小文件文件夹图标") **报表服务器命令提示实用工具**  
 ...
 ![小文件文件夹图标](https://docs.microsoft.com/analysis-services/analysis-services/media/filefolder-small.png "小文件文件夹图标") **Reporting Services WMI 提供程序类库**  
