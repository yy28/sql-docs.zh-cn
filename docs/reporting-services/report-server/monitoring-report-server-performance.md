...
helpviewer_keywords: 
  ...
  - "报表服务器 [Reporting Services], 性能"
  - "计数器 [Reporting Services]"
  - "监视性能 [Reporting Services]"
  - "SQL Server Reporting Services, 性能"
...
## 其他性能计数器  
 仅对 **MSRS 2008 Web Service**、**MSRS 2008 Windows Service** 和 **ReportServer:Service** 提供自定义 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 性能计数器。 下列性能对象为报表服务器提供附加的性能监视数据。  
