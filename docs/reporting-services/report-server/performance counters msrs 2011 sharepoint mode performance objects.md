---
title: "MSRS 2011 Web Service SharePoint Mode 性能对象和 MSRS 2011 Windows Service SharePoint Mode 性能对象的性能计数器（SharePoint 模式） | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "报表服务器 Windows 服务, 性能计数器"
  - "RS Windows 服务性能对象"
  - "计划和传递处理器性能对象 [Reporting Services]"
...
# MSRS 2011 Web Service SharePoint Mode 性能对象和 MSRS 2011 Windows Service SharePoint Mode 性能对象的性能计数器（SharePoint 模式）
  本主题介绍作为 [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)] SharePoint 模式部署一部分的 **MSRS 2011 Web Service SharePoint Mode** 和 **MSRS 2011 Windows Service SharePoint Mode** 性能对象的性能计数器。  
