...
|[报表服务器服务跟踪日志](../../reporting-services/report-server/report-server-service-trace-log.md)|服务跟踪日志包含的信息极为详细，这对于调试应用程序或者调查问题或事件很有帮助。 跟踪日志文件是 ReportServerService_\<timestamp>.log 且位于以下文件夹：<br /><br /> 在 SQL Server Reporting Services 2016 或更低版本中：`C:\Program Files\Microsoft SQL Server\MSRS13.MSSQLSERVER\Reporting Services\LogFiles`<br /><br /> 在 SQL Server Reporting Services 2017 中：`C:\Program Files\Microsoft SQL Server Reporting Services\SSRS\LogFiles`|  
