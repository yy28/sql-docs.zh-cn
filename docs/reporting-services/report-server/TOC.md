...
# [配置报表管理器（本机模式）](configure-report-manager-native-mode.md)
...
# [如何缓存一个共享数据集](cache-a-shared-dataset.md)
...
# [MSRS 2011 Web Service SharePoint Mode 性能对象和 MSRS 2011 Windows Service SharePoint Mode 性能对象的性能计数器（SharePoint 模式）](performance counters msrs 2011 sharepoint mode performance objects.md)
