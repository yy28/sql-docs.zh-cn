---
title: "停止使用的 SQL Server 2016 中的 SQL Server Reporting Services 的功能 |Microsoft 文档"
ms.date: 05/30/2017
...
# <a name="discontinued-functionality-to-sql-server-reporting-services-in-sql-server"></a>到 SQL Server 中的 SQL Server Reporting Services 停止使用的功能 

  本主题介绍[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]将不再可用 SQL Server 2016 中的功能。 此处不包括关于停止支持某些版本的操作系统或 [!INCLUDE[msCoName](../includes/msconame-md.md)] Internet Information Services (IIS) 的声明。 有关系统必备项的详细信息，请参阅 [安装 SQL Server 2016 的硬件和软件要求](../sql-server/install/hardware-and-software-requirements-for-installing-sql-server.md)。  
  
*废弃的功能* 是不再受支持的功能。 可能还会以物理方式将其从产品中删除。 以下功能已不再使用。  
  
|功能|替代功能或解决方法|
|-|-|
|通过以下方法上传报表模型 [!INCLUDE[ssRSWebPortal](../includes/ssrswebportal.md)]|这仍可以通过 SOAP API 完成。|  
|通过以下方法管理报表模型 [!INCLUDE[ssRSWebPortal](../includes/ssrswebportal.md)]|这仍可以通过 SOAP API 完成。|  
