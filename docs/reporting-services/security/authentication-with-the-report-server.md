...
|启用 [!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)] 来处理自定义的身份验证方案。|[配置 Web 门户以传递自定义身份验证 Cookie](http://msdn.microsoft.com/zh-cn/91aeb053-149e-4562-ae4c-a688d0e1b2ba)|  
