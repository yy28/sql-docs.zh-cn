...
|预定义角色|范围|描述|  
|---------------------|-----------|-----------------|  
|[“内容管理员”角色](#bkmk_content)|项|可以管理报表服务器中的内容。 其中包括文件夹、报表和资源。|  
|[“发布者”角色](#bkmk_publisher)|项|可以将报表和链接的报表发布到报表服务器。|  
|[“浏览者”角色](#bkmk_browser)|项|可以查看文件夹、报表，并订阅报表。|  
|[“报表生成者”角色](#bkmk_reportbuilder)|项|可以查看报表定义。|  
|[“我的报表”角色](#bkmk_myreports)|项|可以发布报表和链接的报表；管理用户的“我的报表”文件夹中的文件夹、报表和资源。|  
