...
ms.topic: "article"
helpviewer_keywords: 
  - "安全性 [Reporting Services], 默认值"
  - "默认安全性"
  - "基于角色的安全性 [Reporting Services], 默认值"
...
3.  准备好向用户帐户和组帐户分配特定角色后，请使用报表管理器。 有关详细信息，请参阅[授予用户对报表服务器的访问权限（报表管理器）](../../reporting-services/security/grant-user-access-to-a-report-server-report-manager.md)。  
