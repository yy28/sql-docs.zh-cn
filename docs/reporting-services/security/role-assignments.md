...
ms.topic: "article"
helpviewer_keywords: 
  - "用户 [Reporting Services]"
  - "角色 [Reporting Services]"
  - "基于角色的安全性 [Reporting Services], 角色分配"
  - "组 [Reporting Services]"
...
## 预定义角色分配  
 ...
 有关提供默认安全性的预定义角色分配的详细信息，请参阅[预定义角色](../../reporting-services/security/predefined-roles.md)。  
