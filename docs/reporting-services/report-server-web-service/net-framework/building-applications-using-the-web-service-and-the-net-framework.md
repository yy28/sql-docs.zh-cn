...
|[使用安全 Web 服务方法](../../../reporting-services/report-server-web-service/net-framework/using-secure-web-service-methods.md)|描述**SecureConnectionLevel**设置以及在其中会影响的 Reporting Services SOAP API 使用的方式。|  
