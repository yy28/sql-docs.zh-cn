...
description: 报表生成器是独立的报表创作环境。 首次启动它时，Microsoft 下载中心会提示你下载它。
ms.date: 01/03/2020
...
## <a name="to-start-ssrbnoversion-in-sharepoint-integrated-mode"></a>在 SharePoint 集成模式下启动 [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion.md)]  
