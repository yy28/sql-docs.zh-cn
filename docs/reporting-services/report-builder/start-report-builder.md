...
helpviewer_keywords: 
  - "报表生成器，启动"
  - "启动报表生成器"
  - "SharePoint 集成 [Reporting Services]，启动报表生成器"
  - "启动报表生成器"
...
---
# 启动报表生成器
  Microsoft [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] 是独立的报表创作环境。 使用它，可以创建分页报表并将其发布到在本机或 SharePoint 集成模式下安装的 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 。  
  
 从 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] Web 门户或 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 中以 SharePoint 集成模式首次启动 [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] 时，系统会提示你从 Microsoft 下载中心下载。 
...
![report-builder-get-report-builder](../../reporting-services/report-builder/media/report-builder-get-report-builder.png) 
 ...
 [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] 时未安装 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]；你必须单独下载并安装它。  
...
## 从 [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] Web 门户启动 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]  
  
1.  在 Web 浏览器的地址栏中，键入报表服务器的 URL。 默认情况下，该 URL 为 http://\<*servername*>/reports。  
...
## 在 SharePoint 集成模式下启动 [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)]  
