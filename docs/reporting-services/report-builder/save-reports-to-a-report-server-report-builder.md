...
1.  从“报表生成器”按钮，单击 **“保存”** 。 随即将打开“另存为”\<Report Item> 对话框。  
...
1.  从“报表生成器”按钮，单击 **“另存为”** 。 随即将打开“另存为”\<Report Item> 对话框。  
...
## <a name="see-also"></a>另请参阅  
 ...
 [将报表导出为其他文件类型（报表生成器和 SSRS）](/previous-versions/sql/)  
