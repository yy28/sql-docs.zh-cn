---
title: 矩形和线条（报表生成器）| Microsoft Docs
description: 了解如何在报表生成器的分页报表中创建视觉效果。 添加颜色、图像、工具提示或书签等功能。
ms.date: 03/01/2017
...
##  <a name="using-a-rectangle-as-a-container"></a><a name="RectangleAsContainer"></a> 将矩形用作容器  
