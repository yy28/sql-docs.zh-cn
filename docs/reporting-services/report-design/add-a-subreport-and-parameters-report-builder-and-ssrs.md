---
title: 添加子报表和参数（报表生成器）| Microsoft Docs
description: 了解如何添加子报表。 当想要创建作为多个相关报表地容器的主报表时，在报表生成器中使用子报表。
ms.date: 03/01/2017
...
5.  在 **“值”** 列表框中，键入或选择要传递给子报表的值。 此值可以是静态文本、引用字段的表达式或主报表中的其他对象。  
    ...
    > [!NOTE]  
    >   在报表生成器中，如果 **“参数”** 列表中缺少某参数并且子报表定义了默认值，将会正确处理子报表。  
    >   
