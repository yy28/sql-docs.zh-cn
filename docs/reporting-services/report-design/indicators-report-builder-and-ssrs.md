...
|指示器集|指示器类型|  
|-------------------|--------------------|  
|![Rs_DirectionalIcons](../../reporting-services/report-design/media/rs-directionalicons.png "Rs_DirectionalIcons")|方向：通过使用上升、下降、平（无变化）、趋于上升或趋于下降箭头指示趋势。|  
|![Rs_SymbolIcons](../../reporting-services/report-design/media/rs-symbolicons.png "Rs_SymbolIcons")|符号：通过使用公认的符号（例如复选标记和感叹号）指示状态。|  
|![Rs_ShapeIcons](../../reporting-services/report-design/media/rs-shapeicons.png "Rs_ShapeIcons")|形状：通过使用公认的形状（例如交通标志和菱形形状）指示情况。|  
|![rs_RatingIcons](../../reporting-services/report-design/media/rs-ratingicons.png "rs_RatingIcons")|等级：通过使用显示进展值的公认的形状和符号（例如正方形中的象限数）指示等级。|  
