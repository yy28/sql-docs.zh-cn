---
title: 创建带列表的发票和表单（报表生成器）| Microsoft Docs
description: 了解如何定义和使用列表来创建自由格式的报表或表单，以及如何在报表生成器中将列表与其他数据区域结合使用。
ms.date: 03/07/2017
...
##  <a name="displaying-data-with-one-level-of-grouping"></a><a name="DisplayingGrouping"></a> 显示经过一级分组的数据  
