...
-   返回一组结果表达式值。  
 ...
 若要从具有指定名称的名称/值对（具有 1 对 1 的关系）的数据集中检索单个值，请使用 [Lookup 函数（报表生成器和 SSRS）](../../reporting-services/report-design/lookup-function-report-builder-and-ssrs.md)。 若要为一组值调用 **Lookup**，请使用 [Multilookup 函数（报表生成器和 SSRS）](../../reporting-services/report-design/multilookup-function-report-builder-and-ssrs.md)。  
