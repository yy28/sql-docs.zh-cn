...
---
# 饼图（报表生成器和 SSRS）
  饼图和圆环图将数据显示为整体的一定比例。 饼图常用于在各组之间进行比较。 饼图和圆环图与棱锥图和漏斗图一起构成了一组称为形状图的图表。 形状图没有轴。 在形状图上放置某数值字段后，该图表将计算每个值相对总计的百分比。 有关形状图的详细信息，请参阅[报表生成器和 SSRS](../../reporting-services/report-design/shape-charts-report-builder-and-ssrs.md)  
...
## 对饼图应用绘制样式  
 ...
 ![饼图绘制样式](../../reporting-services/report-design/media/rs-piedrawingeffects-concave2.png "饼图绘制样式")  
  
 有关详细信息，请参阅[向图表添加凹凸效果、阳文和纹理样式（报表生成器和 SSRS）](../../reporting-services/report-design/add-bevel-emboss-and-texture-styles-to-a-chart-report-builder-and-ssrs.md)。  
...
## 在饼图上显示百分比值  
 ...
 ![将数据点标签显示为百分比的饼图](../../reporting-services/report-design/media/rs-piechartpercentages.png "将数据点标签显示为百分比的饼图")  
