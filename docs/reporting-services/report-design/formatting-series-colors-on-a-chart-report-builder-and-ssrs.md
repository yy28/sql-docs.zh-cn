...
# <a name="formatting-series-colors-on-a-chart-report-builder-and-ssrs"></a>设置图表上序列颜色的格式（报表生成器和 SSRS）
 ...
 可以选择新调色板，也可以从“属性”窗格定义自定义调色板。 有关详细信息，请参阅[上图表使用调色板 &#40; 定义颜色报表生成器和 SSRS &#41;](../../reporting-services/report-design/define-colors-on-a-chart-using-a-palette-report-builder-and-ssrs.md).  
...
## <a name="using-custom-palettes"></a>使用自定义调色板  
 如果要向图表应用您自己的颜色，请使用自定义调色板。 使用自定义调色板可以按颜色在图表上的所需显示顺序来添加您自己的颜色。 如果在设计时不知道图表中的序列数，使用自定义调色板尤其有用。 有关详细信息，请参阅[上图表使用调色板 &#40; 定义颜色报表生成器和 SSRS &#41;](../../reporting-services/report-design/define-colors-on-a-chart-using-a-palette-report-builder-and-ssrs.md).  
