...
# [DataSources 和 DataSets 集合引用](datasources-and-datasets-collection-references-report-builder-and-ssrs.md)
...
# [Avg 函数](avg-function-report-builder-and-ssrs.md)
...
# [ReportItems 集合引用](reportitems-collection-references-report-builder-and-ssrs.md)
...
# [Lookup 函数](lookup-function-report-builder-and-ssrs.md)
# [VarP 函数](varp-function-report-builder-and-ssrs.md)
...
# [聚合函数引用](aggregate-functions-reference-report-builder-and-ssrs.md)
...
# [First 函数](first-function-report-builder-and-ssrs.md)
...
# [StDevP 函数](stdevp-function-report-builder-and-ssrs.md)
# [常用筛选器](commonly-used-filters-report-builder-and-ssrs.md)
# [StDev 函数](stdev-function-report-builder-and-ssrs.md)
...
# [Union 函数](union-function-report-builder-and-ssrs.md)
...
# [Parameter 集合引用](parameters-collection-references-report-builder-and-ssrs.md)
...
# [设置图表上图例的格式（报表生成器和 SSRS）](formatting-the-legend-on-a-chart-report-builder-and-ssrs.md)
...
# [将三维效果添加到图表（报表生成器和 SSRS）](add-3d-effects-to-a-chart-report-builder-and-ssrs.md)
...
# [Min 函数](min-function-report-builder-and-ssrs.md)
# [总计、聚合和内置集合的表达式作用域](expression scope for totals, aggregates, and built-in collections.md)
# [InScope 函数](inscope-function-report-builder-and-ssrs.md)
...
# [更改图例项的文本（报表生成器和 SSRS）](change-the-text-of-a-legend-item-report-builder-and-ssrs.md)
# [表、矩阵和列表](tables-matrices-and-lists-report-builder-and-ssrs.md)
# [RowNumber 函数](rownumber-function-report-builder-and-ssrs.md)
...
# [隐藏图表上的图例项（报表生成器和 SSRS）](hide-legend-items-on-the-chart-report-builder-and-ssrs.md)
...
# [CountDistinct 函数](countdistinct-function-report-builder-and-ssrs.md)
...
# [Count 函数](count-function-report-builder-and-ssrs.md)
# [Var 函数](var-function-report-builder-and-ssrs.md)
# [规划报表](planning-a-report-report-builder.md)
# [表达式中的内置集合](built-in-collections-in-expressions-report-builder-and-ssrs.md)
# [表达式](expressions-report-builder-and-ssrs.md)
# [在报表中使用表达式](expression-uses-in-reports-report-builder-and-ssrs.md)
# [LookupSet 函数](lookupset-function-report-builder-and-ssrs.md)
# [在表或矩阵中的图表中对齐数据（报表生成器和 SSRS）](align-the-data-in-a-chart-in-a-table-or-matrix-report-builder-and-ssrs.md)
# [向图表添加凹凸效果、阳文和纹理样式（报表生成器和 SSRS）](add-bevel-emboss-and-texture-styles-to-a-chart-report-builder-and-ssrs.md)
...
# [RunningValue 函数](runningvalue-function-report-builder-and-ssrs.md)
...
# [Max 函数](max-function-report-builder-and-ssrs.md)
# [内置的全局和用户引用](built-in-globals-and-users-references-report-builder-and-ssrs.md)
...
# [CountRows 函数](countrows-function-report-builder-and-ssrs.md)
...
# [报表和组变量集合引用](report-and-group-variables-collections-references-report-builder-and-ssrs.md)
...
# [Level 函数](level-function-report-builder-and-ssrs.md)
# [Previous 函数](previous-function-report-builder-and-ssrs.md)
...
# [Sum 函数](sum-function-report-builder-and-ssrs.md)
...
# [Multilookup 函数](multilookup-function-report-builder-and-ssrs.md)
...
# [图表中的三维效果、凹凸效果和其他效果（报表生成器和 SSRS）](3d-bevel-and-other-effects-in-a-chart-report-builder-and-ssrs.md)
# [Aggregate 函数](aggregate-function-report-builder-and-ssrs.md)
...
# [Last 函数](last-function-report-builder-and-ssrs.md)
...
# [数据集字段集合引用](dataset-fields-collection-references-report-builder-and-ssrs.md)
