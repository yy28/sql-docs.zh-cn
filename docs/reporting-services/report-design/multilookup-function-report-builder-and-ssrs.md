...
-   对于数组中的每个对象，调用 [Lookup 函数（报表生成器和 SSRS）](../../reporting-services/report-design/lookup-function-report-builder-and-ssrs.md)并向返回数组添加结果。  
  
-   返回结果集。  
  
 若要从具有指定名称的名称-值对（具有 1 对 1 的关系）的数据集中检索单个值，请使用 [Lookup 函数（报表生成器和 SSRS）](../../reporting-services/report-design/lookup-function-report-builder-and-ssrs.md)。 若要从具有某名称的名称-值对（具有 1 对多的关系）的数据集中检索多个值，请使用 [LookupSet 函数（报表生成器和 SSRS）](../../reporting-services/report-design/lookupset-function-report-builder-and-ssrs.md)。  
