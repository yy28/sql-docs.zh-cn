...
> [!NOTE]  
>  您可以禁用信息栏，这样，当更改报表部件时系统将不会通知您。 您可以在向报表中添加报表部件时设置此选项。 即使已禁用信息栏，也仍可以检查更新。 有关详细信息，请参阅[检查更新或关闭更新（报表生成器和 SSRS）](http://msdn.microsoft.com/zh-cn/9c69792d-d7c4-453b-ae2f-6d2d071d8606)。  
