---
title: "隐藏页眉或页脚第一个或最后一页报表生成器 SSRS |Microsoft 文档"
ms.custom: 
ms.date: 03/01/2017
...
### <a name="to-hide-a-page-header-on-the-first-or-last-page"></a>隐藏第一页或最后一页的页眉  
...
4.  在 **“打印选项”** 部分，清除每个选项对应的复选框以隐藏报表第一页或最后一页上的显示。  
  
5.  [!INCLUDE[clickOK](../../includes/clickok-md.md)]  
  
### <a name="to-hide-a-page-footer-on-the-first-or-last-page"></a>隐藏第一页或最后一页的页脚  
...
## <a name="see-also"></a>另请参阅  
 ...
 [添加或删除页眉或页脚 &#40;报表生成器和 SSRS &#41;](../../reporting-services/report-design/add-or-remove-a-page-header-or-footer-report-builder-and-ssrs.md)  
