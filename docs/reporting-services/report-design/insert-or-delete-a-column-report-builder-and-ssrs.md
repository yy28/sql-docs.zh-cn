...
-   右键单击要插入列的位置对应的列控点，再单击“插入列”，然后单击“左侧”或“右侧”。  
...
-   在要插入列的 Tablix 数据区域的列组区中，右键单击插入位置的列组单元，再单击“插入列”，然后单击“左侧 - 组外部”、“左侧 - 组内部”、“右侧 - 组内部”或“右侧 - 组外部”。  
  
     此时将在您单击过的列组单元所表示的组的内部或外部添加一列。  
  
## 删除所选数据区域的组中的列  
  
-   右键单击要删除的列所在的 Tablix 数据区域的列组区中的列组单元，然后单击“删除列”。  
