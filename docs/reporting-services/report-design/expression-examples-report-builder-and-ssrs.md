...
-   若要基于单个参数提供日期范围，可使用 **Regex** [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] <xref:System.Text.RegularExpressions> 函数对更改现有字符串的格式很有用，例如设置电话号码格式。 下面的表达式使用 **Replace** 函数，将字段中的 10 位电话号码格式从“*nnn*-*nnn*-*nnnn*”更改为“(*nnn*) *nnn*-*nnnn*”：  
