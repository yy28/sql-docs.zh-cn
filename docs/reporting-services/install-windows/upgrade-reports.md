...
ms.topic: "article"
helpviewer_keywords: 
  - "报表 [Reporting Services], 升级"
  - "已发布报表 [Reporting Services], 升级"
  - "自定义报表项, 升级"
  - "Reporting Services, 升级"
  - "升级 Reporting Services"
  - "快照 [Reporting Services], 升级"
  - "报表定义文件 [Reporting Services]"
  - ".rdl 文件"
...
-   将 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 安装升级到 [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)] 安装时，已发布到报表服务器的现有报表和快照将在第一次进行处理时编译并自动升级为新的架构。 如果报表不能自动升级，则将使用向后兼容模式处理报表。 报表定义保留在原始架构中。  
 ...
 有关 [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)] 的新功能的详细信息，请参阅 [Reporting Services (SSRS) 中的新增功能](../Topic/What's%20New%20in%20Reporting%20Services%20\(SSRS\).md)。  
  
 本主题内容：  
  
-   [能够升级的版本](#bkmk_versionsupported)  
...
-   在 [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)] 的报表设计器中打开 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)]、[!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]、[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 或 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)][!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 报表。 将创建原始报表的一个备份副本。 发生以下两种情况之一：  
...
###  <a name="OpeningaReport"></a> 在报表设计器中使用 CRI 打开报表  
 在 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)]、 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]、 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]、 or [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)][!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 或 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]、 the report will be upgraded to the new report definition schema. 根据报表中包含的 CRI，将执行下列操作之一：  
...
-   **否** ：如果不希望转换报表中的 CRI，请选择 **“否”** 。 当前版本中的报表处理器无法显示这些 CRI。 如果你的系统管理员计划安装来自第三方软件供应商且与新报表定义格式兼容的新版本 CRI，则应当选择“否”。 在使用新版本以前，CRI 将作为带有红色 X 的空文本框显示在报表中。  
...
## 另请参阅  
 ...
 [SQL Server 2016 的 SQL Server Reporting Services 中的重大更改](../../reporting-services/breaking-changes-in-sql-server-reporting-services-in-sql-server-2016.md)   
 [SQL Server 2016 中 SQL Server Reporting Services 的行为更改](../../reporting-services/behavior-changes-to-sql-server-reporting-services-in-sql-server-2016.md)   
 [SQL Server 2016 的 SQL Server Reporting Services 中停止使用的功能](../Topic/Discontinued%20Functionality%20to%20SQL%20Server%20Reporting%20Services%20in%20SQL%20Server%202016.md)   
