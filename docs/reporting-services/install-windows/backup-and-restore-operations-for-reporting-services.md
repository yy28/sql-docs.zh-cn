...
ms.topic: "article"
helpviewer_keywords: 
  - "数据库 [Reporting Services], 备份"
  - "数据库 [Reporting Services], 还原"
  - "数据库 [Reporting Services], 移动"
  - "备份数据库 [Reporting Services]"
  - "移动数据库"
  - "还原数据库 [Reporting Services]"
  - "文件 [Reporting Services], 还原"
  - "文件 [Reporting Services], 备份"
...
## 备份加密密钥  
 首次配置 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 安装时，应备份加密密钥。 此外，任何时候更改服务帐户标识或重命名计算机时，都应备份密钥。 有关详细信息，请参阅 [Back Up and Restore Reporting Services Encryption Keys](../../reporting-services/install-windows/back-up-and-restore-reporting-services-encryption-keys.md)。 有关 SharePoint 模式报表服务器的信息，请参阅[管理 Reporting Services SharePoint 服务应用程序](../../reporting-services/report-server-sharepoint/manage-a-reporting-services-sharepoint-service-application.md) 中的“密钥管理”部分。  
