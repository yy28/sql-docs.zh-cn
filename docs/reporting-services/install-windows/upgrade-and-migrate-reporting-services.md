...
helpviewer_keywords: 
  ...
  - "SQL Server Reporting Services, 升级"
...
##  <a name="bkmk_side_by_side"></a> 并行安装  
 [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)] 本机模式可与 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 或 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 本机模式部署并行安装。  
...
-   检查相关要求，以确定硬件和软件是否可以支持 [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)]。 有关详细信息，请参阅[安装 SQL Server 2016 的硬件和软件要求](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md)。  
...
-   备份对称密钥。 有关详细信息，请参阅 [Back Up and Restore Reporting Services Encryption Keys](../../reporting-services/install-windows/back-up-and-restore-reporting-services-encryption-keys.md)。  
...
4.  安装程序为 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 程序文件创建新的文件夹。 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 安装的程序文件夹包括 MSRS13.<instance name>。  
...
### [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 实例部署到 Windows Azure 虚拟机 (VM) 中的 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
 ...
 **结束环境：**[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]、SharePoint 2013 或 SharePoint 2016。   
...
### [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 实例部署到 Windows Azure 虚拟机 (VM) 中的 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
### [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] 实例部署到 Windows Azure 虚拟机 (VM) 中的 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
-   运行 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 安装以升级每个“报表服务器”的 SharePoint 模式。 SQL Server 安装向导会安装 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 服务并创建新的服务应用程序。 
...
-   本机模式：请参阅[备份和还原 Reporting Services 加密密钥](../../reporting-services/install-windows/back-up-and-restore-reporting-services-encryption-keys.md)  
