...
- 订阅!WindowsService_1!1458!09/24/2015-00:09:27:: e 错误:PowerBI 交付错误: 仪表板:IT 支出分析示例，视觉对象:Chart2，错误:无法完成当前操作。 用户数据源凭据不符合运行此报表或共享数据集的要求。 用户数据源凭据未存储在报表服务器数据库中，或用户数据源配置为不需要凭据但未指定无人参与的执行帐户。

- 注意!WindowsService_1!1458!09/24/2015-00:09:27:: e 错误:处理订阅 fcdb8581-d763-4b3b-ba3e-8572360df4f9 时出错:PowerBI 交付错误: 仪表板:IT 支出分析示例，视觉对象:Chart2，错误:无法完成当前操作。 用户数据源凭据不符合运行此报表或共享数据集的要求。 用户数据源凭据未存储在报表服务器数据库中，或用户数据源配置为不需要凭据但未指定无人参与的执行帐户。
