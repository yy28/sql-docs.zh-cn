...
- 使用 SharePoint 管理中心创建 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 服务应用程序。 有关详细信息，请参阅[步骤 3：创建 Reporting Services 服务应用程序](../../reporting-services/install-windows/install-the-first-report-server-in-sharepoint-mode.md#bkmk_create_serrviceapplication)中的“服务应用程序”一节。  
...
[Reporting Services 配置管理器](https://msdn.microsoft.com/63519ef4-e68a-42fb-9cf7-31228ea4e434)  
