...
helpviewer_keywords: 
  ...
  - "安全性 [Reporting Services], 无人参与的报表处理"
  - "无人参与的报表处理 [Reporting Services]"
  - "凭据 [Reporting Services]"
  - "外部数据源 [Reporting Services]"
  - "帐户 [Reporting Services]"
  - "报表 [Reporting Services], 处理"
...
## 另请参阅  
 [Reporting Services 配置管理器（SSRS 本机模式）](http://msdn.microsoft.com/zh-cn/379eab68-7f13-4997-8d64-38810240756e)  
