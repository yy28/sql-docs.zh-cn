---
title: "在哪里可以找到 Reporting Services 外接程序用于 SharePoint 产品 |Microsoft 文档"
ms.custom:
- SQL2016_New_Updated
ms.date: 05/30/2016
...
在 SQL Server 2016 版本中外, 接程序可以作为一部分进行安装的 SQL Server 安装向导，在功能选择页。 如果你希望单独下载和安装此外接程序，则可以通过 [!INCLUDE[msCoName](../../includes/msconame-md.md)] 下载中心的 [用于 Microsoft® SharePoint® 技术 2010 的 Microsoft® SQL Server® 2012 Reporting Services 外接程序](http://go.microsoft.com/fwlink/?LinkID=207242) 页获得此文件的最新版本。
