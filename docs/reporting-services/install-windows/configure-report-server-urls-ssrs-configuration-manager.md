---
title: "配置报表服务器 Url （SSRS 配置管理器） |Microsoft 文档"
ms.custom: 
ms.date: 05/18/2016
...
> [!NOTE]  
>  基本 URL 保留项可启用将在 URL 中使用的任何有效主机名。 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 配置工具可使用允许将主机名变体解析为特殊报表服务器实例的语法在 HTTP.SYS 中创建一个 URL 保留项。 有关 URL 保留的详细信息，请参阅 [关于 URL 保留项和注册（SSRS 配置管理器）](../../reporting-services/install-windows/about-url-reservations-and-registration-ssrs-configuration-manager.md)。  
