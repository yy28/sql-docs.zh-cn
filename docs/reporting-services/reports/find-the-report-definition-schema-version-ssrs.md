...
ms.topic: "article"
helpviewer_keywords: 
  - "XML 架构 [Reporting Services]"
  - "报表定义语言, XML 架构"
  - "架构 [Reporting Services]"
...
1.  打开一个新项目。 您选择的项目版本决定 RDL 架构的版本。 在 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]中，支持多个架构版本。 有关详细信息，请参阅 [SQL Server Data Tools 中的部署和版本支持 (SSRS)](../../reporting-services/tools/deployment-and-version-support-in-sql-server-data-tools-ssrs.md)。  
