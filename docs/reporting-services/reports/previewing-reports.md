...
ms.topic: "article"
helpviewer_keywords: 
  - "报表设计器 [Reporting Services], 预览报表"
  - "预览报表 [Reporting Services]"
  - "打印预览"
  - "测试服务器 [Reporting Services]"
...
-   在 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 标准工具栏 ![ssrs_ssdt_startdebug](../../reporting-services/reports/media/ssrs-ssdt-startdebug.png "ssrs_ssdt_startdebug") 上，单击“启动”按钮。  
