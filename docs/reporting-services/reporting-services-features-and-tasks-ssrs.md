---
title: "Reporting Services 功能和任务 (SSRS) |Microsoft 文档"
ms.custom: 
ms.date: 12/18/2015
...
# <a name="reporting-services-features-and-tasks-ssrs"></a>Reporting Services 功能和任务 (SSRS)
  [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]基础内容按报表和报表功能，报表服务器功能，组织和[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]产品功能。  
