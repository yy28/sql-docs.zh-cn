...
除了[从 Excel 文件中加载数据](../../reporting-services/mobile-reports/prepare-excel-data-for-reporting-services-mobile-reports.md)外，[!INCLUDE[PRODUCT_NAME](../../includes/product-name.md)] 还可以访问几乎任何来源的数据。 访问数据需要在 [!INCLUDE[PRODUCT_NAME](../../includes/ssrsnoversion.md)] [!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)]上配置的共享数据源。 了解有关 [创建共享数据源](../../reporting-services/report-data/create-modify-and-delete-shared-data-sources-ssrs.md) 和 [创建共享数据集](../../reporting-services/report-data/manage-shared-datasets.md)的详细信息。  
  
在 [!INCLUDE[PRODUCT_NAME](../../includes/ssrsnoversion.md)] 服务器上配置共享数据源和共享数据集后，可以在 [!INCLUDE[PRODUCT_NAME](../../includes/ss-mobilereptpub-short.md)]中创建的移动报表中使用它们。   
  
从 [!INCLUDE[PRODUCT_NAME](../../includes/ss-mobilereptpub-short.md)] 连接到 [!INCLUDE[PRODUCT_NAME](../../includes/ssrsnoversion.md)] 服务器后，将移动报表连接到共享数据集非常简单。   
...
-  [Reporting Services, Web 门户](../../reporting-services/web-portal-ssrs-native-mode.md)  
