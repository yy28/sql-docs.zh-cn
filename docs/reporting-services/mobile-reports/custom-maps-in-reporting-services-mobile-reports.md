...
> **注意**：这两个地图文件 SHP 和 DBF 的大小加起来不能超过 512 KB。 如果地图文件太大，可以使用工具，例如 [https://mapshaper.org/](https://mapshaper.org/)，来减小其大小。  
...
- Manco 形状文件编辑器：[https://www.mancosoftware.com/ShapeFileEditor](https://www.mancosoftware.com/ShapeFileEditor)  
