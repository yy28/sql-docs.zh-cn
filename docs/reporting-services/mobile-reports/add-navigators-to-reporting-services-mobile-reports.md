...
1. 从**布局**选项卡上，拖动**选择列表**到设计图面并调整其大小所需的方式。

2. 选择**数据**选项卡上，然后在**数据属性**窗格中，在**密钥**，选择表和列将筛选器。 

3. 下**标签**，选择将显示的标签的列。 键列和标签列可以相同。  
  
   对于层次结构树数据，请选择父键列。  
  
4. 在设置数据属性后**表筛选的选择列表**，选择要筛选的表和要作为筛选依据的列。 此列需要匹配选择列表的键列中的值。 

对于希望选择列表筛选的移动报表中的每个可视化效果：

1. 选择可视化效果中，选择**数据**选项卡上，然后在**数据属性**窗格中，选择**选项**字段名称旁边。
...
1. 从**布局**选项卡上，拖动**记分卡网格**到设计图面并调整其大小所需的方式。

2. 选择**数据**选项卡上，然后在**数据属性**窗格中，在**密钥**，选择表和列将筛选器。 

3. 下**标签**，选择将显示的标签的列。 键列和标签列可以相同。  
  
4. 若要添加分数指示器，在**数据列**窗格中，选择**添加分数**。   
  
5. 命名该分数指示器，并选择**选项**设置将为指示器数据网格中设置的相同属性：  
...
6. 在中添加值指示器，**数据列**窗格中，选择**添加值**。

7. 根据需要命名值指示器，从表中选择其源列，并选择如何对其进行格式处理。  

   ![mobile-report-scorecard-grid-data-properties](../../reporting-services/mobile-reports/media/mobile-report-scorecard-grid-data-properties.png)

8. 在设置数据属性后**表筛选的选择列表**，选择要筛选的表和要作为筛选依据的列。 此列需要匹配选择列表的键列中的值。 
...
2. 下**按筛选**，选择导航器。 每个可视化效果可以按多个导航器进行筛选。
