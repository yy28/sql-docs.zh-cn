---
title: 服务器和数据库连接问题疑难解答 | Microsoft Docs
description: 使用本主题可以排除在连接到报表服务器时所遇到的故障。 本主题还提供了与“意外错误”消息有关的信息。
ms.date: 12/16/2019
...
完整错误文本如下：“报表服务器无法打开与报表服务器数据库的连接。 登录失败 (**rsReportServerDatabaseLogonFailed**)。 登录失败: 用户名未知或密码错误。”  
