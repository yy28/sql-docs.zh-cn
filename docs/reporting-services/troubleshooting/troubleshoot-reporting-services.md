---
title: "排除 Reporting Services 故障 | Microsoft Docs"
ms.custom: ""
ms.date: "05/25/2016"
...
---
# 排除 Reporting Services 故障
  此部分的主题帮助确定并解决 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 的问题。  
  
 ![![小文件夹图标](../../analysis-services/media/filefolder-small.png "小文件夹图标")](/Image/filefolder_small.png)   **解决 Reporting Services 的问题**  
...
![![](../ Image/filefolder_small.gif)](/Image/filefolder_small.png)   **错误和事件参考**  
