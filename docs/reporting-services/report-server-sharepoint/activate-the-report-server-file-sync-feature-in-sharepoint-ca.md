---
title: "激活 SharePoint 中的报表服务器文件同步功能 |Microsoft 文档"
ms.custom: 
ms.date: 09/25/2017
...
---
# <a name="activate-the-report-server-file-sync-feature-in-sharepoint"></a>激活 SharePoint 中的报表服务器文件同步功能
...
### <a name="to-activate-or-deactivate-the-reporting-services-file-sync-feature-on-a-site"></a>若要激活或停用站点上的 Reporting Services 文件同步功能
...
## <a name="see-also"></a>另请参阅
 ...
 [解决报表部件 （报表生成器和 SSRS）](http://msdn.microsoft.com/d9fe1932-46e7-421b-a8a9-4c54d9576e94)   
