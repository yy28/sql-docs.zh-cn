...
manager: "erikre"
---
# 配置和管理报表服务器（Reporting Services SharePoint 模式）
...
-   SharePoint 文档库中的菜单选项  
    ...
    -   [缓存刷新选项（报表管理器）](../Topic/Cache%20Refresh%20Options%20\(Report%20Manager\).md)  
  
-   [Reporting Services 网站集功能](../../reporting-services/report-server-sharepoint/reporting-services-site-collection-features.md)  
...
-   [设置处理选项（SharePoint 集成模式下的 Reporting Services）](../../reporting-services/report-server-sharepoint/set-processing-options-reporting-services-in-sharepoint-integrated-mode.md)  
 ...
 有关 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 的一般信息，请参阅 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 联机丛书中的 [ Reporting Services (SSRS) ](../../reporting-services/reporting-services-ssrs.md)。 有关其他 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 组件、工具和资源的信息，请参阅 [SQL Server 联机丛书](../../sql-server/sql-server-技术文档.md)。  
