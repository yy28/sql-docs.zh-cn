...
ms.topic: "article"
helpviewer_keywords: 
  - "SharePoint 集成 [Reporting Services], 查看报表"
  - "Web 部件 [Reporting Services]"
  - "SharePoint 集成 [Reporting Services], Web 部件"
  - "报表查看器 Web 部件 [Reporting Services]"
...
# 在 SharePoint 站点上的报表查看器 Web 部件
 ...
 ![报表查看器 Web 部件](../../reporting-services/report-server-sharepoint/media/rs-sharepointrvwebpart.gif "报表查看器 Web 部件")  
...
### 设置报表查看器 Web 部件的属性  
 Web 部件的属性包括特定于报表查看器的自定义属性以及可以为任何 Web 部件设置的常规属性。 有关详细信息，请参阅[自定义报表查看器 Web 部件](../../reporting-services/report-server-sharepoint/customize-the-report-viewer-web-part.md)。  
