...
helpviewer_keywords: 
  - "安全 [Reporting Services], 扩展插件"
  - "报表服务器 [Reporting Services], 关于报表服务器"
  - "呈现扩展插件 [Reporting Services], 关于扩展插件"
  - "扩展插件 [Reporting Services], 关于扩展插件"
  - "存储数据 [Reporting Services]"
  - "报表服务器 [Reporting Services]"
  - "数据处理扩展插件 [Reporting Services], 关于扩展插件"
  - "传递扩展插件 [Reporting Services], 关于扩展插件"
  - "数据存储 [Reporting Services]"
  - "组件 [Reporting Services], 报表服务器"
  - "报表处理 [Reporting Services], 扩展插件"
  - "Web 服务 [Reporting Services], 报表服务器"
  - "存储 [Reporting Services]"
...
了解 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 安装的核心部分。 它包含一个处理引擎以及用于添加功能的扩展。
...
-   [安装 Reporting Services 本机模式报表服务器](assetid:///8f25e6dc-b753-400e-9e9a-50f4f35bf6c4)  
  
-   [使用 SharePoint 安装 SQL Server BI 功能（Power Pivot 和 Reporting Services）](assetid:///ac6cba68-2665-4a39-8fa3-cb7d7e6723c0)  
  
 **Windows Azure**：有关结合使用 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 和 Windows Azure 虚拟机的信息，请参阅以下内容：  
  
-   [Windows Azure 虚拟机中的 SQL Server 商业智能](http://msdn.microsoft.com/library/windowsazure/jj992719.aspx)。  
...
|任务|链接|  
|----------|----------|  
|查看硬件和软件要求。|[Hardware and Software Requirements for Reporting Services in SharePoint Mode](../Topic/Hardware%20and%20Software%20Requirements%20for%20Reporting%20Services%20in%20SharePoint%20Mode.md)列中的一个值匹配。|  
|在 SharePoint 模式下安装 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 。|[安装用于 SharePoint 2010 的 Reporting Services SharePoint 模式](http://msdn.microsoft.com/zh-cn/47efa72e-1735-4387-8485-f8994fb08c8c)|  
|如果您是 Web 开发人员或具备创建级联样式表的专业知识，则可以修改默认样式，以更改工具栏或报表管理器的颜色、字体和布局，但需自行承担相应的风险。 此版本中既没有记录默认样式表，也没有记录修改样式表的说明。|[自定义 HTML 查看器和报表管理器的样式表](../Topic/Customize%20Style%20Sheets%20for%20HTML%20Viewer%20and%20Report%20Manager.md)|  
...
## 另请参阅  
 ...
 [如何使用 PowerShell 管理 SSRS（专业回答）](http://go.microsoft.com/fwlink/?LinkId=321992)  
