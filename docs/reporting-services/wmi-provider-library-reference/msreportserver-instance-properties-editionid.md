---
description: EditionID 属性 (WMI MSReportServer_Instance)
...
ms.locfileid: "92258031"
---
# <a name="msreportserver_instance-properties---editionid"></a>MSReportServer_Instance 属性 - EditionID
  返回报表服务器的版本类别。 只读。  
