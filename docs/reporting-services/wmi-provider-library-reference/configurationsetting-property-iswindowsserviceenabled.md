---
title: "IsWindowsServiceEnabled 属性 (WMI MSReportServer_ConfigurationSetting) |Microsoft 文档"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-property---iswindowsserviceenabled"></a>ConfigurationSetting 属性-IsWindowsServiceEnabled
...
## <a name="property-values"></a>属性值  
 只读 **布尔** 值。 如果值为 **true** ，指示报表服务器 Windows 服务已启用。  
