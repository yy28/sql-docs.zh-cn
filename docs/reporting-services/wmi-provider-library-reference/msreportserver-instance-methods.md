---
description: MSReportServer_Instance 方法
...
|方法|说明|  
|-|-|  
|[GetReportServerUrls 方法 (WMI MSReportServer_Instance)](../../reporting-services/wmi-provider-library-reference/msreportserver-instance-methods-getreportserverurls.md)|列出用户可用于访问报表服务器和 [!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)]的 URL。|  
