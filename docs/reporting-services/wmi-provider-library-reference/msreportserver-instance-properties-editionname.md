---
title: "EditionName 属性 (WMI MSReportServer_Instance) |Microsoft 文档"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="msreportserverinstance-properties---editionname"></a>MSReportServer_Instance 属性-EditionName
  返回报表服务器版本类别的可读名称。 只读。  
