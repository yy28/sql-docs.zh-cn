---
title: "IsInitialized 属性 (WMI MSReportServer_ConfigurationSetting) |Microsoft 文档"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-property---isinitialized"></a>ConfigurationSetting 属性-IsInitialized
  指示报表服务器实例是否已初始化。 只读。  
