...
ms.topic: "article"
helpviewer_keywords: 
  - "订阅 [Reporting Services], 电子邮件"
  - "电子邮件 [Reporting Services]"
  - "邮件 [Reporting Services]"
...
## 电子邮件服务器配置  
 ...
 有关如何配置本机模式报表服务器的信息，请参阅[电子邮件设置 — Reporting Services 本机模式（配置管理器）](https://msdn.microsoft.com/library/ms189342.aspx)
