...
ms.topic: "article"
helpviewer_keywords: 
  - "SharePoint 集成 [Reporting Services], 报表传递"
  - "传递报表 [Reporting Services]"
  - "订阅 [Reporting Services], SharePoint 库传递"
...
---
# Reporting Services 中的 SharePoint 库传递
...
## 设置传递选项  
 ...
 路径  
 指定一个指向 SharePoint 库的完全限定 URL，包括 SharePoint Web 应用程序和站点。 例如：http://mySharePointWeb/MySite/MyDocLib；其中“http://mySharePointWeb”指示 Web 应用程序，“MySite”是 SharePoint 站点，而“MyDocLib”是将传入报表的 SharePoint 库。  
