...
ms.topic: "article"
helpviewer_keywords: 
  - "报表处理 [Reporting Services], 状态信息"
  - "作业 [Reporting Services]"
  - "查看作业"
  - "取消作业"
  - "用户作业 [Reporting Services]"
  - "系统作业 [Reporting Services]"
  - "报表处理 [Reporting Services], 管理正在运行的进程"
  - "进程 [Reporting Services]"
  - "扫描进程 [Reporting Services]"
  - "状态信息 [Reporting Services]"
  - "报表处理 [Reporting Services]"
  - "取消订阅"
  - "报表服务器 [Reporting Services], 作业"
  - "数据驱动订阅"
  - "显示作业"
  - "订阅 [Reporting Services], 正在运行的进程"
