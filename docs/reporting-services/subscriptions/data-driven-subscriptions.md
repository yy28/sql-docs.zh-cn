...
description: 了解数据驱动订阅，其提供了一种使用动态订阅数据的方式，这些数据是在运行时从外部数据源中检索的。
ms.date: 05/20/2019
...
## <a name="see-also"></a>另请参阅
 ...
 [预加载缓存（Web 门户）](../../reporting-services/report-server/preload-the-cache-report-manager.md)  
