---
title: "设置 URL 中的报表语言参数 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  - "覆盖报表语言设置"
  - "报表服务器 [Reporting Services], 语言设置"
  - "语言 [Reporting Services]"
  - "URL 访问 [Reporting Services], 语言覆盖"
  - "国际化注意事项 [Reporting Services]"
  - "全球化注意事项 [Reporting Services]"
