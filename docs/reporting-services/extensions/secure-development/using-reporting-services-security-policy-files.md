---
title: "使用 Reporting Services Security Policy Files |Microsoft 文档"
ms.custom: 
ms.date: 03/06/2017
...
> [!NOTE]  
>  有两个报表设计器预览模式: 预览选项卡和弹出预览窗口启动报表项目时启动**DebugLocal**模式。 **预览**选项卡上不是安全对象的组件，而不适用于安全策略设置。 预览窗口旨在模拟报表服务器的功能，因此具有策略配置文件，您或管理员必须修改该文件才能在报表设计器中使用自定义程序集和自定义扩展插件。  
