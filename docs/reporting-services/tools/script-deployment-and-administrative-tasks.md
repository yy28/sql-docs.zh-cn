...
-   SQL Server 2012 版本引入了用于 SharePoint 集成模式的 PowerShell cmdlet。 您可以使用 PowerShell 配置和管理 SharePoint 集成。  有关详细信息，请参阅 [用于 Reporting Services SharePoint 模式的 PowerShell cmdlet](../../reporting-services/report-server-sharepoint/powershell-cmdlets-for-reporting-services-sharepoint-mode.md)。  
