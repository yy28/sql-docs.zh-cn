---
title: "用于 SharePoint 模式下在报表服务器上已发布的报表项的 URL 示例 (SSRS)  | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|[!INCLUDE[offSPServ](../../includes/offspserv-md.md)] 或 [!INCLUDE[SPS2010](../../includes/sps2010-md.md)] 实例的 **Documents/Doc** 文件夹中的 Company Sales 示例报表。|http://TestServer/TestSite/Documents/Doc/Company%20Sales.rdl|  
