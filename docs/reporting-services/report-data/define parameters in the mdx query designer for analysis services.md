---
title: "在 Analysis Services 的 MDX 查询设计器中定义参数（报表生成器和 SSRS） | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "参数 [Reporting Services]，MDX"
  - "多维表达式 [Reporting Services]"
  - "数据挖掘预测 [Reporting Services]"
  - "MDX [Reporting Services]，定义参数"
...
3.  在 MDX 查询设计器工具栏中，单击“**查询参数**”\(![“查询参数”对话框图标](../../reporting-services/report-data/media/iconqueryparameter.png "“查询参数”对话框图标")。 此时将打开“查询参数”对话框。  
