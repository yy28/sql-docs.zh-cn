...
f1_keywords: 
  ...
  - "10014"
helpviewer_keywords: 
  - "数据源 [Reporting Services], SAP NetWeaver Business Intelligence"
  - "SAP NetWeaver Business Intelligence [Reporting Services], 查询设计器"
...
|![“查询参数”对话框图标](../../reporting-services/report-data/media/iconqueryparameter.png "“查询参数”对话框图标")|显示 **“变量”** 对话框。 仅当选定的多维数据集为“查询”多维数据集时此按钮才可用（因为只有“查询”多维数据集支持变量）。 当向变量分配默认值时，将创建一个相应的报表参数。|  
...
## 查询模式下的图形查询设计器  
 ...
 ![查询视图中的 SAP BW MDX 查询设计器](../../reporting-services/report-data/media/rsqd-dssapbw-mdx-querymode.gif "查询视图中的 SAP BW MDX 查询设计器")  
...
-   **删除** (![删除](../../reporting-services/report-data/media/rsqdicon-delete.png "删除"))  
