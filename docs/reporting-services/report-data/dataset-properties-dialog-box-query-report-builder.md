...
-   [“数据集属性”对话框 ->“参数”（报表生成器）](../Topic/Dataset%20Properties%20Dialog%20Box,%20Parameters%20\(Report%20Builder\).md)  
...
-   [“数据集属性”对话框 ->“筛选器”（报表生成器）](../Topic/Dataset%20Properties%20Dialog%20Box,%20Filters%20\(Report%20Builder\).md)  
 ...
 **刷新字段**  
 运行查询命令来更新“数据集属性”对话框 ->“字段”[](../Topic/Dataset%20Properties%20Dialog%20Box,%20Fields%20\(Report%20Builder\).md)页中的字段列表。  
