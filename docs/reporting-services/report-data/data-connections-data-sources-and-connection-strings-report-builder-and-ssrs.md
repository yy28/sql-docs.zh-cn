---
title: "数据连接、数据源和连接字符串（报表生成器和 SSRS） | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "连接 [Reporting Services], 数据源"
  - "报表 [Reporting Services], 数据"
  - "表达式 [Reporting Services], 数据源"
  - "数据源 [Reporting Services], 连接"
  - "连接字符串 [Reporting Services]"
  - "共享数据源 [Reporting Services]"
  - "Reporting Services，数据源"
  - "登录名 [Reporting Services]"
...
---
# 数据连接、数据源和连接字符串（报表生成器和 SSRS）
  若要在 [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] 和  [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 已分页的报表中包含数据，必须首先创建“数据源”  和“数据集” 。 本主题解释数据源的类型、如何创建数据源以及与数据源凭据相关的重要信息。 数据源包含数据源类型、连接信息以及要使用的凭据的类型。 有两种类型的数据源：嵌入数据源和共享数据源。 嵌入数据源在报表中定义并只由该报表使用。 共享数据源独立于报表定义并可由多个报表使用。 有关详细信息，请参阅[嵌入和共享的数据连接或数据源（报表生成器和 SSRS）](../Topic/Embedded%20and%20Shared%20Data%20Connections%20or%20Data%20Sources%20\(Report%20Builder%20and%20SSRS\).md)和[嵌入数据集和共享数据集（报表生成器和 SSRS）](../../reporting-services/report-data/embedded-and-shared-datasets-report-builder-and-ssrs.md)。  
  
||  
|-|  
|**[!INCLUDE[applies](../../includes/applies-md.md)]** [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] &#124; [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 本机模式 &#124; [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]SharePoint 模式|  
...
|-----------------|------------------------------|----------------------------|  
|数据连接嵌入在报表定义中。|![可用](../../reporting-services/report-data/media/greencheck.png "可用")||  
|指向报表服务器上的数据连接的指针嵌入在报表定义中。||![可用](../../reporting-services/report-data/media/greencheck.png "可用")|  
|在报表服务器上管理|![可用](../../reporting-services/report-data/media/greencheck.png "可用")|![可用](../../reporting-services/report-data/media/greencheck.png "可用")|  
|对于共享数据集，要求这么做||![可用](../../reporting-services/report-data/media/greencheck.png "可用")|  
|对于组件，要求这么做||![可用](../../reporting-services/report-data/media/greencheck.png "可用")|  
...
## 数据位于 [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)]  
...
|[!INCLUDE[ssSDS](../../includes/sssds-md.md)] 云中的|`Data Source=<host>;Initial Catalog=AdventureWorks; Encrypt=True`|将数据源类型设置为 **Windows Azure SQL Database**。 有关详细信息，请参阅 [SQL Azure 连接类型 (SSRS)](../../reporting-services/report-data/sql-azure-connection-type-ssrs.md)。|  
