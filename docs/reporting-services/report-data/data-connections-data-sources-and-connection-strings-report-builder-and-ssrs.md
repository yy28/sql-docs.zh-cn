...
| Power BI Premium 数据集（从 Reporting Services 2019 开始） | Server = powerbi：//api.powerbi.com/v1.0/myorg/<workspacename>; 初始目录 = <YourDatasetName> | 将数据源类型设置为 **Microsoft SQL Server Analysis Services**。 |
