---
title: "注册标准 .NET Framework 数据访问接口 (SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/18/2017"
...
helpviewer_keywords: 
  ...
  - "用于 Reporting Services 的 .NET Framework 数据访问接口"
...
---
# 注册标准 .NET Framework 数据访问接口 (SSRS)
...
## 在报表服务器上注册 .NET Framework 数据访问接口  
...
## 在报表设计器客户端上注册 .NET Framework 数据访问接口  
