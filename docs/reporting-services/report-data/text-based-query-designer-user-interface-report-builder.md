...
|![运行查询](../../reporting-services/report-data/media/rsqdicon-run.png "运行查询")|运行查询并在“结果”窗格中显示结果集。|  
...
|窗格|函数|  
|----------|--------------|  
|Query|显示 [!INCLUDE[tsql](../../includes/tsql-md.md)] 查询文本。 使用此窗格可以编写或编辑 [!INCLUDE[tsql](../../includes/tsql-md.md)] 查询。|  
