...
||存储、提示、无（带有 Windows 凭据）<br /><br /> 不支持带有非 Windows 凭据的存储和提示凭据。|是|是|  
|远程 SharePoint 列表|Windows 身份验证（集成）或 SharePoint 用户标记|是|是<br /><br /> 远程 SharePoint 列表不支持基于窗体的身份验证和声明身份验证。|  
||存储、提示、无（带有 Windows 凭据）<br /><br /> 不支持带有非 Windows 凭据的存储和提示凭据。|是|是<br /><br /> 远程 SharePoint 列表不支持基于窗体的身份验证和声明身份验证。|  
