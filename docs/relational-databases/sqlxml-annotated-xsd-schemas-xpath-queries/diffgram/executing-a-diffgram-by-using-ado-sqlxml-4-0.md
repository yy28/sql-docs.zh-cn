...
1.  到您的计算机上的文件夹，任一 Diffgram 和对应的 XSD 架构将从复制中的示例之一[DiffGram 示例](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/diffgram/diffgram-examples-sqlxml-4-0.md)。  
