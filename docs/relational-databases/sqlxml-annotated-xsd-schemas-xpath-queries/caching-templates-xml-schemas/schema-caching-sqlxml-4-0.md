...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]与通过并行安装的 Microsoft SQL Server 2000 Web 版本 1、 Microsoft SQLXML 2.0 和 SQLXML 3.0 的 XML，你可以显式控制缓存在所有版本中使用以下注册表项的架构：  
