---
title: 对 XML 数据执行大容量加载（SQLXML）
description: 了解如何使用 SQLXML 4.0 中的 XML 大容量加载将半结构化 XML 数据加载到 Microsoft SQL Server 表中。
ms.date: 03/17/2017
ms.prod: sql
...
## <a name="in-this-section"></a>本节内容  
 [&#40;SQLXML 4.0&#41;的 XML 大容量加载简介](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/bulk-load-xml/introduction-to-xml-bulk-load-sqlxml-4-0.md)  
 提供有关使用 XML 大容量加载实用工具对 XML 数据进行大容量加载的常规信息。 主题包括 XML 数据流以及事务和非事务大容量加载操作。  
  
 [&#40;SQLXML 4.0&#41;的记录生成过程](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/bulk-load-xml/record-generation-process-sqlxml-4-0.md)  
 ...
 [XML 大容量加载 &#40;SQLXML 4.0&#41;的准则和限制](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/bulk-load-xml/guidelines-and-limitations-of-xml-bulk-load-sqlxml-4-0.md)  
