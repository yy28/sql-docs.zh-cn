...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]XML 大容量加载进程**sql:limit-字段**和**sql:limit-值**每个其定义的批注。 有关详细信息，请参阅[筛选值使用 sql:limit-字段和 sql:limit-值 &#40;SQLXML 4.0 &#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-using/filtering-values-using-sql-limit-field-and-sql-limit-value-sqlxml-4-0.md).  
