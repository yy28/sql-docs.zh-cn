---
title: "应用 XSL 转换 （SQLXML 托管类） |Microsoft 文档"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]在此示例中，将根据 AdventureWorks 数据库执行 SQL 查询。 对查询结果应用 XSL 转换以生成包含雇员的姓和名这两个列的表。  
  
 SqlXmlCommand 对象的 XslPath 属性用于指定该 XSL 文件和其目录路径。  
