...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
 ...
 在下面的示例中，XPath 查询使用通配符（\*）和命名空间 uri （） XPath 函数指定命名空间。 此 XPath 查询返回本地名称为**Employee**的所有元素，命名空间 URI 为**urn： myschema.xml： Contacts**：  
...
2.  将此C#示例中提供的代码（DocSample.cs）保存到存储架构的相同文件夹中。 （如果将文件存储在其他文件夹中，则必须编辑代码并为映射架构指定相应的目录路径。）  
