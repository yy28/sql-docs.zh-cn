...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]节点测试指定的位置步选择的节点类型。 每个轴 (**子**，**父**，**属性**，或**自助**) 具有主体数据库节点类型。 有关**属性**轴，主体数据库节点类型是**\<属性 >**。 有关**父**，**子**，和**自助**轴，主体数据库节点类型是**\<元素 >**。  
