...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]XML 语法表示缺少为 NULL。 （例如，如果属性或元素值是 NULL，则该属性或元素不出现在 XML 文档中。）在[!INCLUDE[msCoName](../../../includes/msconame-md.md)]SQLXML， **updg:nullvalue**特性允许元素或属性的值指定 NULL。  
