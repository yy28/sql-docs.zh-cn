---
title: 使用 Updategram 修改 SQLXML 4.0 中的数据
description: 查看有关 updategram 以及如何使用它们来修改 SQLXML 4.0 中的数据的信息和示例。
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
...
## <a name="in-this-section"></a>本节内容  
 [SQLXML 4.0 &#40;Updategram 简介&#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/updategrams/introduction-to-updategrams-sqlxml-4-0.md)  
 ...
 [SQLXML 4.0 &#40;的 NULL 处理&#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/updategrams/null-handling-sqlxml-4-0.md)  
 说明如何为元素和属性值指定 NULL。  
