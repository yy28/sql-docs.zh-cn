---
title: "SQLXML 4.0 数据访问组件 |Microsoft 文档"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)][!INCLUDE[msCoName](../../../includes/msconame-md.md)] SQLXML 4.0 包括三个数据提供程序可以插入到 XML 数据并从数据库中检索 XML 数据[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]:  
