---
title: "使用标记的事务一致地恢复相关的数据库的事务（完全恢复模式） | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "事务标记 [SQL Server]"
  - "标记的事务 [SQL Server]"
  - "数据库还原 [SQL Server], 插入事务标记"
  - "恢复 [SQL Server], 相关数据库"
  - "还原数据库 [SQL Server], 相关数据库恢复"
  - "数据库还原 [SQL Server], 相关数据库"
  - "标记的事务 [SQL Server], 创建"
  - "BEGIN TRAN...WITH MARK 语句"
  - "两阶段提交"
