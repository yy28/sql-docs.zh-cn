...
ms.topic: "article"
helpviewer_keywords: 
  - "还原数据库 [SQL Server], 设备还原"
  - "备份设备 [SQL Server], 还原自"
  - "数据库还原 [SQL Server], 设备还原"
  - "设备 [SQL Server]"
...
3.  在 [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md) 语句中，指定用于备份操作的逻辑备份设备或物理备份设备。 此示例从具有物理名称 `Z:\SQLServerBackups\AdventureWorks2012.bak`的磁盘文件还原。  
