...
---
# 使用 Microsoft Azure Blob 存储服务进行 SQL Server 备份和还原
...
## <a name="benefits-of-using-the-microsoft-azure-blob-service-for-includessnoversiontokenssnoversionmdmd-backups"></a>将 Microsoft Azure Blob 服务用于 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 备份的好处  
...
##  <a name="a-namebillinga-microsoft-azure-billing-considerations"></a><a name="Billing"></a>Microsoft Azure 计费注意事项：  
...
## <a name="see-also"></a>另请参阅  
 ...
 [教程：将 Microsoft Azure Blob 存储服务用于 SQL Server 2016 数据库](Tutorial:%20Using%20the%20Microsoft%20Azure%20Blob%20storage%20service%20with%20SQL%20Server%202016%20databases.md)  
