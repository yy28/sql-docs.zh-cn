...
1.  **注册 Azure：** 如果已经有 Azure 订阅，请转到下一步。 如果没有，可以使用 [免费试用版](https://azure.microsoft.com/pricing/free-trial/) 开始，或者浏览 [购买选项](https://azure.microsoft.com/pricing/purchase-options/)。  
