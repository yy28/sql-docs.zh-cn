---
title: "对 Microsoft Azure 禁用 SQL Server 托管备份 | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
#### 为特定数据库禁用[!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)]：  
...
#### 为所有数据库禁用 [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] ：  
...
#### 禁用 [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] 默认配置设置：  
...
#### 使用 Transact-SQL 暂停[!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)]服务：  
...
#### 使用 Transact-SQL 恢复[!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)]：  
