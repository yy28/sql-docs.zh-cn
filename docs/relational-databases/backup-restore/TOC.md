# [概述](back-up-and-restore-of-sql-server-databases.md)  
# [使用 Microsoft Azure Blob 存储服务进行 SQL Server 备份和还原](sql-server-backup-and-restore-with-microsoft-azure-blob-storage-service.md)  
## [连接到 Microsoft Azure 订阅](connect-to-a-microsoft-azure-subscription.md)  
## [SQL Server 备份到 URL](sql-server-backup-to-url.md)  
### [使用 PowerShell 将多个数据库备份到 Microsoft Azure Blob 存储服务](back-up-multiple-databases-to-azure-blob-storage-powershell.md)  
...
### [配置 Managed Backup to Microsoft Azure 的高级选项](configure-advanced-options-for-sql-server-managed-backup-to-microsoft-azure.md)  
### [对 Microsoft Azure 禁用托管备份](disable-sql-server-managed-backup-to-microsoft-azure.md)  
...
## [使用 SSMS 还原数据库备份](restore-a-database-backup-using-ssms.md)  
...
### [连接到 Microsoft Azure 存储（还原）](connect-to-microsoft-azure-storage-restore.md)  
