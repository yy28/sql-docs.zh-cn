---
title: "使用 PowerShell 将多个数据库备份到 Microsoft Azure Blob 存储服务 | Microsoft Docs"
ms.custom: ""
ms.date: "05/20/2016"
...
### 为所有 SQL Server 实例上的 MASTER 和 MSDB（系统数据库）进行完整数据库备份  
...
### 为 SQL Server 实例上的所有用户数据库进行完整数据库备份  
...
### 仅为 SQL Server 实例上的系统数据库（MASTER 和 MSDB）进行完整数据库备份  
