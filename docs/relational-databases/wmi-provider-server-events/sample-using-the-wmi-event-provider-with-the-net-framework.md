...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]下面的示例在 C# 程序使用 WMI 事件提供程序返回的默认安装实例发生的语言 (DDL) 事件的所有数据定义的事件数据中创建应用程序[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。  
