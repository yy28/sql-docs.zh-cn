...
###  <a name="HowToEnableCreate"></a> 如何在没有全文索引时创建语义索引  
...
###  <a name="HowToEnableAlter"></a> 如何在存在现有全文索引时创建语义索引  
 ...
 **使用 SQL Server Management Studio 添加语义索引**  
 可以在“全文索引属性”对话框的“全文索引列”页上更改启用语义索引和全文索引的列。 有关详细信息，请参阅[管理全文索引](../Topic/Manage%20Full-Text%20Indexes.md)。  
...
###  <a name="HowToCheckEnabled"></a> 如何检查是否在数据库对象上启用了语义搜索  
 **是否为数据库启用了语义搜索？**  
...
###  <a name="doctypes"></a> 如何确定可对哪些文档类型编制索引  
