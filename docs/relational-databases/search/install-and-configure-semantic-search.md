...
###  <a name="HowToCheckInstalled"></a> 如何检查是否安装了语义搜索  
...
###  <a name="BasicsSemanticSearch"></a> 如何安装语义搜索  
...
###  <a name="HowToCheckDatabase"></a> 如何检查是否安装了语义语言统计数据库  
...
###  <a name="HowToInstallModel"></a> 如何安装、附加和注册语义语言统计数据库  
 ...
 **1.安装语义语言统计数据库。**  
 1.  在 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 安装介质上找到语义语言统计数据库，或者从 Web 上下载它。  
    ...
    -   在 **安装介质上找到名为** SemanticLanguageDatabase.msi [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的 Windows 安装程序包。  
...
###  <a name="HowToUnregister"></a> 如何取消注册、分离和删除语义语言统计数据库  
 **取消注册语义语言统计数据库。**  
...
###  <a name="reqinstall"></a> 安装和删除语义语言统计数据库的要求和限制  
...
###  <a name="office"></a> 如何为 Microsoft Office 和其他 Microsoft 文档类型安装最新筛选器  
