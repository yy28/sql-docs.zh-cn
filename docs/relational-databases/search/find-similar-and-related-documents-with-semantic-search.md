...
###  <a name="HowToQuerySimilar"></a> 如何使用 SEMANTICSIMILARITYTABLE 查找相似或相关文档  
...
###  <a name="HowToQuerySimilarity"></a> 如何使用 SEMANTICSIMILARITYDETAILSTABLE 查找文档相似或相关程度的信息  
