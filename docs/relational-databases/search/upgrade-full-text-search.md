...
-   如果全文目录处于脱机状态，备份将失败。  
 ...
 有关备份和还原 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 全文目录的详细信息，请参阅 [联机丛书中的](http://go.microsoft.com/fwlink/?LinkId=121052) 备份和还原全文目录 [和](http://go.microsoft.com/fwlink/?LinkId=121053)文件备份和还原和全文目录 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 。  
