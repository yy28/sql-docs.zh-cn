...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]向数据库中添加角色或从中删除角色时，将发生 Audit Add Role 事件类。 此事件类用于 **sp_addrole** 和 **sp_droprole** 存储过程。  
...
|**RoleName**|**nvarchar**|添加或删除的数据库角色的名称。|38|是|  
