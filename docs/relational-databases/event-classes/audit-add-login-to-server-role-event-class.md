---
description: Audit Add Login to Server Role 事件类
...
ms.locfileid: "88385103"
---
# <a name="audit-add-login-to-server-role-event-class"></a>Audit Add Login to Server Role 事件类
[!INCLUDE [SQL Server - ASDB](../../includes/applies-to-version/sql-asdb.md)]
  每当向固定服务器角色添加登录名或从其删除登录名时，都会发生 **Audit Add Login to Server Role** 事件类。 此事件类用于 **sp_addsrvrolemember** 和 **sp_dropsrvrolemember** 存储过程。  
