...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]当 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 连接到全文筛选器后台程序进程并与之通信时，会出现 Audit Fulltext  事件类。  
