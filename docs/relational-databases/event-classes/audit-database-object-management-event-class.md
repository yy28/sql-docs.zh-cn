...
---
# <a name="audit-database-object-management-event-class"></a>Audit Database Object Management 事件类
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]当对数据库对象（如架构）执行 CREATE、ALTER 或 DROP 语句时，会发生 Audit Database Object Management 事件类。  
  
> [!NOTE]  
>  不审核与公钥相关的操作。  
  
## <a name="audit-database-object-management-event-class-data-columns"></a>Audit Database Object Management 事件类的数据列  
...
|**EventSubClass**|**int**|事件子类的类型。<br /><br /> 1 = 创建<br /><br /> 2 = 更改<br /><br /> 3 = 删除<br /><br /> 4 = 转储<br /><br /> 10 ＝ 打开<br /><br /> 11 = 加载<br /><br /> 12 ＝ 访问|21|是|  
