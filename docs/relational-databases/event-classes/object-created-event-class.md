...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Object:Created 事件类指明已创建一个对象，例如使用 CREATE INDEX、CREATE TABLE 或 CREATE DATABASE 语句创建的对象。  
