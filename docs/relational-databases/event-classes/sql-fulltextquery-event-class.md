...
|Duration|**bigint**|完成全文查询所用的时间。|13|是|  
|EndTime|**datetime**|事件结束时间|15|是|  
|错误|**int**|错误消息号。|31|是|  
|EventClass|**int**|记录的事件类型 = 123。|27|是|  
...
|TextData|**nvarchar**|提交给 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的查询的全文部分。|1|是|  
