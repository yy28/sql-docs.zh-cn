...
|**EventSubClass**|**int**|事件子类的类型：<br /><br /> 1: 同步创建/更新的统计信息； **TextData** 列指示创建或更新的统计信息，以及哪些统计信息是创建的，哪些是更新的<br /><br /> 2: 异步统计信息更新；作业已排队。<br /><br /> 3: 异步统计信息更新；作业已开始。<br /><br /> 4: 异步统计信息更新；作业已完成。|21|用户帐户控制|  
...
|**IntegerData**|**int**|成功更新的统计信息集合数。|25|用户帐户控制|  
