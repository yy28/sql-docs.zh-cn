...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]SQL:BatchCompleted 事件类指示 [!INCLUDE[tsql](../../includes/tsql-md.md)] 批处理已完成。  
...
|TextData|**ntext**|批处理文本。|1|是|  
|TransactionID|**bigint**|系统分配的事务 ID。|4|是|  
|Writes|**bigint**|批处理导致的页写入 I/O 数。|17|是|  
