...
|CPU|**int**|批处理使用的 CPU 时间（毫秒）。|18|用户帐户控制|  
...
|错误|**int**|事件的错误号。<br /><br /> 0 = 确定<br /><br /> 1 = 错误<br /><br /> 2 = 中止|31|用户帐户控制|  
...
|Reads|**bigint**|批处理导致的页读取 I/O 数。|16|用户帐户控制|  
...
|TextData|**ntext**|批处理文本。|@shouldalert|用户帐户控制|  
|TransactionID|**bigint**|系统分配的事务 ID。|4|用户帐户控制|  
|Writes|**bigint**|批处理导致的页写入 I/O 数。|17|用户帐户控制|  
