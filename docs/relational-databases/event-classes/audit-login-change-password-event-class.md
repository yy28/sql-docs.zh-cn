...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]只要用户更改了其 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 登录密码，就会发生 Audit Login Change Password 事件类。  
...
|**EventClass**|**int**|事件类型 = 107。|27|是|  
|**EventSequence**|**int**|给定事件在请求中的顺序。|51|是|  
|**EventSubClass**|**int**|事件子类的类型。<br /><br /> 1 = 密码自身已更改<br /><br /> 2 = 密码已更改<br /><br /> 3 = 密码自身已重置<br /><br /> 4 = 密码已重置<br /><br /> 5 = 密码已解锁<br /><br /> 6 = 密码必须更改|21|是|  
