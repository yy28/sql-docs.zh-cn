...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]当使用对象权限（例如 SELECT）时，会发生 Audit Schema Object Access 事件类。  
