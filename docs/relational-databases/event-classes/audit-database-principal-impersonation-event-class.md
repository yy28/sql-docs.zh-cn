...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Audit Database Principal Impersonation 事件类在数据库作用域中出现模拟（例如 EXECUTE AS \<user> 或 SETUSER）时出现。  
