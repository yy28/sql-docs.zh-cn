...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]只要 Microsoft SQL Server 中的任何用户针对服务器对象权限发出 GRANT、REVOKE 或 DENY，Audit Server Object GDR 事件类就会出现。  
...
|**EventClass**|**int**|事件的类型为 171|27|是|  
