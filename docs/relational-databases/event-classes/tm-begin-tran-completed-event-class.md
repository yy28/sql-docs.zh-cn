...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]TM: Begin Tran Completed 事件类指示已完成 BEGIN TRANSACTION 请求。 该请求是通过事务管理界面从客户端发送的。  
