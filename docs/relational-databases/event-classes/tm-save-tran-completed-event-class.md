...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]TM: Save Tran Completed 事件类指明 SAVE TRANSACTION 请求已完成。 该请求是通过事务管理界面从客户端发送的。  
  
## <a name="tm-save-tran-completed-event-class-data-columns"></a>TM: Save Tran Completed 事件类的数据列  
