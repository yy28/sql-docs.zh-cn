...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]当收到磁带装入请求时，将发生 Mount Tape 事件类。 使用此事件类可以监视磁带装入请求及其成功与否。  
...
|EventClass|**int**|事件类型 = 195。|27|是|  
|EventSequence|**int**|指定事件在请求中的顺序。|51|是|  
