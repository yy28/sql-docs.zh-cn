...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Exec Prepared SQL 事件类指示 SqlClient、ODBC、OLE DB 或 DB-Library 已执行准备好的 [!INCLUDE[tsql](../../includes/tsql-md.md)] 语句。  
