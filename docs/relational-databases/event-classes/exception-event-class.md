...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Exception 事件类用于指示 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 中发生了异常。  
