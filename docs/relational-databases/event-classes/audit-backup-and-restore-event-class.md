...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]每当发出备份或还原命令时，都会发生 Audit Backup/Restore 事件类。  
...
|**EventClass**|**int**|事件类型 = 115。|27|是|  
|**EventSequence**|**int**|给定事件在请求中的顺序。|51|是|  
|**EventSubClass**|**int**|事件子类的类型。<br /><br /> 1 = 备份<br /><br /> 2 = 还原<br /><br /> 3 = 备份日志|21|是|  
...
|**TextData**|**ntext**|备份或还原语句的 SQL 文本。|@shouldalert|是|  
