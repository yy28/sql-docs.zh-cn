...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]每当发出备份或还原命令时，都会发生 Audit Backup/Restore 事件类。  
...
|**TextData**|**ntext**|备份或还原语句的 SQL 文本。|1|是|  
