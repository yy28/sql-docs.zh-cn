...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]User-Configurable 事件类别包含 User-Configurable 事件类。  
  
## <a name="in-this-section"></a>本节内容  
  
|主题|说明|  
|-----------|-----------------|  
|[User-Configurable 事件类](../../relational-databases/event-classes/user-configurable-event-class.md)|用于监视其他事件类别中的系统提供的事件无法监视且由用户定义的事件。|  
