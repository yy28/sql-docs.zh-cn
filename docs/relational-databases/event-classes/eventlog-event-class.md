...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]EventLogevent 类指示已将事件记录到 [!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows 事件日志中。  
