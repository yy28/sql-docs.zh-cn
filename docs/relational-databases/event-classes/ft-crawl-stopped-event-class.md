...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]:Crawl Stopped 事件类指示全文爬网（填充）已停止。 之所以停止，可能是由于成功完成了爬网或者出错。  
...
|**ObjectID**|**int**|系统分配的对象 ID。 此对象上对全文索引的全文爬网已停止。|22|是|  
