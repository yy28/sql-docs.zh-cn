...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]当 Service Broker 转发消息时，[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 会生成 Broker:Forwarded Message Sent 事件。  
