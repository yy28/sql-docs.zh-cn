---
description: Broker:Forwarded Message Sent 事件类
...
|RoleName|**nvarchar**|会话句柄的角色。 有效值是：<br /><br /> Initiator。 此 Broker 发起了该会话。<br /><br /> Target。 此 Broker 是会话的目标。|38|否|  
