...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]创建、更改或删除服务器主体时，会发生 Audit Server Principal Management 事件类。  
  
## <a name="audit-server-principal-management-event-class-data-columns"></a>Audit Server Principal Management 事件类的数据列  
...
|**EventSubClass**|**int**|事件子类的类型。<br /><br /> 1 = 创建<br /><br /> 2 = 更改<br /><br /> 3 = 删除<br /><br /> 4 = 转储<br /><br /> 5 = 禁用<br /><br /> 6 = 启用<br /><br /> 11 = 加载|21|是|  
