...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]SQL:StmtCompleted 事件类指示 [!INCLUDE[tsql](../../includes/tsql-md.md)] 语句已完成。  
...
|Reads|**bigint**|由 SQL 语句发出的页读取数。|16|是|  
...
|Writes|**bigint**|由 SQL 语句发出的页写入数。|17|是|  
