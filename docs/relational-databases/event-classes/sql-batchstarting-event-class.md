...
---
# <a name="sqlbatchstarting-event-class"></a>SQL:BatchStarting 事件类
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] SQL:BatchStarting 事件类指示正在启动 [!INCLUDE[tsql](../../includes/tsql-md.md)] 批处理。  
  
## <a name="sqlbatchstarting-event-class-data-columns"></a>SQL:BatchStarting 事件类的数据列  
...
|TextData|**ntext**|Transact-SQL 批处理的文本。|1|是|  
