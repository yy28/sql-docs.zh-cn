...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]TM: Save Tran Starting 事件类指示正在启动 SAVE TRANSACTION 请求。 该请求是从客户端通过事务管理界面发送的。  
