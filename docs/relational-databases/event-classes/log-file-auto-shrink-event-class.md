...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Log File Auto Shrink 事件类指示日志文件自动收缩。 如果由于显式 ALTER DATABASE 语句而使日志文件收缩，则不会触发此事件。  
