...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]SQL:StmtStarting 事件类指示 [!INCLUDE[tsql](../../includes/tsql-md.md)] 语句已启动。  
