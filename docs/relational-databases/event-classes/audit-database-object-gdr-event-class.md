...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]如果对数据库对象（例如，程序集和架构）发出 GRANT、REVOKE 或 DENY，则会发生 Audit Database Object GDR 事件类。  
