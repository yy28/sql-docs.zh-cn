...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]当 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 执行 XQuery 表达式时，会发生 XQuery Static Type 事件类。 此事件类提供静态类型的 XQuery 表达式。  
...
|TextData|**ntext**|XQuery 表达式的静态推断类型。|1|是|  
