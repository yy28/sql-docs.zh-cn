...
|EventSubClass|**int**|事件子类的类型。<br /><br /> 1=Compplan Remove：一个经过编译的查询计划已从缓存中删除。<br /><br /> 2=Proc Cache Flush：所有项都已从过程缓存中删除。|21|用户帐户控制|  
...
|TextData|**ntext**|要从缓存中删除的 SQL 文本。|@shouldalert|用户帐户控制|  
