...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]SP:CacheRemove 事件类指示存储过程已从计划缓存中删除。  
...
|EventClass|**int**|事件类型 = 36。|27|是|  
|EventSequence|**int**|给定事件在请求中的顺序。|51|是|  
|EventSubClass|**int**|事件子类的类型。<br /><br /> 1=Compplan Remove：一个经过编译的查询计划已从缓存中删除。<br /><br /> 2=Proc Cache Flush：所有项都已从过程缓存中删除。|21|是|  
...
|TextData|**ntext**|要从缓存中删除的 SQL 文本。|1|是|  
