...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]TM: Commit Tran Starting 事件类表示正在启动 COMMIT TRANSACTION 请求。 将通过事务管理接口从客户端发送请求。 EventSubClass 列指示在提交当前事务后是否启动新事务。  
