...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]QN:Dynamics 事件类报告有关 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 执行以支持查询通知的后台活动的信息。 在 [!INCLUDE[ssDE](../../includes/ssde-md.md)]中，后台线程监视订阅超时、要激发的挂起订阅和参数表析构。  
