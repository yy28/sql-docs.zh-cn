...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]当 Service Broker 确定消息的路由时，[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 生成 Broker:Message Classify 事件。  
