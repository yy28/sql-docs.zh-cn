...
|**EventSubClass**|**nvarchar**|事件子类的类型，提供有关每个事件类的进一步信息。 此列可能包含以下值：<br /><br /> **Local**：所选路由具有 LOCAL 地址。<br /><br /> **Remote**：所选路由具有非 LOCAL 地址。<br /><br /> **Delayed**：由于禁止转发或者没有出现匹配的路由，因此消息被延迟。|21|用户帐户控制|  
...
|**Start Time**|**datetime**|事件（如果有）的开始时间。|14|用户帐户控制|  
