...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]当为了获取服务器范围内的权限（例如，创建登录名）而发出 GRANT、REVOKE 或 DENY 时，会产生 Audit Server Scope GDR 事件类。  
