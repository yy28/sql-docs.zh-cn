...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]ErrorLog 事件类指示消息已记录在 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 错误日志中。  
