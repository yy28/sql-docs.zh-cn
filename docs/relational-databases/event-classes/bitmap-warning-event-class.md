...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Bitmap Warning 事件类可用于监视查询中位图筛选器的使用情况。 该事件子类可用于报告何时禁用了查询中的位图筛选器。  
