...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]TM: Rollback Tran Starting 事件类表示正在启动 ROLLBACK TRANSACTION 请求。 客户端通过事务管理界面发送请求。 EventSubClass 列指示在当前事务回滚后是否启动新事务。  
