...
|**EventClass**|**int**|记录的事件类型 = 70。|27|否|  
|**EventSequence**|**int**|**CursorPrepare** 事件类在批处理中的顺序。|51|否|  
|**GroupID**|**int**|在其中激发 SQL 跟踪事件的工作负荷组的 ID。|66|用户帐户控制|  
|**Handle**|**int**|事件类的处理程序。|33|用户帐户控制|  
...
|**NTDomainName**|**nvarchar**|用户所属的 Windows 域。|7|否|  
|**NTUserName**|**nvarchar**|Windows 用户名。|6|用户帐户控制|  
|**RequestID**|**int**|准备了游标的请求标识。|49|用户帐户控制|  
