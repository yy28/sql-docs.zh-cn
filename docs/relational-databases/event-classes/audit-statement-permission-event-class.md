...
|**权限**|**bigint**|表示所检查的权限类型的整型值。<br /><br /> 1=CREATE DATABASE（仅 master 据库）<br /><br /> 2 = CREATE TABLE<br /><br /> 4 = CREATE PROCEDURE<br /><br /> 8 = CREATE VIEW<br /><br /> 16 = CREATE RULE<br /><br /> 32 = CREATE DEFAULT<br /><br /> 64 = BACKUP DATABASE<br /><br /> 128 = BACKUP LOG<br /><br /> 256 = BACKUP TABLE<br /><br /> 512 = CREATE FUNCTION|19|用户帐户控制|  
...
|**TextData**|**ntext**|需要语句权限的语句的 SQL 文本。|@shouldalert|用户帐户控制|  
