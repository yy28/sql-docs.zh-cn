...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]TM: Begin Tran Starting 事件类表示正在启动 BEGIN TRANSACTION 请求。 将通过事务管理接口从客户端发送请求。  
