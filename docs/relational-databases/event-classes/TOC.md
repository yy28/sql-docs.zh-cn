...
# [Broker:Message Drop 事件类](broker-message-drop-event-class.md)
...
# [Security Audit 事件类别 (SQL Server Profiler)](security-audit-event-category-sql-server-profiler.md)
...
# [Transactions 事件类别](transactions-event-category.md)
...
# [Database 事件类别](database-event-category.md)
# [数据库镜像连接事件类](database-mirroring-connection-event-class.md)
...
# [Objects 事件类别](objects-event-category.md)
...
# [审核全文事件类](audit-fulltext-event-class.md)
...
# [Full Text 事件类别](full-text-event-category.md)
...
# [Cursors 事件类别](cursors-event-category.md)
# [Audit DBCC 事件类](audit-dbcc-event-class.md)
# [SP:StmtStarting 事件类](sp-stmtstarting-event-class.md)
# [Stored Procedures 事件类别](stored-procedures-event-category.md)
# [Performance 事件类别](performance-event-category.md)
...
# [Deprecation 事件类别](deprecation-event-category.md)
...
# [Server 事件类别](server-event-category.md)
...
# [Locks 事件类别](locks-event-category.md)
...
# [Errors and Warnings 事件类别（数据库引擎）](errors-and-warnings-event-category-database-engine.md)
...
# [User-Configurable 事件类别](user-configurable-event-category.md)
# [Audit Logout 事件类](audit-logout-event-class.md)
# [Audit Database Scope GDR 事件类](audit-database-scope-gdr-event-class.md)
# [Progress Report 事件类别](progress-report-event-category.md)
# [Query Notifications 事件类别](query-notifications-event-category.md)
