...
|ObjectName|**nvarchar**|存储过程的名称。 如果填充了 ObjectName，则将不填充 TextData。|34|用户帐户控制|  
...
|TextData|**ntext**|正在缓存的 SQL 代码的文本。 如果填充了 TextData，则将不填充 ObjectName。|@shouldalert|用户帐户控制|  
