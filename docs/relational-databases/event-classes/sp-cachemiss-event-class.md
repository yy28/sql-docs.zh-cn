...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]SP:CacheMiss 事件类表明未在缓存中找到过程。 如果 SP:CacheMiss 事件类频繁出现，则可能指示 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]需要更多内存，从而提高过程缓存的大小。  
...
|TextData|**ntext**|正在缓存的 SQL 代码的文本。 如果填充了 TextData，则将不填充 ObjectName。|1|是|  
...
## <a name="see-also"></a>另请参阅  
 ...
 [SP:CacheInsert 事件类](../../relational-databases/event-classes/sp-cacheinsert-event-class.md)  
