---
title: "通过使用 OPENROWSET BULK 行集提供程序大容量导入大型对象数据 (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "OPENROWSET 函数, 批量导入大型数据"
  - "SINGLE_CLOB 选项"
  - "数据格式 [SQL Server], 大型对象数据"
  - "大型数据, 批量导入"
  - "SINGLE_BLOB 选项"
...
manager: "jhubbard"
---
# 通过使用 OPENROWSET BULK 行集提供程序大容量导入大型对象数据 (SQL Server)
