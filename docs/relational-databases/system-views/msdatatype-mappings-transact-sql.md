...
|列名|数据类型|Description|  
|-----------------|---------------|-----------------|  
|**dbms_name**|**nvarchar(128)**|是 DBMS 的名称。 以下是可能的值及其说明。<br /><br /> **MSSQLSERVER**： 目标数据库为 SQL Server 数据库。<br />**ORACLE**： 目标数据库为 Oracle 数据库。<br />**DB2**： 目标为 IBM DB2 数据库。<br />**SYBASE**： 目标为 Sybase 数据库。|  
