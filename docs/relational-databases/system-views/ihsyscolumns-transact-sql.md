...
|**长度**|**bigint**|从的最大的物理存储长度[sys.systypes &#40;Transact SQL &#41;](../../relational-databases/system-compatibility-views/sys-systypes-transact-sql.md).|  
...
|**数**|**int**|子过程号在分组过程 (**0**表示非过程项)。|  
|**colorder**|**int**|[!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]|  
|**autoval**|**int**|[!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]|  
|**偏移量**|**int**|此列将显示在行中插入偏移量。|  
...
|**type**|**int**|物理存储类型从[sys.systypes &#40;Transact SQL &#41;](../../relational-databases/system-compatibility-views/sys-systypes-transact-sql.md).|  
