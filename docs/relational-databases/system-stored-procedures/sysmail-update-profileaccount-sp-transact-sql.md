---
title: sysmail_update_profileaccount_sp (Transact SQL) |Microsoft 文档
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
## <a name="remarks"></a>注释  
 ...
 存储的过程**sysmail_update_profileaccount_sp**处于**msdb**数据库，而且由拥有**dbo**架构。 如果当前数据库不是，必须使用由三部分名称执行过程**msdb**。  
