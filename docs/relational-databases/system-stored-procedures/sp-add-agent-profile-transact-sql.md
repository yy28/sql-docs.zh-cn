 ...
 **sp_add_agent_profile**快照复制、 事务复制和合并复制中使用。  
 ...
 当**sp_add_agent_profile**是执行，在新的自定义配置文件添加一个行[MSagent_profiles &#40;Transact SQL &#41;](../../relational-databases/system-tables/msagent-profiles-transact-sql.md)表和关联的默认参数为此配置文件添加到[MSagent_parameters &#40;Transact SQL &#41;](../../relational-databases/system-tables/msagent-parameters-transact-sql.md)表。  
