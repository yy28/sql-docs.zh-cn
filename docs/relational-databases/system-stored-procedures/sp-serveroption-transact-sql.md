...
`[ @optvalue = ] 'option_value'` 指定是否*option_name*应启用 (**TRUE**或**上**) 还是禁用 (**FALSE**或**关闭**). *option_value*是**varchar (** 10 **)**，无默认值。  
