...
|**优先级**||可用于向后兼容性存储器。运行[sp_changemergesubscription](../../relational-databases/system-stored-procedures/sp-changemergesubscription-transact-sql.md)发布服务器上改为修改的订阅的优先级。|  
