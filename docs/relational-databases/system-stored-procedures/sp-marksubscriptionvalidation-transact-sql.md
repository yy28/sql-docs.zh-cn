 ...
 **sp_marksubscriptionvalidation**必须连同使用[sp_article_validation &#40;Transact SQL &#41;](../../relational-databases/system-stored-procedures/sp-article-validation-transact-sql.md)，将值指定为**1**为*subscription_level*，并可与其他调用使用**sp_marksubscriptionvalidation**标记有关其他订阅服务器当前打开的事务。  
