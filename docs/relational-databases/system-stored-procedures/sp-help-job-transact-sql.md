...
|**类别**|**sysname**|作业类别。|  
|**owner**|**sysname**|作业所有者。|  
|**notify_level_eventlog**|**int**|**位掩码**，指示在何种情况下，通知事件应记录到 Microsoft Windows 应用程序日志中。 可以是以下值之一：<br /><br /> **0** = 从不<br /><br /> **1** = 作业成功时<br /><br /> **2** = 作业失败时<br /><br /> **3** = 每次作业完成时（不管作业结果如何）|  
