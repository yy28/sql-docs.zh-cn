...
## <a name="arguments"></a>参数  
 ...
 [  **@column_name=**] **'**_列\_名称_  
 请求全文索引元数据的列的名称。 *column_name*是**sysname**，默认值为 NULL。 如果*column_name*省略或为 NULL，为每个全文索引列返回全文索引列信息*table_name*。 如果*table_name*也未指定或为 NULL，为数据库中的所有表的每个全文索引列返回全文索引列信息。  
