...
|**type**|**int**|项目的类型：<br /><br /> **1** = 基于日志的。<br /><br /> **3**带手工筛选 = 基于日志的。<br /><br /> **5** = 基于日志的网站与手动视图。<br /><br /> **7** = 日志基于具有手工筛选和手动视图。<br /><br /> **8** = 存储过程执行。<br /><br /> **24** = 可序列化的存储的过程执行。<br /><br /> **32** = 存储过程 （仅限架构）。<br /><br /> **64** = 视图 （仅限架构）。<br /><br /> **96** = 聚合函数 （仅限架构）。<br /><br /> **128** = 函数 （仅限架构）。<br /><br /> **257** = 基于日志的索引的视图。<br /><br /> **259**带手工筛选 = 基于日志的索引的视图。<br /><br /> **261** = 与手动视图基于日志的索引的视图。<br /><br /> **263** = 手动筛选器基于日志的索引的视图和手动视图。<br /><br /> **320** = 索引视图 （仅限架构）。<br /><br />|  
...
|**sync_object_owner**|**sysname**|用于定义已发布项目的视图的所有者。 实例时都提供 SQL Server 登录名。|  
...
|**阈值**|**bigint**|表示分发代理何时分配新标识范围的百分比值。|  
