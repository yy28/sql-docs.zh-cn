...
## <a name="remarks"></a>备注  
 ...
 作业的名称为**cdc。** _\<database\_name\>_** \_ 清除**或**cdc。** _\<database\_name\>_** \_ 捕获**，其中 *<database_name>* 是当前数据库的名称。 如果已存在具有相同名称的作业，则将在该名称后追加一个句点（**.**），后跟一个唯一标识符，例如： **cdc。AdventureWorks_capture。A1ACBDED-13FC-428C-8302-10100EF74F52**。  
