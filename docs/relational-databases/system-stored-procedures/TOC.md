...
# 临时表
## [时态表 - sys.sp_cleanup_temporal_history](temporal-table-sys-sp-cleanup-temporal-history.md)  
## [时态表 - sp_xtp_flush_temporal_history](temporal-table-sp-xtp-flush-temporal-history.md)  
# 快照备份
...
# PolyBase
## [PolyBase 存储过程 - sp_polybase_join_group](polybase-stored-procedures-sp-polybase-join-group.md)  
## [PolyBase 存储过程 - sp_polybase_leave_group](polybase-stored-procedures-sp-polybase-leave-group.md)  
# 文件流和 Filetable
## [文件流和 FileTable - sp_filestream_force_garbage_collection](filestream-and-filetable-sp-filestream-force-garbage-collection.md)  
## [文件流和 FileTable - sp_kill_filestream_non_transacted_handles](filestream-and-filetable-sp-kill-filestream-non-transacted-handles.md)  
# 活动的地理复制
...
# [分布式查询](distributed-queries-stored-procedures-transact-sql.md)  
...
# [防火墙规则（Azure SQL 数据库）](firewall-rules-stored-procedures-azure-sql-database.md)  
