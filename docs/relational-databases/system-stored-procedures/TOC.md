# [概述](system-stored-procedures-transact-sql.md)  
# [空间索引](spatial-index-stored-procedures-arguments-and-properties.md)  
...
# 临时表
## [临时表的 sys.sp_cleanup_temporal_history](temporal-table-sys-sp-cleanup-temporal-history.md)  
## [临时表的 sp_xtp_flush_temporal_history](temporal-table-sp-xtp-flush-temporal-history.md)  
# 快照备份
## [快照备份-sp_delete_backup_file_snapshot](snapshot-backup-sp-delete-backup-file-snapshot.md)  
## [快照备份-sp_delete_backup](snapshot-backup-sp-delete-backup.md)  
# PolyBase
## [PolyBase 存储过程的 sp_polybase_join_group](polybase-stored-procedures-sp-polybase-join-group.md)  
## [PolyBase 存储过程的 sp_polybase_leave_group](polybase-stored-procedures-sp-polybase-leave-group.md)  
# Filestream 和 Filetable
## [Filestream 和 FileTable-sp_filestream_force_garbage_collection](filestream-and-filetable-sp-filestream-force-garbage-collection.md)  
...
# [目录](catalog-stored-procedures-transact-sql.md)  
...
# [变更数据捕获](change-data-capture-stored-procedures-transact-sql.md)  
...
# [游标](cursor-stored-procedures-transact-sql.md)  
...
# [数据收集器](data-collector-stored-procedures-transact-sql.md)  
...
# [数据库引擎](database-engine-stored-procedures-transact-sql.md)  
...
## [sp_execute_remote （Azure SQL 数据库）](sp-execute-remote-azure-sql-database.md)  
...
# [数据库邮件](database-mail-stored-procedures-transact-sql.md)  
...
# [数据库维护计划](database-maintenance-plan-stored-procedures-transact-sql.md)  
...
# [分布式的查询](distributed-queries-stored-procedures-transact-sql.md)  
...
# [防火墙规则 (Azure SQL Database)](firewall-rules-stored-procedures-azure-sql-database.md)  
## [sp_set_firewall_rule （Azure SQL 数据库）](sp-set-firewall-rule-azure-sql-database.md)  
## [sp_set_database_firewall_rule （Azure SQL 数据库）](sp-set-database-firewall-rule-azure-sql-database.md)  
## [sp_delete_firewall_rule （Azure SQL 数据库）](sp-delete-firewall-rule-azure-sql-database.md)  
## [sp_delete_database_firewall_rule （Azure SQL 数据库）](sp-delete-database-firewall-rule-azure-sql-database.md)  
# [全文搜索和语义搜索](full-text-search-and-semantic-search-stored-procedures-transact-sql.md)  
...
# [常规扩展](general-extended-stored-procedures-transact-sql.md)  
...
# [日志传送](log-shipping-stored-procedures-transact-sql.md)  
...
# [托管备份](managed-backup-stored-procedures-transact-sql.md)  
...
# [管理数据仓库](management-data-warehouse-stored-procedures-transact-sql.md)  
...
# [OLE 自动化](ole-automation-stored-procedures-transact-sql.md)  
## [对象层次结构语法](object-hierarchy-syntax-transact-sql.md)  
...
# [基于策略的管理](policy-based-management-stored-procedures-transact-sql.md)  
...
# [查询存储](query-store-stored-procedures-transact-sql.md)  
...
## [sp_query_store_remove_plan (这 SQL)](sp-query-store-remove-plan-transct-sql.md)  
...
# [SQL 数据仓库](sql-data-warehouse-stored-procedures.md)  
...
# [SQL Server 代理](sql-server-agent-stored-procedures-transact-sql.md)  
...
## [sp_detach_schedule 将](sp-detach-schedule-transact-sql.md)  
...
# [SQL Server 事件探查器](sql-server-profiler-stored-procedures-transact-sql.md)  
...
# [Stretch Database 扩展](stretch-database-extended-stored-procedures-transact-sql.md)  
...
# [复制](replication-stored-procedures-transact-sql.md)  
...
## [用 sp_dropmergepullsubscription](sp-dropmergepullsubscription-transact-sql.md)  
...
## [正确无误](sp-helparticle-transact-sql.md)  
