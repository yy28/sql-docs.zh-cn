 ...
 **sp_droparticle**快照和事务复制中使用。  
 ...
 为水平筛选的项目， **sp_droparticle**检查**类型**中项目的列[sysarticles &#40;TRANSACT-SQL&#41; ](../../relational-databases/system-tables/sysarticles-transact-sql.md)表确定是否一个视图或筛选器应还删除。 如果视图或筛选是自动生成的，则将其与项目一起删除。 如果是手动创建的，则不将其删除。  
