...
## <a name="remarks"></a>备注  
 ...
 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]提供了一种简单的图形方式来管理整个警报系统。 建议使用 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] 配置警报基本结构。  
...
> **注意：** 此示例假定`Test Alert`已存在并且是有效`François Ajenstat`的运算符名称。  
