...
## <a name="remarks"></a>备注  
 ...
 当你添加的服务器级防火墙设置的起始和结束 IP 地址等于`0.0.0.0`时, 你可以从 Azure 中启用对[!INCLUDE[ssSDS](../../includes/sssds-md.md)]服务器的访问。 为*name*参数提供一个值, 该值有助于记住服务器级防火墙设置的用途。  
...
## <a name="examples"></a>示例  
 以下代码将创建一个名`Allow Azure`为的服务器级防火墙设置, 该设置可实现从 Azure 的访问。 在虚拟 master 数据库中执行以下。  
