---
title: sp_syscollector_delete_collection_item (TRANSACT-SQL) |Microsoft 文档
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
## <a name="arguments"></a>参数  
 ...
 收集项的唯一标识符。 *collection_item_id*是**int**默认值为 NULL。 *collection_item_id*必须具有一个值，如果*名称*为 NULL。  
