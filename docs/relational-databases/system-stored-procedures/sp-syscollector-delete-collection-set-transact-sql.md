---
title: sp_syscollector_delete_collection_set (TRANSACT-SQL) |Microsoft 文档
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
## <a name="remarks"></a>注释  
 ...
 任一*collection_set_id*或*名称*必须具有一个值，都不能为 NULL。 若要获取这些值，请查询 syscollector_collection_set 系统视图。  
