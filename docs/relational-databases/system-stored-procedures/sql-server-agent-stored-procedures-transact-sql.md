---
title: "SQL Server 代理存储过程 (Transact SQL) |Microsoft 文档"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 支持以下系统存储过程，通过使用[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]代理以管理计划和事件驱动活动。  
