---
title: sp_help_targetserver (Transact SQL) |Microsoft 文档
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
## <a name="result-sets"></a>结果集  
 如果*server_name*未指定， **sp_help_targetserver**返回该结果集。  
...
|**unread_instructions**|**int**|指示服务器是否有未读指令。 如果已经下载了所有行，此列为**0**。|  
