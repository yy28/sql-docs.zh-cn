...
|**type**|**tinyint**|订阅服务器的类型：<br /><br /> **0**  = 数据库1 = ODBC 数据源[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
...
|**frequency_relative_interval**|**int**|*Frequency_type*设置为**32**时使用的分发代理日期 (每月相对):<br /><br /> **1** = 第一<br /><br /> **2** = 秒<br /><br /> **4** = 第三<br /><br /> **8** = 第四<br /><br /> **16** = 最后|  
...
|**security_mode**|**int**|实现的安全模式：<br /><br /> 0 =  身份[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]验证<br /><br /> 1 = 个Windows身份[!INCLUDE[msCoName](../../includes/msconame-md.md)]验证|  
...
|**frequency_relative_interval2**|**int**|*Frequency_type*设置为 32 (每月相对) 时使用的合并代理日期:<br /><br /> **1** = 第一<br /><br /> **2** = 秒<br /><br /> **4** = 第三<br /><br /> **8** = 第四<br /><br /> **16** = 最后|  
...
## <a name="permissions"></a>权限  
 只有**sysadmin**固定服务器角色的成员、 **db_owner**固定数据库角色的成员或发布的发布访问列表中的成员才能执行**sp_helpsubscriberinfo**。  
