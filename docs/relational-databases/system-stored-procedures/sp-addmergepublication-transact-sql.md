...
|**character**|生成所有表的字符模式大容量复制程序输出。 需要该项以支持[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssEW](../../includes/ssew-md.md)]和非-[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]订阅服务器。|  
