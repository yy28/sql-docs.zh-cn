...
## <a name="examples"></a>示例  
 下面的示例根据收集类型`Generic T-SQL Query Collector Type`创建一个收集项，并将该项添加到名为 `Simple collection set test 2` 的收集组。 若要创建指定的收集组，请运行中的示例 B [sp_syscollector_create_collection_set &#40;TRANSACT-SQL&#41;](../../relational-databases/system-stored-procedures/sp-syscollector-create-collection-set-transact-sql.md)。  
