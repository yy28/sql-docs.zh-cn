...
`[ @tracer_id = ] tracer_id`为其返回历史记录信息的[MStracer_tokens &#40;transact-sql&#41; ](../../relational-databases/system-tables/mstracer-tokens-transact-sql.md)表中的跟踪令牌的 ID。 *tracer_id*的值为**int**, 无默认值。  
 ...
 **sp_helptracertokenhistory**用于事务复制。  
 ...
 执行[sp_helptracertokens &#40;&#41; ](../../relational-databases/system-stored-procedures/sp-helptracertokens-transact-sql.md)以获取发布的跟踪令牌列表。  
