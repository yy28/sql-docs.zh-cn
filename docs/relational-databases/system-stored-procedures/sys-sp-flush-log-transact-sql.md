---
title: "sys.sp_flush_log (TRANSACT-SQL) |Microsoft 文档"
ms.custom: 
ms.date: 03/14/2017
...
||  
|-|  
|**适用范围**： [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] （[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 到 [当前版本](http://go.microsoft.com/fwlink/p/?LinkId=299658)）。|  
