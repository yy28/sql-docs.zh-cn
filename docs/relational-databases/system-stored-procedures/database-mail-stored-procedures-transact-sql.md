---
description: 数据库邮件存储过程 (Transact-SQL)
title: 数据库邮件存储过程 (Transact-sql) |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "89542042"
---
# <a name="database-mail-stored-procedures-transact-sql"></a>数据库邮件存储过程 (Transact-SQL)
[!INCLUDE [SQL Server - ASDBMI](../../includes/applies-to-version/sql-asdbmi.md)]

  [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]支持下列系统存储过程，这些存储过程用于在的实例内执行电子邮件操作 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 。  
  
## <a name="database-mail-procedures"></a>数据库邮件过程  
