...
ms.locfileid: "70211320"
---
# <a name="database-mail-stored-procedures-transact-sql"></a>数据库邮件存储过程 (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2008-asdbmi-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-asdbmi-xxxx-xxx-md.md)]

  [!INCLUDE[msCoName](../../includes/msconame-md.md)]支持下列系统存储过程, 这些存储过程用于在的[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]实例内执行电子邮件操作。 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
