---
title: 数据库邮件存储过程 (Transact SQL) |Microsoft 文档
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "33238747"
---
# <a name="database-mail-stored-procedures-transact-sql"></a>数据库邮件存储过程 (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]

  [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 支持的下列系统存储过程用于执行从实例中的电子邮件操作[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。  
