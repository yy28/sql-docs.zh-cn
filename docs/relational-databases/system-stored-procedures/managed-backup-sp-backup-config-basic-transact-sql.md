...
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]
  ...
  为特定[!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)]数据库或实例配置基本设置[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。  
...
>  目前此参数仅支持 SAS URL。  
 ...
 @retention_days  
 备份文件的保持期（以天为单位）。 @storage_url为 INT。 这是在实例上首次[!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)]配置时所需的参数[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。 更改[!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)]配置时，此参数是可选的。 如果不指定，则会保留现有的配置值。  
