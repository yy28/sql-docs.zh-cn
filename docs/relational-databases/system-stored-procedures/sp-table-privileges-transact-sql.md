...
|GRANTEE|**sysname**|已被列出的 GRANTOR 授予对此 TABLE_NAME 的权限的数据库用户名。 在[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]，此列始终包括从 sys.database_principalssystem 视图的数据库用户。 此字段始终返回值。|  
