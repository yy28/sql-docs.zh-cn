...
ms.locfileid: "43017791"
---
# <a name="spdropalias-transact-sql"></a>sp_dropalias (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]

  **sp_dropalias**已删除[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]。 有关语法，请参阅[sp_dropalias (Transact SQL)](https://msdn.microsoft.com/library/ms177513\(v=sql.105\).aspx)早期文档中。  
