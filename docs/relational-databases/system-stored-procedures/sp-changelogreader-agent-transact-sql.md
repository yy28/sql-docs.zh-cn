...
`[ @job_login = ] 'job_login'`运行代理时所用的帐户的登录名。 *job_login*为**nvarchar （257）**，默认值为 NULL。 在 Azure SQL 数据库托管实例上，使用 SQL Server 帐户。 *对于非发布服务器，不能更改此项*[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] *。*  
