...
|**run_requested_source**|**sysname**|请求运行作业的请求源。 可为下列值之一：<br /><br /> **1** = 按计划运行<br /><br /> **2** = 运行以响应警报<br /><br /> **3** = 启动时运行<br /><br /> **4** = 由用户运行<br /><br /> **6** = 按 CPU 空闲计划运行|  
...
## <a name="remarks"></a>Remarks  
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 代理在每次启动代理服务时都会创建一个会话 ID。 会话 id 存储在表**msdb.dbo.syssessions**。  
  
 如果未*session_id*提供，列出有关最新的会话的信息。  
