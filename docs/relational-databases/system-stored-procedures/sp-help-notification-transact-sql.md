...
|**use_email**|**int**|使用电子邮件通知操作员：<br /><br /> **1** = yes<br /><br /> **0** = 否|  
|**use_pager**|**int**|使用寻呼通知操作员：<br /><br /> **1** = yes<br /><br /> **0** = 否|  
|**use_netsend**|**int**|使用网络弹出消息通知操作员：<br /><br /> **1** = yes<br /><br /> **0** = 否|  
...
|**use_email**|**int**|使用电子邮件发送操作员的通知：<br /><br /> **1** = yes<br /><br /> **0** = 否|  
|**use_pager**|**int**|使用寻呼发送操作员的通知：<br /><br /> **1** = yes<br /><br /> **0** = 否|  
|**use_netsend**|**int**|用于通知该操作员弹出的网络：<br /><br /> **1** = yes<br /><br /> **0** = 否|  
|**has_email**|**int**|操作员有电子邮件地址：<br /><br /> **1** = yes<br /><br /> **0** = 否|  
|**has_pager**|**int**|操作员有寻呼地址：<br /><br /> **1** = yes<br /><br /> **0** = 否|  
|**has_netsend**|**int**|操作员已配置网络发送通知。<br /><br /> **1** = yes<br /><br /> **0** = 否|  
