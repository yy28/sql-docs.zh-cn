...
ms.topic: "article"
helpviewer_keywords: 
  - "应用程序角色 [SQL Server], 关于应用程序角色"
  - "主体 [SQL Server], 应用程序角色"
  - "凭据 [SQL Server], 角色"
  - "应用程序角色 [SQL Server]"
  - "角色 [SQL Server], 应用程序"
  - "权限 [SQL Server], 角色"
  - "用户 [SQL Server], 应用程序角色"
  - "身份验证 [SQL Server], 角色"
  - "组 [SQL Server], 角色"
...
# 应用程序角色
 ...
 在 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 中，应用程序角色无法访问服务器级元数据，因为它们不与服务器级主体关联。 若要禁用此限制，从而允许应用程序角色访问服务器级元数据，请设置全局标志 4616。 有关详细信息，请参阅[跟踪标志 (Transact-SQL)](../Topic/Trace%20Flags%20\(Transact-SQL\).md) 和 [DBCC TRACEON (Transact-SQL)](../../../t-sql/database-console-commands/dbcc-traceon-transact-sql.md)。  
