...
|为使用 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]|[为访问 SSIS 服务配置 Windows 防火墙](../../integration-services/service/configure-a-windows-firewall-for-access-to-the-ssis-service.md)|  
...
|有关信息|请参阅|  
|---------------------------|---------|  
|连接、配置和控制 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|[使用 SQL Server Management Studio](../../ssms/use-sql-server-management-studio.md)|  
