...
description: SQL Server 和 Azure SQL 数据库中提供了扩展事件的系统视图。 了解如何以不同视角表示事件会话信息。
ms.date: 08/02/2016
ms.prod: sql
...
每月 [安装 SSMS 的最新更新](../../ssms/download-sql-server-management-studio-ssms.md)是明智之举，以避免意外故障。
...
|Type-of-Item|   程序包|        Item|                          Item-Description|
|---|---|---|---|
