...
## <a name="remarks"></a>Remarks  
 srv_message_handler 函数使扩展存储过程能够与  **的集中错误日志记录和报告功能集成**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。 可以为扩展存储过程中的事件建立 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 警报，SQL Server 代理将监视这些警报情况。  
