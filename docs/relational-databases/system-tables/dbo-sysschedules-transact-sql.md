...
|**启用**|**int**|作业计划的状态：<br /><br /> **0** = 不启用。<br /><br /> **1** = 启用。<br /><br /> 如果未启用计划，则不会运行该计划中的任何作业。|  
...
|**freq_recurrence_**<br /><br /> **因素**|**int**|在计划的作业执行之间间隔的周数或月数。 **freq_recurrence_factor**仅当使用**freq_type**是**8**， **16**，或**32**。 如果此列包含**0**， **freq_recurrence_factor**未使用。|  
