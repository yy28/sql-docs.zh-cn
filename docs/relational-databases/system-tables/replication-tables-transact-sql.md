...
|[MSpublications](../../relational-databases/system-tables/mspublications-transact-sql.md)|[MStracer_tokens](../../relational-databases/system-tables/mstracer-tokens-transact-sql.md)|  
 ...
 分发数据库中的这些表可用于从非 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 发布服务器复制数据。 有关详细信息，请参阅[非 SQL Server 发布服务器](../../relational-databases/replication/non-sql/non-sql-server-publishers.md)。  
...
|||  
|-|-|  
|[conflict_\<架构 > _\<表 >](../../relational-databases/system-tables/conflict-schema-table-transact-sql.md)|[MSpeer_originatorid_history](../../relational-databases/system-tables/mspeer-originatorid-history-transact-sql.md)|  
