---
title: IHconstrainttypes (Transact SQL) |Microsoft 文档
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
...
ms.locfileid: "32999054"
---
# <a name="ihconstrainttypes-transact-sql"></a>IHconstrainttypes (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]

  **IHconstrainttypes**系统表包含有关每种类型的支持的非 SQL Server 发布服务器的非 SQL Server 约束的一行。 此表存储在分发数据库中。  
