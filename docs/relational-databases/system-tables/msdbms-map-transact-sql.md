---
title: MSdbms_map (Transact SQL) |Microsoft 文档
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "33009434"
---
# <a name="msdbmsmap-transact-sql"></a>MSdbms_map (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]

  **MSdbms_map**表包含源数据类型信息，以及源和目标 DBMS 对默认目标数据类型信息的链接。 此表存储在**msdb**数据库和用于异类发布。  
  
|列名|数据类型|Description|  
|-----------------|---------------|-----------------|  
|**map_id**|**int**|唯一标识数据类型映射。|  
|**src_dbms_id**|**int**|通过指定标识的源 DBMS 其**dbms_id**中[MSdbms](../../relational-databases/system-tables/msdbms-transact-sql.md)表。|  
|**dest_dbms_id**|**int**|通过指定标识目标 DBMS 其**dbms_id**中[MSdbms](../../relational-databases/system-tables/msdbms-transact-sql.md)表。|  
...
|**default_datatype_mapping_id**|**int**|通过指定标识的默认数据类型映射其**map_id**表中[MSdbms_datatype_mapping](../../relational-databases/system-tables/msdbms-datatype-mapping-transact-sql.md)。|  
