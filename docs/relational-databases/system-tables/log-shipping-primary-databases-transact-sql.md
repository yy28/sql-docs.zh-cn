...
|**backup_job_id**|**uniqueidentifier**|与主服务器上的备份作业关联的 @no__t 0 @no__t 代理作业 ID。|  
|**monitor_server**|**sysname**|在日志传送配置中用作监视服务器的 [!INCLUDE[msCoName](../../includes/msconame-md.md)] @no__t 的实例名称。|  
