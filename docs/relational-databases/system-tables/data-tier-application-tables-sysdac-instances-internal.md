---
title: sysdac_instances_internal (Transact SQL) |Microsoft 文档
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
...
## <a name="remarks"></a>注释  
 可供有权连接到 master 数据库的所有用户对此视图的只读访问。  
