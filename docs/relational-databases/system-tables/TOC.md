# [概述](system-tables-transact-sql.md)  
# [扩展事件表-trace_xe_action_map](extended-events-tables-trace-xe-action-map.md)  
# [扩展事件表-trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
# [数据层应用程序表-sysdac_history_internal](data-tier-application-tables-sysdac-history-internal.md)  
# [数据层应用程序表-sysdac_instances_internal](data-tier-application-tables-sysdac-instances-internal.md)  
# [将系统表映射到系统视图](mapping-system-tables-to-system-views-transact-sql.md)  
# [系统基表](system-base-tables.md)  
# [备份和还原表](backup-and-restore-tables-transact-sql.md)  
...
# [更改数据捕获表](change-data-capture-tables-transact-sql.md)  
...
## [cdc.change_tables 反映](cdc-change-tables-transact-sql.md)  
...
# [数据库维护计划表](database-maintenance-plan-tables-transact-sql.md)  
## [sysdbmaintplan_databases](sysdbmaintplan-databases-transact-sql.md)  
## [值来生成 sysdbmaintplan_history](sysdbmaintplan-history-transact-sql.md)  
## [sysdbmaintplan_jobs](sysdbmaintplan-jobs-transact-sql.md)  
## [sysdbmaintplans](sysdbmaintplans-transact-sql.md)  
# [Integration Services 表](integration-services-tables-transact-sql.md)  
...
# [日志传送表](log-shipping-tables-transact-sql.md)  
...
# [SQL Server 代理表](sql-server-agent-tables-transact-sql.md)  
...
# [复制表](replication-tables-transact-sql.md)  
