...
||  
|-|  
|**适用范围**：[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]（[!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] 到[当前版本](../../sql-server/what-s-new-in-sql-server-2016.md)）、[!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)]。|  
