...
###  <a name="Security"></a> 安全性  
 文件访问权限可在很多数据库操作过程中设置，其中包括分离或附加数据库。 有关分离或附加数据库时设置的文件权限的信息，请参阅[!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]联机丛书（仍为有效读物！）中的[保护数据和日志文件](http://technet.microsoft.com/library/ms189128.aspx) 
