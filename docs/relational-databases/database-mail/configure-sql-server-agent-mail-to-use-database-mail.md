...
ms.topic: "article"
helpviewer_keywords: 
  - "数据库邮件 [SQL Server], SQL Server 代理邮件"
  - "SQL Server 代理邮件"
...
-    创建供 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 代理服务帐户使用的[数据库邮件帐户](../../relational-databases/database-mail/create-a-database-mail-account.md)。  
  
-   创建供 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 代理服务帐户使用的[数据库邮件配置文件](../../relational-databases/database-mail/create-a-database-mail-profile.md)，并将用户添加到 **msdb** 数据库的 **DatabaseMailUserRole** 中。  
