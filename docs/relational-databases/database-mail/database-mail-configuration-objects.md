...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]数据库邮件有两个配置对象：数据库配置对象提供了一种方法，用于配置从数据库应用程序或 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 代理发送电子邮件时数据库邮件应使用的设置。  
 ...
 **公共配置文件** 对 **msdb** 数据库中的 **DatabaseMailUserRole** 数据库角色的所有成员都可用。 它们允许 **DatabaseMailUserRole** 角色的所有成员使用该配置文件发送电子邮件。  
...
|配置任务|主题链接|  
|------------------------|----------------|  
|介绍如何创建数据库邮件帐户|[创建数据库邮件帐户](../../relational-databases/database-mail/create-a-database-mail-account.md)|  
|介绍如何创建数据库邮件配置文件|[创建数据库邮件配置文件](../../relational-databases/database-mail/create-a-database-mail-profile.md)|  
|介绍如何配置数据库邮件|[配置数据库邮件](../../relational-databases/database-mail/configure-database-mail.md)|  
|介绍如何使用模板创建数据库邮件配置脚本||  
...
|[sysmail_delete_profile_sp (Transact-SQL)](../../relational-databases/system-stored-procedures/sysmail-delete-profile-sp-transact-sql.md)|删除数据库邮件配置文件。|  
|[sysmail_delete_profileaccount_sp (Transact-SQL)](../../relational-databases/system-stored-procedures/sysmail-delete-profileaccount-sp-transact-sql.md)|从数据库邮件配置文件中删除帐户。|  
|[sysmail_help_account_sp (Transact-SQL)](../../relational-databases/system-stored-procedures/sysmail-help-account-sp-transact-sql.md)|列出有关数据库邮件帐户的信息。|  
|[sysmail_help_profile_sp (Transact-SQL)](../../relational-databases/system-stored-procedures/sysmail-help-profile-sp-transact-sql.md)|列出有关一个或多个数据库邮件配置文件的信息。|  
|[sysmail_help_profileaccount_sp (Transact-SQL)](../../relational-databases/system-stored-procedures/sysmail-help-profileaccount-sp-transact-sql.md)|列出与一个或多个数据库邮件配置文件相关联的帐户。|  
|[sysmail_update_account_sp (Transact-SQL)](../../relational-databases/system-stored-procedures/sysmail-update-account-sp-transact-sql.md)|更新现有数据库邮件帐户中的信息。|  
...
|[sysmail_help_principalprofile_sp (Transact-SQL)](../../relational-databases/system-stored-procedures/sysmail-help-principalprofile-sp-transact-sql.md)|列出所给数据库用户的数据库邮件配置文件信息。|  
|[sysmail_update_principalprofile_sp (Transact-SQL)](../../relational-databases/system-stored-procedures/sysmail-update-principalprofile-sp-transact-sql.md)|更新所给数据库用户的权限信息。|  
