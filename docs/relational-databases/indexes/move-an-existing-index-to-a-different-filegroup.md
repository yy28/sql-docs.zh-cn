...
7.  选择移动此索引的目标文件组。  
     ...
     如果表或索引已分区，则选择要在其中移动索引的分区架构。 有关已分区索引的详细信息，请参阅 [Partitioned Tables and Indexes](../../relational-databases/partitions/partitioned-tables-and-indexes.md)。  
