...
> [!NOTE]
> [!INCLUDE[ssManStudio](../../includes/ssManStudio-md.md)] 不能用于计算 SQL Server 中列存储索引的碎片，并且不能用于计算 Azure SQL 数据库中任何索引的碎片。 使用[下面](#TsqlProcedureFrag)的 [!INCLUDE[tsql](../../includes/tsql-md.md)] 示例。
