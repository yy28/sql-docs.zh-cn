...
|SQL_CONVERT_BIGINT|不支持转换 ODBC SQL_BIGINT 数据类型。 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Native CLIENT odbc 驱动程序支持将 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **十进制（19，0）** 数据类型作为 ODBC 类型 SQL_DECIMAL。 请参阅下文中的 SQL_CONVERT_DECIMAL。|  
...
|SQL_CONVERT_DATE|不支持转换 ODBC SQL_TYPE_DATE 数据类型。 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Native CLIENT ODBC 驱动程序支持将 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **datetime**数据类型用作 ODBC 类型 SQL_TYPE_TIMESTAMP。 请参阅下文中的 SQL_CONVERT_TIMESTAMP。|  
...
|SQL_CONVERT_TIME|不支持转换 ODBC SQL_TYPE_TIME 数据类型。 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Native CLIENT ODBC 驱动程序支持将 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **datetime**数据类型用作 ODBC 类型 SQL_TYPE_TIMESTAMP。 请参阅下文中的 SQL_CONVERT_TIMESTAMP。|  
...
|SQL_INFO_SS_NETLIB_NAME|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client ODBC 驱动程序特定的属性。 连接使用的网络库的名称。<br /><br /> 默认情况下，将返回 DBNETLIB。  在这种情况下，DBNETLIB 引用网络库，与 dbnetlib.dll 无关。|  
|SQL_INTEGRITY|"Y"|  
