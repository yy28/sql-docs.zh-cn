...
helpviewer_keywords: 
  - "OLE DB, 链接服务器"
  - "OLE DB 访问接口, 链接服务器"
  - "服务器管理 [SQL Server], 链接服务器"
  - "链接服务器 [SQL Server]"
  - "分布式查询 [SQL Server], 链接服务器"
  - "服务器 [SQL Server], 链接"
  - "远程服务器 [SQL Server], 链接服务器"
  - "链接服务器 [SQL Server], 关于链接服务器"
