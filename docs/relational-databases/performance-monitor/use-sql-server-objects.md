...
ms.topic: "article"
helpviewer_keywords: 
  - "服务器性能 [SQL Server], 监视对象"
  - "数据库监视 [SQL Server], 监视对象"
  - "图表 [SQL Server]"
  - "系统监视器 [SQL Server], 计数器"
  - "计数器 [SQL Server], 已列出"
  - "对象 [SQL Server], 性能监视"
  - "对象 [SQL Server], Windows 系统监视器"
  - "性能计数器 [SQL Server], 关于性能计数器"
  - "系统监视器 [SQL Server], 对象"
  - "性能计数器 [SQL Server]"
  - "计数器 [SQL Server], 关于性能计数器"
  - "优化数据库 [SQL Server], 监视对象"
  - "数据库性能 [SQL Server], 监视对象"
  - "SQL Server, 对象"
  - "监视性能 [SQL Server], 监视对象"
  - "Windows 系统监视器 [SQL Server], 对象"
  - "Windows 系统监视器 [SQL Server], 计数器"
  - "计数器 [SQL Server]"
  - "性能计数器 [SQL Server], 已列出"
