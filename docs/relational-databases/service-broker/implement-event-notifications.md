...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]要实现事件通知，必须先创建目标服务以接收事件通知，然后再创建事件通知。  
...
## <a name="see-also"></a>另请参阅  
 [获取有关事件通知的信息](../../relational-databases/service-broker/get-information-about-event-notifications.md)   
