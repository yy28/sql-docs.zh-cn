...
|主题|Description|  
|-----------|-----------------|  
|[入门 Visual 的 c&#35;.NET](../../relational-databases/server-management-objects-smo/smo-programming-getting-started-in-visual-csharp-net.md)|提供有关如何开始在 Visual C#.NET 编写的 SMO 程序的信息|  
