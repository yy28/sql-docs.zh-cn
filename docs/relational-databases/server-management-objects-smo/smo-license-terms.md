---
title: SQL Server 共享管理对象（SMO）-许可条款 |Microsoft Docs
ms.custom: ''
ms.date: 08/08/2018
ms.prod: sql
ms.reviewer: ''
...
&nbsp;&nbsp;&nbsp;&nbsp;**i.  使用和分发权。如果你遵守以下条款：**
*   您可以在您开发的程序中复制和分发该软件的对象代码形式（"可分发代码"）;与
...
**3.许可范围。** 该软件只授予使用许可，而非出售。 除非适用的法律为你提供了更多权利，否则 Microsoft 保留此协议未明确授予的任何其他权利，无论是明示还是暗示、禁止或者其他方式。 你只能在本协议明示规定的范围内使用该软件。 在按规定使用该软件时，您必须遵守软件中的所有技术限制，这些限制只允许您以特定方式使用该软件。 不能执行以下任一操作：
