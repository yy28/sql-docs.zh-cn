...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]在 SMO 中，由系统消息<xref:Microsoft.SqlServer.Management.Smo.SystemMessageCollection>所属的对象**服务器**对象。 由于不能修改系统消息， **SystemMessage**对象属性是只读的。  
