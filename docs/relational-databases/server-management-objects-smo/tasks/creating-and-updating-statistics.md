...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]在 SMO 中，处理数据库中的查询有关的统计信息可收集通过<xref:Microsoft.SqlServer.Management.Smo.Statistic>对象。  
