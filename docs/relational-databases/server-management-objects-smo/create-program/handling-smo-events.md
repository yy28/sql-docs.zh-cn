...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]可以通过使用事件处理程序订阅的服务器事件类型和<xref:Microsoft.SqlServer.Management.Common.ServerConnection>对象。  
