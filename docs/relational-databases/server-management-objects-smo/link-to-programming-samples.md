...
---
# <a name="available-programming-samples"></a>可用编程示例
[!INCLUDE[appliesto-ss-asdb-asdw-xxx-md](../../includes/appliesto-ss-asdb-asdw-xxx-md.md)]

  下表列出[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]管理对象 (SMO) 编程示例中提供[!INCLUDE[ssSampPathEng](../../includes/sssamppatheng-md.md)]Programmability\SMO 目录。 这些示例都提供[!INCLUDE[csprcs](../../includes/csprcs-md.md)]和[!INCLUDE[vbprvb](../../includes/vbprvb-md.md)].NET。  
...
|CreateSPs|演示如何创建**选择**所选数据库中存储的每个表的过程。|  
...
|触发器|显示数据库触发器。|  
|UtilityConversion|与使用**LoadRegAssembly**。 包含要用于 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的演示公共语言运行时 (CLR) 函数。|  
