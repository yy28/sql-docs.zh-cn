...
ms.locfileid: "87246725"
---
# <a name="ole-db-table-valued-parameter-type-support-in-sql-server-native-client-methods"></a>OLE DB SQL Server Native Client 中的表值参数类型支持（方法）
