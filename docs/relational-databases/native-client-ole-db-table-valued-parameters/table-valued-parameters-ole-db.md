...
## <a name="remarks"></a>Remarks  
 目前，可以发送多行数据到服务器为带有参数集的过程的参数 (中的 DBPARAMS 参数**icommand:: Execute**)。 使用参数集时，该参数集中的每个元素都必须通过单独的远程过程调用 (RPC) 请求发送到服务器。 表值参数提供类似的功能，但可以与服务器更好地集成。 这可以减少 RPC 请求数，并在服务器上启用基于集的操作。  
