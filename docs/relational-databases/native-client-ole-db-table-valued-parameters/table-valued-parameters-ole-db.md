---
title: 表值参数（Native Client OLE DB 提供程序）
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "87331867"
---
# <a name="table-valued-parameters--in-sql-server-native-client-ole-db"></a>SQL Server Native Client （OLE DB）中的表值参数
