---
description: " (Native Client OLE DB 提供程序 OLE DB 表值参数类型支持) "
title: " (Native Client OLE DB 提供程序的表值参数类型支持) "
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "88482589"
---
# <a name="ole-db-table-valued-parameter-type-support-native-client-ole-db-provider"></a> (Native Client OLE DB 提供程序 OLE DB 表值参数类型支持) 
