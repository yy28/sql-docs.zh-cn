...
description: 了解如何在 SQL Server 中设计高效索引以实现良好的数据库和应用程序性能。 了解索引体系结构和最佳做法。
ms.custom: ''
ms.date: 01/19/2019
ms.prod: sql
...
[使用 SQL Server 2008 索引视图提高性能](/previous-versions/sql/sql-server-2008/dd171921(v=sql.100))  
