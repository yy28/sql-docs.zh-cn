# [概述](system-functions-for-transact-sql.md)  
# [Always On 可用性组](always-on-availability-groups-functions-transact-sql.md)  
...
# [变更数据捕获](change-data-capture-functions-transact-sql.md)  
...
# [更改跟踪](change-tracking-functions-transact-sql.md)  
...
## [与 CHANGE_TRACKING_CONTEXT](with-change-tracking-context-transact-sql.md)  
# [数据收集器](data-collector-functions-transact-sql.md)  
...
## [路径名](pathname-transact-sql.md)  
# [托管备份](managed-backup-functions-transact-sql.md)  
...
# [全文搜索和语义搜索](full-text-search-and-semantic-search-functions-transact-sql.md)  
...
# [系统元数据](system-metadata-functions.md)  
...
# [系统安全](system-security-functions.md)  
...
# [系统跟踪](system-trace-functions.md)  
