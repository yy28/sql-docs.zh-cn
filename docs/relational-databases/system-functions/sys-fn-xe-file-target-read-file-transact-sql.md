...
## <a name="remarks"></a>备注  
 通过在中[!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]执行**fn_xe_file_target_read_file**读取大型结果集可能会导致错误。 使用 "**结果**" 设置为 "文件模式" （**Ctrl + Shift + F**），将较大的结果集导出到文件中，并改为使用其他工具读取文件。  
