---
title: Alwayson 可用性组函数 (Transact SQL) |Microsoft 文档
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
...
ms.locfileid: "33223752"
---
# <a name="always-on-availability-groups-functions-transact-sql"></a>Alwayson 可用性组函数 (TRANSACT-SQL)
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 提供了以下的 Alwayson 可用性组函数。  
