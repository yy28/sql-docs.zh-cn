---
title: 数据收集器函数 (Transact SQL) |Microsoft Docs
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
...
## <a name="see-also"></a>请参阅  
 ...
 [管理数据仓库存储的过程&#40;Transact SQL&#41;](../../relational-databases/system-stored-procedures/management-data-warehouse-stored-procedures-transact-sql.md)  
