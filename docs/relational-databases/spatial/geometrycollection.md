...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]GeometryCollection 是零个或更多个 geometry 或 geography 实例的集合。 **GeometryCollection** 可以为空。  
