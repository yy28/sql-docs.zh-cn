...
---
# <a name="point"></a>点
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]在 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 空间数据中，Point 是表示单个位置的 0 维对象，可能包含 Z（仰角）和 M（度量）值。  
