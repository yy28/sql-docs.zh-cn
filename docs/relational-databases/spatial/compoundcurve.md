...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] CompoundCurve 是几何图形或地域类型的零个或多个连续 CircularString 或 LineString 实例的集合。  
  
> [!IMPORTANT]  
>  有关此发行版中新的空间功能的详细说明和示例（包括 **CompoundCurve** 子类型），请下载白皮书 [SQL Server 2012 中的新空间功能](http://go.microsoft.com/fwlink/?LinkId=226407)。  
