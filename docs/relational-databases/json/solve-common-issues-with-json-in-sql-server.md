---
title: "关于 SQL Server 中 JSON 的常见问题解答 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "07/07/2016"
...
### 使用 WITHOUT_ARRAY_WRAPPER 子句生成的 JSON 在 FOR JSON 输出中被转义  
...
### 使用 OPENJSON 从 JSON 文本中返回嵌套的 JSON 子对象  
...
### 使用 OPENJSON 而不是 JSON_VALUE 返回长文本值  
...
### 使用 OPENJSON 而不是 JSON_VALUE 处理重复键  
