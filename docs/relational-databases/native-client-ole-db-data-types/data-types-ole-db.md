---
title: 数据类型（Native Client OLE DB 提供程序） |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "87245882"
---
# <a name="sql-server-native-client-data-types-ole-db"></a>SQL Server Native Client 数据类型（OLE DB）
