---
title: 程序集（数据库引擎） |微软文档
description: SQL Server 实例可以承载以 CLR 语言编写的函数、过程、触发器和用户定义的聚合和类型的程序集。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
 ...
 程序集[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]是在 实例中使用的 DLL 文件，用于部署函数、存储过程、触发器、用户定义的聚合和用户定义的类型，这些类型是使用[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)]通用语言运行时 （CLR） 托管的托管代码语言之一编写的，而不是在[!INCLUDE[tsql](../../includes/tsql-md.md)]中。  
...
-   CLR 函数。 有关详细信息，请参阅创建[CLR 函数](../../relational-databases/user-defined-functions/create-clr-functions.md)。  
  
-   CLR 存储过程。 有关详细信息，请参阅[CLR 存储过程](https://msdn.microsoft.com/library/bbdd51b2-a9b4-4916-ba6f-7957ac6c3f33)。  
  
-   CLR 触发器。 有关详细信息，请参阅创建[CLR 触发器](../../relational-databases/triggers/create-clr-triggers.md)。  
  
-   用户定义聚合函数。 有关详细信息，请参阅[创建用户定义的聚合](../../relational-databases/user-defined-functions/create-user-defined-aggregates.md)。  
