...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]本主题提供有关可以用来监视和解决托管的数据库对象和在运行的程序集的工具的信息[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。  
