...
description: 承载 CLR Microsoft SQL Server 称为 CLR 集成。 在托管代码中创作可以提高性能。 SQL Server 使用 CAS 来帮助保护托管代码。
ms.custom: ''
ms.date: 04/19/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="see-also"></a>另请参阅  
 ...
 [CLR 集成的体系结构](./clr-integration-architecture-clr-hosted-environment.md)   
