...
# 技术参考（数据库引擎）
 ...
 ![小文件夹图标](../analysis-services/media/filefolder-small.png "小文件夹图标") **功能参考**  
 ...
 ![小文件夹图标](../analysis-services/media/filefolder-small.png "小文件夹图标") **命令提示实用工具参考**  
 ...
 ![小文件夹图标](../analysis-services/media/filefolder-small.png "小文件夹图标") **数据库引擎 PowerShell Cmdlet**  
 ...
 ![小文件夹图标](../analysis-services/media/filefolder-small.png "小文件夹图标") **错误和事件参考**  
 [数据库引擎错事件和错误](../relational-databases/errors-events/database-engine-events-and-errors.md)  
  
 ![小文件夹图标](../analysis-services/media/filefolder-small.png "小文件夹图标") **Showplan 逻辑运算符和物理运算符参考**  
