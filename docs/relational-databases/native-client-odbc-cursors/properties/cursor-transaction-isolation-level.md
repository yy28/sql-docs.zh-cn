...
-   快照 (SQL_TXN_SS_SNAPSHOT)  
 ...
 请注意，ODBC API 指定其他事务隔离级别，但 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 或 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client ODBC 驱动程序不支持这些级别。  
