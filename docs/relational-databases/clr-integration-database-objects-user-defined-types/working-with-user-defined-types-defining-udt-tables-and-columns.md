...
ms.locfileid: "85727772"
---
# <a name="working-with-user-defined-types---defining-udt-tables-and-columns"></a>使用用户定义类型 - 定义 UDT 表和列
 [!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]
  一旦包含用户定义类型（UDT）定义的程序集已在数据库中注册 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ，它就可以在列定义中使用。 有关详细信息，请参阅 [CREATE TYPE (Transact-SQL)](../../t-sql/statements/create-type-transact-sql.md)。  
