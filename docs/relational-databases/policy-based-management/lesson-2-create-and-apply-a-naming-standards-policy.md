...
## <a name="next"></a>Next  
现已学完了本教程。 若要返回到开始位置，请访问[教程：使用基于策略的管理来管理服务器](../../relational-databases/policy-based-management/tutorial-administering-servers-by-using-policy-based-management.md)。  
