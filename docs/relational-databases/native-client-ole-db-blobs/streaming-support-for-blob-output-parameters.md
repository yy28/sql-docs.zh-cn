---
description: SQL Server Native Client 中的 BLOB 输出参数的流支持
title: " (Native Client OLE DB 提供程序的 BLOB 输出参数的流支持) "
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "88455849"
---
# <a name="streaming-support-for-blob-output-parameters-in-sql-server-native-client"></a>SQL Server Native Client 中的 BLOB 输出参数的流支持
[!INCLUDE[SQL Server Azure SQL Database Synapse Analytics PDW ](../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]

  本主题包含一个示例，显示针对 BLOB 输出参数的流支持，它将 BLOB 输出参数绑定为 ISequentialStreams。  
  
 可以在 IMultipleResults::GetResult 中锁定输出参数，并且接收 DB_E_OBJECTOPEN 返回值。 调用方应检查是否存在挂起的 blob 参数，并且完全读取它们或释放它们。  
