---
description: 在 SQL Server Native Client 中设置大型数据
title: " (Native Client OLE DB 提供程序设置大型数据) "
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88328323"
---
# <a name="setting-large-data-in-sql-server-native-client"></a>在 SQL Server Native Client 中设置大型数据
