---
title: "查看信息并执行与订阅相关联的代理任务（复制监视器） | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
### 查看信息并执行与订阅相关联的代理任务（“所有订阅”选项卡）  
  
1.  在左窗格中展开发布服务器组，再展开其中的一个发布服务器，然后单击其中的一个发布。  
  
2.  单击 **“所有订阅”** 选项卡以查看有关订阅的信息。 您还可以通过此选项卡访问更详细的信息并执行任务：  
  
    -   要查看有关与订阅关联的代理的详细的信息，请右键单击该订阅，然后单击 **查看详细信息**。 详细信息包括：代理历史记录和错误消息；事务复制的性能统计信息；合并复制的项目级同步统计信息。  
    ...
    -   要验证单个合并订阅，请右键单击该订阅，然后单击 **验证单个订阅**。 要验证对合并发布的所有订阅，请右键单击的发布，然后单击 **都验证所有订阅**; 若要将都验证事务发布的所有订阅，请在发布中，右键单击，然后单击 **都都验证多个订阅**。  
