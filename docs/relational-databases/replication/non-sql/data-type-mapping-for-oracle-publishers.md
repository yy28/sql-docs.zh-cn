...
### 大型对象类型  
 ...
 有关大型对象类型的详细信息，请参阅"大型对象注意事项"部分中 [设计注意事项和限制为 Oracle 发布服务器](../../../relational-databases/replication/non-sql/design-considerations-and-limitations-for-oracle-publishers.md)。  
