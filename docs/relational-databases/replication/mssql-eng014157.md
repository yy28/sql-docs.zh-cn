...
-   有关创建订阅的信息，请参阅 [订阅的发布](../../relational-databases/replication/subscribe-to-publications.md)。  
  
-   有关初始化订阅的信息，请参阅 [初始化的订阅](../../relational-databases/replication/initialize-a-subscription.md)。  
