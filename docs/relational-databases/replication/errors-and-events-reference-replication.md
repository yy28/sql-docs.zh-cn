...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]本部分文档包含与复制相关的多个错误的原因和解决方法的信息。  
...
|[MSSQL_ENG014157](../../relational-databases/replication/mssql-eng014157.md)|由发布 '%s' 的订阅服务器 '%s' 创建的订阅已过期，且已停止。|  
