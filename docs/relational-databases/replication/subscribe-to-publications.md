...
helpviewer_keywords: 
  - "订阅 [SQL Server 复制], 关于订阅"
  - "请求订阅 [SQL Server 复制]"
  - "订阅 [SQL Server 复制]"
  - "推送订阅 [SQL Server 复制], 关于推送订阅"
  - "合并复制订阅 [SQL Server 复制]"
  - "合并复制订阅 [SQL Server 复制], 关于订阅"
  - "发布 [SQL Server 复制], 订阅"
  - "推送订阅 [SQL Server 复制]"
  - "请求订阅 [SQL Server 复制], 关于请求订阅"
  - "快照复制 [SQL Server], 订阅"
  - "事务复制, 订阅"
...
## 非 SQL Server 订阅服务器  
 Oracle 和 IBM DB2 可以使用推送订阅来订阅快照和事务发布。 有关详细信息，请参阅 [非 SQL Server 订阅服务器](../../relational-databases/replication/non-sql/non-sql-server-subscribers.md)。  
 ...
 **删除推送订阅**  
 ...
 [!包括 [ssManStudioFull] (.../ Token/ssManStudioFull_md.md)]: [Delete a Push Subscription](../../relational-databases/replication/delete-a-push-subscription.md)  
 ...
 **创建请求订阅**  
 ...
 [!包括 [ssManStudioFull] (.../ Token/ssManStudioFull_md.md)]: [Create a Pull Subscription](../../relational-databases/replication/create-a-pull-subscription.md)  
