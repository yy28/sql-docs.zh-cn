...
# <a name="technical-reference-replication"></a>技术参考（复制）
 ...
 ![小文件文件夹图标](../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **错误和事件**  
 [错误和事件参考（复制）](../../relational-databases/replication/errors-and-events-reference-replication.md)  
  
 ![小文件文件夹图标](../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **功能参考**  
 ...
 [更多信息...](../../relational-databases/replication/properties-reference-replication.md)  
  
 ![小文件文件夹图标](../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **复制代理**  
 [Replication Snapshot Agent](../../relational-databases/replication/agents/replication-snapshot-agent.md)  
  
 [Replication Distribution Agent](../../relational-databases/replication/agents/replication-distribution-agent.md)  
  
 [更多信息...](../../relational-databases/replication/agents/replication-agents.md)  
  
 ![小文件文件夹图标](../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **复制存储过程**  
 ...
 [更多信息...](../../relational-databases/system-stored-procedures/replication-stored-procedures-transact-sql.md)  
  
 ![小文件文件夹图标](../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **复制表**  
 ...
 [更多信息...](../../relational-databases/system-tables/replication-tables-transact-sql.md)  
  
 ![小文件文件夹图标](../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **复制视图**  
 ...
 [更多信息...](../../relational-databases/system-views/replication-views-transact-sql.md)  
  
 ![小文件文件夹图标](../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **复制类库**  
