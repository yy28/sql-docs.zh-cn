---
title: 启用通过备份初始化（事务）
description: 了解如何在 SQL Server 中为事务发布启用从备份初始化。
...
-   在“发布属性 - \<Publication>”对话框的“订阅选项”页中启用发布。  有关访问此对话框的详细信息，请参阅 [View and Modify Publication Properties](../../relational-databases/replication/publish/view-and-modify-publication-properties.md)。  
