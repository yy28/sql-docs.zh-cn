...
## <a name="additional-resources"></a>其他资源
 ...
 [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 中为实现向后兼容性而保留，但在 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的将来版本中将删除的复制功能。  
