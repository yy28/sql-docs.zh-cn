...
-   复制监视器的左窗格用于监视发布服务器和发布服务器组。 将一个或多个发布服务器添加到复制监视器，可以显示发布和订阅信息。 有关详细信息，请参阅 [从复制监视器中添加和删除发布服务器](../../relational-databases/replication/monitor/add-and-remove-publishers-from-replication-monitor.md)。  
