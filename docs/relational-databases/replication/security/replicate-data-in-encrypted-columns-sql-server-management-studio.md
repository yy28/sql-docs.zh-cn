...
---
# 复制加密列中的数据 (SQL Server Management Studio)
...
8.  在订阅服务器上，执行 [CREATE SYMMETRIC KEY](../../../t-sql/statements/create-symmetric-key-transact-sql.md) 的 ALGORITHM、 KEY_SOURCE 和 IDENTITY_VALUE 使用相同的值，如步骤 1 中所示。 您可以为 ENCRYPTION BY 指定不同的值。  
