---
title: CLR 用户定义的聚合 |微软文档
description: SQL Server CLR 集成允许您在托管代码中创建自定义聚合函数，这些函数对一组值执行计算并返回值。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
