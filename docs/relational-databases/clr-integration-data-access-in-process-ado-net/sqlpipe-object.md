...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]在以前版本的[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]，是很常见，它将结果或输出参数发送到调用的客户端编写存储的过程 （或扩展存储的过程）。  
