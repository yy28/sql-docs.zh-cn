...
---
# 删除统计信息
  你可以通过使用 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]，删除 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 中表和视图中的统计信息，或 [!INCLUDE[tsql](../../includes/tsql-md.md)]  
