...
>  [!INCLUDE[ssNoteDepFutureDontUse](../../includes/ssnotedepfuturedontuse-md.md)]请改用 CLR 集成。  
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 身份验证用户的 [!INCLUDE[msCoName](../../includes/msconame-md.md)] 可以通过运行**sp_helpextendedproc**系统过程来显示当前定义的扩展存储过程和每个存储过程所属的 DLL 的名称。 例如，下面的示例返回**xp_hello**所属的 DLL：  
