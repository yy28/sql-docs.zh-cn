...
## <a name="in-this-section"></a>本节内容  
 ...
 [增强的日期和时间类型与以前的 SQL Server 版本的行为&#40;ODBC&#41;](../../relational-databases/native-client-odbc-date-time/enhanced-date-and-time-type-behavior-with-previous-sql-server-versions-odbc.md)  
