---
title: 增强的日期和时间功能的 ODBC API 支持 |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "37429666"
---
# <a name="odbc-api-support-for-enhanced-date-and-time-features"></a>增强的日期和时间功能的 ODBC API 支持
