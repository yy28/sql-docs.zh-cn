...
ms.locfileid: "73763182"
---
# <a name="icommandwithparameters"></a>ICommandWithParameters
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  从 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 开始的数据库引擎中的改进允许 ICommandWithParameters：： GetParameterInfo 获取预期结果的更准确说明。 更准确的结果可能与 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]早期版本中的 CommandWithParameters：： GetParameterInfo 返回的值不同。 有关详细信息，请参阅[元数据发现](../../relational-databases/native-client/features/metadata-discovery.md)。  
