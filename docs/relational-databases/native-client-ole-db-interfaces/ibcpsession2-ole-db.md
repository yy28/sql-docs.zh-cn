...
ms.locfileid: "68091423"
---
# <a name="ibcpsession2-ole-db"></a>IBCPSession2 (OLE DB)
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]

  IBCPSession2 接口是 IBCPSession 提供了成员函数，是为每个列调用 ibcpsession:: Bcpcolfmt 的替代方法的扩展。  IBCPSession2 IBCPSession 继承，并添加了一个新方法：[IBCPSession2::BCPSetBulkMode](../../relational-databases/native-client-ole-db-interfaces/ibcpsession2-bcpsetbulkmode.md)。  
