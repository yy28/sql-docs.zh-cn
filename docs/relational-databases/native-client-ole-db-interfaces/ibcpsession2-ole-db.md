...
ms.locfileid: "73789488"
---
# <a name="ibcpsession2-ole-db"></a>IBCPSession2 (OLE DB)
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  IBCPSession2 接口是 IBCPSession 的扩展，它提供了成员函数，该函数是一种为每个列调用 IBCPSession：： BCPColFmt 的替代方法。  IBCPSession2 继承自 IBCPSession，并添加了一个新方法： [IBCPSession2：： BCPSetBulkMode](../../relational-databases/native-client-ole-db-interfaces/ibcpsession2-bcpsetbulkmode.md)。  
