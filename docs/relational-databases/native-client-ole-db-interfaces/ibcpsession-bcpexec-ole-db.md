...
## <a name="remarks"></a>备注  
 BCPExec 方法将数据从用户文件复制到数据库表或执行相反的操作，具体取决于与 **IBCPSession::BCPInit** 方法一起使用的 eDirection 参数的值**[](../../relational-databases/native-client-ole-db-interfaces/ibcpsession-bcpinit-ole-db.md)。  
