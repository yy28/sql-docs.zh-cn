...
|[ISSCommandWithParameters：： SetParameterProperties &#40;OLE DB&#41;](../../relational-databases/native-client-ole-db-interfaces/isscommandwithparameters-setparameterproperties-ole-db.md)|按参数为每个参数设置参数属性，或者通过指定**SSPARAMPROPS**结构数组来设置大容量参数属性。|  
