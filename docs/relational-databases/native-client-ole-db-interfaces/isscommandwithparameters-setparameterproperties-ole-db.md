...
ms.locfileid: "87246861"
---
# <a name="isscommandwithparameterssetparameterproperties-in-sql-server-native-client-ole-db"></a>SQL Server Native Client （OLE DB）中的 ISSCommandWithParameters：： SetParameterProperties
