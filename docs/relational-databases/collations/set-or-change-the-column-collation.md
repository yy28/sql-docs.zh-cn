...
-   [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]实例时都提供 SQL Server 登录名。 有关详细信息，请参阅 [Collation and Unicode Support](../../relational-databases/collations/collation-and-unicode-support.md)。  
