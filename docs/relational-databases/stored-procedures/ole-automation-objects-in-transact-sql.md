...
ms.topic: "article"
helpviewer_keywords: 
  - "触发器 [SQL Server], OLE 自动化"
  - "批次 [SQL Server], OLE 自动化"
  - "OLE 自动化 [SQL Server]"
  - "OLE 自动化 [SQL Server], 关于 OLE 自动化"
