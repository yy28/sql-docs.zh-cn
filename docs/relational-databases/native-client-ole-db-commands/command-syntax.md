...
```  
 ...
 当指定为命令的文本时，[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供程序成功地处理一种语句形式。  
  
## <a name="stored-procedures"></a>存储过程  
 使用 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供程序命令执行 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 存储过程时，请在命令文本中使用 ODBC CALL 转义序列。 然后，[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供程序将使用 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的远程过程调用机制优化命令处理。 例如，以下 ODBC SQL 语句是比 [!INCLUDE[tsql](../../includes/tsql-md.md)] 形式更常使用的命令文本：  
