...
description: FileTable 功能使用目录结构来存储文件。 了解如何使用其目录、路径、限制和语义。
ms.custom: ''
ms.date: 08/26/2016
ms.prod: sql
...
|为得到这一结果|使用此函数|  
|------------------------|-----------------------|  
|获取特定 FileTable 或当前数据库的根级 UNC 路径。|[FileTableRootPath (Transact-SQL)](../../relational-databases/system-functions/filetablerootpath-transact-sql.md)|  
