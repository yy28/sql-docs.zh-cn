...
description: 探索可用于管理 FileTable 的常见管理任务，并了解 FileTable 的安全性、备份和审核。
ms.custom: ''
ms.date: 08/23/2017
ms.prod: sql
...
ms.locfileid: "85631264"
---
# <a name="manage-filetables"></a>管理 FileTable
 [!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]
  说明用于管理 FileTable 的常见管理任务。  
  
##  <a name="how-to-get-a-list-of-filetables-and-related-objects"></a><a name="HowToEnumerate"></a> 如何：获取 FileTable 和相关对象的列表  
...
###  <a name="how-to-disable-and-re-enable-non-transactional-access-at-the-database-level"></a><a name="HowToDisable"></a> 如何：禁用和重新启用数据库级别的非事务性访问权限  
...
###  <a name="how-to-ensure-the-visibility-of-the-filetables-in-a-database"></a><a name="visible"></a> 如何：确保数据库中的 FileTable 的可见性  
...
###  <a name="how-to-disable-and-re-enable-the-filetable-namespace-at-the-table-level"></a><a name="HowToEnableNS"></a> 如何：禁用和重新启用表级别的 FileTable 命名空间  
...
###  <a name="how-to-get-a-list-of-open-file-handles-associated-with-a-filetable"></a><a name="HowToListOpen"></a> 如何：获取与 FileTable 关联的打开的文件句柄的列表  
...
###  <a name="how-to-kill-open-file-handles-associated-with-a-filetable"></a><a name="HowToKill"></a> 如何：终止与 FileTable 关联的打开的文件句柄  
...
###  <a name="how-to-identify-the-locks-held-by-filetables"></a><a name="HowToIdentifyLocks"></a> 如何：确定 FileTable 持有的锁  
