...
|**file_guid**|**uniqueidentifier**|文件的 GUID。<br /><br /> NULL = 从 @no__t 的早期版本升级了数据库（对 SQL Server 2005 及更早版本有效）。|  
