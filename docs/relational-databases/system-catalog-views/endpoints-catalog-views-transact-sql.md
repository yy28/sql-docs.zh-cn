---
description: 端点目录视图 (Transact-SQL)
title: 终结点目录视图 (Transact-sql) |Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
ms.locfileid: "89545138"
---
# <a name="endpoints-catalog-views-transact-sql"></a>端点目录视图 (Transact-SQL)
