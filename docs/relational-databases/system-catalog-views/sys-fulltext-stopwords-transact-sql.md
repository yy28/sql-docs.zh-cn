...
|**language**|**sysname**|是中的别名值[sys.fulltext_languages](../../relational-databases/system-catalog-views/sys-fulltext-languages-transact-sql.md)对应于区域设置标识符的值 (**LCID**)，或数值 LCID 的字符串表示形式。|  
