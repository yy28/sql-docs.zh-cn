---
description: 对象目录视图 (Transact-SQL)
title: " (Transact-sql) 的对象目录视图 |Microsoft Docs"
ms.custom: ''
ms.date: 01/19/2019
ms.prod: sql
...
## <a name="see-also"></a>另请参阅  
 [系统目录视图](catalog-views-transact-sql.md)[系统视图 &#40;transact-sql&#41;](../../t-sql/language-reference.md)  
