...
|列名称|数据类型|说明|  
|-----------------|---------------|-----------------|  
|**路径名**|**sysname**|证书的名称。 在该数据库中是唯一的。|  
|**certificate_id**|**整形**|证书的 ID。 在该数据库中是唯一的。|  
|**principal_id**|**整形**|拥有此证书的数据库主体的 ID。|  
...
|**expiry_date**|**型**|证书的过期时间。|  
|**start_date**|**型**|证书生效的时间。|  
|**指纹**|**varbinary （32）**|证书的 SHA-1 哈希。 SHA-1 哈希在全局内唯一。|  
|**attested_by**|**nvarchar(260)**|仅供系统使用。|  
|**pvt_key_last_backup_date**|**型**|上次导出证书的私钥的日期和时间。|  
...
## <a name="see-also"></a>另请参阅  
 ...
 [&#40;Transact-sql&#41;创建证书](../../t-sql/statements/create-certificate-transact-sql.md)  
