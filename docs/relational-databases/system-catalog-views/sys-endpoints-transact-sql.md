...
|列名|数据类型|描述|  
|-----------------|---------------|-----------------|  
|**name**|**sysname**|终结点的名称。 中是唯一的服务器。 不可为 null。|  
...
|**protocol_desc**|**nvarchar(60)**|端点协议的说明。 可以为 NULL。 以下值之一：<br /><br /> **HTTP**<br /><br /> **TCP**<br /><br /> **NAMED_PIPES**<br /><br /> **SHARED_MEMORY**<br /><br /> **通过**注意：不推荐使用 VIA 协议。 [!INCLUDE[ssNoteDepFutureAvoid](../../includes/ssnotedepfutureavoid-md.md)]|  
