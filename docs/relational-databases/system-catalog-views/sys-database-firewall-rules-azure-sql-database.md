...
## <a name="remarks"></a>备注  
 若要返回有关与 Microsoft Azure SQL 数据库关联的服务器级防火墙设置的信息, 请使用[firewall_rules (AZURE SQL 数据库)](../../relational-databases/system-catalog-views/sys-firewall-rules-azure-sql-database.md)。  
