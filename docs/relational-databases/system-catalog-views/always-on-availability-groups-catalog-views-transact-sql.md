---
title: Alwayson 可用性组目录视图 (Transact SQL) |Microsoft 文档
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "33177683"
---
# <a name="always-on-availability-groups-catalog-views-transact-sql"></a>Alwayson 可用性组目录视图 (Transact SQL)
...
> [!NOTE]  
>  有关联接的可用性数据库的信息，请参阅**replica_id**和**group_database_id**中的列[sys.databases (TRANSACT-SQL);](../../relational-databases/system-catalog-views/sys-databases-transact-sql.md)。  
