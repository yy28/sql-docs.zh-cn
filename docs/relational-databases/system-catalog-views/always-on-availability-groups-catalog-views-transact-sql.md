...
> [!NOTE]  
>  有关联接的可用性数据库的信息，请参阅**replica_id**并**group_database_id**中的列[sys.databases (Transact SQL);](../../relational-databases/system-catalog-views/sys-databases-transact-sql.md)。  
