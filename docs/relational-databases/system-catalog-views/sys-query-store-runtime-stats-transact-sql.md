...
|**avg_rowcount**|**float**|聚合间隔内查询计划的返回行的平均数目。<br/>**注意：** [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] 将始终返回零 (0) 。|
