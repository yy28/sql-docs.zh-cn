---
title: sys.soap_endpoints (Transact SQL) |Microsoft 文档
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
 ...
 携带 SOAP 类型负载的服务器中的每个端点在该表中对应一行。 此视图中每一行，存在不具有相同的相应行**endpoint_id**中**sys.http_endpoints**目录执行 HTTP 配置元数据的视图。  
  
 
|列名|数据类型|Description|  
|-----------------|---------------|-----------------|  
|**< 继承的列 >**||该视图继承的列的列表，请参阅[sys.endpoints &#40;TRANSACT-SQL&#41;](../../relational-databases/system-catalog-views/sys-endpoints-transact-sql.md)。|  
...
|**default_namespace**|**nvarchar(384)**|指定命名空间中的默认命名空间 = 选项，或http://tempuri.org如果改为指定默认值。|  
