---
title: sys.database_mirroring_witnesses (TRANSACT-SQL) |Microsoft 文档
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
  ...
  在数据库镜像会话中，执行自动故障转移需要使用见证服务器。 理想状况是，见证服务器驻留在与主体服务器和镜像服务器分离的单独的计算机上。 见证服务器不为数据库提供服务。 相反，它会监视主体服务器和镜像服务器的状态。 如果主体服务器发生故障，则见证服务器可启动自动故障转移到见证服务器。 
...
|**safety_sequence_number**|**int**|更新的更改的序列号**safety_level**。|  
...
|**is_suspended_sequence_number**|**int**|序列号设置**is_suspended**。|  
