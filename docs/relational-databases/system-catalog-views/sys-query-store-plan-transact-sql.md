...
|**is_online_index_plan**|**小段**|在联机索引生成过程中使用了 Plan。 <br/>**注意：** Azure SQL 数据仓库将始终返回零（0）。|  
|**is_trivial_plan**|**小段**|计划是一个简单的计划（查询优化器的阶段0中的输出）。 <br/>**注意：** Azure SQL 数据仓库将始终返回零（0）。|  
|**is_parallel_plan**|**小段**|计划是并行的。 <br/>**注意：** Azure SQL 数据仓库将始终返回一（1）。|  
...
|**plan_forcing_type**|**整形**|计划强制类型。<br /><br />0：无<br /><br />1：手动<br /><br />2：自动|  
