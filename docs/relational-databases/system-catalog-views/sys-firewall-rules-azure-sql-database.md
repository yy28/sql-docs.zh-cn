---
title: firewall_rules (Azure SQL 数据库) |Microsoft Docs
ms.date: 03/26/2019
ms.prod: sql
...
## <a name="remarks"></a>备注
 ...
 若要返回有关与 Microsoft Azure SQL 数据库关联的数据库级防火墙设置的信息, 请使用[database_firewall_rules &#40;Azure SQL 数据库&#41;](../../relational-databases/system-catalog-views/sys-database-firewall-rules-azure-sql-database.md)。  
