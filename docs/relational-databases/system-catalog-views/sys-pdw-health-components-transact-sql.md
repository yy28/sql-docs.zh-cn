...
|group_id|**整形**|此组件所属的逻辑组件组。 请参阅[sys.databases pdw_health_components （并行数据仓库）](../../relational-databases/system-catalog-views/sys-pdw-health-components-transact-sql.md)。|NOT NULL|  
|component_name|**nvarchar(255)**|组件名称。|NOT NULL|  
