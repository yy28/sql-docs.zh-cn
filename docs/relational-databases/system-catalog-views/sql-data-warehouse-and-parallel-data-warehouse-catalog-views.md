---
description: Azure Synapse Analytics 和并行数据仓库目录视图
title: 目录视图
...
ms.locfileid: "92059575"
---
# <a name="azure-synapse-analytics-and-parallel-data-warehouse-catalog-views"></a>Azure Synapse Analytics 和并行数据仓库目录视图
...
## <a name="sssdw-catalog-views"></a>[!INCLUDE[ssSDW](../../includes/sssdw-md.md)] 目录视图
 ...
 [sys.pdw_materialized_view_mappings &#40;transact-sql&#41;](./sys-pdw-materialized-view-mappings-transact-sql.md?view=azure-sqldw-latest) (预览) 
