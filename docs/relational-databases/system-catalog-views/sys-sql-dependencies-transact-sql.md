...
|**referenced_minor_id**|**int**|被引用实体的 Minor-ID，由类的值解释，如下所示：<br /><br /> 当 class =:<br /><br /> 0， **referenced_minor_id**为列 ID; 或者如果不是列，则为 0。<br /><br /> 1， **referenced_minor_id**为列 ID; 或者如果不是列，则为 0。<br /><br /> 否则为**referenced_minor_id** = 0。|  
