 ...
 **注意：** 如果通过 Windows 防火墙将需要确保已正确配置您的计算机进行连接。 请参阅"通过 Windows 防火墙连接"文章中的 Windows Management Instrumentation 文档[!INCLUDE[msCoName](../../includes/msconame-md.md)]MSDN[网站](https://go.microsoft.com/fwlink/?linkid=15426)。  
