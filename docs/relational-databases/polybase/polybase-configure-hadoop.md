...
> [!NOTE]
> 从 SQL Server 2016 SP1 CU7 和 SQL Server 2017 CU3 开始，PolyBase 支持 Hadoop 加密区域。 如果使用 [PolyBase 横向扩展组](polybase-scale-out-groups.md)，所有计算节点还必须位于包含对 Hadoop 加密区域的支持的内部版本上。
