...
###  <a name="bkmk_CreateResourcePool"></a> 创建一个资源池并配置内存  
 ...
 有关在虚拟机环境下工作时的详细信息，请参阅[最佳做法：在虚拟机环境中使用内存中 OLTP](../Topic/Using%20In-Memory%20OLTP%20in%20a%20VM%20Environment.md)。  
