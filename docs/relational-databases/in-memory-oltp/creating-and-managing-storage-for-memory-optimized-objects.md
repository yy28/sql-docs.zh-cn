---
title: 创建和管理存储 - 内存优化对象
description: 了解内存优化表和基于磁盘的表的属性。 使用这些资源来创建和管理内存优化对象的存储。
...
-   [为内存优化表配置存储](../../relational-databases/in-memory-oltp/configuring-storage-for-memory-optimized-tables.md)  
