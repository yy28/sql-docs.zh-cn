---
title: "对内存中 OLTP 的 Transact-SQL 支持 | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
-   [ALTER DATABASE 文件和文件组选项 (Transact-SQL)](../Topic/ALTER%20DATABASE%20File%20and%20Filegroup%20Options%20\(Transact-SQL\).md)（已添加 **MEMORY_OPTIMIZED_DATA**）  
