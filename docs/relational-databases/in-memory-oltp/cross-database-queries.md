...
1. 创建测试对象。  在 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 中执行以下 [!INCLUDE[tsql](../../includes/tsql-md.md)]。  
...
2.  尝试跨数据库查询。 在 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 中执行以下 [!INCLUDE[tsql](../../includes/tsql-md.md)]。
...
3.  创建内存优化表类型。  在 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 中执行以下 [!INCLUDE[tsql](../../includes/tsql-md.md)]。
