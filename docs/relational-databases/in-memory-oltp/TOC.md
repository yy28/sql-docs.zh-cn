...
# [本机过程中的 ATOMIC 块](本机过程中的-atomic-块.md)
...
# [快速入门 1：可提高 Transact SQL 性能的内存中 OLTP 技术](quick-start-1-in-memory-oltp-technologies-for-faster-transact-sql-performance.md)
