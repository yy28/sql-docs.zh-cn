...
![多版本控制。](../../relational-databases/in-memory-oltp/media/hekaton-tables-1.png "多版本控制。")  
...
##  <a name="a-namerlsa-row-level-security-in-memory-optimized-tables"></a><a name="rls"></a>内存优化表中的行级安全性  
