...
-   [通过本机编译的存储过程创建和访问 TempDB 中的表](../../relational-databases/in-memory-oltp/create-and-access-tables-in-tempdb-from-stored-procedures.md)  
  
-   [在本机编译模块中模拟 IF-WHILE EXISTS 语句](../../relational-databases/in-memory-oltp/simulating-an-if-while-exists-statement-in-a-natively-compiled-module.md)  
...
-   [实现包含 FROM 或子查询的 UPDATE](../../relational-databases/in-memory-oltp/implementing-update-with-from-or-subqueries.md)  
  
-   [实现外部联接](../../relational-databases/in-memory-oltp/implementing-an-outer-join.md)  
