...
- 报表查询，通常使用本机编译的存储过程中不可用的构造（如 *window* 函数，有时称为 [OVER](../Topic/OVER%20Clause%20\(Transact-SQL\).md) 函数）。  
...
有关表提示的详细信息，请参阅。 [表提示 (Transact-SQL)](../Topic/Table%20Hints%20\(Transact-SQL\).md)。 添加了 SNAPSHOT 以支持 [!INCLUDE[hek_2](../../includes/hek-2-md.md)]。  
...
- 将数据库选项 [MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT](../Topic/ALTER%20DATABASE%20SET%20Options%20\(Transact-SQL\).md) 设置为 ON。  
  
由在[自动提交模式](http://msdn.microsoft.com/zh-cn/c8de5b60-d147-492d-b601-2eeae8511d00)下运行的查询访问的内存优化表不需要隔离级别表提示。  
