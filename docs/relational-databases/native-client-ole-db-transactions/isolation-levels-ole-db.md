...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供程序默认自动提交模式 DBPROPSET_SESSION 属性 DBPROP_SESS_AUTOCOMMITISOLEVELS。  
  
     级别的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供程序默认值为 DBPROPVAL_TI_READCOMMITTED。  
