...
|**cntr_type**|**int**|Windows 性能体系结构定义的计数器类型。 请参阅[WMI 性能计数器类型](http://msdn2.microsoft.com/library/aa394569.aspx)MSDN 或 Windows Server 文档有关的性能计数器类型的详细信息上。|  
