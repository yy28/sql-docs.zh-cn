...
本主题列出了 [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] 和 [!INCLUDE[ssPDW](../../includes/sspdw-md.md)] 动态管理视图（Dmv）。  
 ...
 所有 [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] 和 [!INCLUDE[ssPDW](../../includes/sspdw-md.md)] Dmv 都以 **_pdw**开始。  
...
## <a name="sql-data-warehouse-dynamic-management-views"></a>SQL 数据仓库动态管理视图
...
[sys. dm _pdw_nodes_exec_sql &#40;&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-pdw-nodes-exec-sql-text-transact-sql.md)  
