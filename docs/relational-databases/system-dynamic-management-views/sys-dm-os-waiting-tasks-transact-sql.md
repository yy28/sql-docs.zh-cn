...
> [!NOTE]  
>  若要从[!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)]或[!INCLUDE[ssPDW](../../includes/sspdw-md.md)]调用此，请使用名称**dm_pdw_nodes_os_waiting_tasks**。  
...
## <a name="example"></a>示例
此示例将标识已阻止的会话。 在中[!INCLUDE[tsql](../../includes/tsql-md.md)] [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]执行查询。
