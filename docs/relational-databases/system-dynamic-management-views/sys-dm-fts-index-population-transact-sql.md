...
|**status**|**int**|**适用于**：[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 及更高版本。<br /><br /> 此填充的状态。 说明：某些状态是暂时的。 可以是以下类型之一：<br /><br /> 3 = 正在启动<br /><br /> 5 = 正常处理<br /><br /> 7 = 已停止处理<br /><br /> 例如，正在进行自动合并时将出现此状态。<br /><br /> 11 = 已中止填充<br /><br /> 12 = 处理语义相似性提取|  
