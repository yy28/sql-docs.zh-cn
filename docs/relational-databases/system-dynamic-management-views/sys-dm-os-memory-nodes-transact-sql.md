...
|**target_kb** |**bigint** |**适用于**:[!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)]通过[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]， [!INCLUDE[ssSDS_md](../../includes/sssds-md.md)]。<br /><br /> 指定内存节点中，内存目标 (KB) 中。 |   
