...
> [!NOTE]  
>  若要从 [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] 或 [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]中调用此名称，请使用名称**sys.databases. dm_pdw_nodes_db_file_space_usage**。  
  
|列名|数据类型|描述|  
|-----------------|---------------|-----------------|  
|database_id|**int**|数据库 ID。|  
|file_id|**int**|文件 ID。<br /><br /> file_id 映射到 sys.databases 中的 file_id [dm_io_virtual_file_stats](../../relational-databases/system-dynamic-management-views/sys-dm-io-virtual-file-stats-transact-sql.md)和[sys.sysfiles](../../relational-databases/system-compatibility-views/sys-sysfiles-transact-sql.md)中的 fileid。|  
|filegroup_id|**int**|**适用于**：[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 及更高版本。<br /><br /> 文件组 ID。|  
...
|modified_extent_page_count|**bigint**|**适用**于： [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] SP2 及更高版本。<br /><br />自上次完整数据库备份以来，在文件分配的范围内修改的总页数。 修改后的页计数可用于跟踪自上次完整备份以来数据库的差异变化量，以确定是否需要进行差异备份。|
...
## <a name="see-also"></a>另请参阅  
 ...
 [与数据库相关的&#40;&#41;动态管理视图 transact-sql](../../relational-databases/system-dynamic-management-views/database-related-dynamic-management-views-transact-sql.md)   
