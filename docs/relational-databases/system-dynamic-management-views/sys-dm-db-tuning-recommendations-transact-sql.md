...
| State | **nvarchar(4000)** | 描述的状态的建议的 JSON 文档。 将可使用以下字段：<br />-   `currentValue` -当前状态的建议。<br />-   `reason` – 介绍的推荐方法是在当前状态的原因的常量。|
...
你可以使用以下查询来获取[!INCLUDE[tsql](../../includes/tsql-md.md)]将解决此问题的脚本：  
