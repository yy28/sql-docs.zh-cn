...
|**session_id**|**int**|变更数据捕获日志扫描会话的 ID。 此列映射到**session_id**中的列[sys.dm_cdc_logscan_sessions](../../relational-databases/system-dynamic-management-views/change-data-capture-sys-dm-cdc-log-scan-sessions.md)。|  
|**session_phase**|**int**|指示出错时会话所处阶段的数字。 此列映射到**phase_number**中的列[sys.dm_cdc_errors](../../relational-databases/system-dynamic-management-views/change-data-capture-sys-dm-cdc-errors.md)。|  
