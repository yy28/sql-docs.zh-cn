---
title: 系统dm_resource_governor_external_resource_pool_affinity（转算-SQL） |微软文档
ms.custom: ''
ms.date: 11/13/2017
ms.prod: sql
ms.reviewer: ''
...
---
# <a name="sysdm_resource_governor_external_resource_pool_affinity-transact-sql"></a>系统dm_resource_governor_external_resource_pool_affinity（转算-SQL）
...
|processor_group|**小林特**|Windows 逻辑处理器组的 ID。 不可为 null。|
|cpu_mask|**比金特**|表示与此池关联的 CPU 的二进制掩码。 不可为 null。|
  
## <a name="remarks"></a>备注

创建具有 的关联池`AUTO`不会显示在此视图中，因为它们没有关联。 有关详细信息，请参阅[创建外部资源池&#40;处理-SQL&#41;](../../t-sql/statements/create-external-resource-pool-transact-sql.md)和[更改外部资源池&#40;处理-SQL&#41;](../../t-sql/statements/alter-external-resource-pool-transact-sql.md)语句。
