...
## <a name="arguments"></a>参数  
 db_id('*database_name*')  
 调用[db_id （)](../../t-sql/functions/db-id-transact-sql.md)函数。 此函数接受的数据库名称，并返回哪些 sys.dm_fts_index_keywords_by_property 用于查找指定的数据库的数据库 ID。 如果省略 database_name，则返回当前数据库 ID。  
