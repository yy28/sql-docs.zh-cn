 ...
 **end_of_log_lsn**， **last_hardened_lsn**，和**recovery_lsn**是刷新 Lsn。 例如， **last_hardened_lsn**指示越过已位于磁盘的块的下一个块的开头。  因此任何 LSN < 的值**last_hardened_lsn**磁盘上。  LSN，它是 > = 此值将不会刷新。  
