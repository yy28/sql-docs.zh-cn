...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  为参与 Always On 可用性组的每个数据库返回一行，该可用性组 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的本地实例为其承载可用性副本。 此动态管理视图公开与主副本和辅助副本有关的状态信息。 在辅助副本上，此视图为服务器实例上的每个辅助数据库都返回一行。 在主副本上，此视图为每个主数据库都返回一行，并且为相应的辅助数据库另外返回一行。  
...
|**is_primary_replica**|**bit**|如果副本是主要副本则返回 1；如果副本是辅助副本则返回 0。<br /><br />**适用于：** [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 及更高版本。|  
