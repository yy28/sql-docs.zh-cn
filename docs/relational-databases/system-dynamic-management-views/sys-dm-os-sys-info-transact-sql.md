...
|**sqlserver_start_time_ms_ticks**|**bigint**|表示上次**** 启动时[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]的 ms_tick 数字。 与当前 ms_ticks 列进行比较。 不可为 Null。|  
