---
title: "sys.dm_resource_governor_workload_groups (TRANSACT-SQL) |Microsoft 文档"
ms.custom: 
ms.date: 03/30/2016
...
> [!NOTE]  
>  若要从我们称之为[!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)]或[!INCLUDE[ssPDW](../../includes/sspdw-md.md)]，使用名称**sys.dm_pdw_nodes_resource_governor_workload_groups**。  
...
|max_request_cpu_time_ms|**bigint**|单个请求的最大 CPU 使用情况，以毫秒为单位。 不可为 null。<br /><br /> **注意：**这是测量的值，与 request_max_cpu_time_sec，这是可配置的设置。 有关详细信息，请参阅[CPU 阈值超出 Event Class](../../relational-databases/event-classes/cpu-threshold-exceeded-event-class.md)。|  
...
|importance|**sysname**|此工作负荷组中请求的相对重要性的当前配置值。 重要性是以下项之一，使用介质正在默认值： 低、 中或高。<br /><br /> 不可为 null。|  
