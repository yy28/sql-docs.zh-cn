...
# [异地复制 (Azure SQL Database)](geo-replication-dynamic-management-views-and-functions-azure-sql-database.md)  
...
# [与安全相关](security-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [与服务器相关](server-related-dynamic-management-views-and-functions-transact-sql.md)  
