# [概述](system-dynamic-management-views.md)  

# [Always On 可用性组](always-on-availability-groups-dynamic-management-views-functions.md)  
...
# [公共语言运行时](common-language-runtime-related-dynamic-management-views-transact-sql.md)  
...
# [数据库](database-related-dynamic-management-views-transact-sql.md)  
...
## [sys.dm_db_objects_impacted_on_version_change（Azure SQL 数据库）](sys-dm-db-objects-impacted-on-version-change-azure-sql-database.md)  
...
## [sys.dm_db_wait_stats（Azure SQL 数据库）](sys-dm-db-wait-stats-azure-sql-database.md)  
## [sys.dm_operation_status（Azure SQL 数据库）](sys-dm-operation-status-azure-sql-database.md)  
## [sys.dm_database_copies（Azure SQL 数据库）](sys-dm-database-copies-azure-sql-database.md)  
## [sys.dm_db_resource_stats（Azure SQL 数据库）](sys-dm-db-resource-stats-azure-sql-database.md)  
...
# [执行](execution-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [扩展事件](extended-events-dynamic-management-views.md)  
## [sys.dm_xe_database_sessions（Azure SQL 数据库）](sys-dm-xe-database-sessions-azure-sql-database.md)  
## [sys.dm_xe_database_session_targets（Azure SQL 数据库）](sys-dm-xe-database-session-targets-azure-sql-database.md)  
## [sys.dm_xe_database_session_object_columns（Azure SQL 数据库）](sys-dm-xe-database-session-object-columns-azure-sql-database.md)  
## [sys.dm_xe_database_session_events（Azure SQL 数据库）](sys-dm-xe-database-session-events-azure-sql-database.md)  
## [sys.dm_xe_database_session_event_actions（Azure SQL 数据库）](sys-dm-xe-database-session-event-actions-azure-sql-database.md)  
...
# [文件流和 FileTable](filestream-and-filetable-dynamic-management-views-transact-sql.md)  
...
# [全文搜索和语义搜索](full-text-and-semantic-search-dynamic-management-views-functions.md)  
...
# [异地复制（Azure SQL 数据库）](geo-replication-dynamic-management-views-and-functions-azure-sql-database.md)  
## [sys.geo_replication_links（Azure SQL 数据库）](sys-geo-replication-links-azure-sql-database.md)  
## [sys.dm_geo_replication_link_status（Azure SQL 数据库）](sys-dm-geo-replication-link-status-azure-sql-database.md)  
## [sys.dm_continuous_copy_status（Azure SQL 数据库）](sys-dm-continuous-copy-status-azure-sql-database.md)  
...
# [内存优化表](memory-optimized-table-dynamic-management-views-transact-sql.md)  
...
# [对象](object-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [复制](replication-related-dynamic-management-views-transact-sql.md)  
...
# [资源调控器](resource-governor-related-dynamic-management-views-transact-sql.md)  
...
# [安全相关](security-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [服务器相关](server-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [SQL 数据仓库和并行数据仓库](sql-and-parallel-data-warehouse-dynamic-management-views.md)  
...
# [SQL Server 操作系统](sql-server-operating-system-related-dynamic-management-views-transact-sql.md)  
...
# [中的](transaction-related-dynamic-management-views-and-functions-transact-sql.md)  
