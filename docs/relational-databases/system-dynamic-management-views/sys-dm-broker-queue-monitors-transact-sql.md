---
title: sys.dm_broker_queue_monitors (TRANSACT-SQL) |Microsoft 文档
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
ms.reviewer: ''
...
|**状态**|**nvarchar(32)**|此监视器的状态。 可以为 NULL。 这是以下之一：<br /><br /> **非活动状态**<br /><br /> **通知**<br /><br /> **RECEIVES_OCCURRING**|  
...
|**tasks_waiting**|**int**|当前正在 RECEIVE 语句中等待此队列的会话数。 可以为 NULL。<br /><br /> 注意： 此数字包括执行接收语句，而不管是否队列监视器启动会话任何会话。 它表示您是否与 RECEIVE 一起使用 WAITFOR。 基本上，这些任务都在等待到达队列的消息。|  
