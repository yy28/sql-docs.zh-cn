...
> [!NOTE]  
>  若要从[!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)]或[!INCLUDE[ssPDW](../../includes/sspdw-md.md)]调用此，请使用名称**dm_pdw_nodes_os_memory_pools**。  
...
|**路径名**|**nvarchar(256)**|系统为此内存对象分配的名称。 不可为 null。|  
