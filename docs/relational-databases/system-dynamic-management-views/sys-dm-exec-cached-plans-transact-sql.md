...
|refcounts|**int**|引用该缓存对象的缓存对象数。 若要在缓存中输入， **Refcounts**必须至少为1。|  
...
|cacheobjtype|**nvarchar （34）**|缓存中的对象类型。 该值可以是以下值之一：<br /><br /> Compiled Plan<br /><br /> Compiled Plan Stub<br /><br /> Parse Tree<br /><br /> Extended Proc<br /><br /> CLR Compiled Func<br /><br /> CLR Compiled Proc|  
