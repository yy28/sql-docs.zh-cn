...
> [!NOTE]
> 在的[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]未来版本中将删除以下列： **row_count**。 应避免在新的开发工作中使用该列，并着手修改当前使用该列的应用程序。  
...
|**路径名**|**nvarchar(4000)**|执行该分配的共享内存缓冲区的名称。|  
