---
description: 与数据库有关的动态管理视图 (Transact-SQL)
...
:::row:::
    ...
    :::column:::
        ...
        [dm_db_objects_impacted_on_version_change &#40;Azure SQL 数据库&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-db-objects-impacted-on-version-change-azure-sql-database.md)
    :::column-end:::
:::row-end:::
