---
title: sys.dm_os_memory_cache_entries (Transact SQL) |Microsoft 文档
ms.custom: ''
ms.date: 08/18/2017
ms.prod: sql
ms.reviewer: ''
...
> [!NOTE]  
>  若要从我们称之为[!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)]或[!INCLUDE[ssPDW](../../includes/sspdw-md.md)]，使用名称**sys.dm_pdw_nodes_os_memory_cache_entries**。  
