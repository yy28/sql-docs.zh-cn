...
|**路径名**|**sysname**|审核的名称。 与**server_audits sys.databases**目录视图中的**name**字段相同。|  
|**状态值**|**smallint**|服务器审核的数值状态：<br /><br /> 0 = 未启动<br /><br /> 1 =<br />        已启动<br /><br /> 2 =<br />      运行时失败<br /><br /> 3 = 目标创建失败<br /><br /> 4 = 正在关闭|  
