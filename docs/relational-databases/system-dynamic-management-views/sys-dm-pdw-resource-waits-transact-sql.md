...
|类型|**nvarchar(255)**|等待此条目表示的类型。|可能的值：<br /><br /> 连接<br /><br /> 本地查询并发<br /><br /> 分布式的查询并发<br /><br /> DMS 并发<br /><br /> 备份的并发|  
|object_type|**nvarchar(255)**|通过在等待受影响的对象类型。|可能的值：<br /><br /> **对象**<br /><br /> **DATABASE**<br /><br /> **系统**<br /><br /> **SCHEMA**<br /><br /> **应用程序**|  
