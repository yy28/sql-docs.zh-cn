...
|**xusertype**|**int**|用户定义的扩展的数据类型的 ID。 如果数据类型的数字超过 32,767，则溢出或返回 NULL。|  
|**长度**|**int**|从最大物理存储长度**sys**。**类型**。|  
|**xprec**|**tinyint**|[!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]|  
|**xscale**|**tinyint**|[!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]|  
|**列 id**|**int**|列 ID 或参数 ID。|  
...
|**usertype**|**int**|从用户定义数据类型的 ID **sys.types**。 如果数据类型的数字超过 32,767，则溢出或返回 NULL。|  
|**printfmt**|**varchar(255)**|[!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]|  
|**prec**|**int**|此列的精度级别。<br /><br /> -1 = **xml**或大值类型。|  
