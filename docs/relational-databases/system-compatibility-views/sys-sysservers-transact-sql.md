...
|**collation**|**sysname**|如所设置的服务器排序规则**sp_serveroption@collation名称**。|  
|**nonsqlsub**|bit|0 = 服务器是的一个实例 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]<br /><br /> 1 = 不是实例的服务器。 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
