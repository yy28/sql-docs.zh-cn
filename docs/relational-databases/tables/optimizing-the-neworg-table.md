...
---
# 优化 NewOrg 表
在[使用现有层次结构数据填充表](../../relational-databases/tables/populating-a-table-with-existing-hierarchical-data.md)任务中创建的 **NewOrd** 表包含所有雇员的信息，该表使用 **hierarchyid** 数据类型表示层次结构。 此任务添加了新的索引，以便支持对“hierarchyid”列的搜索。  
