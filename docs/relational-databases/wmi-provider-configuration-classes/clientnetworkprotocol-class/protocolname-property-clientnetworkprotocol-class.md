---
title: "ProtocolName 属性 （ClientNetworkProtocol 类） |Microsoft 文档"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]获取由指定的当前网络协议的名称[Configure Client Protocols](http://technet.microsoft.com/library/ms181035.aspx)。  
...
## <a name="property-valuereturn-value"></a>属性值/返回值  
 一个字符串值，指定当前的客户端的名称的网络协议引用[SetOrderValue 方法 （ClientNetworkProtocol 类）](http://technet.microsoft.com/library/ms179295.aspx)。  
