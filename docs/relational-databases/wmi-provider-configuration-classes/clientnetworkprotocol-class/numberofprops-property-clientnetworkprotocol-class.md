---
title: NumberOfProps 属性（ClientNetworkProtocol）
...
ms.locfileid: "73660824"
---
# <a name="numberofprops-property-clientnetworkprotocol-class"></a>NumberOfProps 属性（ClientNetworkProtocol 类）
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  获取[SetOrderValue 方法（ClientNetworkProtocol 类）](../../../relational-databases/wmi-provider-configuration-classes/clientnetworkprotocol-class/setordervalue-method-clientnetworkprotocol-class.md)指定的客户端网络协议的属性数。  
