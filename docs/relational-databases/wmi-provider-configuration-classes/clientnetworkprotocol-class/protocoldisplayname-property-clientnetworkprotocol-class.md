---
title: ProtocolDisplayName 属性 （ClientNetworkProtocol 类） |Microsoft 文档
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  获取由指定的客户端网络协议的显示名称[Configure Client Protocols](http://technet.microsoft.com/library/ms181035.aspx)。  
