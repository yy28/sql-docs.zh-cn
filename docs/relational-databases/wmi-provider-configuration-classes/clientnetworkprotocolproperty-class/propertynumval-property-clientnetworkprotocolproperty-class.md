---
description: PropertyNumVal 属性（ClientNetworkProtocolProperty 类）
...
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sqlserver.md)]
  获取 PropertyIdx 属性引用的当前属性的数值) 值 [ (ClientNetworkProtocolProperty 类 ](../../../relational-databases/wmi-provider-configuration-classes/clientnetworkprotocolproperty-class/propertyidx-property-clientnetworkprotocolproperty-class.md) 。  
