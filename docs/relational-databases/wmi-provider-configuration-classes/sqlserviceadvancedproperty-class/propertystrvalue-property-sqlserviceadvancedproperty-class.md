...
## <a name="parts"></a>部件  
 *object*  
 一个[SqlServiceAdvancedProperty 类](../../../relational-databases/wmi-provider-configuration-classes/sqlserviceadvancedproperty-class/sqlserviceadvancedproperty-class.md)表示高级的属性的对象。  
