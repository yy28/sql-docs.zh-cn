...
|*11*|SQLPBDMS 是 Polybase 数据移动服务 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]。|  
|*12*|MSSQLLaunchpad 是 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 启动板服务。|  
