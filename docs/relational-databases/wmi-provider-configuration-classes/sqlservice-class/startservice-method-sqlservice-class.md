---
title: "StartService 方法 （SqlService 类） |Microsoft 文档"
ms.custom: 
ms.date: 03/03/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]尝试将该服务放入其启动状态。  
