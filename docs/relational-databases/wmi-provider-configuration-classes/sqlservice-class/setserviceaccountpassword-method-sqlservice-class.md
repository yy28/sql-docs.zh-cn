---
title: "SetServiceAccountPassword 方法 （SqlService 类） |Microsoft 文档"
ms.custom: 
ms.date: 03/04/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]修改运行时引用的服务帐户的密码。  
