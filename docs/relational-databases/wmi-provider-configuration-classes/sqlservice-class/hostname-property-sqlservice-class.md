---
description: HostName 属性（SqlService 类）
title: 'HostName 属性 (SqlService) '
...
ms.locfileid: "88485095"
---
# <a name="hostname-property-sqlservice-class"></a>HostName 属性（SqlService 类）
