---
title: "Properties 属性 （ServerNetworkProtocolIPAddress 类） |Microsoft 文档"
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="properties-property-servernetworkprotocolipaddress-class"></a>Properties 属性（ServerNetworkProtocolIPAddress 类）
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]获取与 IP 地址关联的属性。  
