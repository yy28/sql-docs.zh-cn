---
title: "ProtocolDisplayName 属性 （ClientNetLibInfo 类） |Microsoft 文档"
ms.custom: 
ms.date: 03/03/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]获取或设置用于显示协议的名称。  
