---
description: FileName 属性（ClientNetLibInfo 类）
title: 'FileName 属性 (ClientNetLibInfo) '
...
ms.locfileid: "89523463"
---
# <a name="filename-property-clientnetlibinfo-class"></a>FileName 属性（ClientNetLibInfo 类）
