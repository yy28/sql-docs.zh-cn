---
title: "FlagName 属性 （ClientSettingsGeneralFlag 类） |Microsoft 文档"
ms.custom: 
ms.date: 03/03/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]获取标志的名称。  
