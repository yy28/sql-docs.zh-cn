---
description: CInstance 类 - InstanceName 属性
title: 'InstanceName 属性 (CInstance) '
...
ms.locfileid: "89542872"
---
# <a name="cinstance-class---instancename-property"></a>CInstance 类 - InstanceName 属性
