---
title: "InstanceName 属性 (CInstance Class) |Microsoft 文档"
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="cinstance-class---instancename-property"></a>CInstance Class-InstanceName 属性
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]获取的实例的名称[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]客户端。  
