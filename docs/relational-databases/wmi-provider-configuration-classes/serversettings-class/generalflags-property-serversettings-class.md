---
title: GeneralFlags 属性 （ServerSettings 类） |Microsoft 文档
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  获取与 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]实例关联的常规标志。  
...
## <a name="property-valuereturn-value"></a>属性值/返回值  
 一组用于指定与 [实例关联的常规标志的](../../../relational-databases/wmi-provider-configuration-classes/serversettingsgeneralflag-class/serversettingsgeneralflag-class.md) ServerSettingsGeneralFlag 类 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]对象。  
