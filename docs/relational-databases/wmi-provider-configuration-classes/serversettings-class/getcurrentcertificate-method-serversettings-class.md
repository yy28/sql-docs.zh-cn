...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]获取当前安全证书。  
...
## <a name="parts"></a>组成部分  
 *对象*  
 A **ServerSettings**对象，表示的实例上的服务器设置[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]。  
