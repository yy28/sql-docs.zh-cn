...
## <a name="example"></a>示例  
 ...
 执行第一个[!INCLUDE[tsql](../../includes/tsql-md.md)]（ ） 代码列表以创建示例使用的表。  
...
## <a name="see-also"></a>另请参阅  
 [管理文本和图像列"如何"主题&#40;ODBC&#41;](https://msdn.microsoft.com/library/f97333ad-e2ab-4d26-9395-741ba25f2c28)  
