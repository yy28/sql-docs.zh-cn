...
4.  对[SQLFetch](https://go.microsoft.com/fwlink/?LinkId=58401)或[SQLFetchScroll](../../../relational-databases/native-client-odbc-api/sqlfetchscroll.md)的每个调用都会检索 R 行并将数据传输到绑定列中。  
...
3.  对于结果集中的每个列，调用[SQLBindCol](../../../relational-databases/native-client-odbc-api/sqlbindcol.md)将列的数据值和数据长度指针指向步骤 1 中分配的结构数组的第一个元素中的变量。  
  
4.  执行语句。  
  
5.  对[SQLFetch](https://go.microsoft.com/fwlink/?LinkId=58401)或[SQLFetchScroll](../../../relational-databases/native-client-odbc-api/sqlfetchscroll.md)的每个调用都会检索 R 行并将数据传输到绑定列中。  
  
## <a name="see-also"></a>另请参阅  
 [使用光标操作主题&#40;ODBC&#41;](../../../relational-databases/native-client-odbc-how-to/cursors/using-cursors-how-to-topics-odbc.md)   
 [游标的实现方式](../../../relational-databases/native-client-odbc-cursors/implementation/how-cursors-are-implemented.md)   
