...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 有关演示此功能的示例应用程序，请参阅[处理返回代码和输出参数&#40;ODBC&#41;](../../relational-databases/native-client-odbc-how-to/running-stored-procedures-process-return-codes-and-output-parameters.md)。  
...
3.  使用[SQLExecDirect](https://go.microsoft.com/fwlink/?LinkId=58399)执行语句。  
