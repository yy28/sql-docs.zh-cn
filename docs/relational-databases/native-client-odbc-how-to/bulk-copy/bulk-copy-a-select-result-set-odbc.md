---
title: 批量复制 SELECT 结果集 （ODBC） |微软文档
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
5.  调用[bcp_control](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-control.md)，将 eOption 设置为 BCPHINTS，并将指向包含 SELECT 语句的 SQLTCHAR 数组的指针放在 iValue 中。  
  
6.  调用[bcp_exec](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-exec.md)以执行批量复制操作。  

 按以上步骤操作时文件是以本机格式创建的。 可以使用[bcp_colfmt](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-colfmt.md)将数据值转换为其他数据类型。 有关详细信息，请参阅[创建批量复制格式文件&#40;ODBC&#41;](../../../relational-databases/native-client-odbc-how-to/bulk-copy/create-a-bulk-copy-format-file-odbc.md)。  
