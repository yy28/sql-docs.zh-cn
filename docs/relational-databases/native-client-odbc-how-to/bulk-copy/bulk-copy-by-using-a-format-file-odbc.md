...
5.  调用[bcp_readfmt](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-readfmt.md)读取描述要由批量复制操作使用的数据文件的格式文件。  
...
## <a name="example"></a>示例  
 ...
 执行第五个[!INCLUDE[tsql](../../../includes/tsql-md.md)]（ ） 代码列表以删除示例使用的表。  
