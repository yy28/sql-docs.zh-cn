---
title: 如何： 将行插入到 Geography 列 (ODBC) |Microsoft 文档
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]
 ...
 空间存储有关的详细信息，请参阅[空间数据&#40;SQL Server&#41;](../../relational-databases/spatial/spatial-data-sql-server.md)。  
