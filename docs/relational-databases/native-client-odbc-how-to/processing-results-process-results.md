...
ms.locfileid: "32942272"
---
# <a name="processing-results---process-results"></a>处理结果的过程结果
...
4.  当 [SQLFetch](http://go.microsoft.com/fwlink/?LinkId=58401) 通过返回 SQL_NO_DATA 指示到达结果集末尾时，调用 [SQLMoreResults](../../relational-databases/native-client-odbc-api/sqlmoreresults.md) 确定是否有其他可用结果集。  
...
> [!NOTE]  
>  若要在 [SQLFetch](http://go.microsoft.com/fwlink/?LinkId=58401) 返回 SQL_NO_DATA 之前取消处理结果集，请调用 [SQLCloseCursor](../../relational-databases/native-client-odbc-api/sqlclosecursor.md)。  
  
## <a name="see-also"></a>另请参阅  
[检索结果集信息 & #40; ODBC & #41;](../../relational-databases/native-client-odbc-how-to/processing-results-retrieve-result-set-information.md)   
