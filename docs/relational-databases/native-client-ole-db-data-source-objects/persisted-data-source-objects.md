---
description: SQL Server Native Client 中的持久化数据源对象
title: '持久性数据源对象 (Native Client OLE DB 提供程序) '
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88381473"
---
# <a name="persisted-data-source-objects-in-sql-server-native-client"></a>SQL Server Native Client 中的持久化数据源对象 
