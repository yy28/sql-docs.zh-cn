...
## <a name="in-this-section"></a>本节内容  
 ...
 [新的日期和时间与以前的 SQL Server 版本的功能&#40;OLE DB&#41;](../../relational-databases/native-client-ole-db-date-time/new-date-and-time-features-with-previous-sql-server-versions-ole-db.md)  
