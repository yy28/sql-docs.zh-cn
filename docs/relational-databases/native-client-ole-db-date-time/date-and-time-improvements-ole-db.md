...
ms.locfileid: "73772811"
---
# <a name="date-and-time-improvements-ole-db"></a>日期和时间改进 (OLE DB)
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 引入了新的日期和时间数据类型。 本部分介绍如何将这些新类型公开为 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client 中的扩展。 有关对新日期和时间数据类型的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client 支持的概述，请参阅[日期和时间改进](../../relational-databases/native-client/features/date-and-time-improvements.md)。 有关示例，请参阅[使用增强的日期和时间&#40;功能&#41;OLE DB](../../relational-databases/native-client-ole-db-how-to/use-enhanced-date-and-time-features-ole-db.md)。  
...
## <a name="in-this-section"></a>本节内容  
 ...
 提供有关支持 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 日期和时间数据类型的 OLE DB （[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client）类型的信息。  
 ...
 [OLE DB 和 ODBC 的增强日期和时间类型&#40;的大容量复制更改&#41;](../../relational-databases/native-client-odbc-date-time/bulk-copy-changes-for-enhanced-date-and-time-types-ole-db-and-odbc.md)  
 ...
 [具有以前 SQL Server 版本&#40;的新的日期和时间功能 OLE DB&#41;](../../relational-databases/native-client-ole-db-date-time/new-date-and-time-features-with-previous-sql-server-versions-ole-db.md)  
