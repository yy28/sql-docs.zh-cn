...
-   显示 SQLNCLI11 错误的错误处理。  
 ...
 有关表值参数的详细信息，请参阅[&#40;SQL Server 本机客户端&#41;的表值参数](../../relational-databases/native-client/features/table-valued-parameters-sql-server-native-client.md)。  
