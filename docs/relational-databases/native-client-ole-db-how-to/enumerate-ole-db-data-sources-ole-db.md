---
title: 枚举 OLE DB 数据源（Native Client OLE DB 提供程序） |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "87247856"
---
# <a name="enumerate-sql-server-native-client-ole-db-data-sources-ole-db"></a>枚举数据源 OLE DB SQL Server Native Client （OLE DB）
