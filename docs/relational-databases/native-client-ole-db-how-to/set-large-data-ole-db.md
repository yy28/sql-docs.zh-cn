---
description: '设置大型数据 (Native Client OLE DB 提供程序) '
title: '设置大型数据 (Native Client OLE DB 提供程序) '
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "91867609"
---
# <a name="set-large-data-native-client-ole-db-provider"></a>设置大型数据 (Native Client OLE DB 提供程序) 
