---
description: '从结果集中提取行 (Native Client OLE DB 提供程序) '
title: 从结果集中提取行 (Native Client OLE DB 提供程序) |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "91867639"
---
# <a name="fetch-rows-from-a-result-set-native-client-ole-db-provider"></a>从结果集中提取行 (Native Client OLE DB 提供程序) 
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]

  此示例显示如何从结果集中提取行。 IA64 平台不支持此示例。  
