---
description: " (Native Client OLE DB 提供程序的集成 Kerberos 身份验证) "
title: 集成的 Kerberos 身份验证 (Native Client OLE DB 提供程序) |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88455680"
---
# <a name="integrated-kerberos-authentication-native-client-ole-db-provider"></a> (Native Client OLE DB 提供程序的集成 Kerberos 身份验证) 
[!INCLUDE[SQL Server Azure SQL Database Synapse Analytics PDW ](../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]
 ...
 有关 SPN 和 Kerberos 身份验证的详细信息，请参阅[客户端连接中的服务主体名称 (SPN) 支持](../../relational-databases/native-client/features/service-principal-name-spn-support-in-client-connections.md)。  
