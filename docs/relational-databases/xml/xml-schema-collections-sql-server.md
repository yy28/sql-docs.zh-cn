...
-   [ALTER XML SCHEMA COLLECTION (Transact-SQL)](../../t-sql/statements/alter-xml-schema-collection-transact-sql.md) 修改现有 XML 架构集合中的架构组件。  
  
-   [DROP XML SCHEMA COLLECTION (Transact-SQL)](../../t-sql/statements/drop-xml-schema-collection-transact-sql.md) 删除整个 XML 架构集合及其所有组件。  
 ...
 若要删除架构集合，请使用 DROP XML SCHEMA COLLECTION 语句。 它将删除包含在集合中的所有架构并删除集合对象。 请注意，只有在满足 [DROP XML SCHEMA COLLECTION (Transact-SQL)](../../t-sql/statements/drop-xml-schema-collection-transact-sql.md) 中所述的条件时，才能删除架构集合。  
...
-   [拒绝对 XML 架构集合的权限](../../relational-databases/xml/deny-permissions-on-an-xml-schema-collection.md)  
