...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]此示例说明如何在使用 EXPLICIT 模式的 `SELECT` 语句中使用 XMLTEXT 指令处理溢出列中的数据。  
