...
# [对 XML 列创建视图](create-views-over-xml-columns.md)
...
# [示例：检索雇员信息](example-retrieving-employee-information.md)
...
# [撤消对 XML 架构集合的权限](revoke-permissions-on-an-xml-schema-collection.md)
