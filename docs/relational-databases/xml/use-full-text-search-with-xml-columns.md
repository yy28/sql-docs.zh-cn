...
description: 了解如何使用 SQL 对 XML 列创建全文检索并对 XML 值执行全文搜索。
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
...
## <a name="example-full-text-search-on-xml-values-using-stemming"></a>示例：使用词干分解对 XML 值进行全文搜索  
