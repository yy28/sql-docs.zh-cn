...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]下面的查询包括 xml 类型的列。 该查询从 `Instructions` xml **类型的** 列的第一个位置检索产品型号 ID、名称和生产步骤。  
