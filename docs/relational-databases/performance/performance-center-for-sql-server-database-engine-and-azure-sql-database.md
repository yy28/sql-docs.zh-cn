...
|**Azure 虚拟机中的数据库引擎性能**|![security-center-sqlserver](../../relational-databases/performance/media/security-center-sqlserver.png "security-center-sqlserver") [快速检查列表](https://docs.microsoft.com/aspnet/core/performance/performance-best-practices)<br />![security-center-sqlserver](../../relational-databases/performance/media/security-center-sqlserver.png "security-center-sqlserver") [虚拟机大小和存储帐户注意事项](https://docs.microsoft.com/aspnet/core/performance/performance-best-practices)<br />![security-center-sqlserver](../../relational-databases/performance/media/security-center-sqlserver.png "security-center-sqlserver") [磁盘和性能注意事项](https://docs.microsoft.com/aspnet/core/performance/performance-best-practices)<br />![security-center-sqlserver](../../relational-databases/performance/media/security-center-sqlserver.png "security-center-sqlserver") [I/O 性能注意事项](https://docs.microsoft.com/aspnet/core/performance/performance-best-practices)<br />![security-center-sqlserver](../../relational-databases/performance/media/security-center-sqlserver.png "security-center-sqlserver") [功能特定的性能注意事项](https://docs.microsoft.com/aspnet/core/performance/performance-best-practices)| 
...
## <a name="see-also"></a>另请参阅  
 ...
 [SQL Server 事务锁定和行版本控制指南](https://docs.microsoft.com/sql/relational-databases/sql-server-transaction-locking-and-row-versioning-guide)  
