...
helpviewer_keywords: 
  ...
  - "监视服务器性能 [SQL Server]"
  - "数据库引擎 [SQL Server], 性能"
  - "监视性能 [SQL Server], 关于性能"
  - "服务器性能 [SQL Server]"
  - "监视性能 [SQL Server]"
  - "数据库性能 [SQL Server], 关于性能"
  - "优化数据库 [SQL Server], 关于性能"
  - "状态信息 [SQL Server], 性能监视"
  - "数据库监视 [SQL Server], 关于性能"
  - "监视 [SQL Server], 查询性能"
  - "服务器性能 [SQL Server], 关于性能"
  - "优化数据库 [SQL Server]"
  - "数据库性能 [SQL Server]"
  - "监视 [SQL Server], 服务器性能"
  - "数据库监视 [SQL Server]"
  - "监视服务器性能 [SQL Server], 关于监视服务器性能"
