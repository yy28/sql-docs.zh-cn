...
description: 使用这些资源来了解如何使用 SQL Server 以及 Windows 性能和活动监视工具评估服务器的性能。
ms.custom: ''
ms.date: 11/27/2018
ms.prod: sql
ms.reviewer: ''
...
-   [修改跟踪模板 (SQL Server Profiler)](../../tools/sql-server-profiler/modify-trace-templates.md)  
