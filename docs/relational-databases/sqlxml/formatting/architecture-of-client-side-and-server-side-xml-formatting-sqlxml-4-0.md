...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]下图显示了服务器端格式设置 XML 的体系的结构。  
  
 ![XML 的格式设置在服务器端体系结构。](../../../relational-databases/sqlxml/formatting/media/serversidexml.gif "体系结构的 XML 的格式设置在服务器端。")  
...
>  XPath 查询和 Updategram 将在客户端上进行分析。 若要获得 SQLXML 4.0 中的 XPath 模板或 Updategram 功能，请使用 Sqlxml4.dll。  
 ...
 ![XML 的格式设置在客户端体系结构。](../../../relational-databases/sqlxml/formatting/media/clientsidexml.gif "体系结构的 XML 的格式设置在客户端。")  
