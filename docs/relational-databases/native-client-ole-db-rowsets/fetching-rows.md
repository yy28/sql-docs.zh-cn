---
description: " (Native Client OLE DB 提供程序中提取行) "
title: OLE DB 提供程序) 提取 (Native Client 的行 |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88448352"
---
# <a name="fetching-rows-native-client-ole-db-provider"></a> (Native Client OLE DB 提供程序中提取行) 
