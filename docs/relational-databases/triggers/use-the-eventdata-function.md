...
-   激发触发器的事件类型。  
 ...
 根据事件类型，该架构还包括其他信息，例如事件在其中发生的数据库、发生事件的相关对象以及事件的 [!INCLUDE[tsql](../../includes/tsql-md.md)] 语句。 有关详细信息，请参阅 [DDL Triggers](../../relational-databases/triggers/ddl-triggers.md)。  
