...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  本主题介绍支持客户端应用程序中的服务主体名称 (SPN) 的 ODBC 属性和函数。 有关客户端应用程序中的 SPN 的详细信息，请参阅[服务主体名称&#40;SPN&#41;客户端连接中的支持](../../../relational-databases/native-client/features/service-principal-name-spn-support-in-client-connections.md)，以及[获取相互 Kerberos 身份验证](../../../relational-databases/native-client-odbc-how-to/get-mutual-kerberos-authentication.md)。  
