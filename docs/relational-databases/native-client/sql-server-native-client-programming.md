...
> [!NOTE]  
>  有关之间的差异的列表[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]本机客户端和 Windows DAC，以及有关问题的信息更新到 Windows DAC 应用程序之前要考虑[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]本机客户端，请参阅[更新到 SQL Server 的应用程序本机客户端从 MDAC](../../relational-databases/native-client/applications/updating-an-application-to-sql-server-native-client-from-mdac.md)。  
 ...
 ActiveX 数据对象 (ADO) 应用程序可能使用[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Native Client OLE DB 提供程序，但建议结合使用 ADO **DataTypeCompatibility**连接字符串关键字 （或其相应**数据源**属性)。 使用 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 访问接口时，ADO 应用程序可以通过连接字符串关键字、OLE DB 属性或 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 利用在 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 中引入的通过 [!INCLUDE[tsql](../../includes/tsql-md.md)] Native Client 提供的那些新功能。 用 ADO 这些功能使用的详细信息，请参阅[with SQL Server Native Client 中使用 ADO](../../relational-databases/native-client/applications/using-ado-with-sql-server-native-client.md)。  
