...
## <a name="in-this-section"></a>本节内容  
 ...
 讨论 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client 如何适应 Microsoft 数据访问技术，它如何与 Windows DAC 和 ADO.NET 进行比较，并提供用于决定要使用哪种数据访问技术的指针。  
