---
description: SQL Server Native Client 中的元数据发现
...
ms.locfileid: "88498907"
---
# <a name="metadata-discovery-in-sql-server-native-client"></a>SQL Server Native Client 中的元数据发现
