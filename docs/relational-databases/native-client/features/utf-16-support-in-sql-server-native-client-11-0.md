...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  从 [!INCLUDE[ssSQL11](../../../includes/sssql11-md.md)]开始，如果在绑定列结果或输出参数时提供固定长度的缓冲区，并且如果在终止字符之前写入缓冲区的**wchar**字符是代理项对的高代理项码位，则为; 如果next **wchar**字符是低代理项码位，[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 将不会向缓冲区添加高代理项码位。  
