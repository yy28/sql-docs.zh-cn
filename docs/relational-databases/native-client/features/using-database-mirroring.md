---
description: 在 SQL Server Native Client 中使用数据库镜像
...
ms.locfileid: "88448269"
---
# <a name="using-database-mirroring-in-sql-server-native-client"></a>在 SQL Server Native Client 中使用数据库镜像
