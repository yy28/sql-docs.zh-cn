...
## <a name="in-this-section"></a>本节内容  
 ...
 讨论本机客户端[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]如何支持使用镜像数据库，即在备用服务器上保留[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]数据库的副本或镜像的功能。  
 ...
 讨论本机客户端[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]如何支持用户定义类型 （UDT），该类型通过允许您在[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]数据库中存储对象和自定义数据结构来扩展 SQL 类型系统。  
 ...
 讨论本机客户端[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]如何支持允许将大量数据传输到[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]表或视图中或移出的批量复制操作。  
 ...
 [&#40;SQL 服务器本机客户端&#41;表值参数](../../../relational-databases/native-client/features/table-valued-parameters-sql-server-native-client.md)  
 ...
 讨论[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]对增强的 FILESTREAM 功能的本机客户端支持。  
 ...
 讨论 [!INCLUDE[ssSQL11](../../../includes/sssql11-md.md)] 中引入的行为更改。 如果在绑定列结果或输出参数时提供固定长度缓冲区，并且在终止字符之前写入缓冲区的**wchar**字符是代理项对的高代理项代码点，并且下一个**wchar**字符是低代理代码点，[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]则本机客户端将不会向缓冲区添加高代理项代码点。  
...
## <a name="see-also"></a>另请参阅  
 ...
 [OLE DB 如何使用主题](../../../relational-databases/native-client-ole-db-how-to/ole-db-how-to-topics.md)   
