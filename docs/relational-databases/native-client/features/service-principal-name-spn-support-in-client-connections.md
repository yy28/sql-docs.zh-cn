...
|MSSQLSvc/*fqdn*:*InstanceName*|使用除 TCP 之外的协议时访问接口生成的用于命名实例的默认 SPN。<br /><br /> InstanceName 为  *实例名*[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]。|  
