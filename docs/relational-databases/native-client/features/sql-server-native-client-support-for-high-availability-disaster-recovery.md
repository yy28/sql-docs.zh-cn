...
-   **SQL_COPT_SS_MULTISUBNET_FAILOVER**  
 ...
 从 ** 开始，将在使用 ** Native Client 驱动程序的 DSN 的 ODBC 数据源管理器中公开 **ApplicationIntent** 和 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]MultiSubnetFailover[!INCLUDE[ssSQL11](../../../includes/sssql11-md.md)] 关键字的功能。  
 ...
 **IDataInitialize：： GetDataSource**采用可包含**Application 意向**关键字的输入连接字符串。  
  
 **IDBProperties::GetProperties**  
 **IDBProperties：： GetProperties**检索当前为数据源设置的属性的值。  可以通过 DBPROP_INIT_PROVIDERSTRING 属性和 SSPROP_INIT_APPLICATIONINTENT 属性检索 **Application Intent** 值。  
