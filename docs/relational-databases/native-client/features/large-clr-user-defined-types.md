---
description: SQL Server Native Client 中的大型 CLR 用户定义类型
...
ms.locfileid: "88498915"
---
# <a name="large-clr-user-defined-types-in-sql-server-native-client"></a>SQL Server Native Client 中的大型 CLR 用户定义类型
