...
ms.locfileid: "37408666"
---
# <a name="stored-procedures---calling"></a>存储的过程-调用
...
### <a name="transact-sql-execute-statement"></a>Transact-SQL EXECUTE 语句  
 ODBC CALL 转义序列和 RPC 转义序列是首选的方法为调用存储的过程而非[EXECUTE](../../../t-sql/language-elements/execute-transact-sql.md)语句。 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client OLE DB 提供程序使用的 RPC 机制[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]优化命令处理。 此 RPC 协议通过避免在服务器上进行大量参数处理和语句分析来提高性能。  
