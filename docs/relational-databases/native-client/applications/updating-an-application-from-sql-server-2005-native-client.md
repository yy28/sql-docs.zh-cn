...
|sp_columns**** 存储过程现在返回“否”****，而不是为 IS_NULLABLE 列返回“否”****。|[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]从 Native Client[!INCLUDE[ssKatmai](../../../includes/sskatmai-md.md)]10.0 （）开始， **sp_columns**存储过程现在为 IS_NULLABLE 列返回 **"no"** ，而不是 **"否"** 。|  
