...
你还可以从 SQL Server 2012 功能包网页获取 sqlncli.msi。 若要下载最新版本的 SQL Server Native Client，请参阅[Microsoft® SQL Server®2012功能包](https://www.microsoft.com/download/confirmation.aspx?id=29065)。 如果计算机上还安装了以前版本的 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 之前 SQL Server 2012，[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 11.0 将与早期版本并行安装。  
  
 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 文件（sqlncli11.dll、sqlnclir11.rll 和 s11ch_sqlncli.chm）将安装到以下位置：{2}  
  
 `%SYSTEMROOT%\system32\`  
  
> [!NOTE]  
>  [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client OLE DB 访问接口和 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client ODBC 驱动程序的所有相应注册表设置都将在安装过程中完成。{3}  
  
 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 头文件和库文件（sqlncli.h 和 sqlncli11.lib）安装在以下位置：{2}  
...
## <a name="uninstalling-sql-server-native-client"></a>卸载 SQL Server Native Client  
 由于 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] server 和 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 工具之类的应用程序依赖于 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client，因此在卸载所有从属应用程序之前，不要卸载 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client。 若要向提供者用户提供应用程序依赖 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 的警告，请使用 MSI 中的 APPGUID 安装选项，如下所示：  
