...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 没有 SQL Server 2016 本机客户端。 有关详细信息，请参阅 [SQL Server Native Client](../../../relational-databases/native-client/sql-server-native-client.md)。 
 
你还可以从 SQL Server 2012 功能包网页获取 sqlncli.msi。 要下载最新版本的 SQL Server 本机客户端，请转到[Microsoft® SQL Server® 2012 功能包](https://www.microsoft.com/download/confirmation.aspx?id=29065)。 如果计算机上也安装了早于[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]SQL Server 2012 的早期版本，[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]则本机客户端 11.0 将与早期版本并行安装。  
...
>   Native Client OLE DB 访问接口和  Native Client ODBC 驱动程序的所有相应注册表设置都将在安装过程中完成。  
 ...
 在调用 sqlncli.msi 时，默认情况下只会安装客户端组件。 客户端组件是支持运行使用[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]本机客户端开发的应用程序的文件。 若还要安装 SDK 组件，请在命令行中指定 `ADDLOCAL=All`。 例如：  
...
## <a name="uninstalling-sql-server-native-client"></a>卸载 SQL Server Native Client  
 由于[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]服务器和[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]工具等应用程序依赖于[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]本机客户端，因此在卸载所有从属应用程序之前，不要[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]卸载本机客户端非常重要。 对于具有应用程序依赖于[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]本机客户端的警告的提供程序用户，请在 MSI 中使用 APPGUID 安装选项，如下所示：  
...
## <a name="see-also"></a>另请参阅  
 [使用 SQL Server 本机客户端构建应用程序](../../../relational-databases/native-client/applications/installing-sql-server-native-client.md)   
