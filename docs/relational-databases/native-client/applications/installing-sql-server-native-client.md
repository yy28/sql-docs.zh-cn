...
ms.locfileid: "49071681"
---
# <a name="installing-sql-server-native-client"></a>安装 SQL Server Native Client
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 > 有关与以前版本的 SQL Server 相关的内容，请参阅[安装 SQL Server Native Client](installing-sql-server-native-client.md)。
...
你还可以从 SQL Server 2012 功能包网页获取 sqlncli.msi。 若要下载 SQL Server Native Client 的最新版本，请转到[Microsoft® SQL Server® 2012年功能包](http://www.microsoft.com/en-us/download/confirmation.aspx?id=29065)。 如果以前版本的[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]早于的计算机上，也安装 SQL Server 2012 Native Client [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 11.0 将与早期版本并行安装。  
