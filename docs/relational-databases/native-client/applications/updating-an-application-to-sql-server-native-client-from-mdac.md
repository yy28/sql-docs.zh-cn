...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 本主题中的信息有助于将您的 MDAC（或 Windows DAC）应用程序更新到 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 中附带的 [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] Native Client 版本。 若要帮助你使此应用程序与 [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)]附带的 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 的版本最新，请参阅[从 SQL Server 2005 Native Client 更新应用程序](../../../relational-databases/native-client/applications/updating-an-application-from-sql-server-2005-native-client.md)。  
...
-   [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 不包含 XML 集成。 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 支持 SELECT .。。FOR XML 查询，但不支持任何其他 XML 功能。 但 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 支持 [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)]中引入的**xml**数据类型。  
...
-   [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 与 odbcbcp.dll 不兼容。 若要使用 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client，必须重新生成同时使用 ODBC 和**bcp** api 的应用程序以与 sqlncli11 链接。  
...
-   [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 的错误检查比 MDAC 更为严格，也就是说，某些不严格遵从 ODBC and OLE DB 规范的应用程序的行为可能有所不同。 例如，SQLOLEDB 提供程序未强制执行结果参数的参数名称必须以 "\@" 开头的规则，但 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client OLE DB 提供程序将执行此操作。  
...
-   数据类型**varchar （max）** 、 **nvarchar （max）** 、 **varbinary （max）** 、 **xml**、 **udt**或其他大型对象类型的返回值不能返回到低于 [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)]的客户端版本。 如果希望将这些类型用作返回值，则必须使用 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client。  
...
-   MDAC 应用程序连接到 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 时，[!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] 中引入的数据类型将显示为与 [!INCLUDE[ssVersion2000](../../../includes/ssversion2000-md.md)] 兼容的数据类型，如下表所示。  
    ...
    |**xml**|**ntext**|  
     ...
     此类型映射会影响为列元数据返回的值。 例如， **text**列的最大大小为2147483647，但 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] NATIVE client ODBC 将**varchar （max）** 列的最大大小报告为 SQL_SS_LENGTH_UNLIMITED，[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] native client OLE DB 报告最大大小**varchar （max）** 列作为2147483647或-1，具体取决于平台。  
...
-   将 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 驱动程序与 system.exception 一起使用时，可能会遇到错误，以访问公开新的、[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]特定的数据类型或功能的 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 服务器计算机。 System.exception 提供通用 ODBC 实现，随后不公开特定于供应商的功能或扩展。 （[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 驱动程序已更新为本机支持最新 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 功能。）若要解决此问题，可以还原到 MDAC 或迁移到 SqlClient。  
