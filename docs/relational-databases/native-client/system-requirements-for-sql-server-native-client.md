...
## <a name="operating-system-requirements"></a>操作系统要求  
 有关支持 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client 的操作系统的列表，请参阅[SQL Server Native Client 的支持策略](../../relational-databases/native-client/applications/support-policies-for-sql-server-native-client.md)。  
