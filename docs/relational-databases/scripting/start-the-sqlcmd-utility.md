...
1.  打开“命令提示符”窗口，键入 **sqlcmd -S***myServer\instanceName*。 使用计算机名称和要连接的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的实例替换 *myServer\instanceName*。  
...
## 另请参阅  
 [使用 sqlcmd 运行 Transact-SQL 脚本文件](../../relational-databases/scripting/run-transact-sql-script-files-using-sqlcmd.md)  
