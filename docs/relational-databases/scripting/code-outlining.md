...
ms.topic: "article"
helpviewer_keywords: 
  - "查询编辑器 [SQL Server Management Studio], 大纲代码"
  - "查询编辑器 [SQL Server Management Studio], 隐藏代码"
...
### Analysis Services XMLA 查询编辑器区域  
 ...
 ![显示大纲的 XML 代码](../../relational-databases/scripting/media/editoutlinexmlfull.gif "显示大纲的 XML 代码")  
  
 单击 \<InnerTag> 行上的减号时，只有 InnerTag 才会折叠起来，如下图所示。  
  
 ![隐藏内部节点的 XML 代码](../../relational-databases/scripting/media/editoutlinexmlinnercol.png "隐藏内部节点的 XML 代码")  
  
 将指针移动到含有三个句点 ( ) 的框上方时，折叠区域中的代码将出现在工具提示中，如下图所示。  
  
 ![带有显示隐藏代码的工具提示的 XML 代码](../../relational-databases/scripting/media/editoutlinexmlmouse.gif "带有显示隐藏代码的工具提示的 XML 代码")  
  
 单击 \<MiddleTag> 行上的减号时，MiddleTag 和 InnerTag 均折叠起来，如下图所示。  
  
 ![隐藏内部和中间标记的 XML 代码](../../relational-databases/scripting/media/editoutlinexmlmiddlecol.png "隐藏内部和中间标记的 XML 代码")  
  
 单击 \<OuterTag> 行上的减号时，所有三行均折叠起来，如下图所示。  
  
 ![显示所有三个隐藏标记的 XML 代码](../../relational-databases/scripting/media/editoutlinexmloutercol.png "显示所有三个隐藏标记的 XML 代码")  
