---
title: "更改字体颜色、大小和样式 | Microsoft Docs"
ms.custom: 
ms.date: 03/01/2017
...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]可以自定义文本在编辑器和 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 的其他位置的显示方式。  
...
## <a name="see-also"></a>另请参阅  
 [打印代码和结果](../../relational-databases/scripting/print-code-and-results.md)   
