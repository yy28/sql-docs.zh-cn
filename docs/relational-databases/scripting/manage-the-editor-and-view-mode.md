...
ms.topic: "article"
helpviewer_keywords: 
  - "查询编辑器 [SQL Server Management Studio], 管理窗口行为"
  - "工作区视图模式 [SQL Server Management Studio]"
  - "全屏模式 [SQL Server Management Studio]"
  - "字体 [SQL Server Management Studio]"
  - "换行 [SQL Server Management Studio]"
  - "虚拟空间模式 [SQL Server Management Studio]"
  - "拆分文档视图"
  - "显示行号"
  - "视图模式 [SQL Server Management Studio]"
