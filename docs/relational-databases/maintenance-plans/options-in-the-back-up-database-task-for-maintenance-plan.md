 ...
 **备份日志尾部，并使数据库处于还原状态**  
 在还原数据库前，执行作为最后一个步骤的日志备份。 有关详细信息，请参阅[结尾日志备份 (SQL Server)](../../relational-databases/backup-restore/tail-log-backups-sql-server.md)。  
