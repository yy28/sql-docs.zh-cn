---
title: 类型属性 （密钥） (ADOX) |Microsoft 文档
ms.prod: sql
...
ms.author: genemi
manager: craigg
ms.openlocfilehash: 98cdadee63c117eb9a0fe0eb1131afa0933bd72f
ms.sourcegitcommit: 2ddc0bfb3ce2f2b160e3638f1c2c237a898263f4
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/03/2018
---
# <a name="type-property-key-adox"></a>类型属性 （密钥） (ADOX)
指示键的类型。  
  
## <a name="settings-and-return-values"></a>设置和返回值  
 设置或返回**长**值可以是之一[KeyTypeEnum](../../../ado/reference/adox-api/keytypeenum.md)常量。 默认值是**adKeyPrimary**。  
