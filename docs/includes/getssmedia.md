...
ms.locfileid: "68185302"
---
[!INCLUDE[ssnoversion](ssnoversion-md.md)] 的下载位置由版本决定：
...
* 以下链接提供了“免费版本”：[SQL Server 下载](https://www.microsoft.com/sql-server/sql-server-downloads)  。