...
##  <a name="DataProfiling"></a>复合域的数据事件探查  
 ...
 有关清理活动期间的数据事件探查的详细信息，请参阅[使用 DQS（内部）知识清理数据](../data-quality-services/cleanse-data-using-dqs-internal-knowledge.md#Profiler)中的[事件探查器统计信息](../data-quality-services/cleanse-data-using-dqs-internal-knowledge.md)。  
