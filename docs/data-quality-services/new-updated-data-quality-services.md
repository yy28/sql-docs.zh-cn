---
title: 已更新 - SQL Server Data Quality Services 文档 | Microsoft Docs
description: 显示 Microsoft SQL Server Data Quality Services 文档中最近更新内容的片段。
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "32514755"
---
# <a name="new-and-recently-updated-data-quality-services-for-sql-server"></a>新增内容和最近更新内容：SQL Server Data Quality Services
...
- 主题区域：SQL Server Data Quality Services&nbsp;。
