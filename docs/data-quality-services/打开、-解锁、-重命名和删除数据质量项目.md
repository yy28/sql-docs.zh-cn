...
4.  数据质量项目打开时的状态就是上次在其中关闭该项目的活动的状态。 数据质量项目具有以下状态：  
    ...
    -   有关 **清理** 活动，数据质量项目可以具有以下状态︰ **清理-映射**, ，**清理-清理**, ，**清理 – 管理和查看结果**, ，和 **清理 – 导出**。  
  
    -   有关 **匹配** 活动，数据质量项目可以具有以下状态︰ **匹配-映射**, ，**匹配-匹配**, ，**匹配 – 存活**, ，和 **匹配 – 导出**。  
...
3.  在 **打开项目** 屏幕，用鼠标右键单击您创建的锁定的数据质量项目，然后单击 **解锁** 的快捷菜单中。 系统将为此项目显示一个绿色对钩标记，指示项目未锁定。  
...
3.  在 **打开项目** 屏幕，用鼠标右键单击您创建一个数据质量项目，然后单击 **重命名** 的快捷菜单中。  
...
3.  在 **打开项目** 屏幕，右键单击您创建未锁定的数据质量项目，然后单击 **删除** 的快捷菜单中。  
