...
4.  在上下文菜单中，您可以执行以下操作：  
    ...
    3.  **放弃工作**：在知识库处于处理状态时单击，如表的 "状态" 字段中的条目所示。 如果知识库未处于某一活动状态中，则此命令将不可用；并且在知识库被锁定时不可用。 有关详细信息，请参阅 [Open a Knowledge Base](../data-quality-services/open-a-knowledge-base.md)。  
