...
|**新建**|显示 DQS 没有足够信息，因此不能映射到任何其他选项卡的有效域。此外，此选项卡还包含置信度小于*自动建议阈值*的值，但足以标记为有效。<br /><br /> 如果您认为值是正确的，请单击 **“批准”** 列中的单选按钮。 否则，请单击 **“拒绝”** 列中的单选按钮。 接受的值移到 "**正确**" 选项卡，被拒绝的值移到 "**无效**" 选项卡。您还可以手动键入正确的值，以替换 "**更正为**" 列中的原始值和值，然后单击 "**批准**" 列中的单选按钮以接受更改。 在此情况下，值将移到 **“已更正”** 选项卡。|  
