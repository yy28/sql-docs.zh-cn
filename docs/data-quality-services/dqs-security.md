...
|任务说明|主题|  
|----------------------|-----------|  
|介绍如何使用 SQL Server Management Studio 创建用户并授予 DQS 角色。|[在 SSMS 中管理 DQS 用户](http://msdn.microsoft.com/library/955af01d-00da-4c51-9311-f3848749df54)|  
