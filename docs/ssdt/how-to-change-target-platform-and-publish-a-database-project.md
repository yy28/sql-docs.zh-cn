...
7.  请注意 **“数据工具操作”** 窗口中的消息。 单击“创建发布预览…”右侧的“查看预览”链接  右侧的“视图预览”链接。这将打开部署预览报表。 如果项目的目标平台并不是项目所发布到的数据库服务器，则 SSDT 将在报表中发出警告。  例如，如果项目的目标平台是 Microsoft SQL Server 2012 并且正在尝试将该项目发布到某一 SQL Server 2008 R2 服务器实例，则你将会在“输出”窗口中看到以下警告  ：  
