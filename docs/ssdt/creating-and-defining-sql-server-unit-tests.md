---
title: 创建和定义 SQL Server 单元测试
description: 了解 SQL Server 单元测试。 查看相关信息，了解如何创建和运行单元测试、排查问题以及其他相关任务。
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
...
[场景：定义数据库单元测试的自定义测试条件](https://msdn.microsoft.com/library/dd193282(VS.100).aspx)  
