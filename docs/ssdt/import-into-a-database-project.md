...
有关详细信息，请参阅 [http://social.msdn.microsoft.com/Forums/en-US/ssdt/threads](http://social.msdn.microsoft.com/Forums/en-US/ssdt/threads) 中的 SSDT 团队论坛。  
