...
## 在未预安装 Visual Studio 的情况下安装 SSDT
...
> [!NOTE]
> Visual Studio 2017 中的 SSDT 数据库项目当前最多支持到 SQL Server 2016。  对 SQL Server 2017 的支持将很快在 Visual Studio 2017 更新中推出。
