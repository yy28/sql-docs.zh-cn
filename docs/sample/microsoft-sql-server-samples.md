...
若要在 GitHub 中，请转到https://github.com/microsoft/sql-server-samples和分叉存储库。 在你自己分叉中工作，并且当你准备好提交以进行更改或者首次发布您的示例，到 sql server 示例的主分支提交拉取请求。 审批者之一将查看你的请求和接受或拒绝拉取请求。
